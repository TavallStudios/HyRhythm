...
public class BuilderField<Type, FieldType> {
   ...
   protected BuilderField(@Nonnull KeyedCodec<FieldType> codec, TriConsumer<Type, FieldType, ExtraInfo> setter, BiFunction<Type, ExtraInfo, FieldType> getter, TriConsumer<Type, Type, ExtraInfo> inherit) {
      this.codec = (KeyedCodec)Objects.requireNonNull(codec, "codec parameter can't be null");
      this.setter = (TriConsumer)Objects.requireNonNull(setter, "setter parameter can't be null");
      this.getter = (BiFunction)Objects.requireNonNull(getter, "getter parameter can't be null");
      this.inherit = inherit;
      this.validators = null;
      this.metadata = null;
      this.minVersion = -2147483648;
   ...
   public int getHighestSupportedVersion() {
      return this.maxVersion != 2147483647 ? this.maxVersion : this.minVersion;
   }

   public boolean supportsVersion(int version) {
      return version == -2147483648 || version >= this.minVersion && version <= this.maxVersion;
   }
   ...
   public void decodeAndInherit(BsonDocument document, Type t, @Nullable Type parent, @Nonnull ExtraInfo extraInfo) {
      FieldType parentValue = (FieldType)(parent != null ? this.getter.apply(parent, extraInfo) : null);
      FieldType value = (FieldType)this.codec.getAndInherit(document, parentValue, extraInfo).orElse((Object)null);
      this.setValue(t, value, extraInfo);
   }

   public void encode(@Nonnull BsonDocument document, Type t, @Nonnull ExtraInfo extraInfo) {
      FieldType value = (FieldType)this.getter.apply(t, extraInfo);
      if (value != null) {
      ...
      if (read == -1) {
         ...
         switch (read) {
            ...
            case 110:
               ...
               this.setValue(t, (Object)null, extraInfo);
               return;
            default:
         ...
         switch (read) {
            ...
            default:
               ...
               if (child instanceof InheritCodec) {
                  FieldType parentValue = (FieldType)(parent != null ? this.getter.apply(parent, extraInfo) : null);
                  FieldType value = (FieldType)((InheritCodec)child).decodeAndInheritJson(reader, parentValue, extraInfo);
                  this.setValue(t, value, extraInfo);
               } else {
   ...
   public void setValue(Type t, @Nullable FieldType value, @Nonnull ExtraInfo extraInfo) {
      if (this.validators != null) {
         ...
         for(int i = 0; i < this.validators.size(); ++i) {
            ((Validator)this.validators.get(i)).accept(value, results);
         }
      ...
      if (this.isPrimitive && value == null) {
         ValidationResults results = extraInfo.getValidationResults();
         Validators.nonNull().accept((Object)null, (ValidationResults)results);
         results._processValidationResults();
      } else {
   ...
   public void validate(Type t, @Nonnull ExtraInfo extraInfo) {
      FieldType value = (FieldType)this.getter.apply(t, extraInfo);
      this.validateValue(value, extraInfo, (Predicate)null);
   }

   public void validateDefaults(Type t, @Nonnull ExtraInfo extraInfo, Set<Codec<?>> tested) {
      FieldType defaultValue = (FieldType)this.getter.apply(t, extraInfo);
   ...
   private void validateValue(FieldType value, @Nonnull ExtraInfo extraInfo, @Nullable Predicate<Validator<? super FieldType>> filter) {
      ...
      if (this.validators != null) {
         ...
         for(int i = 0; i < this.validators.size(); ++i) {
            Validator<? super FieldType> validator = (Validator)this.validators.get(i);
   ...
   public void nullValidate(Type t, @Nonnull ValidationResults results, ExtraInfo extraInfo) {
      if (this.nonNullValidator != null) {
         FieldType apply = (FieldType)this.getter.apply(t, extraInfo);
         if (apply == null) {
            this.nonNullValidator.accept((Object)null, (ValidationResults)results);
            results._processValidationResults();
         }
      }
   }
   ...
   public String toString() {
      ...
      return "BuilderField{codec=" + var10000 + ", setter=" + String.valueOf(this.setter) + ", getter=" + String.valueOf(this.getter) + "}";
   }
   ...
   public static class FieldBuilder<T, FieldType, Builder extends BuilderCodec.BuilderBase<T, Builder>> {
      ...
      protected int minVersion = -2147483648;
      protected int maxVersion = 2147483647;
      ...
      public FieldBuilder(Builder parentBuilder, KeyedCodec<FieldType> codec, TriConsumer<T, FieldType, ExtraInfo> setter, BiFunction<T, ExtraInfo, FieldType> getter, TriConsumer<T, T, ExtraInfo> inherit) {
         this.parentBuilder = (Builder)(Objects.requireNonNull(parentBuilder, "parentBuilder parameter can't be null"));
         this.codec = (KeyedCodec)Objects.requireNonNull(codec, "codec parameter can't be null");
         this.setter = (TriConsumer)Objects.requireNonNull(setter, "setter parameter can't be null");
         this.getter = (BiFunction)Objects.requireNonNull(getter, "getter parameter can't be null");
         this.inherit = inherit;
