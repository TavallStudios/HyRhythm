   ...
   public void updateSchema(SchemaContext context, @Nonnull Schema target) {
      if (target.getAllOf() != null) {
         ...
         if (target instanceof StringSchema && this.value instanceof String) {
            ...
            HytaleLogger.Api var10000 = LOGGER.at(Level.WARNING);
            String var10001 = String.valueOf(this.value.getClass());
            var10000.log("Cannot compare " + var10001 + " with " + String.valueOf(target.getClass()));
         }
