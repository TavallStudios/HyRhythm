...
public class BiomeInterpolation {
   public static final Int2IntMap EMPTY_MAP = new EmptyInt2IntMap();
   ...
   public String toString() {
      int var10000 = this.radius;
      return "BiomeInterpolation{radius=" + var10000 + ", biomeRadii2=" + String.valueOf(this.biomeRadii2) + "}";
   }
   ...
   static {
      DEFAULT = new BiomeInterpolation(5, EMPTY_MAP);
   }
