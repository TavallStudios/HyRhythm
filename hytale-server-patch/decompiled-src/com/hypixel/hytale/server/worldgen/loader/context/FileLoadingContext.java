...
public class FileLoadingContext extends FileContext<FileLoadingContext> {
   private final FileContext.Registry<ZoneFileContext> zones = new FileContext.Registry<ZoneFileContext>("Zone");
   private final FileContext.Registry<PrefabCategory> prefabCategories = new FileContext.Registry<PrefabCategory>("Category");
   private int zoneIdCounter = -1;
   private int biomeIdCounter = -1;

   public FileLoadingContext(@Nonnull Path filepath) {
      super(-1, filepath.getFileName().toString(), filepath, (Object)null);
   }
