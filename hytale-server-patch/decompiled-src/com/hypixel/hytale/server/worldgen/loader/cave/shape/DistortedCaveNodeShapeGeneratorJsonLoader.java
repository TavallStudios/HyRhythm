...
public class DistortedCaveNodeShapeGeneratorJsonLoader extends CaveNodeShapeGeneratorJsonLoader {
   ...
   private IDoubleRange loadWidth() {
      return this.has("RadiusX") ? (new DoubleRangeJsonLoader(this.seed, this.dataFolder, this.get("RadiusX"), 3.0)).load() : (new DoubleRangeJsonLoader(this.seed, this.dataFolder, this.get("Width"), 3.0)).load();
   }

   @Nullable
   private IDoubleRange loadHeight() {
      return this.has("RadiusY") ? (new DoubleRangeJsonLoader(this.seed, this.dataFolder, this.get("RadiusY"), 3.0)).load() : (new DoubleRangeJsonLoader(this.seed, this.dataFolder, this.get("Height"), 3.0)).load();
   }
