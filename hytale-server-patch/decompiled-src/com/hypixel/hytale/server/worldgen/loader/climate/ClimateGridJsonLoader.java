...
public class ClimateGridJsonLoader<K extends SeedResource> extends JsonLoader<K, ClimateNoise.Grid> {
   ...
   public ClimateNoise.Grid load() {
      return this.json == null ? ClimateGridJsonLoader.Constants.DEFAULT_GRID : new ClimateNoise.Grid(this.loadSeed(), this.loadScale(), GridCellDistanceFunction.DISTANCE_FUNCTION, this.loadEvaluator());
   }
