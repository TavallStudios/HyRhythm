...
public class WeightedPrefabMapJsonLoader extends JsonLoader<SeedStringResource, IWeightedMap<WorldGenPrefabSupplier>> {
   ...
   public IWeightedMap<WorldGenPrefabSupplier> load() {
      WorldGenPrefabLoader prefabLoader = ((SeedStringResource)this.seed.get()).getLoader();
      WeightedMap.Builder<WorldGenPrefabSupplier> builder = WeightedMap.<WorldGenPrefabSupplier>builder(WorldGenPrefabSupplier.EMPTY_ARRAY);
