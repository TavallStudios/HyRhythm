...
public class ChunkGeneratorResource {
   ...
   public ChunkGeneratorResource() {
      this.prefabs = new TimeoutCache<WorldGenPrefabSupplier, IPrefabBuffer>(30L, TimeUnit.SECONDS, this::getPrefab, (key, value) -> value.release());
      this.climateBuffer = new ClimateNoise.Buffer();
      this.prefabPopulator = new PrefabPopulator();
      this.prefabCollector = new WorldGenPrefabLoader.PrefabPathCollector();
      ...
      this.cacheCaveCoordinateKey = new ExtendedCoordinateCache.ExtendedCoordinateKey<CaveType>();
