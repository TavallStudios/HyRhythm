...
public class DistortedPipeShape extends DistortedCylinderShape {
   ...
   public String toString() {
      ...
      return "DistortedPipeShape{origin=" + var10000 + ", direction=" + String.valueOf(this.v) + ", startWidth=" + this.startWidth + ", startHeight=" + this.startHeight + ", midWidth=" + this.midWidth + ", midHeight=" + this.midHeight + ", endWidth=" + this.endWidth + ", endHeight=" + this.endHeight + "}";
   }
