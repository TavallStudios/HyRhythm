...
public abstract class AbstractDistortedBody extends AbstractDistortedShape {
   ...
   public Vector3d getStart() {
      return new Vector3d(this.o.x, (double)this.getHighBoundY(), this.o.z);
   }

   @Nonnull
   public Vector3d getEnd() {
      return new Vector3d(this.o.x, (double)this.getLowBoundY(), this.o.z);
   }
   ...
   protected abstract static class Factory implements DistortedShape.Factory {
      public DistortedShape create(Vector3d origin, @Nonnull Vector3d direction, double length, double startWidth, double startHeight, double midWidth, double midHeight, double endWidth, double endHeight, GeneralNoise.InterpolationFunction interpolation) {
         ...
         double yaw = (double)TrigMathUtil.atan2(nx, nz);
