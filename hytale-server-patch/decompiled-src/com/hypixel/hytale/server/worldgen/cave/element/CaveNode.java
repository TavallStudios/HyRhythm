...
public class CaveNode implements CaveElement {
   ...
   public void compile() {
      this.cavePrefabs = (CavePrefab[])this.rawCavePrefabs.toArray((x$0) -> new CavePrefab[x$0]);
      this.rawCavePrefabs = null;
   }

   @Nonnull
   public String toString() {
      String var10000 = Arrays.toString(this.cavePrefabs);
      return "CaveNode{cavePrefabs=" + var10000 + "rawCavePrefabs=" + Arrays.toString(this.cavePrefabs) + ", caveNodeType=" + String.valueOf(this.caveNodeType) + ", shape=" + String.valueOf(this.shape) + ", bounds=" + String.valueOf(this.bounds) + ", seedOffset=" + this.seedOffset + ", pitch=" + this.pitch + ", yaw=" + this.yaw + "}";
   }
}
