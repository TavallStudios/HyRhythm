...
public class CaveNodeType {
   ...
   public BlockFluidEntry getFilling(@Nonnull Random random) {
      return (BlockFluidEntry)this.fillings.get(random);
   }
   ...
   public boolean hasEnvironment() {
      return this.environment != -2147483648;
   }
   ...
   public static class CaveNodeCoverEntry {
      ...
      public Entry get(Random random) {
         return (Entry)this.entries.get(random);
      }
      ...
      public static class Entry {
         ...
         public String toString() {
            ...
            return "Entry{entry=" + var10000 + ", offset=" + this.offset + "}";
         }
      }
   }
