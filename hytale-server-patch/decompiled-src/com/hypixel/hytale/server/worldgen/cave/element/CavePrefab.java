...
public class CavePrefab implements CaveElement {
   ...
   public CavePrefab(@Nonnull WorldGenPrefabSupplier prefabSupplier, @Nonnull PrefabRotation rotation, IIntCondition biomeMask, BlockMaskCondition blockMask, int x, int y, int z) {
      ...
      this.bounds = new WorldBounds(MathUtil.floor((double)(x + prefab.getMinX(rotation))), MathUtil.floor((double)(y + prefab.getMinY())), MathUtil.floor((double)(z + prefab.getMinZ(rotation))), MathUtil.ceil((double)(x + prefab.getMaxX(rotation))), MathUtil.ceil((double)(y + prefab.getMaxY())), MathUtil.ceil((double)(z + prefab.getMaxZ(rotation))));
   }
