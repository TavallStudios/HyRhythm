...
public class ShapeDistortion {
   ...
   public static ShapeDistortion of(@Nullable NoiseProperty widthNoise, @Nullable NoiseProperty floorNoise, @Nullable NoiseProperty ceilingNoise) {
      ...
      return widthNoise == DEFAULT_NOISE && floorNoise == DEFAULT_NOISE && ceilingNoise == DEFAULT_NOISE ? DEFAULT : new ShapeDistortion(widthNoise, floorNoise, ceilingNoise);
   }

   static {
      DEFAULT = new ShapeDistortion(DEFAULT_NOISE, DEFAULT_NOISE, DEFAULT_NOISE);
   }
}
