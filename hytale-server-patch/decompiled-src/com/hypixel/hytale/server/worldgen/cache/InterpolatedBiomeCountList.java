...
public class InterpolatedBiomeCountList {
   @Nonnull
   private final Int2ObjectMap<BiomeCountResult> results = new Int2ObjectOpenHashMap();
   @Nonnull
   ...
   public String toString() {
      String var10000 = String.valueOf(this.results);
      return "InterpolatedBiomeCountList{results=" + var10000 + ", biomeIds=" + String.valueOf(this.biomeIds) + "}";
   }
   ...
   public static class BiomeCountResult {
      ...
      @Nonnull
      public String toString() {
         String var10000 = String.valueOf(this.biome);
         return "BiomeCountResult{biome=" + var10000 + ", heightThresholdContext=" + this.heightThresholdContext + ", heightNoise=" + this.heightNoise + ", count=" + this.count + "}";
      }
   }
}
