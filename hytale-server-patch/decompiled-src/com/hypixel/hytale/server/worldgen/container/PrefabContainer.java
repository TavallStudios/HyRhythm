   ...
   public static class PrefabContainerEntry {
      ...
      public int getExtents() {
         if (this.extend == -1) {
            ...
            for(WorldGenPrefabSupplier supplier : (WorldGenPrefabSupplier[])this.prefabs.internalKeys()) {
      ...
      @Nonnull
      public String toString() {
         String var10000 = String.valueOf(this.prefabs);
         return "PrefabContainerEntry{prefabs=" + var10000 + ", prefabPatternGenerator=" + String.valueOf(this.prefabPatternGenerator) + ", extend=" + this.extend + "}";
      }
   }
}
