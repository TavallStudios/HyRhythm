...
public class ChunkWorkerThreadFactory implements ThreadFactory {
   ...
   public Thread newThread(Runnable r) {
      ...
      ChunkWorker workerThread = new ChunkWorker(r, threadName, this.chunkGenerator);
   ...
   public String toString() {
      String var10000 = String.valueOf(this.chunkGenerator);
      return "ChunkWorkerThreadFactory{chunkGenerator=" + var10000 + ", threadNameFormat='" + this.threadNameFormat + "', factoryId=" + this.factoryId + ", threadCounter=" + String.valueOf(this.threadCounter) + "}";
   }
