...
public final class ResolvedBlockArray {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.entrySet);
      return "ResolvedBlockArray{entrySet=" + var10000 + ", entries=" + Arrays.toString(this.entries) + "}";
   }

   static {
      EMPTY = new ResolvedBlockArray(BlockFluidEntry.EMPTY_ARRAY);
      RESOLVED_BLOCKS = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
      RESOLVED_BLOCKS_WITH_VARIANTS = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   }
}
