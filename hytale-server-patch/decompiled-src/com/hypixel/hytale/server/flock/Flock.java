...
public class Flock implements Component<EntityStore> {
   ...
   public Flock() {
      this.removedStatus = Flock.FlockRemovedStatus.NOT_REMOVED;
   }
   ...
   public void onTargetKilled(@Nonnull ComponentAccessor<EntityStore> componentAccessor, @Nonnull Ref<EntityStore> targetEntityReference) {
      TransformComponent targetTransformComponent = (TransformComponent)componentAccessor.getComponent(targetEntityReference, TransformComponent.getComponentType());
