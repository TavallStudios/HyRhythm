...
public class BuilderActionFlockJoin extends BuilderActionBase {
   ...
   public BuilderActionFlockJoin readConfig(@Nonnull JsonElement data) {
      this.getBoolean(data, "ForceJoin", (b) -> this.forceJoin = b, false, BuilderDescriptorState.Stable, "Enforce joining flock if true", "Disables checking flock join conditions test and forces joining flock.");
