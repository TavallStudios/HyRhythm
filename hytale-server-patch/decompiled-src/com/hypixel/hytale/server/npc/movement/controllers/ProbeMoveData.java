...
public class ProbeMoveData {
   @Nonnull
   public final Vector3d probePosition = new Vector3d();
   @Nonnull
   public final Vector3d probeDirection = new Vector3d();
   @Nonnull
   public final Vector3d initialPosition = new Vector3d();
   @Nonnull
   public final Vector3d targetPosition = new Vector3d();
   @Nonnull
   public final Vector3d directionComponentSelector = new Vector3d();
   ...
   public boolean canAdvance(@Nonnull Ref<EntityStore> ref, @Nonnull MotionController motionController, double threshold, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
   ...
   public boolean canAdvanceAbs(@Nonnull Ref<EntityStore> ref, @Nonnull MotionController motionController, double requiredDistance, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
      double distance = motionController.probeMove(ref, this, componentAccessor);
      return distance >= requiredDistance;
   }

   public boolean canMoveTo(@Nonnull Ref<EntityStore> ref, @Nonnull MotionController motionController, double maxDistance, double maxDistanceY, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
   ...
   public boolean canMoveTo(@Nonnull Ref<EntityStore> ref, @Nonnull MotionController motionController, double maxDistance, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
   ...
   protected Segment newSegment() {
      if (this.segmentCount == this.segments.length) {
         this.segments = (Segment[])Arrays.copyOf(this.segments, this.segmentCount + 4);
