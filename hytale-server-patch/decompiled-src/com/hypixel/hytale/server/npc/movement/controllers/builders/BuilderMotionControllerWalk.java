...
public class BuilderMotionControllerWalk extends BuilderMotionControllerBase {
   ...
   private final EnumHolder<MotionControllerWalk.DescentAnimationType> descentAnimationType = new EnumHolder<MotionControllerWalk.DescentAnimationType>();
   private final EnumHolder<MotionControllerWalk.AscentAnimationType> ascentAnimationType = new EnumHolder<MotionControllerWalk.AscentAnimationType>();
   ...
   public BuilderMotionControllerWalk readConfig(@Nonnull JsonElement data) {
      this.getDouble(data, "MaxWalkSpeed", this.maxHorizontalSpeed, 3.0, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Maximum horizontal speed", (String)null);
      this.getDouble(data, "MinWalkSpeed", (v) -> this.minHorizontalSpeed = v, 0.1, DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.WorkInProgress, "Minimum horizontal speed", (String)null);
   ...
   public float getMaxMoveTurnAngle(@Nonnull BuilderSupport builderSupport) {
      return 0.017453292F * this.maxMoveTurnAngle.get(builderSupport.getExecutionContext());
   }

   public double getMaxRotationSpeed(@Nonnull BuilderSupport builderSupport) {
      return 0.01745329238474369 * this.maxRotationSpeed.get(builderSupport.getExecutionContext());
   }

   public float getBlendRestTurnAngle(@Nonnull BuilderSupport builderSupport) {
      return 0.017453292F * this.blendRestTurnAngle.get(builderSupport.getExecutionContext());
   }
