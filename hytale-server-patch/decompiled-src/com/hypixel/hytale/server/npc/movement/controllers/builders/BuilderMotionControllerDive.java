...
public class BuilderMotionControllerDive extends BuilderMotionControllerBase {
   ...
   public BuilderMotionControllerDive readConfig(@Nonnull JsonElement data) {
      this.getDouble(data, "MaxSwimSpeed", this.maxHorizontalSpeed, 3.0, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Maximum horizontal speed", (String)null);
      this.getDouble(data, "MaxDiveSpeed", (v) -> this.maxVerticalSpeed = v, 8.0, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Maximum vertical speed", (String)null);
   ...
   public SpawnTestResult canSpawn(@Nonnull SpawningContext context) {
      ...
      double swimDepth = model == null ? 0.5 : MotionControllerDive.relativeSwimDepthToHeight(this.getSwimDepth(), model.getBoundingBox(), model.getEyeHeight());
