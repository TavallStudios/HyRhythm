...
public class IntSequenceValidator extends IntArrayValidator {
   ...
   public static IntSequenceValidator between(int lower, int upper) {
      return new IntSequenceValidator(RelationalOperator.GreaterEqual, lower, RelationalOperator.LessEqual, upper, (RelationalOperator)null);
   }
   ...
   public static IntSequenceValidator fromExclToIncl(int lower, int upper) {
      return new IntSequenceValidator(RelationalOperator.Greater, lower, RelationalOperator.LessEqual, upper, (RelationalOperator)null);
   }
   ...
   static {
      VALIDATOR_BETWEEN_01 = new IntSequenceValidator(RelationalOperator.GreaterEqual, 0, RelationalOperator.LessEqual, 1, (RelationalOperator)null);
