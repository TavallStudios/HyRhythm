...
public abstract class AssetValidator {
   ...
   static {
      CanBeEmpty = EnumSet.of(AssetValidator.Config.NULLABLE, AssetValidator.Config.CAN_BE_EMPTY);
      ListCanBeEmpty = EnumSet.of(AssetValidator.Config.LIST_NULLABLE, AssetValidator.Config.LIST_CAN_BE_EMPTY);
   }
