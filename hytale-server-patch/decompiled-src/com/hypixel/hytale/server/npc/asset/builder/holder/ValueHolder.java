...
public abstract class ValueHolder {
   ...
   protected void readJSON(@Nullable JsonElement optionalJsonElement, @Nonnull Supplier<BuilderExpression> defaultValue, String name, @Nonnull BuilderParameters builderParameters) {
      this.name = name;
      this.expression = optionalJsonElement != null ? BuilderExpression.fromJSON(optionalJsonElement, builderParameters, this.valueType) : (BuilderExpression)defaultValue.get();
   }
