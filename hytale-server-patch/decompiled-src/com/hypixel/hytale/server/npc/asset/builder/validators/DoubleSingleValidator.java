...
public class DoubleSingleValidator extends DoubleValidator {
   ...
   static {
      VALIDATOR_GREATER_0 = new DoubleSingleValidator(RelationalOperator.Greater, 0.0);
      VALIDATOR_GREATER_EQUAL_0 = new DoubleSingleValidator(RelationalOperator.GreaterEqual, 0.0);
   }
}
