...
public class IntSingleValidator extends IntValidator {
   ...
   static {
      VALIDATOR_GREATER_EQUAL_0 = new IntSingleValidator(RelationalOperator.GreaterEqual, 0);
      VALIDATOR_GREATER_0 = new IntSingleValidator(RelationalOperator.Greater, 0);
   }
}
