...
public class BuilderAttributeDescriptor {
   ...
   public <E extends Enum<E> & Supplier<String>> BuilderAttributeDescriptor setEnum(@Nonnull Class<E> clazz) {
      ...
      for(E E : enumConstants) {
         result.put(E.toString(), (String)((Supplier)E).get());
      }
   ...
   public String toString() {
      ...
      return "BuilderAttributeDescriptor{name='" + var10000 + "', type='" + this.type + "', required=" + String.valueOf(this.required) + ", computable=" + this.computable + ", state=" + String.valueOf(this.state) + ", shortDescription='" + this.shortDescription + "', longDescription='" + this.longDescription + "', defaultValue='" + this.defaultValue + "', domain='" + this.domain + "', minSize=" + this.minSize + ", maxSize=" + this.maxSize + ", validator=" + String.valueOf(this.validator) + ", flagDescriptions=" + String.valueOf(this.flagDescriptions) + "}";
   }
