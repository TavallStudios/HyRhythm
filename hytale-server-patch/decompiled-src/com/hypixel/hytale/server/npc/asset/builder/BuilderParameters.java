...
public class BuilderParameters {
   ...
   public ValueType getParameterType(String name) {
      Parameter p = (Parameter)this.parameters.get(name);
      ...
      if (parameterValue != null) {
         ...
         modify.entrySet().forEach((stringElementPair) -> {
            ...
            if (this.parameters.containsKey(key)) {
               ...
               this.parameters.put(key, BuilderParameters.Parameter.fromJSON((JsonElement)stringElementPair.getValue(), this, key));
            }
         });
      }
   }
   ...
   public static class Parameter {
      ...
      private static Parameter fromJSON(@Nonnull JsonElement element, @Nonnull BuilderParameters builderParameters, String parameterName) {
         ...
         String validate = BuilderBase.readString(jsonObject, "Validate", (String)null);
         String confine = BuilderBase.readString(jsonObject, "Confine", (String)null);
         ...
         if (hasValidate && confine != null) {
            ...
            return new Parameter(expression, BuilderBase.readString(jsonObject, "Description", (String)null), code, hasValidate, BuilderBase.readBoolean(jsonObject, "Private", false));
         }
      }
   }
}
