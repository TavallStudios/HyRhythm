...
public class BuilderActionList extends BuilderBase<ActionList> {
   protected final BuilderObjectListHelper<Action> actions = new BuilderObjectListHelper<Action>(Action.class, this);
   ...
   public ActionList build(@Nonnull BuilderSupport builderSupport) {
      ...
      return actions != null && !actions.isEmpty() ? new ActionList((Action[])actions.toArray((x$0) -> new Action[x$0])) : ActionList.EMPTY_ACTION_LIST;
   }
   ...
   public BuilderActionList readConfig(@Nonnull JsonElement data) {
      this.requireArray(data, this.actions, (ArrayValidator)null, BuilderDescriptorState.Stable, "List of actions", (String)null, this.validationHelper);
      return this;
   }
