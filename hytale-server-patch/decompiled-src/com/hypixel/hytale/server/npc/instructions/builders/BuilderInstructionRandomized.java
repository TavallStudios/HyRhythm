...
public class BuilderInstructionRandomized extends BuilderInstruction {
   ...
   public Builder<Instruction> readConfig(@Nonnull JsonElement data) {
      ...
      this.getDoubleRange(data, "ExecuteFor", this.executeFor, DEFAULT_EXECUTION_RANGE, DoubleSequenceValidator.fromExclToInclWeaklyMonotonic(0.0, 1.7976931348623157E308), BuilderDescriptorState.Stable, "How long to execute the chosen instruction before picking another", (String)null);
      this.decreaseDepth();
