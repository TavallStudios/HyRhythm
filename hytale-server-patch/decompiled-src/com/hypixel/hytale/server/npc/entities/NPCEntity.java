...
public class NPCEntity extends LivingEntity implements INonPlayerCharacter {
   ...
   private int roleIndex = -2147483648;
   @Nullable
   private Role role = null;
   private int spawnRoleIndex = -2147483648;
   @Nullable
   private String spawnRoleName;
   @Nullable
   private String spawnConfigurationName;
   private int environmentIndex = -2147483648;
   private int spawnConfigurationIndex = -2147483648;
   ...
   private float cachedEntityHorizontalSpeedMultiplier = 3.4028235E38F;
   ...
   public void invalidateCachedHorizontalSpeedMultiplier() {
      this.cachedEntityHorizontalSpeedMultiplier = 3.4028235E38F;
   }
   ...
   public void playAnimation(@Nonnull Ref<EntityStore> ref, @Nonnull AnimationSlot animationSlot, @Nullable String animationId, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
      ...
      if (animationSlot != AnimationSlot.Action && animationId != null && model != null && !model.getAnimationSetMap().containsKey(animationId)) {
         ...
         ActiveAnimationComponent activeAnimationComponent = (ActiveAnimationComponent)componentAccessor.getComponent(ref, ActiveAnimationComponent.getComponentType());
   ...
   public double getDespawnTime() {
      return (double)this.despawnRemainingSeconds;
   }
   ...
   public int getSpawnRoleIndex() {
      return this.spawnRoleIndex != -2147483648 ? this.spawnRoleIndex : this.roleIndex;
   }

   public void setSpawnRoleIndex(int spawnRoleIndex) {
      if (spawnRoleIndex == this.roleIndex) {
         spawnRoleIndex = -2147483648;
      }

      this.spawnRoleIndex = spawnRoleIndex;
      if (spawnRoleIndex == -2147483648) {
   ...
   public void initBlockTypeBlackboardView(@Nonnull Ref<EntityStore> ref, ComponentAccessor<EntityStore> componentAccessor) {
      if (this.blackboardBlockTypeSets != null) {
         this.blackboardBlockTypeView = (BlockTypeView)((Blackboard)componentAccessor.getResource(Blackboard.getResourceType())).getView(BlockTypeView.class, ref, componentAccessor);
   ...
   public void initBlockChangeBlackboardView(@Nonnull Ref<EntityStore> ref, ComponentAccessor<EntityStore> componentAccessor) {
      if (this.blackboardBlockChangeSets != null) {
         this.blackboardBlockChangeView = (BlockEventView)((Blackboard)componentAccessor.getResource(Blackboard.getResourceType())).getView(BlockEventView.class, ref, componentAccessor);
         this.blackboardBlockChangeView.initialiseEntity(ref, this);
      }

      if (this.blackboardEntityEventSets != null) {
         this.blackboardEntityEventView = (EntityEventView)((Blackboard)componentAccessor.getResource(Blackboard.getResourceType())).getView(EntityEventView.class, ref, componentAccessor);
   ...
   public IntSet getBlackboardBlockChangeSet(BlockEventType type) {
      return (IntSet)this.blackboardBlockChangeSets.getOrDefault(type, (Object)null);
   }
   ...
   public void notifyBlockChange(@Nonnull BlockEventType type, @Nonnull EventNotification notification) {
      ...
      if (isPlayer) {
         support = (EventSupport)store.getComponent(this.reference, PlayerBlockEventSupport.getComponentType());
      } else {
         support = (EventSupport)store.getComponent(this.reference, NPCBlockEventSupport.getComponentType());
      }
   ...
   public IntSet getBlackboardEntityEventSet(@Nonnull EntityEventType type) {
      return (IntSet)this.blackboardEntityEventSets.getOrDefault(type, (Object)null);
   }
   ...
   public void notifyEntityEvent(@Nonnull EntityEventType type, @Nonnull EntityEventNotification notification) {
      ...
      if (isPlayer) {
         support = (EntityEventSupport)store.getComponent(this.reference, PlayerEntityEventSupport.getComponentType());
      } else {
         support = (EntityEventSupport)store.getComponent(this.reference, NPCEntityEventSupport.getComponentType());
      }
   ...
   public void setSpawnConfiguration(int spawnConfigurationIndex) {
      if (spawnConfigurationIndex == -2147483648) {
         this.spawnConfigurationIndex = -2147483648;
         this.spawnConfigurationName = null;
      } else {
         String name = ((WorldNPCSpawn)WorldNPCSpawn.getAssetMap().getAsset(spawnConfigurationIndex)).getId();
         if (name == null) {
      ...
      if (name.isEmpty()) {
         ...
         if (modelComponent == null) {
            ...
            if (name.equals(model.getModelAssetId())) {
               ...
               NPCEntity npcComponent = (NPCEntity)componentAccessor.getComponent(ref, getComponentType());

               assert npcComponent != null;

               ModelAsset modelAsset = (ModelAsset)ModelAsset.getAssetMap().getAsset(name);
               if (modelAsset == null) {
   ...
   public float getCurrentHorizontalSpeedMultiplier(@Nullable Ref<EntityStore> ref, @Nullable ComponentAccessor<EntityStore> componentAccessor) {
      if (this.cachedEntityHorizontalSpeedMultiplier != 3.4028235E38F) {
         ...
         if (ref != null && componentAccessor != null) {
            EffectControllerComponent effectControllerComponent = (EffectControllerComponent)componentAccessor.getComponent(ref, EffectControllerComponent.getComponentType());
            if (effectControllerComponent == null) {
               ...
               if (cachedEffectIndexes == null) {
                  ...
                  for(int cachedEffectIndex : cachedEffectIndexes) {
                     EntityEffect effect = (EntityEffect)EntityEffect.getAssetMap().getAsset(cachedEffectIndex);
                     if (effect != null) {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.role);
      return "NPCEntity{role=" + var10000 + ", spawnRoleIndex=" + this.spawnRoleIndex + ", spawnPoint=" + String.valueOf(this.leashPoint) + ", spawnHeading=" + this.leashHeading + ", spawnPitch=" + this.leashPitch + ", environmentIndex='" + this.environmentIndex + "'} " + super.toString();
   }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(NPCEntity.class, NPCEntity::new, LivingEntity.CODEC).addField(new KeyedCodec("Env", Codec.STRING), (npcEntity, s) -> npcEntity.environmentIndex = Environment.getAssetMap().getIndex(s), (npcEntity) -> {
         Environment environment = (Environment)Environment.getAssetMap().getAssetOrDefault(npcEntity.environmentIndex, (JsonAssetWithMap)null);
         return environment != null ? environment.getId() : null;
      })).addField(new KeyedCodec("HvrPhs", Codec.DOUBLE), (npcEntity, d) -> npcEntity.hoverPhase = d.floatValue(), (npcEntity) -> (double)npcEntity.hoverPhase)).addField(new KeyedCodec("HvrHght", Codec.DOUBLE), (npcEntity, d) -> npcEntity.hoverHeight = d, (npcEntity) -> npcEntity.hoverHeight)).addField(new KeyedCodec("SpawnName", Codec.STRING), (npcEntity, s) -> {
         npcEntity.spawnRoleName = s;
         npcEntity.spawnRoleIndex = NPCPlugin.get().getIndex(s);
      }, (npcEntity) -> npcEntity.spawnRoleName)).addField(new KeyedCodec("MdlScl", Codec.DOUBLE), (npcEntity, d) -> npcEntity.initialModelScale = d.floatValue(), (npcEntity) -> (double)npcEntity.initialModelScale)).addField(new KeyedCodec("SpawnConfig", Codec.STRING), (npcEntity, s) -> {
         npcEntity.spawnConfigurationName = s;
         npcEntity.spawnConfigurationIndex = WorldNPCSpawn.getAssetMap().getIndex(s);
      }, (npcEntity) -> npcEntity.spawnConfigurationName)).addField(new KeyedCodec("SpawnInstant", Codec.INSTANT), (npcEntity, instant) -> npcEntity.spawnInstant = instant, (npcEntity) -> npcEntity.spawnInstant)).append(new KeyedCodec("AlarmStore", AlarmStore.CODEC), (npcEntity, alarmStore) -> npcEntity.alarmStore = alarmStore, (npcEntity) -> npcEntity.alarmStore).add()).addField(new KeyedCodec("WorldgenId", Codec.INTEGER), (npcEntity, i) -> npcEntity.worldgenId = i, (npcEntity) -> npcEntity.worldgenId)).append(new KeyedCodec("PathManager", PathManager.CODEC), (npcEntity, manager) -> npcEntity.pathManager = manager, (npcEntity) -> npcEntity.pathManager).add()).addField(new KeyedCodec("LeashPos", Vector3d.CODEC), (npcEntity, v) -> {
         npcEntity.leashPoint.assign(v);
         npcEntity.hasLeashPosition = true;
      }, (npcEntity) -> npcEntity.requiresLeashPosition() ? npcEntity.leashPoint : null)).addField(new KeyedCodec("LeashHdg", Codec.DOUBLE), (npcEntity, v) -> npcEntity.leashHeading = v.floatValue(), (npcEntity) -> npcEntity.requiresLeashPosition() ? (double)npcEntity.leashHeading : null)).addField(new KeyedCodec("LeashPtch", Codec.DOUBLE), (npcEntity, v) -> npcEntity.leashPitch = v.floatValue(), (npcEntity) -> npcEntity.requiresLeashPosition() ? (double)npcEntity.leashPitch : null)).addField(new KeyedCodec("RoleName", Codec.STRING), (npcEntity, s) -> npcEntity.roleName = s, (npcEntity) -> npcEntity.roleName)).build();
   }
}
