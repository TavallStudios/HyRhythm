...
public class UseNPCInteraction extends SimpleInstantInteraction {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(UseNPCInteraction.class, UseNPCInteraction::new, SimpleInstantInteraction.CODEC).documentation("Interacts with a target NPC.")).build();
