   ...
   public void onEntityAdd(@Nonnull Holder<EntityStore> holder, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store) {
      ...
      if (npcComponent.getRole() == null) {
         ...
         if (!roleBuilder.isSpawnable()) {
            ...
            BuilderSupport builderSupport = new BuilderSupport(npcPlugin.getBuilderManager(), npcComponent, holder, new ExecutionContext(), roleBuilder, (RoleStats)null);
            ...
            Interactions interactionsComponent = (Interactions)holder.ensureAndGetComponent(Interactions.getComponentType());
            ...
            if (spawnedOrPrefab) {
               ...
               if (modelComponent == null) {
                  ...
                  ModelAsset modelAsset = (ModelAsset)ModelAsset.getAssetMap().getAsset(appearance);
                  if (modelAsset == null) {
                     this.fail(holder);
               ...
               if (roleBuilder instanceof SpawnEffect) {
                  SpawnEffect spawnEffect = (SpawnEffect)roleBuilder;
                  TransformComponent transformComponent = (TransformComponent)holder.getComponent(this.transformComponentType);
