...
public class PositionCacheSystems {
   ...
   public static class OnFlockJoinSystem extends RefChangeSystem<EntityStore, FlockMembership> {
      ...
      public OnFlockJoinSystem(@Nonnull ComponentType<EntityStore, NPCEntity> npcComponentType, @Nonnull ComponentType<EntityStore, FlockMembership> flockMembershipComponentType) {
      ...
      public void onComponentAdded(@Nonnull Ref<EntityStore> ref, @Nonnull FlockMembership component, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         ...
         PositionCacheSystems.initialisePositionCache(role, (StateEvaluator)store.getComponent(ref, this.stateEvaluatorComponentType), role.getFlockInfluenceRange());
      }
   ...
   public static class RoleActivateSystem extends HolderSystem<EntityStore> {
      ...
      public void onEntityAdd(@Nonnull Holder<EntityStore> holder, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store) {
         ...
         StateEvaluator stateEvaluator = (StateEvaluator)holder.getComponent(this.stateEvaluatorComponentType);
         if (stateEvaluator != null) {
   ...
   public static class UpdateSystem extends SteppableTickingSystem {
      ...
      public UpdateSystem(@Nonnull ComponentType<EntityStore, NPCEntity> npcComponentType, @Nonnull ResourceType<EntityStore, SpatialResource<Ref<EntityStore>, EntityStore>> npcSpatialResource) {
         this.dependencies = Set.of(new SystemDependency(Order.AFTER, PlayerSpatialSystem.class, OrderPriority.CLOSEST), new SystemDependency(Order.BEFORE, RoleSystems.PreBehaviourSupportTickSystem.class));
         this.npcComponentType = npcComponentType;
