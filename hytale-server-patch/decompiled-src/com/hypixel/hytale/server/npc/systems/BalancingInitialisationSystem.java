...
public class BalancingInitialisationSystem extends HolderSystem<EntityStore> {
   ...
   public BalancingInitialisationSystem() {
      this.dependencies = Set.of(new SystemDependency(Order.AFTER, RoleBuilderSystem.class), new SystemDependency(Order.AFTER, EntityStatsSystems.Setup.class));
      this.query = Archetype.of(this.npcComponentType, this.entityStatMapComponentType);
   }
   ...
   public void onEntityAdd(@Nonnull Holder<EntityStore> holder, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store) {
      ...
      EntityStatMap entityStatMapComponent = (EntityStatMap)holder.getComponent(this.entityStatMapComponentType);
      ...
      StaticModifier modifier = new StaticModifier(Modifier.ModifierTarget.MAX, StaticModifier.CalculationType.ADDITIVE, (float)initialMaxHealth - asset.getMax());
