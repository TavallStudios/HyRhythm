...
public class NPCInteractionSystems {
   public static class AddSimulationManagerSystem extends HolderSystem<EntityStore> {
      ...
      public AddSimulationManagerSystem(@Nonnull ComponentType<EntityStore, NPCEntity> npcEntityComponentType) {
         ...
         this.query = Query.<EntityStore>and(npcEntityComponentType, Query.not(InteractionModule.get().getInteractionManagerComponent()));
      }
      ...
      public void onEntityAdd(@Nonnull Holder<EntityStore> holder, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store) {
         ...
         holder.addComponent(InteractionModule.get().getInteractionManagerComponent(), new InteractionManager(npcComponent, (PlayerRef)null, new NPCInteractionSimulationHandler()));
      }
   ...
   public static class TickHeldInteractionsSystem extends EntityTickingSystem<EntityStore> {
      ...
      public TickHeldInteractionsSystem(@Nonnull ComponentType<EntityStore, NPCEntity> npcEntityComponentType) {
         ...
         this.query = Query.<EntityStore>and(npcEntityComponentType, this.interactionManagerComponentType);
      }
      ...
      public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         ...
         InteractionManager interactionManager = (InteractionManager)archetypeChunk.getComponent(index, this.interactionManagerComponentType);
