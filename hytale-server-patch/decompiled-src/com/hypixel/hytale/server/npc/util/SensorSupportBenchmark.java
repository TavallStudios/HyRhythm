...
public class SensorSupportBenchmark {
   ...
   public static final String[] DEFAULT_COLUMNS_UPDATE = new String[]{"KIND", "COUNT", "G-AVG", "G-MIN", "G-MAX", "L-AVG", "L-MAX", "SD-MAX", "UD-MAX", "AD-MAX"};
   public static final String[] DEFAULT_COLUMNS_LOS = new String[]{"L-CNT", "L-AVG", "L-MAX", "L-HIT%", "T-CNT", "T-AVG", "T-MIN", "T-MAX", "I-CNT", "I-AVG", "I-MAX", "I-HIT%", "F-CNT", "F-AVG", "F-MAX", "F-HIT%"};
   @Nonnull
   ...
   public void collectPlayerList(long getNanos, double maxPlayerDistanceSorted, double maxPlayerDistance, double maxPlayerDistanceAvoidance, int numPlayers) {
      ...
      this.playerCount.record((long)numPlayers);
   }
   ...
   public void collectEntityList(long getNanos, double maxEntityDistanceSorted, double maxEntityDistance, double maxEntityDistanceAvoidance, int numEntities) {
      ...
      this.entityCount.record((long)numEntities);
   }
   ...
   public void tickDone() {
      ...
      if (this.losTestTick > 0L) {
         this.losCacheHit.record((double)this.losCacheHitTick / (double)this.losTestTick);
      }
      ...
      if (this.inverseLosTestTick > 0L) {
         this.inverseLosCacheHit.record((double)this.inverseLosCacheHitTick / (double)this.inverseLosTestTick);
      }
      ...
      if (this.friendlyBlockingTestTick > 0L) {
         this.friendlyBlockingCacheHit.record((double)this.friendlyBlockingCacheHitTick / (double)this.friendlyBlockingTestTick);
      }
