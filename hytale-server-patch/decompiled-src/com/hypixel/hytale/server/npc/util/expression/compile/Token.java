...
public enum Token implements Supplier<String> {
   ...
   CLOSE_BRACKET(")", 20, EnumSet.of(TokenFlags.CLOSING_BRACKET), OPEN_BRACKET, (Token)null),
   OPEN_SQUARE_BRACKET("[", 19, EnumSet.of(TokenFlags.OPENING_BRACKET, TokenFlags.OPENING_TUPLE), (Token)null, (Token)null),
   CLOSE_SQUARE_BRACKET("]", 19, EnumSet.of(TokenFlags.CLOSING_BRACKET), OPEN_SQUARE_BRACKET, (Token)null),
   ...
   MINUS("-", 13, EnumSet.of(TokenFlags.OPERATOR), (Token)null, UNARY_MINUS),
   PLUS("+", 13, EnumSet.of(TokenFlags.OPERATOR), (Token)null, UNARY_PLUS),
