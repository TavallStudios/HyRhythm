...
public class NPCBenchmarkCommand extends CommandBase {
   ...
   public NPCBenchmarkCommand() {
      ...
      this.secondsArg = (OptionalArg)this.withOptionalArg("seconds", "server.commands.npc.benchmark.role.seconds", ArgTypes.DOUBLE).addValidator(Validators.greaterThan(0.0));
   }

   protected void executeSync(@Nonnull CommandContext context) {
      double seconds = this.secondsArg.provided(context) ? (Double)this.secondsArg.get(context) : 30.0;
      boolean success;
      if ((Boolean)this.roleArg.get(context)) {
      ...
      } else if ((Boolean)this.sensorSupportArg.get(context)) {
