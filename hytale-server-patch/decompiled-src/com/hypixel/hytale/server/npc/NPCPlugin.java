...
public class NPCPlugin extends JavaPlugin {
   ...
   public NPCPlugin(@Nonnull JavaPluginInit init) {
      super(init);
      this.config = this.withConfig("NPCModule", NPCPlugin.NPCConfig.CODEC);
   }
   ...
   protected void setup() {
      ...
      eventRegistry.register((Class)LoadedAssetsEvent.class, ModelAsset.class, this::onModelsChanged);
      eventRegistry.register((Class)LoadedAssetsEvent.class, NPCGroup.class, this::onNPCGroupsLoaded);
      eventRegistry.register((Class)RemovedAssetsEvent.class, NPCGroup.class, this::onNPCGroupsRemoved);
      eventRegistry.register((Class)LoadedAssetsEvent.class, AttitudeGroup.class, this::onAttitudeGroupsLoaded);
      eventRegistry.register((Class)RemovedAssetsEvent.class, AttitudeGroup.class, this::onAttitudeGroupsRemoved);
      eventRegistry.register((Class)LoadedAssetsEvent.class, ItemAttitudeGroup.class, this::onItemAttitudeGroupsLoaded);
      eventRegistry.register((Class)RemovedAssetsEvent.class, ItemAttitudeGroup.class, this::onItemAttitudeGroupsRemoved);
      eventRegistry.register((Class)LoadedAssetsEvent.class, BalanceAsset.class, NPCPlugin::onBalanceAssetsChanged);
      eventRegistry.register((Class)RemovedAssetsEvent.class, BalanceAsset.class, NPCPlugin::onBalanceAssetsRemoved);
      ...
      eventRegistry.register((short)-8, LoadAssetEvent.class, (event) -> {
         ...
         for(int i = 0; i < assetPacks.size(); ++i) {
            ...
            boolean loadSucceeded = this.builderManager.loadBuilders((AssetPack)assetPacks.get(i), includeTests);
            if (!loadSucceeded) {
      ...
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(AttitudeGroup.class, new IndexedLookupTableAssetMap((x$0) -> new AttitudeGroup[x$0])).setPath("NPC/Attitude/Roles")).setCodec(AttitudeGroup.CODEC)).setKeyFunction(AttitudeGroup::getId)).setReplaceOnRemove(AttitudeGroup::new)).loadsAfter(new Class[]{NPCGroup.class})).build());
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(ItemAttitudeGroup.class, new IndexedLookupTableAssetMap((x$0) -> new ItemAttitudeGroup[x$0])).setPath("NPC/Attitude/Items")).setCodec(ItemAttitudeGroup.CODEC)).setKeyFunction(ItemAttitudeGroup::getId)).setReplaceOnRemove(ItemAttitudeGroup::new)).loadsAfter(new Class[]{Item.class})).build());
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(BalanceAsset.class, new DefaultAssetMap()).setPath("NPC/Balancing")).setCodec(BalanceAsset.CODEC)).setKeyFunction(BalanceAsset::getId)).loadsAfter(new Class[]{Condition.class})).build());
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(Condition.class, new IndexedLookupTableAssetMap((x$0) -> new Condition[x$0])).setPath("NPC/DecisionMaking/Conditions")).setCodec(Condition.CODEC)).setKeyFunction(Condition::getId)).setReplaceOnRemove(Condition::getAlwaysTrueFor)).loadsAfter(new Class[]{ResponseCurve.class, NPCGroup.class, EntityStatType.class})).build());
   ...
   public void onSchemaGenerate(@Nonnull GenerateSchemaEvent event) {
      ...
      event.addSchemaLink("NPCRole", List.of("NPC/Roles/*.json", "NPC/Roles/**/*.json"), (String)null);
   ...
   public Pair<Ref<EntityStore>, INonPlayerCharacter> spawnNPC(@Nonnull Store<EntityStore> store, @Nonnull String npcType, @Nullable String groupType, @Nonnull Vector3d position, @Nonnull Vector3f rotation) {
      ...
      if (roleIndex < 0) {
         ...
         Pair<Ref<EntityStore>, NPCEntity> npcPair = this.spawnEntity(store, roleIndex, position, rotation, (Model)null, (TriConsumer)null);
         FlockAsset flockDefinition = groupType != null ? (FlockAsset)FlockAsset.getAssetMap().getAsset(groupType) : null;
         if (npcPair != null) {
            Ref<EntityStore> npcRef = (Ref)npcPair.first();
            NPCEntity npcComponent = (NPCEntity)npcPair.second();
            FlockPlugin.trySpawnFlock(npcRef, npcComponent, store, roleIndex, position, rotation, flockDefinition, (TriConsumer)null);
            return Pair.of((Ref)npcPair.first(), (INonPlayerCharacter)npcPair.second());
         } else {
            return null;
         }
      }
   ...
   public static void reloadNPCsWithRole(int roleIndex) {
      Universe.get().getWorlds().forEach((s, world) -> world.execute(() -> world.getEntityStore().getStore().forEachChunk(NPCEntity.getComponentType(), (BiConsumer)((archetypeChunk, commandBuffer) -> {
   ...
   public List<String> getRoleTemplateNames(boolean spawnableOnly) {
      return (List)this.builderManager.collectMatchingBuilders(new ObjectArrayList(), (entry) -> entry.getBuilder().category() == Role.class && (!spawnableOnly || entry.getBuilder().isSpawnable()), (builderInfo, objects) -> objects.add(builderInfo.getKeyName()));
   }
   ...
   public Pair<Ref<EntityStore>, NPCEntity> spawnEntity(@Nonnull Store<EntityStore> store, int roleIndex, @Nonnull Vector3d position, @Nullable Vector3f rotation, @Nullable Model spawnModel, @Nullable TriConsumer<NPCEntity, Ref<EntityStore>, Store<EntityStore>> postSpawn) {
      return this.spawnEntity(store, roleIndex, position, rotation, spawnModel, (TriConsumer)null, postSpawn);
   }
   ...
   protected void onModelsChanged(@Nonnull LoadedAssetsEvent<String, ModelAsset, DefaultAssetMap<String, ModelAsset>> event) {
      ...
      Universe.get().getWorlds().values().forEach((world) -> world.execute(() -> {
            ...
            store.forEachEntityParallel(NPCEntity.getComponentType(), (index, archetypeChunk, commandBuffer) -> {
               ModelComponent entityModelComponent = (ModelComponent)archetypeChunk.getComponent(index, ModelComponent.getComponentType());
               if (entityModelComponent != null) {
                  Model oldModel = entityModelComponent.getModel();
                  ModelAsset newModelAsset = (ModelAsset)loadedModelAssets.get(oldModel.getModelAssetId());
   ...
   public boolean startRoleBenchmark(double seconds, @Nonnull Consumer<Int2ObjectMap<TimeDistributionRecorder>> onFinished) {
      ...
      (new CompletableFuture()).completeOnTimeout((Object)null, Math.round(seconds * 1000.0), TimeUnit.MILLISECONDS).thenRunAsync(() -> {
      ...
      if (this.benchmarkLock.tryLock()) {
         try {
            if (this.roleTickDistribution != null) {
               ((TimeDistributionRecorder)this.roleTickDistribution.computeIfAbsent(roleIndex, (i) -> new TimeDistributionRecorder(0.01, 1.0E-5))).recordNanos(nanos);
      ...
      if (this.benchmarkLock.tryLock()) {
         try {
            if (this.roleSensorSupportDistribution != null) {
               ((SensorSupportBenchmark)this.roleSensorSupportDistribution.computeIfAbsent(roleIndex, (i) -> new SensorSupportBenchmark())).collectPlayerList(getNanos, maxPlayerDistanceSorted, maxPlayerDistance, maxPlayerDistanceAvoidance, numPlayers);
   ...
   public void collectSensorSupportEntityList(int roleIndex, long getNanos, double maxEntityDistanceSorted, double maxEntityDistance, double maxEntityDistanceAvoidance, int numEntities) {
      if (this.benchmarkLock.tryLock()) {
         try {
            if (this.roleSensorSupportDistribution != null) {
               ((SensorSupportBenchmark)this.roleSensorSupportDistribution.computeIfAbsent(roleIndex, (i) -> new SensorSupportBenchmark())).collectEntityList(getNanos, maxEntityDistanceSorted, maxEntityDistance, maxEntityDistanceAvoidance, numEntities);
   ...
   public void collectSensorSupportLosTest(int roleIndex, boolean cacheHit, long time) {
      if (this.isBenchmarkingSensorSupport() && this.benchmarkLock.tryLock()) {
         try {
            if (this.roleSensorSupportDistribution != null) {
               ((SensorSupportBenchmark)this.roleSensorSupportDistribution.computeIfAbsent(roleIndex, (i) -> new SensorSupportBenchmark())).collectLosTest(cacheHit, time);
   ...
   public void collectSensorSupportInverseLosTest(int roleIndex, boolean cacheHit) {
      if (this.isBenchmarkingSensorSupport() && this.benchmarkLock.tryLock()) {
         try {
            if (this.roleSensorSupportDistribution != null) {
               ((SensorSupportBenchmark)this.roleSensorSupportDistribution.computeIfAbsent(roleIndex, (i) -> new SensorSupportBenchmark())).collectInverseLosTest(cacheHit);
   ...
   public void collectSensorSupportFriendlyBlockingTest(int roleIndex, boolean cacheHit) {
      if (this.isBenchmarkingSensorSupport() && this.benchmarkLock.tryLock()) {
         try {
            if (this.roleSensorSupportDistribution != null) {
               ((SensorSupportBenchmark)this.roleSensorSupportDistribution.computeIfAbsent(roleIndex, (i) -> new SensorSupportBenchmark())).collectFriendlyBlockingTest(cacheHit);
   ...
   public void collectSensorSupportTickDone(int roleIndex) {
      if (this.isBenchmarkingSensorSupport() && this.benchmarkLock.tryLock()) {
         try {
            if (this.roleSensorSupportDistribution != null) {
               ((SensorSupportBenchmark)this.roleSensorSupportDistribution.computeIfAbsent(roleIndex, (i) -> new SensorSupportBenchmark())).tickDone();
   ...
   public <T> NPCPlugin registerCoreComponentType(String name, @Nonnull Supplier<Builder<T>> builder) {
      BuilderFactory<T> factory = this.builderManager.<T>getFactory(((Builder)builder.get()).category());
   ...
   protected void registerCoreFactories() {
      BuilderFactory<Role> roleFactory = new BuilderFactory<Role>(Role.class, "Type");
      ...
      BuilderFactory<MotionController> motionControllerFactory = new BuilderFactory<MotionController>(MotionController.class, "Type");
      ...
      BuilderFactory<Map<String, MotionController>> motionControllerMapFactory = new BuilderFactory<Map<String, MotionController>>(BuilderMotionControllerMapUtil.CLASS_REFERENCE, "Type", BuilderMotionControllerMap::new);
      this.builderManager.registerFactory(motionControllerMapFactory);
      BuilderFactory<ActionList> actionListFactory = new BuilderFactory<ActionList>(ActionList.class, "Type", BuilderActionList::new);
      this.builderManager.registerFactory(actionListFactory);
      BuilderFactory<Instruction> instructionFactory = new BuilderFactory<Instruction>(Instruction.class, "Type", BuilderInstruction::new);
      ...
      BuilderFactory<TransientPathDefinition> transientPathFactory = new BuilderFactory<TransientPathDefinition>(TransientPathDefinition.class, "Type", BuilderTransientPathDefinition::new);
      this.builderManager.registerFactory(transientPathFactory);
      BuilderFactory<RelativeWaypointDefinition> relativeWaypointFactory = new BuilderFactory<RelativeWaypointDefinition>(RelativeWaypointDefinition.class, "Type", BuilderRelativeWaypointDefinition::new);
      this.builderManager.registerFactory(relativeWaypointFactory);
      BuilderFactory<WeightedAction> weightedActionFactory = new BuilderFactory<WeightedAction>(WeightedAction.class, "Type", BuilderWeightedAction::new);
      this.builderManager.registerFactory(weightedActionFactory);
      BuilderFactory<BuilderValueToParameterMapping.ValueToParameterMapping> valueToParameterMappingFactory = new BuilderFactory<BuilderValueToParameterMapping.ValueToParameterMapping>(BuilderValueToParameterMapping.ValueToParameterMapping.class, "Type", BuilderValueToParameterMapping::new);
   ...
   protected static void onBalanceAssetsChanged(@Nonnull LoadedAssetsEvent<String, BalanceAsset, DefaultAssetMap<String, BalanceAsset>> event) {
      ...
      Universe.get().getWorlds().forEach((name, world) -> world.execute(() -> world.getEntityStore().getStore().forEachChunk(NPCEntity.getComponentType(), (BiConsumer)((archetypeChunk, commandBuffer) -> {
               for(int index = 0; index < archetypeChunk.size(); ++index) {
   ...
   public static class NPCConfig {
      ...
      static {
         CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(NPCConfig.class, NPCConfig::new).append(new KeyedCodec("Descriptors", Codec.BOOLEAN), (o, i) -> o.generateDescriptors = i, (o) -> o.generateDescriptors).add()).append(new KeyedCodec("DescriptorsFile", Codec.BOOLEAN), (o, i) -> o.generateDescriptorsFile = i, (o) -> o.generateDescriptorsFile).add()).append(new KeyedCodec("AutoReload", Codec.BOOLEAN), (o, i) -> o.autoReload = i, (o) -> o.autoReload).add()).append(new KeyedCodec("ValidateBuilders", Codec.BOOLEAN), (o, i) -> o.validateBuilder = i, (o) -> o.validateBuilder).add()).append(new KeyedCodec("MaxBlackboardBlockType", Codec.INTEGER), (o, i) -> o.maxBlackboardBlockType = i, (o) -> o.maxBlackboardBlockType).add()).append(new KeyedCodec("LogFailingTestErrors", Codec.BOOLEAN), (o, i) -> o.logFailingTestErrors = i, (o) -> o.logFailingTestErrors).add()).append(new KeyedCodec("PresetCoverageTestNPCs", Codec.STRING_ARRAY), (o, i) -> o.presetCoverageTestNPCs = i, (o) -> o.presetCoverageTestNPCs).add()).build();
      }
   }
