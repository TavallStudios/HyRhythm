...
public class TimeSinceLastUsedCondition extends ScaledCurveCondition {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(TimeSinceLastUsedCondition.class, TimeSinceLastUsedCondition::new, ScaledCurveCondition.ABSTRACT_CODEC).documentation("A scaled curve condition that returns a utility value based on how long it has been since the Option was last used.")).build();
   }
}
