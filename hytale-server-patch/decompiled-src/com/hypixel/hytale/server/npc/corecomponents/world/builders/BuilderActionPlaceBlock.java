...
public class BuilderActionPlaceBlock extends BuilderActionBase {
   ...
   public BuilderActionPlaceBlock readConfig(@Nonnull JsonElement data) {
      this.getDouble(data, "Range", this.range, 3.0, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "The range to target position before block will be placed", (String)null);
