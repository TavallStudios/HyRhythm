...
public class BuilderBodyMotionLeave extends BuilderBodyMotionFindBase {
   ...
   public BuilderBodyMotionFindBase readConfig(@Nonnull JsonElement data) {
      ...
      this.requireDouble(data, "Distance", this.distance, DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Minimum distance required", (String)null);
      return this;
   }
