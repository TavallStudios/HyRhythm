...
public class BuilderSensorEntity extends BuilderSensorEntityBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      ...
      this.getBoolean(data, "GetPlayers", this.getPlayers, false, BuilderDescriptorState.Stable, "Test players", (String)null);
      this.getBoolean(data, "GetNPCs", this.getNPCs, true, BuilderDescriptorState.Stable, "Test mobs/NPCs", (String)null);
      this.getBoolean(data, "ExcludeOwnType", this.excludeOwnType, true, BuilderDescriptorState.Stable, "Exclude NPCs of same type as current NPC", (String)null);
