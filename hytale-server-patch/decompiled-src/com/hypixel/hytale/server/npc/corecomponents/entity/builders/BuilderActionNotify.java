...
public class BuilderActionNotify extends BuilderActionBase {
   ...
   public BuilderActionNotify readConfig(@Nonnull JsonElement data) {
      this.requireString(data, "Message", this.message, StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The message to send", (String)null);
      ...
      this.getString(data, "UseTargetSlot", (s) -> this.usedTargetSlot = s, (String)null, StringNullOrNotEmptyValidator.get(), BuilderDescriptorState.Stable, "A marked target to send to instead of the target provided by a sensor. Omit to use the target provided by the sensor.", (String)null);
   ...
   public int getUsedTargetSlot(@Nonnull BuilderSupport support) {
      return this.usedTargetSlot == null ? -2147483648 : support.getTargetSlot(this.usedTargetSlot);
   }
}
