...
public class BuilderActionResetInstructions extends BuilderActionBase {
   ...
   public BuilderActionResetInstructions readConfig(@Nonnull JsonElement data) {
      this.getStringArray(data, "Instructions", this.instructions, (String[])null, 0, 2147483647, StringArrayNoEmptyStringsValidator.get(), BuilderDescriptorState.Stable, "The instructionList to reset", "The instructionList to reset. If left empty, will reset all instructionList");
      return this;
   }
