...
public class BuilderEntityFilterViewSector extends BuilderEntityFilterBase {
   ...
   public Builder<IEntityFilter> readConfig(@Nonnull JsonElement data) {
      this.getFloat(data, "ViewSector", this.viewSector, 0.0, DoubleRangeValidator.between(0.0, 360.0), BuilderDescriptorState.Stable, "View sector to test entities in", (String)null);
