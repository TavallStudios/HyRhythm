...
public abstract class BuilderSensorMany extends BuilderSensorBase {
   @Nonnull
   protected BuilderObjectListHelper<Sensor> objectListHelper = new BuilderObjectListHelper<Sensor>(Sensor.class, this);
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      ...
      this.requireArray(data, "Sensors", this.objectListHelper, ArrayNotEmptyValidator.get(), BuilderDescriptorState.Stable, "List of sensors", (String)null, this.validationHelper);
      this.getString(data, "AutoUnlockTargetSlot", this.unlockTargetSlot, (String)null, StringNullOrNotEmptyValidator.get(), BuilderDescriptorState.Stable, "A target slot to unlock when sensor doesn't match anymore", (String)null);
      return this;
   }
   ...
   public boolean validate(String configName, @Nonnull NPCLoadTimeValidationHelper validationHelper, @Nonnull ExecutionContext context, Scope globalScope, @Nonnull List<String> errors) {
      return super.validate(configName, validationHelper, context, globalScope, errors) & this.objectListHelper.validate(configName, validationHelper, this.builderManager, context, globalScope, errors);
   }
