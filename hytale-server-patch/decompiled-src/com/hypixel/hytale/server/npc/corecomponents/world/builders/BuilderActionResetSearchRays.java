...
public class BuilderActionResetSearchRays extends BuilderActionBase {
   ...
   public BuilderActionResetSearchRays readConfig(@Nonnull JsonElement data) {
      this.getStringArray(data, "Names", this.names, (String[])null, 0, 2147483647, StringArrayNoEmptyStringsValidator.get(), BuilderDescriptorState.Stable, "The search ray sensor ids", "The search ray sensor ids. If left empty, will reset all search ray sensors");
      return this;
   }
