...
public class BuilderSensorSearchRay extends BuilderSensorBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireString(data, "Name", this.id, StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The id of this search ray sensor so the position can be cached", (String)null);
