...
public class BuilderSensorEval extends BuilderSensorBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireString(data, "Expression", (s) -> this.expression = s, StringNotEmptyValidator.get(), BuilderDescriptorState.Experimental, "Javascript expression", (String)null);
      return this;
   }
