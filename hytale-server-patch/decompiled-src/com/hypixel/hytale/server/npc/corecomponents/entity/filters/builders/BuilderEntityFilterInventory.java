...
public class BuilderEntityFilterInventory extends BuilderEntityFilterBase {
   public static final int[] DEFAULT_FREE_SLOT_RANGE = new int[]{0, 2147483647};
   public static final int[] DEFAULT_ITEM_COUNT_RANGE = new int[]{1, 2147483647};
   ...
   public Builder<IEntityFilter> readConfig(@Nonnull JsonElement data) {
      this.getAssetArray(data, "Items", this.items, DEFAULT_ITEM_PATTERNS, 0, 2147483647, ItemExistsValidator.withConfig(EnumSet.of(AssetValidator.Config.MATCHER)), BuilderDescriptorState.Stable, "A list of glob item patterns to match", (String)null);
      this.getIntRange(data, "CountRange", this.count, DEFAULT_ITEM_COUNT_RANGE, IntSequenceValidator.betweenWeaklyMonotonic(0, 2147483647), BuilderDescriptorState.Stable, "The range of number of items that need to match the patterns", (String)null);
      this.getIntRange(data, "FreeSlotRange", this.freeSlots, DEFAULT_FREE_SLOT_RANGE, IntSequenceValidator.betweenWeaklyMonotonic(0, 2147483647), BuilderDescriptorState.Stable, "The range designating the number of required free slots", "The range designating the number of required free slots. Setting min and max to zero would check if full");
      return this;
   }
