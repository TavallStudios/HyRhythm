...
public class BuilderBodyMotionTakeOff extends BuilderBodyMotionBase {
   ...
   public Builder<BodyMotion> readConfig(@Nonnull JsonElement data) {
      this.getDouble(data, "JumpSpeed", (v) -> this.jumpSpeed = v, 0.0, DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.Experimental, "Speed to jump off", (String)null);
      return this;
   }
