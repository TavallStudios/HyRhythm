...
public class BuilderActionParentState extends BuilderActionBase {
   ...
   public BuilderActionParentState readConfig(@Nonnull JsonElement data) {
      ...
      this.requireString(data, "State", (v) -> this.state = validator.getMainState(), validator, BuilderDescriptorState.Stable, "The alias of the external state to set, as defined by _ImportStates in parameters", (String)null);
      this.registerStateSetter(this.state, (String)null, (m, s) -> {
      });
