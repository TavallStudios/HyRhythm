...
public class BuilderActionOverrideAttitude extends BuilderActionBase {
   protected final EnumHolder<Attitude> attitude = new EnumHolder<Attitude>();
   ...
   public BuilderActionOverrideAttitude readConfig(@Nonnull JsonElement data) {
      this.requireEnum(data, "Attitude", this.attitude, Attitude.class, BuilderDescriptorState.Stable, "The attitude to set", (String)null);
      this.getDouble(data, "Duration", this.duration, 10.0, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "The duration to override for", (String)null);
