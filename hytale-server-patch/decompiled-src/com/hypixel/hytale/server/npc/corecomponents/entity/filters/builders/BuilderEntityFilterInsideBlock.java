...
public class BuilderEntityFilterInsideBlock extends BuilderEntityFilterBase {
   ...
   public Builder<IEntityFilter> readConfig(@Nonnull JsonElement data) {
      this.requireAsset(data, "BlockSet", this.blockSet, BlockSetExistsValidator.required(), BuilderDescriptorState.Stable, "The BlockSet to match against", (String)null);
      return this;
   }
