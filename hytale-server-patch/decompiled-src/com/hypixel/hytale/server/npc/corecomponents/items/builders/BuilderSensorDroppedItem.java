...
public class BuilderSensorDroppedItem extends BuilderSensorBase {
   ...
   protected final EnumSetHolder<ItemAttitudeGroup.Sentiment> attitudes = new EnumSetHolder<ItemAttitudeGroup.Sentiment>();
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireDouble(data, "Range", this.range, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "The range within which to look", (String)null);
      this.getFloat(data, "ViewSector", this.viewSector, 0.0, DoubleRangeValidator.between(0.0, 360.0), BuilderDescriptorState.Stable, "View sector in which to look", (String)null);
      this.getBoolean(data, "LineOfSight", this.hasLineOfSight, false, BuilderDescriptorState.Stable, "Requires line of sight to item", (String)null);
      this.getAssetArray(data, "Items", this.items, (String[])null, 0, 2147483647, ItemExistsValidator.withConfig(EnumSet.of(AssetValidator.Config.LIST_NULLABLE, AssetValidator.Config.LIST_CAN_BE_EMPTY, AssetValidator.Config.MATCHER)), BuilderDescriptorState.Stable, "A list of glob item patterns to match. If omitted, will match any item", (String)null);
      this.getEnumSet(data, "Attitudes", this.attitudes, ItemAttitudeGroup.Sentiment.class, EnumSet.noneOf(ItemAttitudeGroup.Sentiment.class), BuilderDescriptorState.Stable, "Attitudes to match", (String)null);
