...
public class BuilderSensorAnimation extends BuilderSensorBase {
   protected final EnumHolder<NPCAnimationSlot> animationSlot = new EnumHolder<NPCAnimationSlot>();
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireEnum(data, "Slot", this.animationSlot, NPCAnimationSlot.class, BuilderDescriptorState.Stable, "The animation slot to check", (String)null);
      this.requireString(data, "Animation", this.animationId, StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The animation ID to check for", (String)null);
      return this;
   }
