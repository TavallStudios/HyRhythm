...
public class BuilderEntityFilterAltitude extends BuilderEntityFilterBase {
   ...
   public Builder<IEntityFilter> readConfig(@Nonnull JsonElement data) {
      this.requireDoubleArray(data, "AltitudeRange", this.altitudeRange, 0, 2147483647, DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 1.7976931348623157E308), BuilderDescriptorState.Stable, "The range above the ground to match", (String)null);
      return this;
   }
