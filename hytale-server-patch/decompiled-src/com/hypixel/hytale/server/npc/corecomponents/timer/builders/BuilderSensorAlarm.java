...
public class BuilderSensorAlarm extends BuilderSensorBase {
   ...
   protected final EnumHolder<SensorAlarm.State> state = new EnumHolder<SensorAlarm.State>();
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireString(data, "Name", this.name, StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The name of the alarm to check", (String)null);
      this.requireEnum(data, "State", this.state, SensorAlarm.State.class, BuilderDescriptorState.Stable, "The state to check for", (String)null);
      this.getBoolean(data, "Clear", this.clear, false, BuilderDescriptorState.Stable, "Whether to clear the alarm (unset it) if it has passed", (String)null);
      return this;
   }
