...
public class BuilderSensorInteractionContext extends BuilderSensorBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireString(data, "Context", this.interactionContext, StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The context of the interaction", (String)null);
