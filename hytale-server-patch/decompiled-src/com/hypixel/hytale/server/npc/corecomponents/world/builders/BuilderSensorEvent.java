...
public abstract class BuilderSensorEvent extends BuilderSensorBase {
   ...
   protected final EnumHolder<SensorEvent.EventSearchType> searchType = new EnumHolder<SensorEvent.EventSearchType>();
   protected final StringHolder lockOnTargetSlot = new StringHolder();

   @Nonnull
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireDouble(data, "Range", this.range, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Max range to listen in", (String)null);
      this.getEnum(data, "SearchType", this.searchType, SensorEvent.EventSearchType.class, SensorEvent.EventSearchType.PlayerOnly, BuilderDescriptorState.Stable, "Whether to listen for events triggered by players, npcs, or both in a certain order", (String)null);
      this.getString(data, "TargetSlot", this.lockOnTargetSlot, (String)null, StringNullOrNotEmptyValidator.get(), BuilderDescriptorState.Stable, "A target slot to place the target in. If omitted, no slot will be used", (String)null);
