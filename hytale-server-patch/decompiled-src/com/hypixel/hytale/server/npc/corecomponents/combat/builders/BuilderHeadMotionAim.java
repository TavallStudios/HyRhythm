...
public class BuilderHeadMotionAim extends BuilderHeadMotionBase {
   ...
   public BuilderHeadMotionAim readConfig(@Nonnull JsonElement data) {
      this.getDouble(data, "Spread", this.spread, 1.0, DoubleRangeValidator.between(0.0, 5.0), BuilderDescriptorState.Experimental, "Random targeting error", (String)null);
      this.getDouble(data, "HitProbability", this.hitProbability, 0.33, DoubleRangeValidator.between01(), BuilderDescriptorState.Experimental, "Probability of shot being straight on target", (String)null);
      this.getBoolean(data, "Deflection", this.deflection, true, BuilderDescriptorState.Experimental, "Compute deflection for moving targets", (String)null);
