...
public class BuilderSensorEntityEvent extends BuilderSensorEvent {
   ...
   protected final EnumHolder<EntityEventType> entityEventType = new EnumHolder<EntityEventType>();
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      ...
      this.requireAsset(data, "NPCGroup", this.npcGroup, TagSetExistsValidator.required(), BuilderDescriptorState.Stable, "NPC group to listen for", (String)null);
      this.getEnum(data, "EventType", this.entityEventType, EntityEventType.class, EntityEventType.DAMAGE, BuilderDescriptorState.Stable, "The event type to listen for", (String)null);
      this.getBoolean(data, "FlockOnly", this.flockOnly, false, BuilderDescriptorState.Stable, "Whether to only listen for flock events", (String)null);
      return this;
   }
