...
public class BuilderActionSpawn extends BuilderActionBase {
   ...
   public BuilderActionSpawn readConfig(@Nonnull JsonElement data) {
      this.getFloat(data, "SpawnDirection", this.spawnDirection, 0.0, DoubleRangeValidator.between(-180.0, 180.0), BuilderDescriptorState.Experimental, "Direction of spawn cone relative to view direction (in degrees)", (String)null);
      this.getFloat(data, "SpawnAngle", this.spawnAngle, 360.0, DoubleRangeValidator.between(0.0, 360.0), BuilderDescriptorState.Experimental, "Cone width of spawn direction (in degrees)", (String)null);
