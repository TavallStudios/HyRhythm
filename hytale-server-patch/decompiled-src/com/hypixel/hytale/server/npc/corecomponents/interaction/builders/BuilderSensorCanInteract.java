...
public class BuilderSensorCanInteract extends BuilderSensorBase {
   ...
   protected final EnumSetHolder<Attitude> attitudes = new EnumSetHolder<Attitude>();
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.getFloat(data, "ViewSector", this.viewSector, 0.0, DoubleRangeValidator.between(0.0, 360.0), BuilderDescriptorState.Stable, "View sector to test the player in", (String)null);
      this.getEnumSet(data, "Attitudes", this.attitudes, Attitude.class, EnumSet.of(Attitude.NEUTRAL, Attitude.FRIENDLY, Attitude.REVERED), BuilderDescriptorState.Stable, "A set of attitudes to match", (String)null);
