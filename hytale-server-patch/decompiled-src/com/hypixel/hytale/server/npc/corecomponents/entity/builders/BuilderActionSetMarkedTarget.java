...
public class BuilderActionSetMarkedTarget extends BuilderActionBase {
   ...
   public BuilderActionSetMarkedTarget readConfig(@Nonnull JsonElement data) {
      this.getString(data, "TargetSlot", this.targetSlot, "LockedTarget", StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The target slot to set a target to.", (String)null);
