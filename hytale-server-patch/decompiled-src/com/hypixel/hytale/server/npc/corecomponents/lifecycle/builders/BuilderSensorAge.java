...
public class BuilderSensorAge extends BuilderSensorBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireTemporalRange(data, "AgeRange", this.ageRange, TemporalSequenceValidator.betweenMonotonic(MIN_TIME, MAX_TIME), BuilderDescriptorState.Stable, "The age range within which to trigger", (String)null);
      return this;
   }
