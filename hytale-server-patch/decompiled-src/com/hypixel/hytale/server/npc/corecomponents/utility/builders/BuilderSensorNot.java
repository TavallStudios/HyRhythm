...
public class BuilderSensorNot extends BuilderSensorBase {
   ...
   public BuilderSensorNot readConfig(@Nonnull JsonElement data) {
      ...
      this.requireObject(data, "Sensor", this.sensor, BuilderDescriptorState.Stable, "Sensor to test", (String)null, this.validationHelper);
      this.getString(data, "UseTargetSlot", this.targetSlot, (String)null, StringNullOrNotEmptyValidator.get(), BuilderDescriptorState.Stable, "A locked target slot to feed to action (if available)", (String)null);
      this.getString(data, "AutoUnlockTargetSlot", this.autoUnlockTargetSlot, (String)null, StringNullOrNotEmptyValidator.get(), BuilderDescriptorState.Stable, "A target slot to unlock when sensor doesn't match anymore", (String)null);
      return this;
   }
   ...
   public boolean validate(String configName, @Nonnull NPCLoadTimeValidationHelper validationHelper, @Nonnull ExecutionContext context, Scope globalScope, @Nonnull List<String> errors) {
      return super.validate(configName, validationHelper, context, globalScope, errors) & this.sensor.validate(configName, validationHelper, this.builderManager, context, globalScope, errors);
   }
