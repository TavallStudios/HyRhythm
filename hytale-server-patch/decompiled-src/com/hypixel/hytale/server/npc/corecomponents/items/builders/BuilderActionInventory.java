...
public class BuilderActionInventory extends BuilderActionBase {
   protected final EnumHolder<ActionInventory.Operation> operation = new EnumHolder<ActionInventory.Operation>();
   ...
   public Builder<Action> readConfig(@Nonnull JsonElement data) {
      this.getEnum(data, "Operation", this.operation, ActionInventory.Operation.class, ActionInventory.Operation.Add, BuilderDescriptorState.Stable, "Operation to perform", (String)null);
      this.getInt(data, "Count", this.count, 1, IntSingleValidator.greater0(), BuilderDescriptorState.Stable, "Number of items to add/remove", (String)null);
      this.getAsset(data, "Item", this.item, "", ItemExistsValidator.withConfig(AssetValidator.CanBeEmpty), BuilderDescriptorState.Stable, "Item type to add, remove, or equip", (String)null);
      ...
      this.getInt(data, "Slot", this.slot, 0, (IntValidator)null, BuilderDescriptorState.Stable, "The hotbar or off-hand slot to affect", "The hotbar or off-hand to effect. Only valid for Hotbar/OffHand Set/Equip operations");
