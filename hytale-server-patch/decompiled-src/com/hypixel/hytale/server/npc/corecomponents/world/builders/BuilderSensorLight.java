...
public class BuilderSensorLight extends BuilderSensorBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.getDoubleRange(data, "LightRange", this.lightRange, FULL_LIGHT_RANGE, DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 100.0), BuilderDescriptorState.Stable, "The light intensity percentage range", (String)null);
      this.getDoubleRange(data, "SkyLightRange", this.skyLightRange, FULL_LIGHT_RANGE, DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 100.0), BuilderDescriptorState.Stable, "The sky light percentage range", (String)null);
      this.getDoubleRange(data, "SunlightRange", this.sunlightRange, FULL_LIGHT_RANGE, DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 100.0), BuilderDescriptorState.Stable, "The sunlight percentage range", (String)null);
      this.getDoubleRange(data, "RedLightRange", this.redLightRange, FULL_LIGHT_RANGE, DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 100.0), BuilderDescriptorState.Stable, "The red light percentage range", (String)null);
      this.getDoubleRange(data, "GreenLightRange", this.greenLightRange, FULL_LIGHT_RANGE, DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 100.0), BuilderDescriptorState.Stable, "The green light percentage range", (String)null);
      this.getDoubleRange(data, "BlueLightRange", this.blueLightRange, FULL_LIGHT_RANGE, DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 100.0), BuilderDescriptorState.Stable, "The blue light percentage range", (String)null);
      this.getString(data, "UseTargetSlot", this.useTargetSlot, (String)null, StringNullOrNotEmptyValidator.get(), BuilderDescriptorState.Stable, "A target slot to check. If omitted, will check self", (String)null);
      return this;
   }
