...
public class BuilderActionReleaseTarget extends BuilderActionBase {
   ...
   public BuilderActionReleaseTarget readConfig(@Nonnull JsonElement data) {
      this.getString(data, "TargetSlot", this.targetSlot, "LockedTarget", StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The target slot to release", (String)null);
      return this;
   }
