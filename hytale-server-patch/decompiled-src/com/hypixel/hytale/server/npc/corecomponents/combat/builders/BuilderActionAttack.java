...
public class BuilderActionAttack extends BuilderActionBase {
   ...
   protected final EnumHolder<ActionAttack.AttackType> attackType = new EnumHolder<ActionAttack.AttackType>();
   ...
   public BuilderActionAttack() {
      ...
      this.interactionVars = new BuilderCodecObjectHelper<Map<String, String>>(RootInteraction.class, RootInteraction.CHILD_ASSET_CODEC_MAP, (Validator)null);
   }
   ...
   public BuilderActionAttack readConfig(@Nonnull JsonElement data) {
      this.attackProvided = this.getAsset(data, "Attack", this.attack, (String)null, CombatInteractionValidator.withConfig(AssetValidator.CanBeEmpty), BuilderDescriptorState.Experimental, "Attack pattern to use", "Attack pattern to use. If omitted, will cancel current attack");
      this.getEnum(data, "AttackType", this.attackType, ActionAttack.AttackType.class, ActionAttack.AttackType.Primary, BuilderDescriptorState.Stable, "The interaction type to use", (String)null);
