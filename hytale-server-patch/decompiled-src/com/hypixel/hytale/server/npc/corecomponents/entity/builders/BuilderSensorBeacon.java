...
public class BuilderSensorBeacon extends BuilderSensorBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      ...
      this.getDouble(data, "Range", this.range, 64.0, DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "The max distance beacons should be received from", (String)null);
