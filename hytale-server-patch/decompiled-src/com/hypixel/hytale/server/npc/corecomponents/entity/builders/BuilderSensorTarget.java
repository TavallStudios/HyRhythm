...
public class BuilderSensorTarget extends BuilderSensorWithEntityFilters {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.getString(data, "TargetSlot", this.targetSlot, "LockedTarget", StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The target slot to check", (String)null);
      this.getDouble(data, "Range", this.range, 1.7976931348623157E308, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Maximum range of locked target", (String)null);
      this.getBoolean(data, "AutoUnlockTarget", this.autoUnlockTarget, false, BuilderDescriptorState.Stable, "Unlock locked target if match fails", (String)null);
