...
public class ActionTimer extends ActionBase {
   ...
   public boolean execute(@Nonnull Ref<EntityStore> ref, @Nonnull Role role, InfoProvider sensorInfo, double dt, @Nonnull Store<EntityStore> store) {
      ...
      switch (this.action) {
         case START -> this.executeStartAction();
         case PAUSE -> this.executePauseAction();
         case STOP -> this.executeStopAction();
         case MODIFY -> this.executeModifyAction();
         case CONTINUE -> this.executeContinueAction();
         case RESTART -> this.executeRestartAction();
      }
