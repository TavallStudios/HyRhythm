...
public class BuilderActionIgnoreForAvoidance extends BuilderActionBase {
   ...
   public BuilderActionIgnoreForAvoidance readConfig(@Nonnull JsonElement data) {
      this.requireString(data, "TargetSlot", this.targetSlot, StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The target slot containing the entity to be ignored", (String)null);
      return this;
   }
