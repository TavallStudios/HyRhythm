...
public abstract class BuilderMotionTimer<T extends Motion> extends BuilderMotionBase<T> {
   ...
   public BuilderMotionTimer<T> readConfig(@Nonnull JsonElement data) {
      this.getDoubleRange(data, "Time", this.timerRange, DEFAULT_TIMER_RANGE, DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 1.7976931348623157E308), BuilderDescriptorState.Stable, "Range of time from which the random timer length can be chosen", (String)null);
      this.requireObject(data, "Motion", this.motion, BuilderDescriptorState.Stable, "Motion to execute", (String)null, this.validationHelper);
      return this;
   }
