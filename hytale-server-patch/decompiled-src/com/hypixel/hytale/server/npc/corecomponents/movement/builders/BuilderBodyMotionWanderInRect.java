...
public class BuilderBodyMotionWanderInRect extends BuilderBodyMotionWanderBase {
   ...
   public BuilderBodyMotionWanderInRect readConfig(@Nonnull JsonElement data) {
      this.getDouble(data, "Width", (w) -> this.width = w, 10.0, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Rectangle width", (String)null);
      this.getDouble(data, "Depth", (d) -> this.depth = d, 10.0, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Rectangle depth", (String)null);
      return this;
   }
