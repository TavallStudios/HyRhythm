...
public class BuilderEntityFilterCombat extends BuilderEntityFilterBase {
   ...
   protected final EnumHolder<EntityFilterCombat.Mode> mode = new EnumHolder<EntityFilterCombat.Mode>();
   ...
   public Builder<IEntityFilter> readConfig(@Nonnull JsonElement data) {
      this.getAsset(data, "Sequence", this.sequence, (String)null, CombatInteractionValidator.withConfig(AssetValidator.CanBeEmpty), BuilderDescriptorState.Stable, "The attack ID to check for.", (String)null);
      this.getDoubleRange(data, "TimeElapsedRange", this.elapsedTimeRange, DEFAULT_TIME_ELAPSED_RANGE, DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 3.4028234663852886E38), BuilderDescriptorState.Stable, "The acceptable elapsed time range in seconds.", (String)null);
      this.getEnum(data, "Mode", this.mode, EntityFilterCombat.Mode.class, EntityFilterCombat.Mode.Attacking, BuilderDescriptorState.Stable, "Type of combat to trigger on", (String)null);
