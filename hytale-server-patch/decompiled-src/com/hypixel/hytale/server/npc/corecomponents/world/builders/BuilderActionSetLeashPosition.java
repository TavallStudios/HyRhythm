...
public class BuilderActionSetLeashPosition extends BuilderActionBase {
   ...
   public BuilderActionSetLeashPosition readConfig(@Nonnull JsonElement data) {
      this.getBoolean(data, "ToCurrent", (b) -> this.toCurrent = b, false, BuilderDescriptorState.Stable, "Set to the NPCs current position.", (String)null);
      this.getBoolean(data, "ToTarget", (b) -> this.toTarget = b, false, BuilderDescriptorState.Stable, "Set to the target position.", (String)null);
