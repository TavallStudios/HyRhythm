...
public class BuilderSensorSelf extends BuilderSensorWithEntityFilters {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      ...
      this.requireArray(data, "Filters", this.filters, (ArrayValidator)null, BuilderDescriptorState.Stable, "A series of entity filter sensors to test", (String)null, builderHelper);
