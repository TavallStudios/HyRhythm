...
public class BuilderBodyMotionWanderInCircle extends BuilderBodyMotionWanderBase {
   ...
   public BuilderBodyMotionWanderInCircle readConfig(@Nonnull JsonElement data) {
      this.getDouble(data, "Radius", this.radius, 10.0, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Radius of circle to wander in", (String)null);
      this.getBoolean(data, "Flock", (b) -> this.flock = b, false, BuilderDescriptorState.Experimental, "Do not use", (String)null);
