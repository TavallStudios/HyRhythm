...
public class BuilderSensorAdjustPosition extends BuilderSensorBase {
   ...
   public BuilderSensorAdjustPosition readConfig(@Nonnull JsonElement data) {
      ...
      this.requireVector3d(data, "Offset", this.offset, (DoubleArrayValidator)null, BuilderDescriptorState.Stable, "The offset to apply to the returned position from the sensor", (String)null);
