      ...
      if (!super.matches(ref, role, dt, store)) {
         ...
         if (blockData == null) {
            ...
            if (this.reserveBlock || !blockType.isAllowsMultipleUsers()) {
               ResourceView resourceView = (ResourceView)((Blackboard)store.getResource(Blackboard.getResourceType())).getView(ResourceView.class, ResourceView.indexViewFromWorldPosition(position));
