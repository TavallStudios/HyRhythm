...
public class BuilderActionSetStat extends BuilderActionBase {
   ...
   public BuilderActionSetStat readConfig(@Nonnull JsonElement data) {
      this.requireAsset(data, "Stat", this.stat, EntityStatExistsValidator.required(), BuilderDescriptorState.Stable, "The entity stat to affect.", (String)null);
      this.requireFloat(data, "Value", this.value, (DoubleValidator)null, BuilderDescriptorState.Stable, "The value to set the stat to.", (String)null);
      this.getBoolean(data, "Add", this.add, false, BuilderDescriptorState.Stable, "Add the value to the existing value instead of setting it.", (String)null);
      return this;
   }
