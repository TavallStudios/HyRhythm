...
public class BuilderActionTriggerSpawners extends BuilderActionBase {
   ...
   public BuilderActionTriggerSpawners readConfig(@Nonnull JsonElement data) {
      this.getAsset(data, "SpawnMarker", this.spawner, (String)null, ManualSpawnMarkerExistsValidator.withConfig(EnumSet.of(AssetValidator.Config.NULLABLE)), BuilderDescriptorState.Stable, "The spawn marker type to trigger", (String)null);
      this.requireDouble(data, "Range", this.range, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "The range within which to trigger spawn markers", (String)null);
      this.getInt(data, "Count", this.count, 0, IntSingleValidator.greaterEqual0(), BuilderDescriptorState.Stable, "The number of markers to randomly trigger (0 will trigger all matching validators)", (String)null);
      return this;
   }
