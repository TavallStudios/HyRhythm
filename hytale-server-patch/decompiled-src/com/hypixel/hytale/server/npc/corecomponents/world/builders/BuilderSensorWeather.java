...
public class BuilderSensorWeather extends BuilderSensorBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireAssetArray(data, "Weathers", this.weathers, 0, 2147483647, WeatherExistsValidator.withConfig(EnumSet.of(AssetValidator.Config.MATCHER)), BuilderDescriptorState.Stable, "The glob patterns to match against weather", (String)null);
      return this;
   }
