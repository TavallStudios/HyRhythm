...
public class BuilderEntityFilterHeightDifference extends BuilderEntityFilterBase {
   public static final double[] DEFAULT_HEIGHT_DIFFERENCE_RANGE = new double[]{-1.7976931348623157E308, 1.7976931348623157E308};
   ...
   public Builder<IEntityFilter> readConfig(@Nonnull JsonElement data) {
      this.getDoubleRange(data, "HeightDifference", this.heightDifference, DEFAULT_HEIGHT_DIFFERENCE_RANGE, DoubleSequenceValidator.betweenWeaklyMonotonic(-1.7976931348623157E308, 1.7976931348623157E308), BuilderDescriptorState.Stable, "The height range to test entities in", "The height range to test entities in. Extends into negatives for positions below the NPC");
      this.getBoolean(data, "UseEyePosition", this.useEyePosition, true, BuilderDescriptorState.Stable, "Use eye position for height difference checks", (String)null);
