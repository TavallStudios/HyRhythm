...
public class BuilderSensorValueProviderWrapper extends BuilderSensorBase {
   ...
   protected final BuilderObjectStaticListHelper<BuilderValueToParameterMapping.ValueToParameterMapping> parameterMappings = new BuilderObjectStaticListHelper<BuilderValueToParameterMapping.ValueToParameterMapping>(BuilderValueToParameterMapping.ValueToParameterMapping.class, this);
   ...
   public BuilderSensorValueProviderWrapper readConfig(@Nonnull JsonElement data) {
      this.getBoolean(data, "PassValues", this.passValues, true, BuilderDescriptorState.Stable, "Used to enable/disable passing of values in components", (String)null);
      ...
      this.requireArray(data, "ValueToParameterMappings", this.parameterMappings, ArrayNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The mappings of values to override parameters", (String)null, this.validationHelper);
      return this;
   }
   ...
   public boolean validate(String configName, @Nonnull NPCLoadTimeValidationHelper validationHelper, @Nonnull ExecutionContext context, Scope globalScope, @Nonnull List<String> errors) {
      boolean valid = super.validate(configName, validationHelper, context, globalScope, errors) & this.sensor.validate(configName, validationHelper, this.builderManager, context, globalScope, errors) & this.parameterMappings.validate(configName, validationHelper, this.builderManager, context, globalScope, errors);
