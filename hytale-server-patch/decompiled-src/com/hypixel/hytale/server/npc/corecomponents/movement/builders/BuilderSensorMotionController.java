...
public class BuilderSensorMotionController extends BuilderSensorBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireString(data, "MotionController", (s) -> this.motionControllerName = s, StringNotEmptyValidator.get(), BuilderDescriptorState.Experimental, "Motion controller name to test for", (String)null);
      return this;
   }
