...
public abstract class BuilderEntityFilterMany extends BuilderEntityFilterWithToggle {
   @Nonnull
   protected BuilderObjectListHelper<IEntityFilter> objectListHelper = new BuilderObjectListHelper<IEntityFilter>(IEntityFilter.class, this);
   ...
   public Builder<IEntityFilter> readConfig(@Nonnull JsonElement data) {
      this.requireArray(data, "Filters", this.objectListHelper, ArrayNotEmptyValidator.get(), BuilderDescriptorState.Stable, "List of filters", (String)null, this.validationHelper);
      return this;
   }
