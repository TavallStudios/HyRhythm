...
public class BuilderActionState extends BuilderActionBase {
   ...
   public BuilderActionState readConfig(@Nonnull JsonElement data) {
      ...
      }, BuilderDescriptorState.Stable, "State name to set", (String)null);
      this.getBoolean(data, "ClearState", (v) -> this.clearState = v, true, BuilderDescriptorState.Stable, "Clear the state of things like set once flags on transition", (String)null);
