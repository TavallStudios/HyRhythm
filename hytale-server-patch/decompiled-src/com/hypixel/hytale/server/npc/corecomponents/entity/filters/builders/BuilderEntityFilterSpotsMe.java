...
public class BuilderEntityFilterSpotsMe extends BuilderEntityFilterBase {
   ...
   public Builder<IEntityFilter> readConfig(@Nonnull JsonElement data) {
      this.getFloat(data, "ViewAngle", (f) -> this.viewAngle = f * 0.017453292F, 90.0F, DoubleRangeValidator.between(0.0, 360.0), BuilderDescriptorState.Stable, "Angle used for view sector and view cone test", (String)null);
      this.getEnum(data, "ViewTest", (e) -> this.viewTest = e, ViewTest.class, ViewTest.VIEW_SECTOR, BuilderDescriptorState.Stable, "Check if the entity is in the view cone, view sector, or neither", (String)null);
      this.getBoolean(data, "TestLineOfSight", (b) -> this.testLineOfSight = b, true, BuilderDescriptorState.Stable, "Check if view to the npc is not obstructed", (String)null);
