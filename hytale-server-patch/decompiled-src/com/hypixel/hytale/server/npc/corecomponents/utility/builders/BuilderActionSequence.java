...
public class BuilderActionSequence extends BuilderActionBase {
   ...
   public BuilderActionSequence readConfig(@Nonnull JsonElement data) {
      this.getBoolean(data, "Blocking", (b) -> this.blocking = b, false, BuilderDescriptorState.Stable, "Do not execute an action unless the previous action could execute", (String)null);
      this.getBoolean(data, "Atomic", (b) -> this.atomic = b, false, BuilderDescriptorState.Stable, "Only execute actions if all actions can be executed", (String)null);
