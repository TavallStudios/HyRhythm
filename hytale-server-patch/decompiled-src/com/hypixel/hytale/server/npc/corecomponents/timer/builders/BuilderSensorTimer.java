...
public class BuilderSensorTimer extends BuilderSensorBase {
   public static final double[] DEFAULT_TIME_ELAPSED_RANGE = new double[]{0.0, 1.7976931348623157E308};
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireString(data, "Name", this.name, StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The name of the timer", (String)null);
      this.getEnum(data, "State", (e) -> this.timerState = e, Timer.TimerState.class, Timer.TimerState.ANY, BuilderDescriptorState.Stable, "The timer's state to check", (String)null);
      this.getDoubleRange(data, "TimeRemainingRange", this.timeRemainingRange, DEFAULT_TIME_ELAPSED_RANGE, DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 1.7976931348623157E308), BuilderDescriptorState.Stable, "The acceptable remaining time on the timer.", (String)null);
      return this;
   }
