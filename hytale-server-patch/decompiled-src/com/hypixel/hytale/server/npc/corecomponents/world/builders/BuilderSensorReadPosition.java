...
public class BuilderSensorReadPosition extends BuilderSensorBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireString(data, "Slot", this.slot, StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The slot to read the position from", (String)null);
      this.getDouble(data, "MinRange", this.minRange, 0.0, DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.Stable, "Minimum range from stored position", (String)null);
      this.requireDouble(data, "Range", this.range, DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Maximum range from stored position", (String)null);
      this.getBoolean(data, "UseMarkedTarget", this.useMarkedTarget, false, BuilderDescriptorState.Stable, "Whether to read from a marked target slot instead of a position slot", (String)null);
