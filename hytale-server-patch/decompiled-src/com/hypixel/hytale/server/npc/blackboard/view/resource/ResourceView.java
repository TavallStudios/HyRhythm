...
public class ResourceView extends BlockRegionView<ResourceView> {
   ...
   private final Map<Ref<EntityStore>, BlockReservation> reservationsByEntity = new HashMap();
   ...
   public void clearReservation(@Nonnull Ref<EntityStore> ref) {
      BlockReservation reservation = (BlockReservation)this.reservationsByEntity.remove(ref);
      if (reservation != null) {
