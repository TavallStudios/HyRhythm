...
public class BuilderStateTransitionEdges extends BuilderBase<StateTransitionEdges> {
   ...
   public Builder<StateTransitionEdges> readConfig(@Nonnull JsonElement data) {
      this.getInt(data, "Priority", (i) -> this.priority = i, 0, IntSingleValidator.greaterEqual0(), BuilderDescriptorState.Stable, "Priority for the actions in this transition", (String)null);
      this.requireStringArray(data, "From", (o) -> this.fromStates = o, (Function)null, StringArrayNoEmptyStringsValidator.get(), BuilderDescriptorState.Stable, (String)null, "A set of from states");
      this.requireStringArray(data, "To", (o) -> this.toStates = o, (Function)null, StringArrayNoEmptyStringsValidator.get(), BuilderDescriptorState.Stable, (String)null, "A set of to states");
      ...
      if (this.fromStates != null && this.fromStates.length > 0) {
         ...
         for(String state : this.fromStates) {
            this.registerStateRequirer(state, (String)null, (ms, ss) -> {
               int var10004 = pos[0];
               int var10001 = pos[0];
               pos[0] = var10004 + 1;
               this.fromStateIndices[var10001] = ms;
            });
         }
      ...
      if (this.toStates != null && this.toStates.length > 0) {
         ...
         for(String state : this.toStates) {
            this.registerStateRequirer(state, (String)null, (ms, ss) -> {
               ...
               int var10001 = pos[0];
               pos[0] = var10004 + 1;
               this.toStateIndices[var10001] = ms;
            });
         }
