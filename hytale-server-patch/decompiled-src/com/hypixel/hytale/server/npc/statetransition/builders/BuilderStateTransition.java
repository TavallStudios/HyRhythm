...
public class BuilderStateTransition extends BuilderBase<StateTransition> {
   protected final BuilderObjectStaticListHelper<BuilderStateTransitionEdges.StateTransitionEdges> stateTransitionEdges = new BuilderObjectStaticListHelper<BuilderStateTransitionEdges.StateTransitionEdges>(BuilderStateTransitionEdges.StateTransitionEdges.class, this);
   protected final BuilderObjectReferenceHelper<ActionList> actions = new BuilderObjectReferenceHelper<ActionList>(ActionList.class, this);
   ...
   public Builder<StateTransition> readConfig(@Nonnull JsonElement data) {
      this.requireArray(data, "States", this.stateTransitionEdges, (ArrayValidator)null, BuilderDescriptorState.Stable, "List of state transitions", (String)null, this.validationHelper);
      this.requireObject(data, "Actions", this.actions, BuilderDescriptorState.Stable, "List of actions", (String)null, this.validationHelper);
      this.getBoolean(data, "Enabled", this.enabled, true, BuilderDescriptorState.Stable, "Whether this sensor should be enabled on the NPC", (String)null);
      return this;
   }
