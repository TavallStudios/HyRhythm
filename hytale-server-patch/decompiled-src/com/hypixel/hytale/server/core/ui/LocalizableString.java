...
public class LocalizableString {
   ...
   public static LocalizableString fromMessageId(String messageId) {
      return fromMessageId(messageId, (Map)null);
   }
   ...
   static {
      MESSAGE_OBJECT_CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(LocalizableString.class, LocalizableString::new).addField(new KeyedCodec("MessageId", Codec.STRING), (p, t) -> p.messageId = t, (p) -> p.messageId)).addField(new KeyedCodec("MessageParams", MapCodec.STRING_HASH_MAP_CODEC), (p, t) -> p.messageParams = t, (p) -> p.messageParams)).build();
   }
   ...
   public static class LocalizableStringCodec implements Codec<LocalizableString> {
      public LocalizableString decode(BsonValue bsonValue, @Nonnull ExtraInfo extraInfo) {
         return bsonValue instanceof BsonString ? LocalizableString.fromString(bsonValue.asString().getValue()) : (LocalizableString)LocalizableString.MESSAGE_OBJECT_CODEC.decode(bsonValue, extraInfo);
      }
