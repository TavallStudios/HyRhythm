...
public class PatchStyle {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PatchStyle.class, PatchStyle::new).addField(new KeyedCodec("TexturePath", ValueCodec.STRING), (p, t) -> p.texturePath = t, (p) -> p.texturePath)).addField(new KeyedCodec("Border", ValueCodec.INTEGER), (p, t) -> p.border = t, (p) -> p.border)).addField(new KeyedCodec("HorizonzalBorder", ValueCodec.INTEGER), (p, t) -> p.horizontalBorder = t, (p) -> p.horizontalBorder)).addField(new KeyedCodec("VerticalBorder", ValueCodec.INTEGER), (p, t) -> p.verticalBorder = t, (p) -> p.verticalBorder)).addField(new KeyedCodec("Color", ValueCodec.STRING), (p, t) -> p.color = t, (p) -> p.color)).addField(new KeyedCodec("Area", new ValueCodec(Area.CODEC)), (p, t) -> p.area = t, (p) -> p.area)).build();
   }
}
