...
public class UICommandBuilder {
   ...
   public UICommandBuilder clear(String selector) {
      this.commands.add(new CustomUICommand(CustomUICommandType.Clear, selector, (String)null, (String)null));
      return this;
   }

   @Nonnull
   public UICommandBuilder remove(String selector) {
      this.commands.add(new CustomUICommand(CustomUICommandType.Remove, selector, (String)null, (String)null));
      return this;
   }

   @Nonnull
   public UICommandBuilder append(String documentPath) {
      this.commands.add(new CustomUICommand(CustomUICommandType.Append, (String)null, (String)null, documentPath));
      return this;
   }

   @Nonnull
   public UICommandBuilder append(String selector, String documentPath) {
      this.commands.add(new CustomUICommand(CustomUICommandType.Append, selector, (String)null, documentPath));
      return this;
   }

   @Nonnull
   public UICommandBuilder appendInline(String selector, String document) {
      this.commands.add(new CustomUICommand(CustomUICommandType.AppendInline, selector, (String)null, document));
      return this;
   }

   @Nonnull
   public UICommandBuilder insertBefore(String selector, String documentPath) {
      this.commands.add(new CustomUICommand(CustomUICommandType.InsertBefore, selector, (String)null, documentPath));
      return this;
   }

   @Nonnull
   public UICommandBuilder insertBeforeInline(String selector, String document) {
      this.commands.add(new CustomUICommand(CustomUICommandType.InsertBeforeInline, selector, (String)null, document));
      return this;
   }
   ...
   private UICommandBuilder setBsonValue(String selector, BsonValue bsonValue) {
      ...
      this.commands.add(new CustomUICommand(CustomUICommandType.Set, selector, valueWrapper.toJson(), (String)null));
      return this;
   }
   ...
   public UICommandBuilder set(String selector, float n) {
      return this.setBsonValue(selector, new BsonDouble((double)n));
   }
   ...
   public UICommandBuilder setObject(String selector, @Nonnull Object data) {
      Codec codec = (Codec)CODEC_MAP.get(data.getClass());
      if (codec == null) {
   ...
   public <T> UICommandBuilder set(String selector, @Nonnull T[] data) {
      Codec codec = (Codec)CODEC_MAP.get(data.getClass().getComponentType());
      if (codec == null) {
         throw new IllegalArgumentException(data.getClass().getName() + " is not a compatible class");
      } else {
   ...
   public CustomUICommand[] getCommands() {
      return (CustomUICommand[])this.commands.toArray((x$0) -> new CustomUICommand[x$0]);
   }
