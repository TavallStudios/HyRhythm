...
public class EncryptedAuthCredentialStoreProvider implements AuthCredentialStoreProvider {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(EncryptedAuthCredentialStoreProvider.class, EncryptedAuthCredentialStoreProvider::new).append(new KeyedCodec("Path", Codec.STRING), (o, p) -> o.path = p, (o) -> o.path).add()).build();
   }
}
