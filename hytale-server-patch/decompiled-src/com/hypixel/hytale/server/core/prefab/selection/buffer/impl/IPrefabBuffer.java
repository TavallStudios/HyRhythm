...
public interface IPrefabBuffer {
   ...
   default <T extends PrefabBufferCall> boolean compare(@Nonnull BlockComparingPredicate<T> blockComparingPredicate, @Nonnull T t) {
      return this.forEachRaw(iterateAllColumns(), (RawBlockPredicate)((x, y, z, blockId, chance, holder, support, rotation, filler, o) -> blockComparingPredicate.test(x, y, z, blockId, rotation, holder, o)), (FluidPredicate)((x, y, z, fluidId, level, o) -> true), (EntityPredicate)((x, z, entityWrappers, o) -> true), t);
   }
   ...
   public interface BlockComparingPrefabPredicate<T> {
      boolean test(int var1, int var2, int var3, int var4, Holder<ChunkStore> var5, float var6, int var7, int var8, int var9, Holder<ChunkStore> var10, float var11, int var12, int var13, T var14);
   }
