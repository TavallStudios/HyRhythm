...
public class BinaryPrefabBufferCodec implements PrefabBufferCodec<ByteBuf> {
   ...
   public PrefabBuffer deserialize(Path path, @Nonnull ByteBuf buffer) {
      ...
      if (version == 18553) {
         ...
         Int2ObjectOpenHashMap<BlockIdEntry> blockIdMapping = new Int2ObjectOpenHashMap(blockNameCount);
         ...
         Int2ObjectOpenHashMap<FluidIdEntry> fluidIdMapping = new Int2ObjectOpenHashMap(fluidNameCount);
         ...
         for(int i = 0; i < columnCount; ++i) {
            ...
            for(int j = 0; j < blocks; ++j) {
               ...
               if (hasFluid) {
                  ...
                  fluidId = ((FluidIdEntry)fluidIdMapping.get(id)).id;
