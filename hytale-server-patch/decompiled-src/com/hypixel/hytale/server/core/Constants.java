...
public final class Constants {
   ...
   private static boolean checkFreshUniverse() {
      ...
      if (!Files.exists(universePath, new LinkOption[0])) {
         return true;
      } else if (!Files.exists(universePath.resolve("players"), new LinkOption[0])) {
         return true;
      } else {
