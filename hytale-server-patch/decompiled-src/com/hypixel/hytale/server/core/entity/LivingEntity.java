...
public abstract class LivingEntity extends Entity {
   ...
   public static long getPackedMaterialAndFluidAtBreathingHeight(@Nonnull Ref<EntityStore> ref, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
      ...
      return chunkRef != null && chunkRef.isValid() ? WorldUtil.getPackedMaterialAndFluidAtPosition(chunkRef, chunkStore.getStore(), position.x, position.y, position.z) : MathUtil.packLong(BlockMaterial.Empty.ordinal(), 0);
   }
