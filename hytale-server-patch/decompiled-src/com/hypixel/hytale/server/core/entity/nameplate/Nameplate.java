...
public class Nameplate implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(Nameplate.class, Nameplate::new).append(new KeyedCodec("Text", Codec.STRING), (nameplate, s) -> nameplate.text = s, (nameplate) -> nameplate.text).documentation("The contents to display as the nameplate text.").addValidator(Validators.nonNull()).add()).build();
   }
}
