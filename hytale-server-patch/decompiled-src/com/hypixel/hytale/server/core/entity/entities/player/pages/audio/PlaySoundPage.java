...
public class PlaySoundPage extends InteractiveCustomUIPage<PlaySoundPageEventData> {
   ...
   private void buildSoundEventList(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder commandBuilder, @Nonnull UIEventBuilder eventBuilder, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
      ...
      for(int bound = this.soundEvents.size(); i < bound; ++i) {
         String id = (String)this.soundEvents.get(i);
   ...
   public static class PlaySoundPageEventData {
      ...
      static {
         CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PlaySoundPageEventData.class, PlaySoundPageEventData::new).append(new KeyedCodec("SoundEvent", Codec.STRING), (entry, s) -> entry.soundEvent = s, (entry) -> entry.soundEvent).add()).append(new KeyedCodec("Type", Codec.STRING), (entry, s) -> entry.type = s, (entry) -> entry.type).add()).append(new KeyedCodec("@SearchQuery", Codec.STRING), (entry, s) -> entry.searchQuery = s, (entry) -> entry.searchQuery).add()).append(new KeyedCodec("@Volume", Codec.FLOAT), (entry, f) -> entry.volume = f, (entry) -> entry.volume).add()).append(new KeyedCodec("@Pitch", Codec.FLOAT), (entry, f) -> entry.pitch = f, (entry) -> entry.pitch).add()).build();
      }
   }
}
