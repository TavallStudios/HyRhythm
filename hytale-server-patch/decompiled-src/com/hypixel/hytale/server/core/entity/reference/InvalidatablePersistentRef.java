...
public class InvalidatablePersistentRef extends PersistentRef {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(InvalidatablePersistentRef.class, InvalidatablePersistentRef::new, PersistentRef.CODEC).append(new KeyedCodec("RefCount", Codec.INTEGER), (instance, value) -> instance.refCount = value, (instance) -> instance.refCount).add()).build();
   }
}
