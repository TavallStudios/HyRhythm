...
public abstract class ChoiceBasePage extends InteractiveCustomUIPage<ChoicePageEventData> {
   ...
   public static class ChoicePageEventData {
      ...
      static {
         CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ChoicePageEventData.class, ChoicePageEventData::new).append(new KeyedCodec("Index", Codec.STRING), (choicePageEventData, s) -> {
