...
public final class PlayerDeathPositionData {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PlayerDeathPositionData.class, PlayerDeathPositionData::new).append(new KeyedCodec("MarkerId", Codec.STRING), (data, value) -> data.markerId = value, (data) -> data.markerId).documentation("The unique ID of the associated map marker.").add()).append(new KeyedCodec("Transform", Transform.CODEC), (data, value) -> data.transform = value, (data) -> data.transform).documentation("The transform of this death position.").add()).append(new KeyedCodec("Day", Codec.INTEGER), (data, value) -> data.day = value, (data) -> data.day).documentation("The in-game day in which the player died.").add()).build();
      ARRAY_CODEC = new ArrayCodec<PlayerDeathPositionData>(CODEC, (x$0) -> new PlayerDeathPositionData[x$0]);
   }
}
