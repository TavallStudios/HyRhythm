...
public final class UUIDComponent implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(UUIDComponent.class, UUIDComponent::new).append(new KeyedCodec("UUID", Codec.UUID_BINARY), (o, i) -> o.uuid = i, (o) -> o.uuid).addValidator(Validators.nonNull()).add()).afterDecode((v) -> {
         if (v.uuid == null) {
