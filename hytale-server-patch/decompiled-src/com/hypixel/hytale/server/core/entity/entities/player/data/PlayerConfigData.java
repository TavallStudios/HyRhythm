...
public final class PlayerConfigData {
   ...
   public PlayerConfigData() {
      this.unmodifiableKnownRecipes = Collections.unmodifiableSet(this.knownRecipes);
      this.perWorldData = new ConcurrentHashMap();
      this.unmodifiablePerWorldData = Collections.unmodifiableMap(this.perWorldData);
      this.discoveredZones = new HashSet();
      this.unmodifiableDiscoveredZones = Collections.unmodifiableSet(this.discoveredZones);
      this.discoveredInstances = new HashSet();
      this.unmodifiableDiscoveredInstances = Collections.unmodifiableSet(this.discoveredInstances);
      this.reputationData = new Object2IntOpenHashMap();
      this.unmodifiableReputationData = Object2IntMaps.unmodifiable(this.reputationData);
      this.activeObjectiveUUIDs = ConcurrentHashMap.newKeySet();
      this.unmodifiableActiveObjectiveUUIDs = Collections.unmodifiableSet(this.activeObjectiveUUIDs);
   ...
   public PlayerWorldData getPerWorldData(@Nonnull String worldName) {
      return (PlayerWorldData)this.perWorldData.computeIfAbsent(worldName, (s) -> new PlayerWorldData(this));
   }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PlayerConfigData.class, PlayerConfigData::new).addField(new KeyedCodec("BlockIdVersion", Codec.INTEGER), (playerConfigData, s) -> playerConfigData.blockIdVersion = s, (playerConfigData) -> playerConfigData.blockIdVersion)).addField(new KeyedCodec("World", Codec.STRING), (playerConfigData, s) -> playerConfigData.world = s, (playerConfigData) -> playerConfigData.world)).addField(new KeyedCodec("Preset", Codec.STRING), (playerConfigData, s) -> playerConfigData.preset = s, (playerConfigData) -> playerConfigData.preset)).addField(new KeyedCodec("KnownRecipes", new ArrayCodec(Codec.STRING, (x$0) -> new String[x$0])), (playerConfigData, knownRecipes) -> {
      ...
      }, (playerConfigData) -> (String[])playerConfigData.knownRecipes.toArray((x$0) -> new String[x$0]))).addField(new KeyedCodec("PerWorldData", new MapCodec(PlayerWorldData.CODEC, ConcurrentHashMap::new, false)), (playerConfigData, perWorldData) -> {
      ...
      }, (playerConfigData) -> playerConfigData.perWorldData)).addField(new KeyedCodec("DiscoveredZones", Codec.STRING_ARRAY), (playerConfigData, discoveredZones) -> {
      ...
      }, (playerConfigData) -> (String[])playerConfigData.discoveredZones.toArray((x$0) -> new String[x$0]))).addField(new KeyedCodec("DiscoveredInstances", new ArrayCodec(Codec.UUID_BINARY, (x$0) -> new UUID[x$0])), (playerConfigData, discoveredInstances) -> {
      ...
      }, (playerConfigData) -> (UUID[])playerConfigData.discoveredInstances.toArray((x$0) -> new UUID[x$0]))).addField(new KeyedCodec("ReputationData", new Object2IntMapCodec(Codec.STRING, Object2IntOpenHashMap::new, false)), (playerConfigData, reputationData) -> {
      ...
      }, (playerConfigData) -> playerConfigData.reputationData)).addField(new KeyedCodec("ActiveObjectiveUUIDs", new ArrayCodec(Codec.UUID_BINARY, (x$0) -> new UUID[x$0])), (playerConfigData, objectives) -> Collections.addAll(playerConfigData.activeObjectiveUUIDs, objectives), (playerConfigData) -> (UUID[])playerConfigData.activeObjectiveUUIDs.toArray((x$0) -> new UUID[x$0]))).afterDecode((data) -> {
         ...
         BlockMigration migration = (BlockMigration)blockMigrationMap.get(v);

         Function<String, String> blockMigration;
         for(blockMigration = null; migration != null; migration = (BlockMigration)blockMigrationMap.get(v)) {
