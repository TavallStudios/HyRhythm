...
public class InteractionContext {
   ...
   public ItemContext createHeldItemContext() {
      return this.heldItemContainer != null && this.heldItem != null ? new ItemContext(this.heldItemContainer, (short)this.heldItemSlot, this.heldItem) : null;
   }
   ...
   public Map<String, String> getInteractionVars() {
      return (Map)this.interactionVarsGetter.apply(this);
   }
   ...
   public Ref<EntityStore> getTargetEntity() {
      return (Ref)this.metaStore.getIfPresentMetaObject(Interaction.TARGET_ENTITY);
   }

   @Nullable
   public BlockPosition getTargetBlock() {
      return (BlockPosition)this.metaStore.getIfPresentMetaObject(Interaction.TARGET_BLOCK);
   }
   ...
   public EntitySnapshot getSnapshot(@Nonnull Ref<EntityStore> ref, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
      ...
      if (this.snapshotProvider != null) {
         ...
         SnapshotBuffer snapshotBufferComponent = (SnapshotBuffer)componentAccessor.getComponent(ref, SnapshotBuffer.getComponentType());
   ...
   public String getRootInteractionId(@Nonnull InteractionType type) {
      if (this.runningForEntity != null && this.runningForEntity.isValid()) {
         Interactions interactions = (Interactions)this.runningForEntity.getStore().getComponent(this.runningForEntity, Interactions.getComponentType());
      ...
      if (heldItem == null) {
         UnarmedInteractions unarmedInteraction = (UnarmedInteractions)UnarmedInteractions.getAssetMap().getAsset("Empty");
         interactionIds = unarmedInteraction != null ? (String)unarmedInteraction.getInteractions().get(type) : null;
      } else {
   ...
   public static InteractionContext withoutEntity() {
      return new InteractionContext((InteractionManager)null, (Ref)null, -1, (ItemContainer)null, (byte)-1, (ItemStack)null);
   }
