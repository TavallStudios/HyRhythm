...
public class PlayerSkinPart {
   ...
   protected PlayerSkinPart(@Nonnull BsonDocument doc) {
      ...
      if (doc.containsKey("Variants")) {
         ...
         for(Map.Entry<String, BsonValue> set : mapping.entrySet()) {
            this.variants.put((String)set.getKey(), new Variant(((BsonValue)set.getValue()).asDocument()));
         }
         ...
         for(Map.Entry<String, BsonValue> set : mapping.entrySet()) {
            this.textures.put((String)set.getKey(), new PlayerSkinPartTexture(((BsonValue)set.getValue()).asDocument()));
         }
      }
   ...
   public String toString() {
      ...
      return "PlayerSkinPart{id='" + var10000 + "', name='" + this.name + "', model='" + this.model + "', greyscaleTexture='" + this.greyscaleTexture + "', gradientSet='" + this.gradientSet + "', textures=" + String.valueOf(this.textures) + ", variants=" + String.valueOf(this.variants) + ", isDefaultAsset=" + this.isDefaultAsset + ", tags=" + Arrays.toString(this.tags) + ", hairType=" + String.valueOf(this.hairType) + ", requiresGenericHaircut=" + this.requiresGenericHaircut + ", headAccessoryType=" + String.valueOf(this.headAccessoryType) + "}";
   }
   ...
   public static class Variant {
      ...
      public String toString() {
         ...
         return "CharacterPartVariant{model='" + var10000 + "'greyscaleTexture='" + this.greyscaleTexture + "', textures=" + String.valueOf(this.textures) + "}";
      }
   }
