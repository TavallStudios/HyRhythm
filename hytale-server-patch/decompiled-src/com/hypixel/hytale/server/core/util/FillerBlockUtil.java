            ...
            if (filler != 0) {
               ...
               if (baseBlock == null) {
                  ...
                  if (hitbox == null) {
                     ...
                     return baseFiller == 0 && baseRotation == rotation && id.equals(baseId) && hitbox.get(baseRotation).getBoundingBox().containsBlock(fillerX, fillerY, fillerZ) ? FillerBlockUtil.ValidationResult.OK : FillerBlockUtil.ValidationResult.INVALID_BLOCK;
                  }
               }
            } else {
