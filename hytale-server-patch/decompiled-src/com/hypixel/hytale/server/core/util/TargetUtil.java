...
public final class TargetUtil {
   ...
   public static List<Ref<EntityStore>> getAllEntitiesInSphere(@Nonnull Vector3d position, double radius, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
      ...
      entitySpatialResource.getSpatialStructure().collect(position, (double)((float)radius), results);
      ...
      playerSpatialResource.getSpatialStructure().collect(position, (double)((float)radius), results);
      return results;
   }
