...
public class PlayerMouseButtonEvent extends PlayerEvent<Void> implements ICancellable {
   ...
   public String toString() {
      ...
      return "PlayerMouseButtonEvent{clientUseTime=" + var10000 + ", itemInHand=" + String.valueOf(this.itemInHand) + ", targetBlock=" + String.valueOf(this.targetBlock) + ", targetEntity=" + String.valueOf(this.targetEntity) + ", screenPoint=" + String.valueOf(this.screenPoint) + ", mouseButton=" + String.valueOf(this.mouseButton) + ", cancelled=" + this.cancelled + "} " + super.toString();
   }
}
