...
public class PlayerInteractEvent extends PlayerEvent<String> implements ICancellable {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.actionType);
      return "PlayerInteractEvent{actionType=" + var10000 + ", clientUseTime=" + this.clientUseTime + ", itemInHand=" + String.valueOf(this.itemInHand) + ", targetBlock=" + String.valueOf(this.targetBlock) + ", targetEntity=" + String.valueOf(this.targetEntity) + ", cancelled=" + this.cancelled + "} " + super.toString();
   }
}
