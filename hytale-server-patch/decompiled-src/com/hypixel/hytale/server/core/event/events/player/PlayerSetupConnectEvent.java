...
public class PlayerSetupConnectEvent implements IEvent<Void>, ICancellable {
   ...
   public String toString() {
      ...
      return "PlayerSetupConnectEvent{username='" + var10000 + "', uuid=" + String.valueOf(this.uuid) + ", auth=" + String.valueOf(this.auth) + ", referralData=" + (this.referralData != null ? this.referralData.length + " bytes" : "null") + ", referralSource=" + (this.referralSource != null ? this.referralSource.host + ":" + this.referralSource.port : "null") + ", cancelled=" + this.cancelled + ", reason='" + this.reason + "'}";
   }
}
