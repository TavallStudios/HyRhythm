...
public class PlayerMouseMotionEvent extends PlayerEvent<Void> implements ICancellable {
   ...
   public String toString() {
      long var10000 = this.clientUseTime;
      return "PlayerMouseMotionEvent{clientUseTime=" + var10000 + ", itemInHand=" + String.valueOf(this.itemInHand) + ", targetBlock=" + String.valueOf(this.targetBlock) + ", targetEntity=" + String.valueOf(this.targetEntity) + ", screenPoint=" + String.valueOf(this.screenPoint) + ", mouseMotion=" + String.valueOf(this.mouseMotion) + ", cancelled=" + this.cancelled + "} " + super.toString();
   }
}
