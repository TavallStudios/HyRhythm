...
public class Item implements JsonAssetWithMap<String, DefaultAssetMap<String, Item>>, NetworkSerializable<ItemBase> {
   ...
   protected Item() {
      this.utility = ItemUtility.DEFAULT;
      this.itemStackContainerConfig = ItemStackContainerConfig.DEFAULT;
      this.playerAnimationsId = "Default";
      this.usePlayerAnimations = false;
      this.scale = 1.0F;
      this.texture = "Items/Unknown.png";
      this.itemSoundSetId = "ISS_Default";
      this.interactions = Collections.emptyMap();
      this.interactionVars = Collections.emptyMap();
      this.fuelQuality = 1.0;
      this.durabilityLossOnDeath = true;
   }
   ...
   public ItemBase toPacket() {
      ItemBase cached = this.cachedPacket == null ? null : (ItemBase)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
         ...
         for(Map.Entry<String, String> e : this.interactionVars.entrySet()) {
         ...
         if (this.itemAppearanceConditions != null) {
            ...
            for(Map.Entry<String, ItemAppearanceCondition[]> entry : this.itemAppearanceConditions.entrySet()) {
   ...
   public String getItemIdForState(String state) {
      return this.stateToBlock != null ? (String)this.stateToBlock.get(state) : null;
   }

   @Nullable
   public Item getItemForState(String state) {
      String id = this.getItemIdForState(state);
      return id == null ? null : (Item)getAssetMap().getAsset(id);
   }
   ...
   public String getStateForItem(String key) {
      return this.blockToState != null ? (String)this.blockToState.get(key) : null;
   }
   ...
   protected void processConfig() {
      ...
      UnarmedInteractions fallbackInteractions = this.playerAnimationsId != null ? (UnarmedInteractions)unarmedInteractionsAssetMap.getAsset(this.playerAnimationsId) : null;
      if (fallbackInteractions != null) {
         for(Map.Entry<InteractionType, String> entry : fallbackInteractions.getInteractions().entrySet()) {
      ...
      if (this.stateToBlock != null) {
         ...
         for(Map.Entry<String, String> entry : this.stateToBlock.entrySet()) {
      ...
      if (this.recipeToGenerate != null) {
         ...
         MaterialQuantity primaryOutput = new MaterialQuantity(this.id, (String)null, (String)null, newRecipe.primaryOutputQuantity, (BsonDocument)null);
