...
public class HarvestingDropType implements NetworkSerializable<Harvesting> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(HarvestingDropType.class, HarvestingDropType::new).append(new KeyedCodec("ItemId", Codec.STRING), (harvesting, o) -> harvesting.itemId = o, (harvesting) -> harvesting.itemId).addValidatorLate(() -> Item.VALIDATOR_CACHE.getValidator().late()).add()).append(new KeyedCodec("DropList", new ContainedAssetCodec(ItemDropList.class, ItemDropList.CODEC)), (harvesting, o) -> harvesting.dropListId = o, (harvesting) -> harvesting.dropListId).addValidatorLate(() -> ItemDropList.VALIDATOR_CACHE.getValidator().late()).add()).build();
   }
}
