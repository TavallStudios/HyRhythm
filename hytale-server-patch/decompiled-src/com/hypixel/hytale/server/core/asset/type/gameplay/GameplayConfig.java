...
public class GameplayConfig implements JsonAssetWithMap<String, DefaultAssetMap<String, GameplayConfig>> {
   ...
   @Nonnull
   public static final MapKeyMapCodec<Object> PLUGIN_CODEC = new MapKeyMapCodec<Object>(true);
   @Nonnull
   ...
   protected MapKeyMapCodec.TypeMap<Object> pluginConfig = MapKeyMapCodec.TypeMap.<Object>empty();
   ...
   static {
      ...
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(GameplayConfig::getAssetStore));
   }
}
