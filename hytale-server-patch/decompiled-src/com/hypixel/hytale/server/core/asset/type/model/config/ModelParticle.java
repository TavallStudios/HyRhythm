...
public class ModelParticle implements NetworkSerializable<com.hypixel.hytale.protocol.ModelParticle> {
   ...
   public String toString() {
      ...
      return "ModelParticle{systemId='" + var10000 + "', targetEntityPart=" + String.valueOf(this.targetEntityPart) + ", targetNodeName='" + this.targetNodeName + "', color=" + String.valueOf(this.color) + ", scale=" + this.scale + ", positionOffset=" + String.valueOf(this.positionOffset) + ", rotationOffset=" + String.valueOf(this.rotationOffset) + ", detachedFromModel=" + this.detachedFromModel + "}";
   }
