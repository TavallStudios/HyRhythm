...
public class ItemGlider implements NetworkSerializable<com.hypixel.hytale.protocol.ItemGlider> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(ItemGlider.class, ItemGlider::new).appendInherited(new KeyedCodec("TerminalVelocity", Codec.FLOAT), (o, i) -> o.terminalVelocity = i, (o) -> o.terminalVelocity, (o, p) -> o.terminalVelocity = p.terminalVelocity).documentation("The maximum speed the player can fall while gliding.").add()).appendInherited(new KeyedCodec("FallSpeedMultiplier", Codec.FLOAT), (o, i) -> o.fallSpeedMultiplier = i, (o) -> o.fallSpeedMultiplier, (o, p) -> o.fallSpeedMultiplier = p.fallSpeedMultiplier).documentation("The rate at which the fall speed is incremented.").add()).appendInherited(new KeyedCodec("HorizontalSpeedMultiplier", Codec.FLOAT), (o, i) -> o.horizontalSpeedMultiplier = i, (o) -> o.horizontalSpeedMultiplier, (o, p) -> o.horizontalSpeedMultiplier = p.horizontalSpeedMultiplier).documentation("The rate at which the horizontal move speed is incremented.").add()).appendInherited(new KeyedCodec("Speed", Codec.FLOAT), (o, i) -> o.speed = i, (o) -> o.speed, (o, p) -> o.speed = p.speed).documentation("The horizontal movement speed of the glider.").add()).build();
   }
}
