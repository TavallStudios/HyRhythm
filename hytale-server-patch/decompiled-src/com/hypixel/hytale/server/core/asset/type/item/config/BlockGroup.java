...
public class BlockGroup implements JsonAssetWithMap<String, DefaultAssetMap<String, BlockGroup>>, NetworkSerializable<com.hypixel.hytale.protocol.BlockGroup> {
   ...
   static {
      CODEC = ((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(BlockGroup.class, BlockGroup::new, Codec.STRING, (t, k) -> t.id = k, (t) -> t.id, (asset, data) -> asset.data = data, (asset) -> asset.data).addField(new KeyedCodec("Blocks", Codec.STRING_ARRAY), (blockSet, strings) -> blockSet.blocks = strings, (blockSet) -> blockSet.blocks)).build();
   }
}
