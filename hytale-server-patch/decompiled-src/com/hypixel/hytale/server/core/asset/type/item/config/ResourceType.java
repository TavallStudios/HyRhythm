...
public class ResourceType implements JsonAssetWithMap<String, DefaultAssetMap<String, ResourceType>>, NetworkSerializable<com.hypixel.hytale.protocol.ResourceType> {
   ...
   public com.hypixel.hytale.protocol.ResourceType toPacket() {
      com.hypixel.hytale.protocol.ResourceType cached = this.cachedPacket == null ? null : (com.hypixel.hytale.protocol.ResourceType)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
   ...
   static {
      ...
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(ResourceType::getAssetStore));
   }
}
