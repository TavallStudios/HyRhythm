...
public class StructuralCraftingBench extends Bench {
   ...
   public int getCategoryIndex(@Nonnull String category) {
      return this.categoryToIndexMap.getOrDefault(category, 2147483647);
   }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(StructuralCraftingBench.class, StructuralCraftingBench::new, Bench.BASE_CODEC).append(new KeyedCodec("Categories", new ArrayCodec(Codec.STRING, (x$0) -> new String[x$0])), (bench, categories) -> bench.sortedCategories = categories, (bench) -> bench.sortedCategories).add()).append(new KeyedCodec("HeaderCategories", new ArrayCodec(Codec.STRING, (x$0) -> new String[x$0])), (bench, headerCategories) -> bench.headerCategories = headerCategories, (bench) -> bench.headerCategories).add()).append(new KeyedCodec("AlwaysShowInventoryHints", Codec.BOOLEAN), (bench, alwaysShowInventoryHints) -> bench.alwaysShowInventoryHints = alwaysShowInventoryHints, (bench) -> bench.alwaysShowInventoryHints).add()).append(new KeyedCodec("AllowBlockGroupCycling", Codec.BOOLEAN), (bench, allowBlockGroupCycling) -> bench.allowBlockGroupCycling = allowBlockGroupCycling, (bench) -> bench.allowBlockGroupCycling).add()).afterDecode(StructuralCraftingBench::processConfig)).build();
   }
}
