...
public class OptionArg extends ToolArg<String> {
   ...
   public String toString() {
      String var10000 = Arrays.toString(this.options);
      return "OptionArg{options=" + var10000 + "} " + super.toString();
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(OptionArg.class, OptionArg::new, ToolArg.DEFAULT_CODEC).addField(new KeyedCodec("Default", Codec.STRING), (optionArg, o) -> optionArg.value = o, (optionArg) -> optionArg.value)).addField(new KeyedCodec("Options", Codec.STRING_ARRAY), (optionArg, o) -> optionArg.options = o, (optionArg) -> optionArg.options)).build();
   }
}
