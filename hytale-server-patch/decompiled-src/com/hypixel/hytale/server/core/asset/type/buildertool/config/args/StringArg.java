...
public class StringArg extends ToolArg<String> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(StringArg.class, StringArg::new, ToolArg.DEFAULT_CODEC).addField(new KeyedCodec("Default", Codec.STRING), (stringArg, d) -> stringArg.value = d, (stringArg) -> stringArg.value)).build();
   }
}
