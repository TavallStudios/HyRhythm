...
public class BrushShapeArg extends ToolArg<BrushShape> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(BrushShapeArg.class, BrushShapeArg::new, ToolArg.DEFAULT_CODEC).addField(new KeyedCodec("Default", BRUSH_SHAPE_CODEC), (shapeArg, o) -> shapeArg.value = o, (shapeArg) -> shapeArg.value)).build();
   }
}
