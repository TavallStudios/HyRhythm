...
public class WorldParticle implements NetworkSerializable<com.hypixel.hytale.protocol.WorldParticle> {
   ...
   public String toString() {
      ...
      return "WorldParticle{systemId='" + var10000 + "', color=" + String.valueOf(this.color) + ", scale=" + this.scale + ", positionOffset=" + String.valueOf(this.positionOffset) + ", rotationOffset=" + String.valueOf(this.rotationOffset) + "}";
   }
   ...
   static {
      ...
      ARRAY_CODEC = new ArrayCodec<WorldParticle>(CODEC, (x$0) -> new WorldParticle[x$0]);
   }
}
