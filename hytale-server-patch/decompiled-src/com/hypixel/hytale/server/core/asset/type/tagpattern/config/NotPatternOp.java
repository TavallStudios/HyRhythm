...
public class NotPatternOp extends TagPattern {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.pattern);
      return "NotPatternOp{pattern=" + var10000 + "} " + super.toString();
   }

   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(NotPatternOp.class, NotPatternOp::new, TagPattern.BASE_CODEC).append(new KeyedCodec("Pattern", TagPattern.CODEC), (singleTagOp, s) -> singleTagOp.pattern = s, (singleTagOp) -> singleTagOp.pattern).addValidator(Validators.nonNull()).add()).build();
   }
}
