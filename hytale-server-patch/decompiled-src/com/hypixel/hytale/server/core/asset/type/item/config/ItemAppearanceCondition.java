...
public class ItemAppearanceCondition implements NetworkSerializable<com.hypixel.hytale.protocol.ItemAppearanceCondition> {
   ...
   public ItemAppearanceCondition() {
      this.conditionValueType = ValueType.Absolute;
   }
