...
public class AmbienceFX implements JsonAssetWithMap<String, IndexedAssetMap<String, AmbienceFX>>, NetworkSerializable<com.hypixel.hytale.protocol.AmbienceFX> {
   public static final ValidatorCache<String> VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(AmbienceFX::getAssetStore));
   ...
   public static IndexedAssetMap<String, AmbienceFX> getAssetMap() {
      return (IndexedAssetMap)getAssetStore().getAssetMap();
   }
   ...
   public com.hypixel.hytale.protocol.AmbienceFX toPacket() {
      com.hypixel.hytale.protocol.AmbienceFX cached = this.cachedPacket == null ? null : (com.hypixel.hytale.protocol.AmbienceFX)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
         ...
         if (this.sounds != null && this.sounds.length > 0) {
            packet.sounds = (com.hypixel.hytale.protocol.AmbienceFXSound[])ArrayUtil.copyAndMutate(this.sounds, AmbienceFXSound::toPacket, (x$0) -> new com.hypixel.hytale.protocol.AmbienceFXSound[x$0]);
         }
