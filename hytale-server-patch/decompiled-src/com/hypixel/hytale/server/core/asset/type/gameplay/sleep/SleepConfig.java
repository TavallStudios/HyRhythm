...
public class SleepConfig {
   ...
   public boolean isWithinSleepHoursRange(LocalDateTime gameTime) {
      if (this.allowedSleepHoursRange == null) {
         ...
         return ((double)hour - min + 24.0) % 24.0 <= (max - min + 24.0) % 24.0;
      }
   }
