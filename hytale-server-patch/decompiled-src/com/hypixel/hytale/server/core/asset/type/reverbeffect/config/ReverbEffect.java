...
public class ReverbEffect implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, ReverbEffect>>, NetworkSerializable<com.hypixel.hytale.protocol.ReverbEffect> {
   ...
   public com.hypixel.hytale.protocol.ReverbEffect toPacket() {
      com.hypixel.hytale.protocol.ReverbEffect cached = this.cachedPacket == null ? null : (com.hypixel.hytale.protocol.ReverbEffect)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
   ...
   static {
      CODEC = ((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(ReverbEffect.class, ReverbEffect::new, Codec.STRING, (t, k) -> t.id = k, (t) -> t.id, (asset, data) -> asset.data = data, (asset) -> asset.data).documentation("An asset used to define a reverb audio effect.")).metadata(new UIEditorPreview(UIEditorPreview.PreviewType.REVERB_EFFECT))).appendInherited(new KeyedCodec("DryGain", Codec.FLOAT), (reverb, f) -> reverb.dryGain = AudioUtil.decibelsToLinearGain(f), (reverb) -> AudioUtil.linearGainToDecibels(reverb.dryGain), (reverb, parent) -> reverb.dryGain = parent.dryGain).metadata(new UIEditor(new UIEditor.FormattedNumber((Double)null, " dB", (Integer)null))).addValidator(Validators.range(-100.0F, 10.0F)).documentation("Dry signal gain adjustment in decibels.").add()).appendInherited(new KeyedCodec("ModalDensity", Codec.FLOAT), (reverb, f) -> reverb.modalDensity = f, (reverb) -> reverb.modalDensity, (reverb, parent) -> reverb.modalDensity = parent.modalDensity).addValidator(Validators.range(0.0F, 1.0F)).documentation("Modal density of the reverb.").add()).appendInherited(new KeyedCodec("Diffusion", Codec.FLOAT), (reverb, f) -> reverb.diffusion = f, (reverb) -> reverb.diffusion, (reverb, parent) -> reverb.diffusion = parent.diffusion).addValidator(Validators.range(0.0F, 1.0F)).documentation("Diffusion of the reverb reflections.").add()).appendInherited(new KeyedCodec("Gain", Codec.FLOAT), (reverb, f) -> reverb.gain = AudioUtil.decibelsToLinearGain(f), (reverb) -> AudioUtil.linearGainToDecibels(reverb.gain), (reverb, parent) -> reverb.gain = parent.gain).metadata(new UIEditor(new UIEditor.FormattedNumber((Double)null, " dB", (Integer)null))).addValidator(Validators.range(-100.0F, 0.0F)).documentation("Overall reverb gain in decibels.").add()).appendInherited(new KeyedCodec("HighFrequencyGain", Codec.FLOAT), (reverb, f) -> reverb.highFrequencyGain = AudioUtil.decibelsToLinearGain(f), (reverb) -> AudioUtil.linearGainToDecibels(reverb.highFrequencyGain), (reverb, parent) -> reverb.highFrequencyGain = parent.highFrequencyGain).metadata(new UIEditor(new UIEditor.FormattedNumber((Double)null, " dB", (Integer)null))).addValidator(Validators.range(-100.0F, 0.0F)).documentation("High frequency gain in decibels.").add()).appendInherited(new KeyedCodec("DecayTime", Codec.FLOAT), (reverb, f) -> reverb.decayTime = f, (reverb) -> reverb.decayTime, (reverb, parent) -> reverb.decayTime = parent.decayTime).addValidator(Validators.range(0.1F, 20.0F)).documentation("Decay time in seconds.").add()).appendInherited(new KeyedCodec("HighFrequencyDecayRatio", Codec.FLOAT), (reverb, f) -> reverb.highFrequencyDecayRatio = f, (reverb) -> reverb.highFrequencyDecayRatio, (reverb, parent) -> reverb.highFrequencyDecayRatio = parent.highFrequencyDecayRatio).addValidator(Validators.range(0.1F, 2.0F)).documentation("High frequency decay ratio.").add()).appendInherited(new KeyedCodec("ReflectionGain", Codec.FLOAT), (reverb, f) -> reverb.reflectionGain = AudioUtil.decibelsToLinearGain(f), (reverb) -> AudioUtil.linearGainToDecibels(reverb.reflectionGain), (reverb, parent) -> reverb.reflectionGain = parent.reflectionGain).metadata(new UIEditor(new UIEditor.FormattedNumber((Double)null, " dB", (Integer)null))).addValidator(Validators.range(-100.0F, 10.0F)).documentation("Early reflections gain in decibels.").add()).appendInherited(new KeyedCodec("ReflectionDelay", Codec.FLOAT), (reverb, f) -> reverb.reflectionDelay = f, (reverb) -> reverb.reflectionDelay, (reverb, parent) -> reverb.reflectionDelay = parent.reflectionDelay).addValidator(Validators.range(0.0F, 0.3F)).documentation("Early reflections delay in seconds.").add()).appendInherited(new KeyedCodec("LateReverbGain", Codec.FLOAT), (reverb, f) -> reverb.lateReverbGain = AudioUtil.decibelsToLinearGain(f), (reverb) -> AudioUtil.linearGainToDecibels(reverb.lateReverbGain), (reverb, parent) -> reverb.lateReverbGain = parent.lateReverbGain).metadata(new UIEditor(new UIEditor.FormattedNumber((Double)null, " dB", (Integer)null))).addValidator(Validators.range(-100.0F, 20.0F)).documentation("Late reverb gain in decibels.").add()).appendInherited(new KeyedCodec("LateReverbDelay", Codec.FLOAT), (reverb, f) -> reverb.lateReverbDelay = f, (reverb) -> reverb.lateReverbDelay, (reverb, parent) -> reverb.lateReverbDelay = parent.lateReverbDelay).addValidator(Validators.range(0.0F, 0.1F)).documentation("Late reverb delay in seconds.").add()).appendInherited(new KeyedCodec("RoomRolloffFactor", Codec.FLOAT), (reverb, f) -> reverb.roomRolloffFactor = f, (reverb) -> reverb.roomRolloffFactor, (reverb, parent) -> reverb.roomRolloffFactor = parent.roomRolloffFactor).addValidator(Validators.range(0.0F, 10.0F)).documentation("Room rolloff factor.").add()).appendInherited(new KeyedCodec("AirAbsorbptionHighFrequencyGain", Codec.FLOAT), (reverb, f) -> reverb.airAbsorptionHighFrequencyGain = AudioUtil.decibelsToLinearGain(f), (reverb) -> AudioUtil.linearGainToDecibels(reverb.airAbsorptionHighFrequencyGain), (reverb, parent) -> reverb.airAbsorptionHighFrequencyGain = parent.airAbsorptionHighFrequencyGain).metadata(new UIEditor(new UIEditor.FormattedNumber((Double)null, " dB", (Integer)null))).addValidator(Validators.range(-1.0F, 0.0F)).documentation("Air absorption high frequency gain in decibels.").add()).appendInherited(new KeyedCodec("LimitDecayHighFrequency", Codec.BOOLEAN), (reverb, b) -> reverb.limitDecayHighFrequency = b, (reverb) -> reverb.limitDecayHighFrequency, (reverb, parent) -> reverb.limitDecayHighFrequency = parent.limitDecayHighFrequency).documentation("Whether to limit high frequency decay time.").add()).build();
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(ReverbEffect::getAssetStore));
   }
}
