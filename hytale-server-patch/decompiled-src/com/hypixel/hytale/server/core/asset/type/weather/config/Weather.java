...
public class Weather implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, Weather>>, NetworkSerializable<com.hypixel.hytale.protocol.Weather> {
   ...
   public com.hypixel.hytale.protocol.Weather toPacket() {
      com.hypixel.hytale.protocol.Weather cached = this.cachedPacket == null ? null : (com.hypixel.hytale.protocol.Weather)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
         ...
         if (this.clouds != null && this.clouds.length > 0) {
            packet.clouds = (com.hypixel.hytale.protocol.Cloud[])ArrayUtil.copyAndMutate(this.clouds, Cloud::toPacket, (x$0) -> new com.hypixel.hytale.protocol.Cloud[x$0]);
         }
