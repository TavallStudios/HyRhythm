...
public class FieldcraftCategory implements JsonAssetWithMap<String, DefaultAssetMap<String, FieldcraftCategory>>, NetworkSerializable<com.hypixel.hytale.protocol.ItemCategory> {
   ...
   static {
      CODEC = ((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(FieldcraftCategory.class, FieldcraftCategory::new, Codec.STRING, (itemCategory, k) -> itemCategory.id = k, (itemCategory) -> itemCategory.id, (asset, data) -> asset.data = data, (asset) -> asset.data).addField(new KeyedCodec("Name", Codec.STRING), (itemCategory, s) -> itemCategory.name = s, (itemCategory) -> itemCategory.name)).append(new KeyedCodec("Icon", Codec.STRING), (itemCategory, s) -> itemCategory.icon = s, (itemCategory) -> itemCategory.icon).addValidator(CommonAssetValidator.ICON_CRAFTING).add()).addField(new KeyedCodec("Order", Codec.INTEGER), (itemCategory, s) -> itemCategory.order = s, (itemCategory) -> itemCategory.order)).build();
   }
}
