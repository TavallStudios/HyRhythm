...
public class PlayerConfig {
   ...
   protected ArmorVisibilityOption armorVisibilityOption;

   public PlayerConfig() {
      this.armorVisibilityOption = PlayerConfig.ArmorVisibilityOption.ALL;
   }
