...
public class ItemToolSpec implements JsonAssetWithMap<String, DefaultAssetMap<String, ItemToolSpec>>, NetworkSerializable<com.hypixel.hytale.protocol.ItemToolSpec> {
   ...
   public com.hypixel.hytale.protocol.ItemToolSpec toPacket() {
      com.hypixel.hytale.protocol.ItemToolSpec cached = this.cachedPacket == null ? null : (com.hypixel.hytale.protocol.ItemToolSpec)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
