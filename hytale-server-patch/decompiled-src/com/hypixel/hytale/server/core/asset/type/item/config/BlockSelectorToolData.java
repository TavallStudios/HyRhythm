...
public class BlockSelectorToolData implements NetworkSerializable<com.hypixel.hytale.protocol.BlockSelectorToolData> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(BlockSelectorToolData.class, BlockSelectorToolData::new).append(new KeyedCodec("DurabilityLossOnUse", Codec.DOUBLE), (data, x) -> data.durabilityLossOnUse = (double)x.floatValue(), (data) -> data.durabilityLossOnUse).add()).build();
   }
}
