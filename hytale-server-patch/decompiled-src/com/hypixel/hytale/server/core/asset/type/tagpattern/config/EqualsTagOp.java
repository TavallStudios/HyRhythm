...
public class EqualsTagOp extends TagPattern {
   ...
   public String toString() {
      ...
      return "EqualsTagOp{tag='" + var10000 + "'} " + super.toString();
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(EqualsTagOp.class, EqualsTagOp::new, TagPattern.BASE_CODEC).append(new KeyedCodec("Tag", Codec.STRING), (singleTagOp, s) -> singleTagOp.tag = s, (singleTagOp) -> singleTagOp.tag).addValidator(Validators.nonNull()).add()).afterDecode((singleTagOp) -> {
