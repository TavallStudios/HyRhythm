...
public class ItemSoundSet implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, ItemSoundSet>>, NetworkSerializable<com.hypixel.hytale.protocol.ItemSoundSet> {
   ...
   public com.hypixel.hytale.protocol.ItemSoundSet toPacket() {
      com.hypixel.hytale.protocol.ItemSoundSet cached = this.cachedPacket == null ? null : (com.hypixel.hytale.protocol.ItemSoundSet)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
   ...
   protected void processConfig() {
      if (!this.soundEventIds.isEmpty()) {
         ...
         for(Map.Entry<ItemSoundEvent, String> entry : this.soundEventIds.entrySet()) {
            this.soundEventIndices.put((ItemSoundEvent)entry.getKey(), SoundEvent.getAssetMap().getIndex((String)entry.getValue()));
         }
      }
   ...
   public String toString() {
      ...
      return "ItemSoundSet{id='" + var10000 + "', soundEventIds=" + String.valueOf(this.soundEventIds) + ", soundEventIndices=" + String.valueOf(this.soundEventIndices) + "}";
   }
   ...
   static {
      ...
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(ItemSoundSet::getAssetStore));
   }
}
