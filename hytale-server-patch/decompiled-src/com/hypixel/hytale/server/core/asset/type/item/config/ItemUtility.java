...
public class ItemUtility implements NetworkSerializable<com.hypixel.hytale.protocol.ItemUtility> {
   ...
   public String toString() {
      boolean var10000 = this.usable;
      return "ItemUtility{usable=" + var10000 + ", compatible=" + this.compatible + ", rawStatModifiers=" + String.valueOf(this.rawStatModifiers) + ", statModifiers=" + String.valueOf(this.statModifiers) + ", rawEntityStatsToClear=" + Arrays.toString(this.rawEntityStatsToClear) + ", entityStatsToClear=" + Arrays.toString(this.entityStatsToClear) + "}";
   }
