...
public class RotatedMountPointsArray {
   ...
   public BlockMountPoint[] getRotated(int rotationIndex) {
      if (this.raw != null && rotationIndex != 0) {
         ...
         if (value == null) {
            ...
            value = (BlockMountPoint[])list.toArray((x$0) -> new BlockMountPoint[x$0]);
   ...
   static {
      CHILD = new ArrayCodec<BlockMountPoint>(BlockMountPoint.CODEC, (x$0) -> new BlockMountPoint[x$0]);
      CODEC = new FunctionCodec(CHILD, RotatedMountPointsArray::new, RotatedMountPointsArray::getRaw);
   }
}
