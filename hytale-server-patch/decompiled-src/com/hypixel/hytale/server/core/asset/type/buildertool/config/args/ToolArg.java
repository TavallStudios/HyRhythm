...
public abstract class ToolArg<T> implements NetworkSerializable<BuilderToolArg> {
   ...
   public String toString() {
      boolean var10000 = this.required;
      return "ToolArg{required=" + var10000 + ", value=" + String.valueOf(this.value) + "}";
   }

   static {
      DEFAULT_CODEC = ((BuilderCodec.Builder)BuilderCodec.abstractBuilder(ToolArg.class).addField(new KeyedCodec("Required", Codec.BOOLEAN), (shapeArg, o) -> shapeArg.required = o, (shapeArg) -> shapeArg.required)).build();
   }
}
