...
public class IntArg extends ToolArg<Integer> {
   ...
   public BuilderToolIntArg toIntArgPacket() {
      return new BuilderToolIntArg((Integer)this.value, this.min, this.max);
   }
   ...
   public String toString() {
      ...
      return "IntArg{min=" + var10000 + ", max=" + this.max + "} " + super.toString();
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(IntArg.class, IntArg::new, ToolArg.DEFAULT_CODEC).addField(new KeyedCodec("Default", Codec.INTEGER), (intArg, d) -> intArg.value = d, (intArg) -> intArg.value)).addField(new KeyedCodec("Min", Codec.INTEGER), (intArg, d) -> intArg.min = d, (intArg) -> intArg.min)).addField(new KeyedCodec("Max", Codec.INTEGER), (intArg, d) -> intArg.max = d, (intArg) -> intArg.max)).build();
   }
}
