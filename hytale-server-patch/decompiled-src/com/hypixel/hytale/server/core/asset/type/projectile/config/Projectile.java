...
public class Projectile implements JsonAssetWithMap<String, DefaultAssetMap<String, Projectile>>, BallisticData {
   ...
   protected Projectile() {
      this.rotationMode = SimplePhysicsProvider.ROTATION_MODE.Velocity;
      this.deadTimeMiss = 10.0;
      this.density = 2000.0;
      this.waterTerminalVelocityMultiplier = 1.0;
      this.waterHitImpulseLoss = 0.0;
      this.dampingRotation = 0.0;
      this.rotationSpeedVelocityRatio = 2.0;
      ...
      if (this == o) {
         ...
         if (Double.compare(that.radius, this.radius) != 0) {
            ...
            if (this.rotationMode != that.rotationMode) {
               ...
               if (this.bounceSoundEventId != null) {
                  if (!this.bounceSoundEventId.equals(that.bounceSoundEventId)) {
                     return false;
                  }
               } else if (that.bounceSoundEventId != null) {
                  return false;
               }

               if (this.bounceParticles != null) {
                  if (!this.bounceParticles.equals(that.bounceParticles)) {
                     return false;
                  }
               } else if (that.bounceParticles != null) {
                  return false;
               }

               if (this.hitSoundEventId != null) {
                  if (!this.hitSoundEventId.equals(that.hitSoundEventId)) {
                     return false;
                  }
               } else if (that.hitSoundEventId != null) {
                  return false;
               }

               if (this.hitParticles != null) {
                  if (!this.hitParticles.equals(that.hitParticles)) {
                     return false;
                  }
               } else if (that.hitParticles != null) {
                  return false;
               }

               if (this.missSoundEventId != null) {
                  if (!this.missSoundEventId.equals(that.missSoundEventId)) {
                     return false;
                  }
               } else if (that.missSoundEventId != null) {
                  return false;
               }

               if (this.missParticles != null) {
                  if (!this.missParticles.equals(that.missParticles)) {
                     return false;
                  }
               } else if (that.missParticles != null) {
                  return false;
               }

               if (this.deathSoundEventId != null) {
                  if (!this.deathSoundEventId.equals(that.deathSoundEventId)) {
                     return false;
                  }
               } else if (that.deathSoundEventId != null) {
                  return false;
               }
