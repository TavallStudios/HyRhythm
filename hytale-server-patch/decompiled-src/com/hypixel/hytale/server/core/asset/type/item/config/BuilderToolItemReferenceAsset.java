...
public class BuilderToolItemReferenceAsset implements JsonAssetWithMap<String, DefaultAssetMap<String, BuilderToolItemReferenceAsset>> {
   ...
   static {
      CODEC = ((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(BuilderToolItemReferenceAsset.class, BuilderToolItemReferenceAsset::new, Codec.STRING, (t, k) -> t.id = k, (t) -> t.id, (asset, data) -> asset.data = data, (asset) -> asset.data).append(new KeyedCodec("BuilderToolItems", new ArrayCodec(Codec.STRING, (x$0) -> new String[x$0])), (i, itemIds) -> i.itemIds = itemIds, (i) -> i.itemIds).add()).build();
   }
}
