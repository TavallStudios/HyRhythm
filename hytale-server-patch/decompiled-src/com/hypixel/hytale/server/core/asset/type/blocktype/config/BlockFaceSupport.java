...
public class BlockFaceSupport implements NetworkSerializable<com.hypixel.hytale.protocol.BlockFaceSupport> {
   ...
   public String toString() {
      ...
      return "BlockFaceSupport{faceType='" + var10000 + "', filler=" + Arrays.toString(this.filler) + "}";
   }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(BlockFaceSupport.class, BlockFaceSupport::new).append(new KeyedCodec("FaceType", Codec.STRING), (blockFaceSupport, s) -> blockFaceSupport.faceType = s, (blockFaceSupport) -> blockFaceSupport.faceType).add()).documentation("Can be any string. Compared with FaceType in \"Support\". A LOT of blocks use 'Full'.")).append(new KeyedCodec("Filler", new ArrayCodec(Vector3i.CODEC, (x$0) -> new Vector3i[x$0])), (blockFaceSupport, o) -> blockFaceSupport.filler = o, (blockFaceSupport) -> blockFaceSupport.filler).add()).build();
      ALL = new BlockFaceSupport();
   }
}
