...
public class ItemQuality implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, ItemQuality>>, NetworkSerializable<com.hypixel.hytale.protocol.ItemQuality> {
   ...
   public com.hypixel.hytale.protocol.ItemQuality toPacket() {
      com.hypixel.hytale.protocol.ItemQuality cached = this.cachedPacket == null ? null : (com.hypixel.hytale.protocol.ItemQuality)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
   ...
   static {
      ...
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(ItemQuality::getAssetStore));
   }
}
