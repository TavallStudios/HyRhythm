...
public class BrushOriginArg extends ToolArg<BrushOrigin> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(BrushOriginArg.class, BrushOriginArg::new, ToolArg.DEFAULT_CODEC).addField(new KeyedCodec("Default", BRUSH_ORIGIN_CODEC), (originArg, o) -> originArg.value = o, (originArg) -> originArg.value)).build();
   }
}
