...
public class TimeFloat {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(TimeFloat.class, TimeFloat::new).append(new KeyedCodec("Hour", Codec.DOUBLE), (timeFloat, i) -> timeFloat.hour = i.floatValue(), (timeFloat) -> (double)timeFloat.getHour()).addValidator(Validators.range(0.0, 24.0)).add()).addField(new KeyedCodec("Value", Codec.DOUBLE), (timeFloat, d) -> timeFloat.value = d.floatValue(), (timeFloat) -> (double)timeFloat.value)).build();
   }
}
