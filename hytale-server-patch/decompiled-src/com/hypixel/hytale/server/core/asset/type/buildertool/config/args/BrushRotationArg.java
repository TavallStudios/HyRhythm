...
public class BrushRotationArg extends ToolArg<Rotation> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(BrushRotationArg.class, BrushRotationArg::new, ToolArg.DEFAULT_CODEC).append(new KeyedCodec("Default", ROTATION_CODEC), (arg, o) -> arg.value = o, (arg) -> arg.value).documentation("Represents the amount of rotation to be applied to a brush shape").addValidator(Validators.nonNull()).add()).build();
   }
}
