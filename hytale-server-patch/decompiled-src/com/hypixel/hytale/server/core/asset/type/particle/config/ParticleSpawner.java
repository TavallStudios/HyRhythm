...
public class ParticleSpawner implements JsonAssetWithMap<String, DefaultAssetMap<String, ParticleSpawner>>, NetworkSerializable<com.hypixel.hytale.protocol.ParticleSpawner> {
   ...
   public com.hypixel.hytale.protocol.ParticleSpawner toPacket() {
      com.hypixel.hytale.protocol.ParticleSpawner cached = this.cachedPacket == null ? null : (com.hypixel.hytale.protocol.ParticleSpawner)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
