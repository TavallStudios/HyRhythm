...
public class ItemDropList implements JsonAssetWithMap<String, DefaultAssetMap<String, ItemDropList>> {
   ...
   public String toString() {
      ...
      return "ItemDropList{id='" + var10000 + "', container=" + String.valueOf(this.container) + "}";
   }

   static {
      CODEC = ((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(ItemDropList.class, ItemDropList::new, Codec.STRING, (itemDropList, s) -> itemDropList.id = s, (itemDropList) -> itemDropList.id, (asset, data) -> asset.data = data, (asset) -> asset.data).appendInherited(new KeyedCodec("Container", ItemDropContainer.CODEC), (itemDropList, o) -> itemDropList.container = o, (itemDropList) -> itemDropList.container, (itemDropList, parent) -> itemDropList.container = parent.container).add()).validator((asset, results) -> {
      ...
      CHILD_ASSET_CODEC = new ContainedAssetCodec(ItemDropList.class, CODEC);
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(ItemDropList::getAssetStore));
   }
}
