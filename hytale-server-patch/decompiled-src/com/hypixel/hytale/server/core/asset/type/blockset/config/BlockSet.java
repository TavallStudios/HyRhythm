...
public class BlockSet implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, BlockSet>>, NetworkSerializable<com.hypixel.hytale.protocol.BlockSet> {
   ...
   public String toString() {
      ...
      return "BlockSet{name='" + var10000 + "', parent='" + this.parent + "', includeAll=" + this.includeAll + ", includeBlockTypes=" + Arrays.toString(this.includeBlockTypes) + ", excludeBlockTypes=" + Arrays.toString(this.excludeBlockTypes) + ", includeBlockGroups=" + Arrays.toString(this.includeBlockGroups) + ", excludeBlockGroups=" + Arrays.toString(this.excludeBlockGroups) + ", includeHitboxTypes=" + Arrays.toString(this.includeHitboxTypes) + ", excludeHitboxTypes=" + Arrays.toString(this.excludeHitboxTypes) + ", includeCategories=" + Arrays.deepToString(this.includeCategories) + ", excludeCategories=" + Arrays.deepToString(this.excludeCategories) + "}";
   }
