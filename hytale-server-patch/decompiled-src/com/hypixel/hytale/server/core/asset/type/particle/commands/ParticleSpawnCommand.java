...
public class ParticleSpawnCommand extends AbstractTargetPlayerCommand {
   ...
   public ParticleSpawnCommand() {
      ...
      this.particleSystemArg = this.withRequiredArg("particle", "server.commands.particle.spawn.particle.desc", ArgTypes.PARTICLE_SYSTEM);
      this.addUsageVariant(new ParticleSpawnPageCommand());
   }

   protected void execute(@Nonnull CommandContext context, @Nullable Ref<EntityStore> sourceRef, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world, @Nonnull Store<EntityStore> store) {
      ParticleSystem particleSystem = (ParticleSystem)this.particleSystemArg.get(context);
