...
public class AudioCategory implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, AudioCategory>>, NetworkSerializable<com.hypixel.hytale.protocol.AudioCategory> {
   ...
   public com.hypixel.hytale.protocol.AudioCategory toPacket() {
      com.hypixel.hytale.protocol.AudioCategory cached = this.cachedPacket == null ? null : (com.hypixel.hytale.protocol.AudioCategory)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
         ...
         for(AssetExtraInfo.Data parentData = this.data; parentData != null; parentData = parent.data) {
