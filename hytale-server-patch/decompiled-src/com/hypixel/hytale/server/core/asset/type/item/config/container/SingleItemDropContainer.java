...
public class SingleItemDropContainer extends ItemDropContainer {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.drop);
      return "SingleItemDropContainer{drop=" + var10000 + ", weight=" + this.weight + "}";
   }

   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(SingleItemDropContainer.class, SingleItemDropContainer::new, ItemDropContainer.DEFAULT_CODEC).append(new KeyedCodec("Item", ItemDrop.CODEC), (singleItemDropContainer, itemDrop) -> singleItemDropContainer.drop = itemDrop, (singleItemDropContainer) -> singleItemDropContainer.drop).addValidator(Validators.nonNull()).add()).build();
   }
}
