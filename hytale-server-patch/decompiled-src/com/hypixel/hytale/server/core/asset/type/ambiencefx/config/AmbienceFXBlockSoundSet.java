...
public class AmbienceFXBlockSoundSet implements NetworkSerializable<com.hypixel.hytale.protocol.AmbienceFXBlockSoundSet> {
   ...
   public String toString() {
      String var10000 = this.blockSoundSetId;
      return "AmbienceFXBlockSoundSet{blockSoundSetId='" + var10000 + "'blockSoundSetIndex='" + this.blockSoundSetIndex + "', percent=" + String.valueOf(this.percent) + "}";
   }
   ...
   static {
      ...
      DEFAULT_PERCENT = new Rangef(0.0F, 0.0F);
   }
}
