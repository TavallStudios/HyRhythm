...
public class BlockParticleSet implements JsonAssetWithMap<String, DefaultAssetMap<String, BlockParticleSet>>, NetworkSerializable<com.hypixel.hytale.protocol.BlockParticleSet> {
   ...
   public com.hypixel.hytale.protocol.BlockParticleSet toPacket() {
      com.hypixel.hytale.protocol.BlockParticleSet cached = this.cachedPacket == null ? null : (com.hypixel.hytale.protocol.BlockParticleSet)this.cachedPacket.get();
      if (cached != null) {
         return cached;
      } else {
