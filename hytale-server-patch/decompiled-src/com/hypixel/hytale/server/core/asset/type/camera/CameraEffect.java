...
public abstract class CameraEffect implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, CameraEffect>> {
   ...
   static {
      CODEC = new AssetCodecMapCodec<String, CameraEffect>(Codec.STRING, (t, k) -> t.id = k, (t) -> t.id, (t, data) -> t.data = data, (t) -> t.data);
      CHILD_ASSET_CODEC = new ContainedAssetCodec(CameraEffect.class, CODEC);
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(CameraEffect::getAssetStore));
   }
