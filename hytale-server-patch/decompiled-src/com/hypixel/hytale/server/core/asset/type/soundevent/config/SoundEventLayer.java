...
public class SoundEventLayer implements NetworkSerializable<com.hypixel.hytale.protocol.SoundEventLayer> {
   ...
   protected RandomSettings randomSettings;
   ...
   public SoundEventLayer(float volume, float startDelay, boolean looping, int probability, float probabilityRerollDelay, RandomSettings randomSettings, String[] files, int roundRobinHistorySize) {
      this.randomSettings = SoundEventLayer.RandomSettings.DEFAULT;
      this.roundRobinHistorySize = 0;
      this.highestNumberOfChannels = 0;
      this.volume = volume;
   ...
   public static class RandomSettings {
      ...
      public static final RandomSettings DEFAULT;
