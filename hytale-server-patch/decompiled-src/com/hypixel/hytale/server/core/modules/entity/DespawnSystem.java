...
public class DespawnSystem extends EntityTickingSystem<EntityStore> {
   ...
   public DespawnSystem(ComponentType<EntityStore, DespawnComponent> despawnComponentType) {
      ...
      this.query = Query.<EntityStore>and(despawnComponentType, Query.not(Interactable.getComponentType()));
   }
   ...
   public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
      DespawnComponent despawn = (DespawnComponent)archetypeChunk.getComponent(index, this.despawnComponentType);
