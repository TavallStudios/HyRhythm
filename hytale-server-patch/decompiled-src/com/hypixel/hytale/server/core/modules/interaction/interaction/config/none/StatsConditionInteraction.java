...
public class StatsConditionInteraction extends StatsConditionBaseInteraction {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(StatsConditionInteraction.class, StatsConditionInteraction::new, StatsConditionBaseInteraction.CODEC).documentation("Interaction that is successful if the given stat conditions match.")).build();
   }
}
