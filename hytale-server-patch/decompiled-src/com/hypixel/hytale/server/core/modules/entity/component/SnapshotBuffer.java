...
public class SnapshotBuffer implements Component<EntityStore> {
   ...
   private int currentTickIndex = -2147483648;
   private int oldestTickIndex = -2147483648;
   ...
   public void storeSnapshot(int tickIndex, @Nonnull Vector3d position, @Nonnull Vector3f bodyRotation) {
      if (this.currentIndex != -1 && this.currentTickIndex != tickIndex - 1) {
         this.currentIndex = -1;
         this.currentTickIndex = -2147483648;
         this.oldestTickIndex = -2147483648;
      }
   ...
   public void resize(int newLength) {
      if (newLength <= 0) {
         ...
         if (this.snapshots == null) {
            ...
            this.snapshots = (EntitySnapshot[])Arrays.copyOf(this.snapshots, newLength);
