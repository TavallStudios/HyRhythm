...
public class UseBlockInteraction extends SimpleBlockInteraction {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(UseBlockInteraction.class, UseBlockInteraction::new, SimpleBlockInteraction.CODEC).documentation("Attempts to use the target block, executing interactions on it if any.")).build();
   }
}
