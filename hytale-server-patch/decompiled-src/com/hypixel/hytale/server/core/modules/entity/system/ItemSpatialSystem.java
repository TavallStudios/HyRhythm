...
public class ItemSpatialSystem extends SpatialSystem<EntityStore> {
   @Nonnull
   private static final AndQuery<EntityStore> QUERY = Query.<EntityStore>and(ItemComponent.getComponentType(), TransformComponent.getComponentType(), Query.not(PreventItemMerging.getComponentType()));
