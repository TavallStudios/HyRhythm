...
public class EntityInteractableSystems {
   ...
   public static class EntityTrackerUpdate extends EntityTickingSystem<EntityStore> {
      ...
      public EntityTrackerUpdate(ComponentType<EntityStore, EntityTrackerSystems.Visible> componentType) {
         ...
         this.query = Query.<EntityStore>and(componentType, Interactable.getComponentType());
      }
      ...
      public void tick(float dt, int systemIndex, @Nonnull Store<EntityStore> store) {
         ...
         ((QueueResource)store.getResource(EntityInteractableSystems.QueueResource.getResourceType())).queue.clear();
      }
      ...
      public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         ...
         if (((QueueResource)commandBuffer.getResource(EntityInteractableSystems.QueueResource.getResourceType())).queue.remove(ref)) {
   ...
   public static class EntityTrackerAddAndRemove extends RefChangeSystem<EntityStore, Interactable> {
      ...
      public EntityTrackerAddAndRemove(ComponentType<EntityStore, EntityTrackerSystems.Visible> visibleComponentType) {
         ...
         this.query = Query.<EntityStore>and(visibleComponentType, this.interactableComponentType);
      }
      ...
      public void onComponentAdded(@Nonnull Ref<EntityStore> ref, @Nonnull Interactable component, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         ((QueueResource)commandBuffer.getResource(EntityInteractableSystems.QueueResource.getResourceType())).queue.add(ref);
      }

      public void onComponentSet(@Nonnull Ref<EntityStore> ref, Interactable oldComponent, @Nonnull Interactable newComponent, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
      }

      public void onComponentRemoved(@Nonnull Ref<EntityStore> ref, @Nonnull Interactable component, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
