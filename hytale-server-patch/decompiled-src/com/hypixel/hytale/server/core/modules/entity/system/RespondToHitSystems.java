...
public class RespondToHitSystems {
   ...
   public static class EntityTrackerUpdate extends EntityTickingSystem<EntityStore> {
      ...
      public EntityTrackerUpdate(ComponentType<EntityStore, EntityTrackerSystems.Visible> componentType) {
         ...
         this.query = Query.<EntityStore>and(componentType, RespondToHit.getComponentType());
      }
      ...
      public void tick(float dt, int systemIndex, @Nonnull Store<EntityStore> store) {
         ...
         ((QueueResource)store.getResource(RespondToHitSystems.QueueResource.getResourceType())).queue.clear();
      }
      ...
      public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         ...
         if (((QueueResource)commandBuffer.getResource(RespondToHitSystems.QueueResource.getResourceType())).queue.remove(ref)) {
   ...
   public static class EntityTrackerAddAndRemove extends RefChangeSystem<EntityStore, RespondToHit> {
      ...
      public EntityTrackerAddAndRemove(ComponentType<EntityStore, EntityTrackerSystems.Visible> visibleComponentType) {
         ...
         this.query = Query.<EntityStore>and(visibleComponentType, this.respondToHitComponentType);
      }
      ...
      public void onComponentAdded(@Nonnull Ref<EntityStore> ref, @Nonnull RespondToHit component, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         ((QueueResource)commandBuffer.getResource(RespondToHitSystems.QueueResource.getResourceType())).queue.add(ref);
      }
