...
public class Velocity implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(Velocity.class, Velocity::new).append(new KeyedCodec("Velocity", Vector3d.CODEC), (entity, o) -> entity.velocity.assign(o), (entity) -> entity.velocity).add()).build();
   }
