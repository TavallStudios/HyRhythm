...
public class PhysicsValues implements Component<EntityStore> {
   ...
   public void scale(float scale) {
      this.mass *= (double)scale;
      this.dragCoefficient *= (double)scale;
   }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PhysicsValues.class, PhysicsValues::new).append(new KeyedCodec("Mass", Codec.DOUBLE), (instance, value) -> instance.mass = value, (instance) -> instance.mass).addValidator(Validators.greaterThan(ZERO)).add()).append(new KeyedCodec("DragCoefficient", Codec.DOUBLE), (instance, value) -> instance.dragCoefficient = value, (instance) -> instance.dragCoefficient).addValidator(Validators.greaterThanOrEqual(ZERO)).add()).append(new KeyedCodec("InvertedGravity", Codec.BOOLEAN), (instance, value) -> instance.invertedGravity = value, (instance) -> instance.invertedGravity).add()).build();
   }
}
