...
public abstract class Condition {
   @Nonnull
   public static final CodecMapCodec<Condition> CODEC = new CodecMapCodec<Condition>();
   @Nonnull
   ...
   static {
      BASE_CODEC = ((BuilderCodec.Builder)BuilderCodec.abstractBuilder(Condition.class).append(new KeyedCodec("Inverse", Codec.BOOLEAN), (regenerating, value) -> regenerating.inverse = value, (regenerating) -> regenerating.inverse).documentation("Determines whether the condition is inverted.").add()).build();
   }
}
