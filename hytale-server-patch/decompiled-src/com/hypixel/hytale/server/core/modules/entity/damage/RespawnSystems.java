...
public class RespawnSystems {
   ...
   public static class ResetStatsRespawnSystem extends OnRespawnSystem {
      ...
      public void onComponentRemoved(@Nonnull Ref<EntityStore> ref, @Nonnull DeathComponent component, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         EntityStatMap entityStatMapComponent = (EntityStatMap)store.getComponent(ref, EntityStatMap.getComponentType());
   ...
   public static class ClearRespawnUI extends OnRespawnSystem {
      public void onComponentRemoved(@Nonnull Ref<EntityStore> ref, @Nonnull DeathComponent component, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         Player playerComponent = (Player)commandBuffer.getComponent(ref, Player.getComponentType());
