...
public class UIComponentSystems {
   public static class Setup extends HolderSystem<EntityStore> {
      ...
      public void onEntityAdd(@Nonnull Holder<EntityStore> holder, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store) {
         UIComponentList components = (UIComponentList)holder.getComponent(this.uiComponentListComponentType);
         if (components == null) {
            components = (UIComponentList)holder.ensureAndGetComponent(this.uiComponentListComponentType);
            components.update();
         }
   ...
   public static class Update extends EntityTickingSystem<EntityStore> {
      ...
      public Update(ComponentType<EntityStore, EntityTrackerSystems.Visible> visibleComponentType, ComponentType<EntityStore, UIComponentList> uiComponentListComponentType) {
         ...
         this.query = Query.<EntityStore>and(visibleComponentType, uiComponentListComponentType);
      }
      ...
      public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         ...
         UIComponentList uiComponentList = (UIComponentList)archetypeChunk.getComponent(index, this.uiComponentListComponentType);
