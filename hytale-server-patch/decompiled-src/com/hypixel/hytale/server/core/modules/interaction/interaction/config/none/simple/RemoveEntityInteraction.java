...
public class RemoveEntityInteraction extends SimpleInstantInteraction {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.entityTarget);
      return "RemoveEntityInteraction{entityTarget=" + var10000 + "} " + super.toString();
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(RemoveEntityInteraction.class, RemoveEntityInteraction::new, SimpleInstantInteraction.CODEC).documentation("Despawns the given entity.")).appendInherited(new KeyedCodec("Entity", InteractionTarget.CODEC), (o, i) -> o.entityTarget = i, (o) -> o.entityTarget, (o, p) -> o.entityTarget = p.entityTarget).documentation("The entity to target for this interaction.").addValidator(Validators.nonNull()).add()).build();
   }
}
