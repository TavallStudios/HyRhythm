...
public class RepulsionConfigPacketGenerator extends AssetPacketGenerator<String, RepulsionConfig, IndexedLookupTableAssetMap<String, RepulsionConfig>> {
   ...
   public ToClientPacket generateInitPacket(@Nonnull IndexedLookupTableAssetMap<String, RepulsionConfig> assetMap, @Nonnull Map<String, RepulsionConfig> assets) {
      ...
      for(Map.Entry<String, RepulsionConfig> entry : assets.entrySet()) {
         repulsionConfigs.put(assetMap.getIndex((String)entry.getKey()), ((RepulsionConfig)entry.getValue()).toPacket());
      }
   ...
   @Nonnull
   public ToClientPacket generateUpdatePacket(@Nonnull IndexedLookupTableAssetMap<String, RepulsionConfig> assetMap, @Nonnull Map<String, RepulsionConfig> loadedAssets, @Nonnull AssetUpdateQuery query) {
      Int2ObjectMap<com.hypixel.hytale.protocol.RepulsionConfig> repulsionConfigs = new Int2ObjectOpenHashMap();
   ...
   @Nonnull
   public ToClientPacket generateRemovePacket(@Nonnull IndexedLookupTableAssetMap<String, RepulsionConfig> assetMap, @Nonnull Set<String> removed, @Nonnull AssetUpdateQuery query) {
      Int2ObjectMap<com.hypixel.hytale.protocol.RepulsionConfig> repulsionConfigs = new Int2ObjectOpenHashMap();
