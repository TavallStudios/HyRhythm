...
public class OpenContainerInteraction extends SimpleBlockInteraction {
      ...
      if (playerComponent != null) {
         ...
         if (container instanceof ItemContainerState) {
            ...
            if (itemContainerState.isAllowViewing() && itemContainerState.canOpen(ref, commandBuffer)) {
               ...
               ContainerBlockWindow window = new ContainerBlockWindow(pos.x, pos.y, pos.z, chunk.getRotationIndex(pos.x, pos.y, pos.z), blockType, itemContainerState.getItemContainer());
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(OpenContainerInteraction.class, OpenContainerInteraction::new, SimpleBlockInteraction.CODEC).documentation("Opens the container of the block currently being interacted with.")).build();
   }
}
