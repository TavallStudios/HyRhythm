...
public class HitboxCollisionConfig implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, HitboxCollisionConfig>>, NetworkSerializable<com.hypixel.hytale.protocol.HitboxCollisionConfig> {
   ...
   public static AssetStore<String, HitboxCollisionConfig, IndexedLookupTableAssetMap<String, HitboxCollisionConfig>> getAssetStore() {
      if (ASSET_STORE == null) {
         ASSET_STORE = AssetRegistry.<String, HitboxCollisionConfig, IndexedLookupTableAssetMap<String, HitboxCollisionConfig>>getAssetStore(HitboxCollisionConfig.class);
      }
   ...
   public String toString() {
      ...
      return "HitboxCollisionConfig{data=" + var10000 + ", id='" + this.id + "', collisionType=" + String.valueOf(this.collisionType) + ", softOffsetRatio=" + this.softOffsetRatio + "}";
   }
   ...
   static {
      ...
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(HitboxCollisionConfig::getAssetStore));
   }
}
