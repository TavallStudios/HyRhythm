...
public class EntityRegistry extends Registry<EntityRegistration> {
   ...
   @Nullable
   public <T extends Entity> EntityRegistration registerEntity(@Nonnull String key, @Nonnull Class<T> clazz, Function<World, T> constructor, DirectDecodeCodec<T> codec) {
      this.checkPrecondition();
      return (EntityRegistration)this.register(EntityModule.get().registerEntity(key, clazz, constructor, codec));
   }
}
