...
public class WorldGenId implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(WorldGenId.class, WorldGenId::new).append(new KeyedCodec("WorldGenId", Codec.INTEGER), (worldGenId, i) -> worldGenId.worldGenId = i, (worldGenId) -> worldGenId.worldGenId).add()).build();
   }
}
