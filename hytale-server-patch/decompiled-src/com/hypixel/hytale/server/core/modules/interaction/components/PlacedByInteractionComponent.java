...
public class PlacedByInteractionComponent implements Component<ChunkStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(PlacedByInteractionComponent.class, PlacedByInteractionComponent::new).appendInherited(new KeyedCodec("WhoPlacedUuid", Codec.UUID_BINARY), (o, i) -> o.whoPlacedUuid = i, (o) -> o.whoPlacedUuid, (o, parent) -> o.whoPlacedUuid = parent.whoPlacedUuid).add()).build();
   }
}
