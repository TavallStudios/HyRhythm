   ...
   protected void firstRun(@Nonnull InteractionType type, @Nonnull InteractionContext context, @Nonnull CooldownHandler cooldownHandler) {
      ...
      if (blockPosition != null) {
         ...
         if (chunkReference != null) {
            ...
            BlockHarvestUtils.performBlockBreak(ref, (ItemStack)null, position, chunkReference, context.getCommandBuffer(), chunkStoreStore);
         }
      }
   }

   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(DestroyBlockInteraction.class, DestroyBlockInteraction::new, SimpleInstantInteraction.CODEC).documentation("Destroys the target block.")).build();
   }
}
