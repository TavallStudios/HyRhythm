...
public class InteractionCameraSettings implements NetworkSerializable<com.hypixel.hytale.protocol.InteractionCameraSettings> {
   ...
   public String toString() {
      String var10000 = Arrays.toString(this.firstPerson);
      return "InteractionCameraSettings{firstPerson=" + var10000 + ", thirdPerson=" + Arrays.toString(this.thirdPerson) + "}";
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(InteractionCameraSettings.class, InteractionCameraSettings::new).appendInherited(new KeyedCodec("FirstPerson", new ArrayCodec(InteractionCameraSettings.InteractionCamera.CODEC, (x$0) -> new InteractionCamera[x$0])), (o, i) -> o.firstPerson = i, (o) -> o.firstPerson, (o, p) -> o.firstPerson = p.firstPerson).addValidator(getInteractionCameraValidator()).add()).appendInherited(new KeyedCodec("ThirdPerson", new ArrayCodec(InteractionCameraSettings.InteractionCamera.CODEC, (x$0) -> new InteractionCamera[x$0])), (o, i) -> o.thirdPerson = i, (o) -> o.thirdPerson, (o, p) -> o.thirdPerson = p.thirdPerson).addValidator(getInteractionCameraValidator()).add()).build();
   }
   ...
   public static class InteractionCamera implements NetworkSerializable<com.hypixel.hytale.protocol.InteractionCamera> {
      ...
      public String toString() {
         ...
         return "InteractionCamera{time=" + var10000 + ", position=" + String.valueOf(this.position) + ", rotation=" + String.valueOf(this.rotation) + "}";
      }

      static {
         CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(InteractionCamera.class, InteractionCamera::new).appendInherited(new KeyedCodec("Time", Codec.FLOAT), (o, i) -> o.time = i, (o) -> o.time, (o, p) -> o.time = p.time).addValidator(Validators.greaterThan(0.0F)).add()).appendInherited(new KeyedCodec("Position", ProtocolCodecs.VECTOR3F), (o, i) -> o.position = i, (o) -> o.position, (o, p) -> o.position = p.position).addValidator(Validators.nonNull()).add()).appendInherited(new KeyedCodec("Rotation", ProtocolCodecs.DIRECTION), (o, i) -> {
            o.rotation = i;
            Direction var10000 = o.rotation;
            var10000.yaw *= 0.017453292F;
            var10000 = o.rotation;
            var10000.pitch *= 0.017453292F;
            var10000 = o.rotation;
            var10000.roll *= 0.017453292F;
         }, (o) -> new Direction(o.rotation.yaw * 57.295776F, o.rotation.pitch * 57.295776F, o.rotation.roll * 57.295776F), (o, p) -> o.rotation = p.rotation).addValidator(Validators.nonNull()).add()).build();
      }
   }
}
