...
public class PersistentModel implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(PersistentModel.class, PersistentModel::new).append(new KeyedCodec("Model", Model.ModelReference.CODEC), (entity, model) -> entity.modelReference = model, (entity) -> entity.modelReference).add()).build();
   }
}
