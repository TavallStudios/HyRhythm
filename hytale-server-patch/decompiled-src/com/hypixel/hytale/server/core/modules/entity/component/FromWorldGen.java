...
public class FromWorldGen implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(FromWorldGen.class, FromWorldGen::new).append(new KeyedCodec("WorldGenId", Codec.INTEGER), (fromWorldGen, i) -> fromWorldGen.worldGenId = i, (fromWorldGen) -> fromWorldGen.worldGenId).add()).build();
   }
}
