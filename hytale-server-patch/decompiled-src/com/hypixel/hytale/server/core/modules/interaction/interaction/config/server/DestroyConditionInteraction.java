...
public class DestroyConditionInteraction extends SimpleBlockInteraction {
   public static final BuilderCodec<DestroyConditionInteraction> CODEC;
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(DestroyConditionInteraction.class, DestroyConditionInteraction::new, SimpleBlockInteraction.CODEC).documentation("Checks if the target block is destroyable")).build();
   }
}
