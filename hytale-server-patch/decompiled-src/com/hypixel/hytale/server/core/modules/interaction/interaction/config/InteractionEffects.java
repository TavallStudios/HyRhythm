...
public class InteractionEffects implements NetworkSerializable<com.hypixel.hytale.protocol.InteractionEffects> {
   ...
   protected int cameraEffectIndex = -2147483648;
   ...
   public com.hypixel.hytale.protocol.InteractionEffects toPacket() {
      ...
      if (this.cameraEffectIndex != -2147483648) {
         CameraEffect cameraShakeEffect = (CameraEffect)CameraEffect.getAssetMap().getAsset(this.cameraEffectIndex);
