...
public class StaminaModule extends JavaPlugin {
   public static final PluginManifest MANIFEST = PluginManifest.corePlugin(StaminaModule.class).depends(EntityModule.class).depends(EntityStatsModule.class).build();
   ...
   protected void setup() {
      ...
      this.getEventRegistry().register((Class)LoadedAssetsEvent.class, GameplayConfig.class, StaminaModule::onGameplayConfigsLoaded);
   }
