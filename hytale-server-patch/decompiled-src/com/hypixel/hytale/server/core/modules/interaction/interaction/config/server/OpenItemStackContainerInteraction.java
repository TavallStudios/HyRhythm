...
public class OpenItemStackContainerInteraction extends SimpleInstantInteraction {
         ...
         if (pageManager.getCustomPage() == null) {
            ...
            if (!ItemStack.isEmpty(heldItem)) {
               ...
               if (itemContainer != null) {
                  ItemStack itemStack = itemContainer.getItemStack((short)heldItemSlot);
                  ItemStackContainerConfig config = itemStack.getItem().getItemStackContainerConfig();
                  ItemStackItemContainer itemStackItemContainer = ItemStackItemContainer.ensureConfiguredContainer(itemContainer, (short)heldItemSlot, config);
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(OpenItemStackContainerInteraction.class, OpenItemStackContainerInteraction::new, SimpleInstantInteraction.CODEC).documentation("Opens a container contained within the current held item.")).build();
   }
}
