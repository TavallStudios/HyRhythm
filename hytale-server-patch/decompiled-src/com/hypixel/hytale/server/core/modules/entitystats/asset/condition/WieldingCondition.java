...
public class WieldingCondition extends Condition {
   ...
   public boolean eval0(@Nonnull ComponentAccessor<EntityStore> componentAccessor, @Nonnull Ref<EntityStore> ref, @Nonnull Instant currentTime) {
      DamageDataComponent damageComponent = (DamageDataComponent)componentAccessor.getComponent(ref, DamageDataComponent.getComponentType());
   ...
   static {
      CODEC = BuilderCodec.builder(WieldingCondition.class, WieldingCondition::new, Condition.BASE_CODEC).build();
   }
}
