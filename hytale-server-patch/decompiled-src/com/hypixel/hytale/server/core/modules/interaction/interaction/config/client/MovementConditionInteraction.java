...
public class MovementConditionInteraction extends SimpleInteraction {
   ...
   protected void tick0(boolean firstRun, float time, @Nonnull InteractionType type, @Nonnull InteractionContext context, @Nonnull CooldownHandler cooldownHandler) {
      ...
      byte var10002;
      switch (context.getClientState().movementDirection) {
         case None -> var10002 = 0;
         case Forward -> var10002 = 1;
         case Back -> var10002 = 2;
         case Left -> var10002 = 3;
         case Right -> var10002 = 4;
         case ForwardLeft -> var10002 = 5;
         case ForwardRight -> var10002 = 6;
         case BackLeft -> var10002 = 7;
         case BackRight -> var10002 = 8;
         default -> throw new MatchException((String)null, (Throwable)null);
      }

      context.jump(context.getLabel(var10002));
   }
