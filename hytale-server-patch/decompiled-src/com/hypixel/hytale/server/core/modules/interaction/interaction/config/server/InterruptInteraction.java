...
public class InterruptInteraction extends SimpleInstantInteraction {
   ...
   public InterruptInteraction() {
      ...
      this.requiredTagIndex = -2147483648;
      this.excludedTagIndex = -2147483648;
   }
   ...
   protected void firstRun(@Nonnull InteractionType type, @Nonnull InteractionContext context, @Nonnull CooldownHandler cooldownHandler) {
      ...
      if (targetRef != null) {
         ...
         InteractionManager interactionManagerComponent = (InteractionManager)commandBuffer.getComponent(targetRef, InteractionModule.get().getInteractionManagerComponent());
         if (interactionManagerComponent != null) {
            ObjectIterator var8 = interactionManagerComponent.getChains().values().iterator();

            while(var8.hasNext()) {
               InteractionChain interactionChain = (InteractionChain)var8.next();
