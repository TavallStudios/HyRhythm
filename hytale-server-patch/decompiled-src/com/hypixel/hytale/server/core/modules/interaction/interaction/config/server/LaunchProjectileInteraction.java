...
public class LaunchProjectileInteraction extends SimpleInstantInteraction implements BallisticDataProvider {
   ...
   public BallisticData getBallisticData() {
      return (BallisticData)Projectile.getAssetMap().getAsset(this.projectileId);
   }
   ...
   protected void firstRun(@Nonnull InteractionType type, @Nonnull InteractionContext context, @Nonnull CooldownHandler cooldownHandler) {
      ...
      if (var8 instanceof LivingEntity) {
         LivingEntity attackerLivingEntity = (LivingEntity)var8;
         ...
         UUIDComponent sourceUuidComponent = (UUIDComponent)commandBuffer.getComponent(sourceRef, UUIDComponent.getComponentType());
