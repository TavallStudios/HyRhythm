...
public class StatCondition extends EntityStatBoundCondition {
   ...
   protected StatCondition() {
      this.comparison = StatCondition.StatComparisonType.GTE;
   }
