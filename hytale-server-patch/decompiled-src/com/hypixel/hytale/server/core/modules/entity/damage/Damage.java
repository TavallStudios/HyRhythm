...
public class Damage extends CancellableEcsEvent implements IMetaStore<Damage> {
   ...
   @Nonnull
   public static final MetaRegistry<Damage> META_REGISTRY = new MetaRegistry<Damage>();
   @Nonnull
   ...
   public Damage(@Nonnull Source source, @Nonnull DamageCause damageCause, float amount) {
      this.metaStore = new DynamicMetaStore<Damage>(this, META_REGISTRY);
      this.source = source;
   ...
   public DamageCause getCause() {
      return (DamageCause)DamageCause.getAssetMap().getAsset(this.damageCauseIndex);
   }
   ...
   static {
      HIT_LOCATION = META_REGISTRY.registerMetaObject();
      HIT_ANGLE = META_REGISTRY.registerMetaObject();
      IMPACT_PARTICLES = META_REGISTRY.registerMetaObject();
   ...
   public static record CameraEffect(int cameraEffectIndex) {
   ...
   public interface Source {
      ...
      default Message getDeathMessage(@Nonnull Damage info, @Nonnull Ref<EntityStore> targetRef, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
         DamageCause damageCauseAsset = (DamageCause)DamageCause.getAssetMap().getAsset(info.damageCauseIndex);
   ...
   public static class EntitySource implements Source {
      ...
      public Message getDeathMessage(@Nonnull Damage info, @Nonnull Ref<EntityStore> targetRef, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
         ...
         DisplayNameComponent displayNameComponent = (DisplayNameComponent)componentAccessor.getComponent(this.sourceRef, DisplayNameComponent.getComponentType());
