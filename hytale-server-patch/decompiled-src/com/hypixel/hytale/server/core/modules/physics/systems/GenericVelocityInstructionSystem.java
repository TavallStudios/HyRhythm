...
public class GenericVelocityInstructionSystem extends EntityTickingSystem<EntityStore> {
   ...
   public GenericVelocityInstructionSystem() {
      this.dependencies = Set.of(new SystemTypeDependency(Order.AFTER, EntityModule.get().getVelocityModifyingSystemType()));
      this.query = Query.<EntityStore>and(Velocity.getComponentType());
   }
