...
public class EntityScaleComponent implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(EntityScaleComponent.class, EntityScaleComponent::new).addField(new KeyedCodec("Scale", Codec.FLOAT), (o, scale) -> o.scale = scale, (o) -> o.scale)).build();
   }
}
