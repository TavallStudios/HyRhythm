...
public class LaunchPadInteraction extends SimpleBlockInteraction {
   public static final BuilderCodec<LaunchPadInteraction> CODEC;
   ...
   protected void interactWithBlock(@Nonnull World world, @Nonnull CommandBuffer<EntityStore> commandBuffer, @Nonnull InteractionType type, @Nonnull InteractionContext context, @Nullable ItemStack itemInHand, @Nonnull Vector3i targetBlock, @Nonnull CooldownHandler cooldownHandler) {
      ...
      if (chunk != null) {
         ...
         if (blockEntityRef != null) {
            LaunchPad launchPadState = (LaunchPad)blockEntityRef.getStore().getComponent(blockEntityRef, LaunchPad.getComponentType());
            if (launchPadState != null) {
               ...
               if (!launchPadState.isPlayersOnly() || playerComponent != null) {
                  Velocity velocityComponent = (Velocity)commandBuffer.getComponent(ref, Velocity.getComponentType());

                  assert velocityComponent != null;

                  velocityComponent.addInstruction(new Vector3d((double)launchPadState.getVelocityX(), (double)launchPadState.getVelocityY(), (double)launchPadState.getVelocityZ()), (VelocityConfig)null, ChangeVelocityType.Set);
                  ...
                  ParticleUtil.spawnParticleEffect((String)"Splash", particlePos, results, commandBuffer);
               }
            }
         }
      }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(LaunchPadInteraction.class, LaunchPadInteraction::new, SimpleBlockInteraction.CODEC).documentation("Applies the launchpad forces.")).build();
   }
}
