...
public class TransformComponent implements Component<EntityStore> {
   ...
   public void markChunkDirty(@Nonnull ComponentAccessor<EntityStore> componentAccessor) {
      if (this.chunkRef != null && this.chunkRef.isValid()) {
         ...
         WorldChunk worldChunkComponent = (WorldChunk)chunkStore.getComponent(this.chunkRef, WorldChunk.getComponentType());
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(TransformComponent.class, TransformComponent::new).append(new KeyedCodec("Position", Vector3d.CODEC), (o, i) -> o.position.assign(i), (o) -> o.position).add()).append(new KeyedCodec("Rotation", Vector3f.ROTATION), (o, i) -> o.rotation.assign(i), (o) -> o.rotation).add()).build();
   }
}
