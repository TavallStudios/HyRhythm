...
public class Interactions implements Component<EntityStore> {
   ...
   public String getInteractionId(@Nonnull InteractionType type) {
      return (String)this.interactions.get(type);
   }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(Interactions.class, Interactions::new).appendInherited(new KeyedCodec("Interactions", new EnumMapCodec(InteractionType.class, Codec.STRING, false)), (o, v) -> o.interactions = v, (o) -> o.interactions, (o, p) -> o.interactions = p.interactions).add()).appendInherited(new KeyedCodec("InteractionHint", Codec.STRING), (o, v) -> o.interactionHint = v, (o) -> o.interactionHint, (o, p) -> o.interactionHint = p.interactionHint).add()).build();
   }
}
