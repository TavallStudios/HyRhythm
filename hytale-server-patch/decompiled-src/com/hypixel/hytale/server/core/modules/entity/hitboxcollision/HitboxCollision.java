...
public class HitboxCollision implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(HitboxCollision.class, HitboxCollision::new).append(new KeyedCodec("HitboxCollisionConfigIndex", Codec.INTEGER), (hitboxCollision, integer) -> hitboxCollision.hitboxCollisionConfigIndex = integer, (hitboxCollision) -> hitboxCollision.hitboxCollisionConfigIndex).add()).build();
   }
}
