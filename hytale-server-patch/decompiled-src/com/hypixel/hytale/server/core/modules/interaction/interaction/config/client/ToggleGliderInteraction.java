...
public class ToggleGliderInteraction extends SimpleInstantInteraction {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ToggleGliderInteraction.class, ToggleGliderInteraction::new, SimpleInstantInteraction.CODEC).documentation("Toggles Glider movement for the player.")).build();
   }
}
