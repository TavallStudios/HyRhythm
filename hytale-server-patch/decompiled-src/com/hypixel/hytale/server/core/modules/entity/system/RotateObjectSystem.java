...
public class RotateObjectSystem extends EntityTickingSystem<EntityStore> {
   ...
   public Query<EntityStore> getQuery() {
      return Query.<EntityStore>and(this.rotateObjectComponentType, this.transformComponentType);
   }

   public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
      RotateObjectComponent rotateObjectComponent = (RotateObjectComponent)archetypeChunk.getComponent(index, this.rotateObjectComponentType);
