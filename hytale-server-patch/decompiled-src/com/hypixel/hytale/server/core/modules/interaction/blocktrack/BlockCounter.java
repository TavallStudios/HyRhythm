...
public class BlockCounter implements Resource<ChunkStore> {
   ...
   public BlockCounter() {
      this.blockPlacementCounts = new Object2IntOpenHashMap();
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(BlockCounter.class, BlockCounter::new).append(new KeyedCodec("BlockPlacementCounts", new Object2IntMapCodec(Codec.STRING, Object2IntOpenHashMap::new, false)), (o, v) -> o.blockPlacementCounts = v, (o) -> o.blockPlacementCounts).add()).build();
   }
}
