...
public class PlayerMovementManagerSystems {
   public static class AssignmentSystem extends HolderSystem<EntityStore> {
      ...
      static {
         QUERY = Query.<EntityStore>and(PlayerRef.getComponentType(), Query.not(MOVEMENT_MANAGER_COMPONENT_TYPE));
      }
   }
   ...
   public static class PostAssignmentSystem extends RefSystem<EntityStore> {
      ...
      public void onEntityAdded(@Nonnull Ref<EntityStore> ref, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         MovementManager movementManagerComponent = (MovementManager)commandBuffer.getComponent(ref, MOVEMENT_MANAGER_COMPONENT_TYPE);
      ...
      static {
         QUERY = Query.<EntityStore>and(MOVEMENT_MANAGER_COMPONENT_TYPE, PlayerRef.getComponentType());
      }
   }
}
