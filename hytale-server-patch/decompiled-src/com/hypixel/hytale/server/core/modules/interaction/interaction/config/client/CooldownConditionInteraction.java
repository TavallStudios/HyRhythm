...
public class CooldownConditionInteraction extends SimpleInstantInteraction {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CooldownConditionInteraction.class, CooldownConditionInteraction::new, SimpleInstantInteraction.CODEC).documentation("Checks if a given cooldown is complete.")).appendInherited(new KeyedCodec("Id", Codec.STRING), (o, i) -> o.cooldown = i, (o) -> o.cooldown, (o, p) -> o.cooldown = p.cooldown).documentation("The ID of the cooldown to check for in this condition.").addValidator(Validators.nonNull()).add()).build();
   }
}
