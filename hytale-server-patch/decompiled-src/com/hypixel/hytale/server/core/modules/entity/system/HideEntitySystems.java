...
public class HideEntitySystems {
   public static class AdventurePlayerSystem extends EntityTickingSystem<EntityStore> {
      ...
      public AdventurePlayerSystem() {
         this.query = Query.<EntityStore>and(this.entityViewerComponentType, this.playerComponentType, this.playerSettingsComponentType);
      ...
      public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         ...
         PlayerSettings playerSettingsComponent = (PlayerSettings)archetypeChunk.getComponent(index, this.playerSettingsComponentType);
