...
public class PersistentDynamicLight implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(PersistentDynamicLight.class, PersistentDynamicLight::new).addField(new KeyedCodec("Light", ProtocolCodecs.COLOR_LIGHT), (o, light) -> o.colorLight = light, (o) -> o.colorLight)).build();
   }
}
