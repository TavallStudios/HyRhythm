...
public class BlockHealth implements Cloneable {
   ...
   public String toString() {
      float var10000 = this.health;
      return "BlockHealth{health=" + var10000 + ", lastDamageGameTime=" + String.valueOf(this.lastDamageGameTime) + "}";
   }

   static {
      NO_DAMAGE_INSTANCE = new BlockHealth(1.0F, Instant.MIN) {
         public void setHealth(float health) {
