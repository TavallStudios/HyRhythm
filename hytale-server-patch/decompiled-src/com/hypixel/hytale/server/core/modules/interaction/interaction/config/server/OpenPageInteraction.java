...
public class OpenPageInteraction extends SimpleInstantInteraction {
   ...
   private static final Map<Page, PageUsageValidator> USAGE_VALIDATOR_MAP;
   protected Page page;
   ...
   protected void firstRun(@Nonnull InteractionType type, @Nonnull InteractionContext context, @Nonnull CooldownHandler cooldownHandler) {
      ...
      if (playerComponent != null) {
         PageUsageValidator validator = (PageUsageValidator)USAGE_VALIDATOR_MAP.get(this.page);
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(OpenPageInteraction.class, OpenPageInteraction::new, SimpleInstantInteraction.CODEC).documentation("Opens a predefined page.")).appendInherited(new KeyedCodec("Page", new EnumCodec(Page.class)), (o, v) -> o.page = v, (o) -> o.page, (o, p) -> o.page = p.page).addValidator(Validators.nonNull()).add()).appendInherited(new KeyedCodec("CanCloseThroughInteraction", Codec.BOOLEAN), (o, v) -> o.canCloseThroughInteraction = v, (o) -> o.canCloseThroughInteraction, (o, p) -> o.canCloseThroughInteraction = p.canCloseThroughInteraction).add()).build();
      USAGE_VALIDATOR_MAP = new ConcurrentHashMap();
   }
