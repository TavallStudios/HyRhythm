...
public class RotateObjectComponent implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(RotateObjectComponent.class, RotateObjectComponent::new).append(new KeyedCodec("RotationSpeed", Codec.FLOAT), (c, f) -> c.rotationSpeed = f, (c) -> c.rotationSpeed).add()).build();
   }
}
