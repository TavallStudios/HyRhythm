...
public class BlockCollisionData extends BoxCollisionData {
   ...
   public String toString() {
      int var10000 = this.x;
      return "BlockCollisionData{x=" + var10000 + ", y=" + this.y + ", z=" + this.z + ", blockId=" + this.blockId + ", blockType=" + String.valueOf(this.blockType) + ", blockMaterial=" + String.valueOf(this.blockMaterial) + ", collisionPoint=" + String.valueOf(this.collisionPoint) + ", collisionNormal=" + String.valueOf(this.collisionNormal) + ", collisionStart=" + this.collisionStart + ", collisionEnd=" + this.collisionEnd + ", detailBoxIndex=" + this.detailBoxIndex + "}";
   }
}
