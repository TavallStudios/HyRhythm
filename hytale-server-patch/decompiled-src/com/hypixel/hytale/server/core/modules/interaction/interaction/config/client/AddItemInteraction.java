...
public class AddItemInteraction extends SimpleBlockInteraction {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(AddItemInteraction.class, AddItemInteraction::new, SimpleBlockInteraction.CODEC).documentation("Adds an item to the users inventory.")).append(new KeyedCodec("ItemId", Codec.STRING), (i, s) -> i.itemId = s, (i) -> i.itemId).documentation("The id of the item to add.").addValidator(Validators.nonNull()).addValidator(Item.VALIDATOR_CACHE.getValidator()).add()).append(new KeyedCodec("Quantity", Codec.INTEGER), (o, v) -> o.quantity = v, (o) -> o.quantity).documentation("The amount of the item to add.").add()).build();
   }
}
