...
public class StandardPhysicsConfig implements PhysicsConfig {
   ...
   public StandardPhysicsConfig() {
      ...
      this.rollingFrictionFactor = 0.99;
      this.rollingSpeed = 0.1F;
      this.terminalVelocityAir = 1.0;
      this.densityAir = 1.2;
      this.terminalVelocityWater = 1.0;
      this.densityWater = 998.0;
   ...
   public void apply(@Nonnull Holder<EntityStore> holder, @Nullable Ref<EntityStore> creatorRef, @Nonnull Vector3d velocity, @Nonnull ComponentAccessor<EntityStore> componentAccessor, boolean predicted) {
      UUID creatorUUID;
      if (creatorRef != null) {
         UUIDComponent uuidComponent = (UUIDComponent)componentAccessor.getComponent(creatorRef, UUIDComponent.getComponentType());
      ...
      BoundingBox boundingBoxComponent = (BoundingBox)holder.getComponent(BoundingBox.getComponentType());
