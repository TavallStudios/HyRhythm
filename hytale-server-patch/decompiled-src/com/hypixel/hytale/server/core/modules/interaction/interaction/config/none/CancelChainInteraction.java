...
public class CancelChainInteraction extends SimpleInstantInteraction {
   ...
   protected void simulateFirstRun(@Nonnull InteractionType type, @Nonnull InteractionContext context, @Nonnull CooldownHandler cooldownHandler) {
      ...
      ChainingInteraction.Data dataComponent = (ChainingInteraction.Data)commandBuffer.ensureAndGetComponent(ref, ChainingInteraction.Data.getComponentType());
      dataComponent.getNamedMap().removeInt(this.chainId);
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CancelChainInteraction.class, CancelChainInteraction::new, SimpleInstantInteraction.CODEC).documentation("Cancels an active chaining state for the given chain id.")).appendInherited(new KeyedCodec("ChainId", Codec.STRING), (o, i) -> o.chainId = i, (o) -> o.chainId, (o, p) -> o.chainId = p.chainId).documentation("The ID of the chain to cancel.").addValidator(Validators.nonNull()).add()).build();
   }
}
