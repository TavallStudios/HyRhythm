...
public class VulnerableMatcher extends SelectInteraction.EntityMatcher {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(VulnerableMatcher.class, VulnerableMatcher::new, BASE_CODEC).documentation("Used to match any entity that is attackable")).build();
   }
}
