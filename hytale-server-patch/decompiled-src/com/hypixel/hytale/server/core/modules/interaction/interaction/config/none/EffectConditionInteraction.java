...
public class EffectConditionInteraction extends SimpleInstantInteraction {
   ...
   public String toString() {
      String var10000 = Arrays.toString(this.entityEffectIds);
      return "EffectConditionInteraction{entityEffectIds=" + var10000 + ", entityEffectIndexes=" + Arrays.toString(this.entityEffectIndexes) + ", match=" + String.valueOf(this.match) + ", entityTarget=" + String.valueOf(this.entityTarget) + "} " + super.toString();
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(EffectConditionInteraction.class, EffectConditionInteraction::new, SimpleInstantInteraction.CODEC).documentation("An interaction that is successful if the given effects exist (or don't) on the target entity.")).append(new KeyedCodec("EntityEffectIds", Codec.STRING_ARRAY), (effectConditionInteraction, strings) -> effectConditionInteraction.entityEffectIds = strings, (effectConditionInteraction) -> effectConditionInteraction.entityEffectIds).addValidator(Validators.nonNull()).addValidator(Validators.nonEmptyArray()).addValidatorLate(() -> EntityEffect.VALIDATOR_CACHE.getArrayValidator().late()).add()).append(new KeyedCodec("Match", new EnumCodec(Match.class)), (effectConditionInteraction, aBoolean) -> effectConditionInteraction.match = aBoolean, (effectConditionInteraction) -> effectConditionInteraction.match).documentation("Field to specify whether the entity must have the specified effects (All), or must not have the specified effects (None). Default value is: All.").add()).appendInherited(new KeyedCodec("Entity", InteractionTarget.CODEC), (o, i) -> o.entityTarget = i, (o) -> o.entityTarget, (o, p) -> o.entityTarget = p.entityTarget).documentation("The entity to target for this interaction.").addValidator(Validators.nonNull()).add()).afterDecode((effectConditionInteraction) -> effectConditionInteraction.entityEffectIndexes = resolveEntityEffects(effectConditionInteraction.entityEffectIds))).build();
   }
}
