...
public class BlockHarvestUtils {
         ...
         if (gathering == null) {
            ...
            if (breaking == null) {
               ...
               if (gatherType == null) {
                  ...
                  if (tool == null) {
                     ItemToolSpec defaultSpec = (ItemToolSpec)ItemToolSpec.getAssetMap().getAsset(gatherType);
   ...
   public static double calculateDurabilityUse(@Nonnull Item item, @Nullable BlockType blockType) {
      if (blockType == null) {
         ...
         if (durabilityLossBlockTypes == null) {
            ...
            if (hitBlockTypeIndex == -2147483648) {
            ...
            if (targetBlockType == null) {
               ...
               if (blockGathering == null) {
                           ...
                           if (ref != null && entity != null) {
                              ...
                              if ((setBlockSettings & 4) == 0) {
                                 ...
                                 if (particleSystemId != null) {
                                    ...
                                    ParticleUtil.spawnParticleEffect((String)particleSystemId, targetBlockCenterPos, results, entityStore);
                                 }
                              }
                  ...
                  if (targetBlockType.getGathering().shouldUseDefaultDropWhenPlaced()) {
                     BlockPhysics decoBlocks = chunkSectionRef != null ? (BlockPhysics)chunkStore.getComponent(chunkSectionRef, BlockPhysics.getComponentType()) : null;
                  ...
                  BlockHealthChunk blockHealthComponent = (BlockHealthChunk)chunkStore.getComponent(chunkReference, BlockHealthModule.get().getBlockHealthChunkComponentType());
                  ...
                  if (event.isCancelled()) {
                     ...
                     if (!blockHealthComponent.isBlockFragile(targetBlockPos) && !blockDamage.isDestroyed()) {
                        if ((setBlockSettings & 1024) == 0) {
                           BlockSoundSet soundSet = (BlockSoundSet)BlockSoundSet.getAssetMap().getAsset(targetBlockType.getBlockSoundSetIndex());
                           if (soundSet != null) {
                        ...
                        BlockGathering.BlockToolData requiredTool = (BlockGathering.BlockToolData)blockGathering.getToolData().get(toolId);
                        ...
                        if (!toolsMatch) {
                           ...
                           if (shouldChangeState) {
                              ...
                              if ((setBlockSettings & 2048) == 0) {
                                 ...
                                 Vector3d dropPosition = new Vector3d((double)targetBlockPos.x + 0.5, (double)targetBlockPos.y, (double)targetBlockPos.z + 0.5);
                              ...
                              performBlockBreak(world, targetBlockPos, targetBlockType, itemStack, dropQuantity, itemId, dropListId, setBlockSettings | 2048, ref, chunkReference, entityStore, chunkStore);
                              brokeBlock = true;
                              if ((setBlockSettings & 2048) == 0) {
   ...
   public static void performBlockBreak(@Nullable Ref<EntityStore> ref, @Nullable ItemStack heldItemStack, @Nonnull Vector3i targetBlock, int setBlockSettings, @Nonnull Ref<ChunkStore> chunkReference, @Nonnull ComponentAccessor<EntityStore> entityStore, @Nonnull ComponentAccessor<ChunkStore> chunkStore) {
      ...
      BlockType targetBlockTypeAsset = (BlockType)BlockType.getAssetMap().getAsset(targetBlockTypeIndex);
      if (targetBlockTypeAsset != null) {
         ...
         performBlockBreak(world, affectedBlock, targetBlockTypeAsset, heldItemStack, 0, (String)null, (String)null, setBlockSettings, ref, chunkReference, entityStore, chunkStore);
      }
   }
   ...
   public static void performBlockBreak(@Nonnull World world, @Nonnull Vector3i blockPosition, @Nonnull BlockType targetBlockTypeKey, @Nullable ItemStack heldItemStack, int dropQuantity, @Nullable String dropItemId, @Nullable String dropListId, int setBlockSettings, @Nullable Ref<EntityStore> ref, @Nonnull Ref<ChunkStore> chunkReference, @Nonnull ComponentAccessor<EntityStore> entityStore, @Nonnull ComponentAccessor<ChunkStore> chunkStore) {
      ...
      if (ref != null) {
         ...
         targetChunkReference = ((ChunkStore)targetChunkStore.getExternalData()).getChunkReference(chunkIndex);
      ...
      BlockChunk blockChunkComponent = (BlockChunk)chunkStore.getComponent(targetChunkReference, BlockChunk.getComponentType());
      ...
      BlockType blockTypeAsset = (BlockType)BlockType.getAssetMap().getAsset(blockTypeIndex);
   ...
   public static void naturallyRemoveBlock(@Nonnull Vector3i blockPosition, @Nullable BlockType blockType, int filler, int quantity, String itemId, String dropListId, int setBlockSettings, @Nonnull Ref<ChunkStore> chunkReference, @Nonnull ComponentAccessor<EntityStore> entityStore, @Nonnull ComponentAccessor<ChunkStore> chunkStore) {
      if (blockType != null) {
         ...
         if ((setBlockSettings & 1024) == 0) {
            BlockSoundSet soundSet = (BlockSoundSet)BlockSoundSet.getAssetMap().getAsset(blockType.getBlockSoundSetIndex());
            if (soundSet != null) {
               int soundEventIndex = soundSet.getSoundEventIndices().getOrDefault(BlockSoundEvent.Break, 0);
               if (soundEventIndex != 0) {
   ...
   protected static void removeBlock(@Nonnull Vector3i blockPosition, @Nonnull BlockType blockType, int setBlockSettings, @Nonnull Ref<ChunkStore> chunkReference, @Nonnull ComponentAccessor<ChunkStore> chunkStore) {
      ...
      BlockHealthChunk blockHealthComponent = (BlockHealthChunk)chunkStore.getComponent(chunkReference, blockHealthComponentType);
