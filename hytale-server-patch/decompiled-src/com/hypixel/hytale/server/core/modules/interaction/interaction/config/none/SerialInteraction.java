...
public class SerialInteraction extends Interaction {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(SerialInteraction.class, SerialInteraction::new, BuilderCodec.abstractBuilder(Interaction.class).build()).documentation("Runs the given interactions in order.")).appendInherited(new KeyedCodec("Interactions", CHILD_ASSET_CODEC_ARRAY), (o, i) -> o.interactions = i, (o) -> o.interactions, (o, p) -> o.interactions = p.interactions).documentation("A list of interactions to run. They will be executed in the order specified sequentially.").addValidator(Validators.nonNull()).addValidator(Validators.nonNullArrayElements()).add()).build();
   }
