         ...
         if (hasRequiredGameMode) {
            ...
            if (heldItem != null && this.adjustHeldItemQuantity != 0) {
               if (this.adjustHeldItemQuantity < 0) {
                  ItemStackSlotTransaction slotTransaction = context.getHeldItemContainer().removeItemStackFromSlot((short)context.getHeldItemSlot(), heldItem, -this.adjustHeldItemQuantity);
            ...
            if (this.adjustHeldItemDurability != 0.0) {
               ...
               if (item != null) {
                  ...
                  ItemStackSlotTransaction slotTransaction = context.getHeldItemContainer().setItemStackForSlot((short)context.getHeldItemSlot(), newItem);
                  if (!slotTransaction.succeeded()) {
                     context.getState().state = InteractionState.Failed;
                  } else {
