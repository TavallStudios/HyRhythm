...
public class CameraInteraction extends SimpleInteraction {
   ...
   public String toString() {
      ...
      return "CameraInteraction{action=" + var10000 + ", perspective='" + String.valueOf(this.perspective) + "', persistCameraState='" + this.persistCameraState + "', cameraInteractionTime='" + this.cameraInteractionTime + "'} " + super.toString();
   }
