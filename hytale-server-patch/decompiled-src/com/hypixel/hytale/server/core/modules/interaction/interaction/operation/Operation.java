...
public interface Operation {
   void tick(@Nonnull Ref<EntityStore> var1, @Nonnull LivingEntity var2, boolean var3, float var4, @Nonnull InteractionType var5, @Nonnull InteractionContext var6, @Nonnull CooldownHandler var7);

   void simulateTick(@Nonnull Ref<EntityStore> var1, @Nonnull LivingEntity var2, boolean var3, float var4, @Nonnull InteractionType var5, @Nonnull InteractionContext var6, @Nonnull CooldownHandler var7);
   ...
   default Operation getInnerOperation() {
      Operation op;
      for(op = this; op instanceof NestedOperation; op = ((NestedOperation)op).inner()) {
      }
