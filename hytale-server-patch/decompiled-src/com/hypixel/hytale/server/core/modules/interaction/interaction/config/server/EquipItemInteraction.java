...
public class EquipItemInteraction extends SimpleInstantInteraction {
   public static final BuilderCodec<EquipItemInteraction> CODEC;
   ...
   protected void firstRun(@Nonnull InteractionType type, @Nonnull InteractionContext context, @Nonnull CooldownHandler cooldownHandler) {
      ...
      Entity var7 = EntityUtils.getEntity(ref, commandBuffer);
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(EquipItemInteraction.class, EquipItemInteraction::new, SimpleInstantInteraction.CODEC).documentation("Equips the item being held.")).build();
   }
}
