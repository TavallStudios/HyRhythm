...
public class ChangeStatInteraction extends ChangeStatBaseInteraction {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ChangeStatInteraction.class, ChangeStatInteraction::new, ChangeStatBaseInteraction.CODEC).documentation("Changes the given stats.")).build();
   }
}
