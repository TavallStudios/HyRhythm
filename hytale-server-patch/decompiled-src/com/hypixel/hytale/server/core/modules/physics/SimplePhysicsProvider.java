...
public class SimplePhysicsProvider implements IBlockCollisionConsumer {
   ...
   @Nullable
   public Entity tick(double dt, @Nonnull Velocity entityVelocity, @Nonnull World entityWorld, @Nonnull TransformComponent entityTransform, Ref<EntityStore> selfRef, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
      if (this.state == SimplePhysicsProvider.STATE.Inactive) {
         ...
         if (this.movedInsideSolid) {
            ...
            if (this.isSwimming()) {
               Vector3d var10000 = this.forceProviderStandardState.externalForce;
               var10000.y -= this.stateAfter.velocity.y * (this.swimmingDampingFactor / mass);
            }
            ...
            if (!this.bounced) {
               ...
               if (this.velocity.squaredLength() * dt * dt < 0.16000000000000003) {
                  ...
                  if (this.sticksVertically || hitGround) {
                     ...
                     if (this.impactConsumer != null) {
                        this.impactConsumer.accept(selfRef, this.position, (Object)null, componentAccessor);
                     }
                  }
            ...
            switch (this.rotationMode.ordinal()) {
               ...
               case 2:
                  ...
                  if (this.isComputePitch()) {
                     ...
                     float maxDelta = (float)(this.velocity.squaredLength() * dt * (double)this.speedRotationFactor);
                     if (delta > maxDelta) {
                     ...
                     this.forceProviderStandardState.externalForce.addScaled(this.stateAfter.velocity, (double)delta * -this.rotationForce);
                  }
            }
