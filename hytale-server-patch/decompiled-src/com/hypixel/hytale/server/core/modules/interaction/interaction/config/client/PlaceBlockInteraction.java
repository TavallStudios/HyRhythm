      ...
      if (!firstRun) {
         ...
         if (blockPosition != null && blockRotation != null) {
            ...
            if (transformComponent != null && playerComponent != null && playerComponent.getGameMode() != GameMode.Creative) {
               ...
               Vector3d blockCenter = new Vector3d((double)blockPosition.x + 0.5, (double)blockPosition.y + 0.5, (double)blockPosition.z + 0.5);
            ...
            Entity var22 = EntityUtils.getEntity(ref, commandBuffer);
            ...
            String clientPlacedBlockTypeKey = clientPlacedBlockId == -1 ? null : ((BlockType)BlockType.getAssetMap().getAsset(clientPlacedBlockId)).getId();
