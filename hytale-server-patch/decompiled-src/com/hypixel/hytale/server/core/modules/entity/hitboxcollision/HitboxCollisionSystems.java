...
public class HitboxCollisionSystems {
   public static class Setup extends HolderSystem<EntityStore> {
      ...
      public void onEntityAdd(@Nonnull Holder<EntityStore> holder, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store) {
         ...
         if (hitboxCollisionConfigIndex != -1) {
            holder.addComponent(this.componentType, new HitboxCollision((HitboxCollisionConfig)HitboxCollisionConfig.getAssetMap().getAsset(hitboxCollisionConfigIndex)));
         }
      }
   ...
   public static class EntityTrackerUpdate extends EntityTickingSystem<EntityStore> {
      ...
      public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         ...
         HitboxCollision hitboxCollision = (HitboxCollision)archetypeChunk.getComponent(index, this.componentType);
