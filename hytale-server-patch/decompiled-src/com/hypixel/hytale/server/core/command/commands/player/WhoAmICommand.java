...
public class WhoAmICommand extends AbstractPlayerCommand {
   ...
   public WhoAmICommand() {
      ...
      this.addAliases(new String[]{"uuid"});
   ...
   private static void sendPlayerInfo(@Nonnull CommandContext context, @Nonnull PlayerRef playerRef) {
      Message message = Message.translation("server.commands.whoami.header").param("uuid", playerRef.getUuid().toString()).param("username", playerRef.getUsername()).param("language", playerRef.getLanguage());
