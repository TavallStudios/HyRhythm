...
public class EntityRemoveCommand extends AbstractWorldCommand {
   ...
   public EntityRemoveCommand() {
      ...
      this.entityArg = (EntityWrappedArg)this.withOptionalArg("entity", "server.commands.entity.remove.entity.desc", ArgTypes.ENTITY_ID);
   ...
   public static void removeEntity(@Nullable Ref<EntityStore> playerRef, @Nonnull Ref<EntityStore> entityReference, @Nonnull ComponentAccessor<EntityStore> componentAccessor) {
      if (playerRef != null && playerRef.isValid()) {
         EntityTrackerSystems.EntityViewer entityViewer = (EntityTrackerSystems.EntityViewer)componentAccessor.getComponent(playerRef, EntityTrackerSystems.EntityViewer.getComponentType());
