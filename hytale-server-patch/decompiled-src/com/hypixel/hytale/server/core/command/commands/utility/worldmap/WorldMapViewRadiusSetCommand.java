...
public class WorldMapViewRadiusSetCommand extends AbstractTargetPlayerCommand {
   ...
   public WorldMapViewRadiusSetCommand() {
      ...
      this.bypassArg = (FlagArg)this.withFlagArg("bypass", "server.commands.worldmap.viewradius.set.bypass.desc").setPermission("server.commands.worldmap.viewradius.set.bypass");
   }
