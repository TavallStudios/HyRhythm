...
public class RelativeFloat {
   ...
   public String toString() {
      String var10000 = this.isRelative ? "~" : "";
      return var10000 + this.value;
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(RelativeFloat.class, RelativeFloat::new).append(new KeyedCodec("Value", Codec.FLOAT), (o, i) -> o.value = i, RelativeFloat::getRawValue).addValidator(Validators.nonNull()).add()).append(new KeyedCodec("Relative", Codec.BOOLEAN), (o, i) -> o.isRelative = i, RelativeFloat::isRelative).addValidator(Validators.nonNull()).add()).build();
   }
}
