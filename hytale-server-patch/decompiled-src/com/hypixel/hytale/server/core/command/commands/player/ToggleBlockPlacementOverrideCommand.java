...
public class ToggleBlockPlacementOverrideCommand extends AbstractPlayerCommand {
   ...
   protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world) {
      ...
      context.sendMessage(Message.translation("server.commands.toggleBlockPlacementOverride." + (playerComponent.isOverrideBlockPlacementRestrictions() ? "enabled" : "disabled")));
   }
}
