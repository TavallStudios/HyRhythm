...
public class RelativeInteger {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(RelativeInteger.class, RelativeInteger::new).append(new KeyedCodec("Value", Codec.INTEGER), (o, i) -> o.value = i, RelativeInteger::getRawValue).addValidator(Validators.nonNull()).add()).append(new KeyedCodec("Relative", Codec.BOOLEAN), (o, i) -> o.isRelative = i, RelativeInteger::isRelative).addValidator(Validators.nonNull()).add()).build();
   }
}
