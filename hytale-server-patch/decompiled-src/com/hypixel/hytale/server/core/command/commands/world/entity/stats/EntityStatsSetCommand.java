...
public class EntityStatsSetCommand extends AbstractTargetEntityCommand {
   ...
   public EntityStatsSetCommand() {
      ...
      this.entityStatNameArg = this.withRequiredArg("statName", "server.commands.entity.stats.set.statName.desc", ArgTypes.STRING);
      this.statValueArg = this.withRequiredArg("statValue", "server.commands.entity.stats.set.statValue.desc", ArgTypes.INTEGER);
   }
   ...
   protected void execute(@Nonnull CommandContext context, @Nonnull ObjectList<Ref<EntityStore>> entities, @Nonnull World world, @Nonnull Store<EntityStore> store) {
      int newStatValue = (Integer)this.statValueArg.get(context);
         ...
         for(Ref<EntityStore> entity : entities) {
            ...
            if (entityStatMap != null) {
               if (entityStatMap.get(entityStatIndex) == null) {
                  ...
                  float newValueOfStat = entityStatMap.setStatValue(entityStatIndex, (float)newStatValue);
