...
public class UIGalleryPage extends InteractiveCustomUIPage<UIGalleryEventData> {
   private static final Value<String> CATEGORY_BUTTON_STYLE = Value.<String>ref("Pages/UIGallery/CategoryButton.ui", "LabelStyle");
   private static final Value<String> CATEGORY_BUTTON_SELECTED_STYLE = Value.<String>ref("Pages/UIGallery/CategoryButton.ui", "SelectedLabelStyle");
   ...
   public UIGalleryPage(@Nonnull PlayerRef playerRef) {
      ...
      this.selectedCategory = UIGalleryPage.Category.BUTTONS;
      this.expandedCodeBlocks = new IntOpenHashSet();
   }
   ...
   public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store, @Nonnull UIGalleryEventData data) {
      ...
      if (data.category != null) {
         Category newCategory = UIGalleryPage.Category.fromId(data.category);
   ...
   private void buildCategoryList(@Nonnull UICommandBuilder commandBuilder, @Nonnull UIEventBuilder eventBuilder) {
      ...
      for(int i = 0; i < UIGalleryPage.Category.values().length; ++i) {
         Category category = UIGalleryPage.Category.values()[i];
   ...
   private void displayCategory(@Nonnull Category category, @Nonnull UICommandBuilder commandBuilder, @Nonnull UIEventBuilder eventBuilder) {
   ...
   private static enum Category {
      BUTTONS("buttons", "server.customUI.uiGallery.category.buttons", "server.customUI.uiGallery.category.buttons.desc", "Pages/UIGallery/Categories/ButtonsContent.ui", 7),
      INPUTS("inputs", "server.customUI.uiGallery.category.inputs", "server.customUI.uiGallery.category.inputs.desc", "Pages/UIGallery/Categories/InputsContent.ui", 4),
      SELECTION("selection", "server.customUI.uiGallery.category.selection", "server.customUI.uiGallery.category.selection.desc", "Pages/UIGallery/Categories/SelectionContent.ui", 4),
      CONTAINERS("containers", "server.customUI.uiGallery.category.containers", "server.customUI.uiGallery.category.containers.desc", "Pages/UIGallery/Categories/ContainersContent.ui", 7),
      ...
      SLIDERS("sliders", "server.customUI.uiGallery.category.sliders", "server.customUI.uiGallery.category.sliders.desc", "Pages/UIGallery/Categories/SlidersContent.ui", 3),
      PROGRESS("progress", "server.customUI.uiGallery.category.progress", "server.customUI.uiGallery.category.progress.desc", "Pages/UIGallery/Categories/ProgressContent.ui", 3),
      SCROLLBARS("scrollbars", "server.customUI.uiGallery.category.scrollbars", "server.customUI.uiGallery.category.scrollbars.desc", "Pages/UIGallery/Categories/ScrollbarsContent.ui", 3),
      NAVIGATION("navigation", "server.customUI.uiGallery.category.navigation", "server.customUI.uiGallery.category.navigation.desc", "Pages/UIGallery/Categories/NavigationContent.ui", 2),
      TOOLTIPS("tooltips", "server.customUI.uiGallery.category.tooltips", "server.customUI.uiGallery.category.tooltips.desc", "Pages/UIGallery/Categories/TooltipsContent.ui", 2);
   ...
   public static class UIGalleryEventData {
      ...
      static {
         CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(UIGalleryEventData.class, UIGalleryEventData::new).addField(new KeyedCodec("Category", Codec.STRING), (entry, s) -> entry.category = s, (entry) -> entry.category)).addField(new KeyedCodec("ToggleCode", Codec.STRING), (entry, s) -> entry.toggleCode = s, (entry) -> entry.toggleCode)).build();
      }
   }
}
