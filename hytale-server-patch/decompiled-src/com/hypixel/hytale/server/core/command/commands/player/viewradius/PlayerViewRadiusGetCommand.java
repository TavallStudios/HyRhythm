...
public class PlayerViewRadiusGetCommand extends AbstractTargetPlayerCommand {
   ...
   protected void execute(@Nonnull CommandContext context, @Nullable Ref<EntityStore> sourceRef, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world, @Nonnull Store<EntityStore> store) {
      ...
      context.sendMessage(Message.translation("server.commands.player.viewradius.info").param("radius", viewRadiusChunks).param("clientRadius", clientViewRadiusChunks).param("radiusBlocks", viewRadiusBlocks));
   }
}
