...
public class HitboxCollisionAddCommand extends AbstractCommandCollection {
   ...
   public HitboxCollisionAddCommand() {
      ...
      this.addSubCommand(new HitboxCollisionAddEntityCommand());
      this.addSubCommand(new HitboxCollisionAddSelfCommand());
   }
   ...
   public static class HitboxCollisionAddEntityCommand extends AbstractWorldCommand {
      ...
      @Nonnull
      private final RequiredArg<HitboxCollisionConfig> hitboxCollisionConfigArg;
      @Nonnull
      ...
      public HitboxCollisionAddEntityCommand() {
         ...
         this.hitboxCollisionConfigArg = this.withRequiredArg("hitboxCollisionConfig", "server.commands.hitboxcollision.add.hitboxCollisionConfig.desc", ArgTypes.HITBOX_COLLISION_CONFIG);
         this.entityArg = (EntityWrappedArg)this.withOptionalArg("entity", "server.commands.hitboxcollision.add.entityArg.desc", ArgTypes.ENTITY_ID);
      }

      protected void execute(@Nonnull CommandContext context, @Nonnull World world, @Nonnull Store<EntityStore> store) {
         Ref<EntityStore> entityRef = this.entityArg.get(store, context);
         if (entityRef != null && entityRef.isValid()) {
            HitboxCollisionConfig hitboxCollisionConfig = (HitboxCollisionConfig)this.hitboxCollisionConfigArg.get(context);
   ...
   public static class HitboxCollisionAddSelfCommand extends AbstractTargetPlayerCommand {
      @Nonnull
      private static final Message MESSAGE_COMMANDS_HIT_BOX_COLLISION_ADD_ALREADY_ADDED = Message.translation("server.commands.hitboxcollision.add.alreadyAdded");
      @Nonnull
