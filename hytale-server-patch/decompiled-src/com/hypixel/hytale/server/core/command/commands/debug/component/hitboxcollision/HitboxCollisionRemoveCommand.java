...
public class HitboxCollisionRemoveCommand extends AbstractCommandCollection {
   ...
   public HitboxCollisionRemoveCommand() {
      ...
      this.addSubCommand(new HitboxCollisionRemoveEntityCommand());
      this.addSubCommand(new HitboxCollisionRemoveSelfCommand());
   }
   ...
   public static class HitboxCollisionRemoveEntityCommand extends AbstractWorldCommand {
      ...
      public HitboxCollisionRemoveEntityCommand() {
         ...
         this.entityArg = (EntityWrappedArg)this.withRequiredArg("entity", "server.commands.hitboxcollision.remove.entityArg.desc", ArgTypes.ENTITY_ID);
      }
