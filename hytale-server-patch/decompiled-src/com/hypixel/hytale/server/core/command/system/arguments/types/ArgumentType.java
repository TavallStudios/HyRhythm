...
public abstract class ArgumentType<DataType> implements SuggestionProvider {
   ...
   public String toString() {
      ...
      return "ArgumentType{name='" + var10000 + "', argumentUsage=" + String.valueOf(this.argumentUsage) + ", examples=" + Arrays.toString(this.examples) + ", numberOfParameters=" + this.numberOfParameters + "}";
   }
}
