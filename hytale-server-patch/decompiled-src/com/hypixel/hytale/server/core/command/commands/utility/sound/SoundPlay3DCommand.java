...
public class SoundPlay3DCommand extends AbstractTargetPlayerCommand {
   ...
   public SoundPlay3DCommand() {
      ...
      this.addAliases(new String[]{"play3d"});
   }
   ...
   protected void execute(@Nonnull CommandContext context, @Nullable Ref<EntityStore> sourceRef, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world, @Nonnull Store<EntityStore> store) {
      ...
      RelativeVector3i relativePosition = (RelativeVector3i)this.positionArg.get(context);
      ...
      if (this.allFlag.provided(context)) {
         SoundUtil.playSoundEvent3d(soundEventIndex, soundCategory, (double)blockPosition.x, (double)blockPosition.y, (double)blockPosition.z, world.getEntityStore().getStore());
      } else {
         SoundUtil.playSoundEvent3dToPlayer(ref, soundEventIndex, soundCategory, (double)blockPosition.x, (double)blockPosition.y, (double)blockPosition.z, store);
      }
