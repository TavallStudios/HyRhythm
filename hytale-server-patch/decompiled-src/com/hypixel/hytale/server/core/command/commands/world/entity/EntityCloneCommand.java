...
public class EntityCloneCommand extends AbstractWorldCommand {
   ...
   public EntityCloneCommand() {
      ...
      this.entityArg = (EntityWrappedArg)this.withOptionalArg("entity", "server.commands.entity.clone.entity.desc", ArgTypes.ENTITY_ID);
      this.countArg = (DefaultArg)this.withDefaultArg("count", "server.commands.entity.clone.count.desc", ArgTypes.INTEGER, 1, "server.commands.entity.clone.count.default").addValidator(Validators.greaterThan(0));
   }
