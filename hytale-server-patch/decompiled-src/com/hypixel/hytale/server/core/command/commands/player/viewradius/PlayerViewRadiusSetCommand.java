...
public class PlayerViewRadiusSetCommand extends AbstractTargetPlayerCommand {
   ...
   protected void execute(@Nonnull CommandContext context, @Nullable Ref<EntityStore> sourceRef, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world, @Nonnull Store<EntityStore> store) {
      ...
      String radiusInput = (String)this.radiusArg.get(context);
      boolean measureInBlocks = (Boolean)this.blocksArg.get(context);
      ...
      if ("default".equalsIgnoreCase(radiusInput)) {
         ...
         try {
            ...
            viewRadiusChunks = measureInBlocks ? (int)Math.ceil((double)((float)value / 32.0F)) : value;
