...
public class BlockBulkReplaceCommand extends AbstractPlayerCommand {
   ...
   public BlockBulkReplaceCommand() {
      ...
      this.findArg = this.withRequiredArg("find", "server.commands.block.bulk.replace.find.desc", ArgTypes.BLOCK_TYPE_KEY);
      this.replaceArg = this.withRequiredArg("replaceWith", "server.commands.block.bulk.replace.replaceWith.desc", ArgTypes.BLOCK_TYPE_KEY);
      this.radiusArg = this.withRequiredArg("radius", "server.commands.block.bulk.replace.radius.desc", ArgTypes.INTEGER);
   }
   ...
   protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world) {
      ...
      String findBlockTypeKey = (String)this.findArg.get(context);
      String replaceBlockTypeKey = (String)this.replaceArg.get(context);
      ...
      CompletableFuture.runAsync(() -> {
         ...
         playerRef.sendMessage(Message.translation("server.commands.block.bulk.replace.result").param("count", replaced.get()).param("time", TimeUnit.NANOSECONDS.toSeconds(diff)));
      });
   }
