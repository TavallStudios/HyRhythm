...
public interface BlockAccessor {
   ...
   default boolean setBlock(int x, int y, int z, String blockTypeKey) {
      return this.setBlock(x, y, z, (String)blockTypeKey, 0);
   }
   ...
   default boolean setBlock(int x, int y, int z, int id, int settings) {
      return this.setBlock(x, y, z, id, (BlockType)BlockType.getAssetMap().getAsset(id), 0, 0, settings);
   }

   default boolean setBlock(int x, int y, int z, @Nonnull BlockType blockType) {
      return this.setBlock(x, y, z, (BlockType)blockType, 0);
   }
   ...
   default boolean testBlocks(int x, int y, int z, @Nonnull BlockType blockTypeToTest, int rotation, @Nonnull TriIntPredicate predicate) {
      ...
      return FillerBlockUtil.testFillerBlocks(((BlockBoundingBoxes)BlockBoundingBoxes.getAssetMap().getAsset(blockTypeToTest.getHitboxTypeIndex())).get(rotation), (x1, y1, z1) -> {
   ...
   default BlockType getBlockType(int x, int y, int z) {
      return (BlockType)BlockType.getAssetMap().getAsset(this.getBlock(x, y, z));
   }
