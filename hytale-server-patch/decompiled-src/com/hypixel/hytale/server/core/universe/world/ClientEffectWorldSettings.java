...
public class ClientEffectWorldSettings {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(ClientEffectWorldSettings.class, ClientEffectWorldSettings::new).append(new KeyedCodec("SunHeightPercent", Codec.FLOAT), (settings, o) -> settings.sunHeightPercent = o, (settings) -> settings.sunHeightPercent).add()).append(new KeyedCodec("SunAngleDegrees", Codec.FLOAT), (settings, o) -> settings.sunAngleRadians = (float)Math.toRadians((double)o), (settings) -> (float)Math.toDegrees((double)settings.sunAngleRadians)).add()).append(new KeyedCodec("BloomIntensity", Codec.FLOAT), (settings, o) -> settings.bloomIntensity = o, (settings) -> settings.bloomIntensity).add()).append(new KeyedCodec("BloomPower", Codec.FLOAT), (settings, o) -> settings.bloomPower = o, (settings) -> settings.bloomPower).add()).append(new KeyedCodec("SunIntensity", Codec.FLOAT), (settings, o) -> settings.sunIntensity = o, (settings) -> settings.sunIntensity).add()).append(new KeyedCodec("SunshaftIntensity", Codec.FLOAT), (settings, o) -> settings.sunshaftIntensity = o, (settings) -> settings.sunshaftIntensity).add()).append(new KeyedCodec("SunshaftScaleFactor", Codec.FLOAT), (settings, o) -> settings.sunshaftScaleFactor = o, (settings) -> settings.sunshaftScaleFactor).add()).build();
   }
}
