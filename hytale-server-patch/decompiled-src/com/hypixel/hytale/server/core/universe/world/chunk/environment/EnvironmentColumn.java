...
public class EnvironmentColumn {
   ...
   public int getValueMin(int index) {
      return index <= 0 ? -2147483648 : this.maxYs.getInt(index - 1) + 1;
   }

   public int getValueMax(int index) {
      return index >= this.maxYs.size() ? 2147483647 : this.maxYs.getInt(index);
   }
   ...
   public String toString() {
      String var10000 = String.valueOf(this.maxYs);
      return "EnvironmentColumn{maxYs=" + var10000 + ", values=" + String.valueOf(this.values) + "}";
   }
}
