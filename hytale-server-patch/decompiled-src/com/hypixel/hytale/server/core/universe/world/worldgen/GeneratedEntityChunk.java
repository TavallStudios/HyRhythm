...
public class GeneratedEntityChunk {
   ...
   public EntityChunk toEntityChunk() {
      ...
      for(EntityWrapperEntry entry : this.entities) {
         ...
         for(Holder<EntityStore> entityHolder : entry.entityHolders()) {
            ...
            HeadRotation headRotationComponent = (HeadRotation)entityHolder.getComponent(HeadRotation.getComponentType());
   ...
   public static record EntityWrapperEntry(Vector3i offset, PrefabRotation rotation, Holder<EntityStore>[] entityHolders, int worldgenId) {
      @Nonnull
      public String toString() {
         String var10000 = String.valueOf(this.offset);
         return "EntityWrapperEntry{offset=" + var10000 + ", rotation=" + String.valueOf(this.rotation) + ", entityHolders=" + Arrays.toString(this.entityHolders) + "}";
      }
   }
}
