...
public class WorldAddCommand extends CommandBase {
   ...
   public WorldAddCommand() {
      ...
      this.nameArg = this.withRequiredArg("name", "server.commands.addworld.arg.name.desc", ArgTypes.STRING);
      this.genArg = this.withDefaultArg("gen", "server.commands.addworld.arg.gen.desc", ArgTypes.STRING, "default", "");
      this.storageArg = this.withDefaultArg("storage", "server.commands.addworld.arg.gen.desc", ArgTypes.STRING, "default", "");
   }
   ...
   protected void executeSync(@Nonnull CommandContext context) {
      ...
      if (Universe.get().getWorld(name) != null) {
         ...
         String generatorType = (String)context.get(this.genArg);
         String chunkStorageType = (String)context.get(this.storageArg);
         ...
         CompletableFutureUtil._catch(Universe.get().addWorld(name, generatorType, chunkStorageType).thenRun(() -> sender.sendMessage(Message.translation("server.universe.addWorld.worldCreated").param("worldName", name).param("generator", (String)Objects.requireNonNullElse(generatorType, "default")).param("storage", (String)Objects.requireNonNullElse(chunkStorageType, "default")))).exceptionally((throwable) -> {
