...
public class ChunkLightDataBuilder extends ChunkLightData {
   ...
   public ChunkLightData build() {
      if (this.light == null) {
         return new ChunkLightData((ByteBuf)null, this.changeId);
      } else {
      ...
      try {
         if ((i >> innerIndex & 1) == 1) {
            ...
            if (depth == 12) {
               ...
               return DEBUG ? new Res(ByteBufUtil.hexDump(bytes)) : ChunkLightDataBuilder.Res.INSTANCE;
            }
            ...
            Res out = setTraverse(local, currentSegments, index, newSegmentIndex, depth + 3, value);
            if (out != null) {
   ...
   private static class Res {
      public static final Res INSTANCE = new Res((String)null);
