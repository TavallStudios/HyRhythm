...
public class ChunkPreLoadProcessEvent extends ChunkEvent implements IProcessedEvent {
   ...
   public void processEvent(@Nonnull String hookName) {
      ...
      if (diff > (long)this.getChunk().getWorld().getTickStepNanos()) {
   ...
   public String toString() {
      boolean var10000 = this.newlyGenerated;
      return "ChunkPreLoadProcessEvent{newlyGenerated=" + var10000 + ", lastDispatchNanos=" + this.lastDispatchNanos + ", didLog=" + this.didLog + "} " + super.toString();
   }
}
