...
public class BlockComponentChunk implements Component<ChunkStore> {
   ...
   public Component<ChunkStore> clone() {
      ...
      while(var2.hasNext()) {
         Int2ObjectMap.Entry<Holder<ChunkStore>> entry = (Int2ObjectMap.Entry)var2.next();
      ...
      while(var2.hasNext()) {
         Int2ObjectMap.Entry<Ref<ChunkStore>> entry = (Int2ObjectMap.Entry)var2.next();
   ...
   public Component<ChunkStore> cloneSerializable() {
      ...
      while(var3.hasNext()) {
         Int2ObjectMap.Entry<Holder<ChunkStore>> entry = (Int2ObjectMap.Entry)var3.next();
      ...
      while(var3.hasNext()) {
         Int2ObjectMap.Entry<Ref<ChunkStore>> entry = (Int2ObjectMap.Entry)var3.next();
         Ref<ChunkStore> reference = (Ref)entry.getValue();
   ...
   public void addEntityHolder(int index, @Nonnull Holder<ChunkStore> holder) {
      ...
      } else if (this.entityHolders.putIfAbsent(index, (Holder)Objects.requireNonNull(holder)) != null) {
   ...
   public void storeEntityHolder(int index, @Nonnull Holder<ChunkStore> holder) {
      if (this.entityHolders.putIfAbsent(index, (Holder)Objects.requireNonNull(holder)) != null) {
         throw new IllegalArgumentException("Duplicate block components (entity holder) at: " + index);
      }
   }
   ...
   public Holder<ChunkStore> removeEntityHolder(int index) {
      Holder<ChunkStore> reference = (Holder)this.entityHolders.remove(index);
      if (reference != null) {
         this.markNeedsSaving();
      }
   ...
   public void addEntityReference(int index, @Nonnull Ref<ChunkStore> reference) {
      ...
      if (this.entityHolders.containsKey(index)) {
         throw new IllegalArgumentException("Duplicate block components at: " + index);
      } else if (this.entityReferences.putIfAbsent(index, (Ref)Objects.requireNonNull(reference)) != null) {
   ...
   public <T extends Component<ChunkStore>> T getComponent(int index, @Nonnull ComponentType<ChunkStore, T> componentType) {
      Ref<ChunkStore> reference = (Ref)this.entityReferences.get(index);
      if (reference != null) {
         return (T)reference.getStore().getComponent(reference, componentType);
      } else {
         Holder<ChunkStore> holder = (Holder)this.entityHolders.get(index);
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(BlockComponentChunk.class, BlockComponentChunk::new).addField(new KeyedCodec("BlockComponents", new Int2ObjectMapCodec(new StoredCodec(ChunkStore.HOLDER_CODEC_KEY), Int2ObjectOpenHashMap::new)), (entityChunk, map) -> {
         ...
         if (entityChunk.entityReferences.isEmpty()) {
            ...
            while(i$.hasNext()) {
               Int2ObjectMap.Entry<Ref<ChunkStore>> entry = (Int2ObjectMap.Entry)i$.next();
               Ref<ChunkStore> reference = (Ref)entry.getValue();
               Store<ChunkStore> store = reference.getStore();
   ...
   public static class BlockComponentChunkLoadingSystem extends RefChangeSystem<ChunkStore, NonTicking<ChunkStore>> {
      ...
      public void onComponentAdded(@Nonnull Ref<ChunkStore> ref, @Nonnull NonTicking<ChunkStore> component, @Nonnull Store<ChunkStore> store, @Nonnull CommandBuffer<ChunkStore> commandBuffer) {
         BlockComponentChunk blockComponentChunk = (BlockComponentChunk)store.getComponent(ref, BlockComponentChunk.getComponentType());
         ...
         if (entityReferences != null) {
            ...
            for(ObjectIterator var11 = entityReferences.int2ObjectEntrySet().iterator(); var11.hasNext(); ++j) {
               Int2ObjectMap.Entry<Ref<ChunkStore>> entry = (Int2ObjectMap.Entry)var11.next();
      ...
      public void onComponentRemoved(@Nonnull Ref<ChunkStore> ref, @Nonnull NonTicking<ChunkStore> component, @Nonnull Store<ChunkStore> store, @Nonnull CommandBuffer<ChunkStore> commandBuffer) {
         ...
         if (entityHolders != null) {
            ...
            for(ObjectIterator var12 = entityHolders.int2ObjectEntrySet().iterator(); var12.hasNext(); ++j) {
               Int2ObjectMap.Entry<Holder<ChunkStore>> entry = (Int2ObjectMap.Entry)var12.next();
               indexes[j] = entry.getIntKey();
   ...
   public static class LoadBlockComponentPacketSystem extends ChunkStore.LoadPacketDataQuerySystem {
      ...
      public void fetch(int index, @Nonnull ArchetypeChunk<ChunkStore> archetypeChunk, @Nonnull Store<ChunkStore> store, CommandBuffer<ChunkStore> commandBuffer, PlayerRef player, @Nonnull List<ToClientPacket> results) {
         BlockComponentChunk component = (BlockComponentChunk)archetypeChunk.getComponent(index, this.componentType);
