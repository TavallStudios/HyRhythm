...
public class BlockBulkFindHereCommand extends AbstractPlayerCommand {
   ...
   public BlockBulkFindHereCommand() {
      ...
      this.blockTypeArg = this.withRequiredArg("block", "server.commands.block.find-here.block.desc", ArgTypes.BLOCK_TYPE_KEY);
      this.radiusArg = this.withDefaultArg("radius", "server.commands.block.find-here.radius.desc", ArgTypes.INTEGER, 3, "server.commands.block.bulk.find-here.radius.default");
   }
