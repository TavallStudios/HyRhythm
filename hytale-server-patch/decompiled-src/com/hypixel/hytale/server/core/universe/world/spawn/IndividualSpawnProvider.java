...
public class IndividualSpawnProvider implements ISpawnProvider {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(IndividualSpawnProvider.class, IndividualSpawnProvider::new).documentation("A spawn provider that selects a spawn point from a list based on the player being spawned in. This gives random but consistent spawn points for players.")).append(new KeyedCodec("SpawnPoints", new ArrayCodec(Transform.CODEC, (x$0) -> new Transform[x$0])), (o, i) -> o.spawnPoints = i, (o) -> o.spawnPoints).documentation("The list of spawn points to select from.").add()).build();
   }
}
