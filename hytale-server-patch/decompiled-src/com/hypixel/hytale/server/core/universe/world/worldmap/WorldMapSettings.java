...
public class WorldMapSettings {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.worldMapArea);
      return "WorldMapSettings{worldMapArea=" + var10000 + ", imageScale=" + this.imageScale + ", viewRadiusMultiplier=" + this.viewRadiusMultiplier + ", viewRadiusMin=" + this.viewRadiusMin + ", viewRadiusMax=" + this.viewRadiusMax + ", settingsPacket=" + String.valueOf(this.settingsPacket) + "}";
   }
}
