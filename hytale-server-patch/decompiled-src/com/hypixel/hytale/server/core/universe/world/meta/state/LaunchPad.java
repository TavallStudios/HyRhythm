...
public class LaunchPad implements Component<ChunkStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(LaunchPad.class, LaunchPad::new).append(new KeyedCodec("VelocityX", Codec.DOUBLE), (state, d) -> state.velocityX = d.floatValue(), (state) -> (double)state.velocityX).documentation("The X velocity of the launch pad.").add()).append(new KeyedCodec("VelocityY", Codec.DOUBLE), (state, d) -> state.velocityY = d.floatValue(), (state) -> (double)state.velocityY).documentation("The Y velocity of the launch pad.").add()).append(new KeyedCodec("VelocityZ", Codec.DOUBLE), (state, d) -> state.velocityZ = d.floatValue(), (state) -> (double)state.velocityZ).documentation("The Z velocity of the launch pad.").add()).append(new KeyedCodec("PlayersOnly", Codec.BOOLEAN), (state, b) -> state.playersOnly = b, (state) -> state.playersOnly).documentation("Determines whether only players can use this launch pad.").add()).build();
   }
