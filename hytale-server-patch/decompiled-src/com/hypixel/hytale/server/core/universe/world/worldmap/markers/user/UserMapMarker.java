...
public class UserMapMarker {
   ...
   public MapMarker toProtocolMarker() {
      if (this.cachedProto == null) {
         MapMarkerBuilder builder = new MapMarkerBuilder(this.id, this.icon, new Transform((double)this.x, 100.0, (double)this.z));
         if (this.name != null) {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(UserMapMarker.class, UserMapMarker::new).append(new KeyedCodec("Id", Codec.STRING), (marker, o) -> marker.id = o, (marker) -> marker.id).add()).append(new KeyedCodec("X", Codec.FLOAT), (marker, o) -> marker.x = o, (marker) -> marker.x).add()).append(new KeyedCodec("Z", Codec.FLOAT), (marker, o) -> marker.z = o, (marker) -> marker.z).add()).append(new KeyedCodec("Name", Codec.STRING), (marker, o) -> marker.name = o, (marker) -> marker.name).add()).append(new KeyedCodec("Icon", Codec.STRING), (marker, o) -> marker.icon = o, (marker) -> marker.icon).add()).append(new KeyedCodec("ColorTint", ProtocolCodecs.COLOR), (marker, o) -> marker.colorTint = o, (marker) -> marker.colorTint).add()).append(new KeyedCodec("CreatedByUuid", Codec.UUID_BINARY), (marker, o) -> marker.createdByUuid = o, (marker) -> marker.createdByUuid).add()).append(new KeyedCodec("CreatedByName", Codec.STRING), (marker, o) -> marker.createdByName = o, (marker) -> marker.createdByName).add()).build();
      ARRAY_CODEC = new ArrayCodec<UserMapMarker>(CODEC, (x$0) -> new UserMapMarker[x$0]);
   }
}
