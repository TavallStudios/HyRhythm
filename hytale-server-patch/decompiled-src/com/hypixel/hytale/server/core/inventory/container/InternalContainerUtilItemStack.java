...
public class InternalContainerUtilItemStack {
   ...
   protected static ItemStackSlotTransaction internal_addToExistingSlot(@Nonnull ItemContainer container, short slot, @Nonnull ItemStack itemStack, int itemMaxStack, boolean filter) {
      ...
      if (ItemStack.isEmpty(slotItemStack)) {
         return new ItemStackSlotTransaction(false, ActionType.ADD, slot, slotItemStack, slotItemStack, (ItemStack)null, false, false, filter, true, itemStack, itemStack);
      } else if (!slotItemStack.isStackableWith(itemStack)) {
         return new ItemStackSlotTransaction(false, ActionType.ADD, slot, slotItemStack, slotItemStack, (ItemStack)null, false, false, filter, true, itemStack, itemStack);
         ...
         if (quantityAdjustment <= 0) {
            ...
            return new ItemStackSlotTransaction(true, ActionType.ADD, slot, slotItemStack, slotNew, (ItemStack)null, false, false, filter, true, itemStack, remainder);
         }
      }
   }
   ...
   protected static ItemStackSlotTransaction internal_addToEmptySlot(@Nonnull ItemContainer container, short slot, @Nonnull ItemStack itemStack, int itemMaxStack, boolean filter) {
      ...
      if (slotItemStack != null && !slotItemStack.isEmpty()) {
         return new ItemStackSlotTransaction(false, ActionType.ADD, slot, slotItemStack, slotItemStack, (ItemStack)null, false, false, filter, false, itemStack, itemStack);
      } else if (filter && container.cantAddToSlot(slot, itemStack, slotItemStack)) {
         return new ItemStackSlotTransaction(false, ActionType.ADD, slot, slotItemStack, slotItemStack, (ItemStack)null, false, false, filter, false, itemStack, itemStack);
      } else {
         int quantityRemaining = itemStack.getQuantity();
         ...
         return new ItemStackSlotTransaction(true, ActionType.ADD, slot, slotItemStack, slotNew, (ItemStack)null, false, false, filter, false, itemStack, remainder);
      }
   }
   ...
   protected static ItemStackSlotTransaction internal_addItemStackToSlot(@Nonnull ItemContainer itemContainer, short slot, @Nonnull ItemStack itemStack, boolean allOrNothing, boolean filter) {
      ...
      return (ItemStackSlotTransaction)itemContainer.writeAction(() -> {
         int quantityRemaining = itemStack.getQuantity();
         ...
         if (filter && itemContainer.cantAddToSlot(slot, itemStack, slotItemStack)) {
            return new ItemStackSlotTransaction(false, ActionType.ADD, slot, slotItemStack, slotItemStack, (ItemStack)null, allOrNothing, false, filter, false, itemStack, itemStack);
         } else if (slotItemStack == null) {
            itemContainer.internal_setSlot(slot, itemStack);
            return new ItemStackSlotTransaction(true, ActionType.ADD, slot, (ItemStack)null, itemStack, (ItemStack)null, allOrNothing, false, filter, false, itemStack, (ItemStack)null);
         } else {
            int quantity = slotItemStack.getQuantity();
            if (!itemStack.isStackableWith(slotItemStack)) {
               ...
               if (allOrNothing && quantityRemaining > 0) {
                  ...
                  return new ItemStackSlotTransaction(true, ActionType.ADD, slot, slotItemStack, newItemStack, (ItemStack)null, allOrNothing, false, filter, false, itemStack, remainder);
               }
            }
         }
      });
   ...
   protected static ItemStackSlotTransaction internal_setItemStackForSlot(@Nonnull ItemContainer itemContainer, short slot, ItemStack itemStack, boolean filter) {
      ...
      return (ItemStackSlotTransaction)itemContainer.writeAction(() -> {
         ItemStack slotItemStack = itemContainer.internal_getSlot(slot);
         if (filter && itemContainer.cantAddToSlot(slot, itemStack, slotItemStack)) {
            return new ItemStackSlotTransaction(false, ActionType.SET, slot, slotItemStack, slotItemStack, (ItemStack)null, false, false, filter, false, itemStack, itemStack);
         } else {
            ItemStack oldItemStack = itemContainer.internal_setSlot(slot, itemStack);
            return new ItemStackSlotTransaction(true, ActionType.SET, slot, oldItemStack, itemStack, (ItemStack)null, false, false, filter, false, itemStack, (ItemStack)null);
         }
      });
   }
   ...
   protected static SlotTransaction internal_removeItemStackFromSlot(@Nonnull ItemContainer itemContainer, short slot, boolean filter) {
      ItemContainer.validateSlotIndex(slot, itemContainer.getCapacity());
      return (SlotTransaction)itemContainer.writeAction(() -> {
         if (filter && itemContainer.cantRemoveFromSlot(slot)) {
            ItemStack itemStack = itemContainer.internal_getSlot(slot);
            return new ItemStackSlotTransaction(false, ActionType.REMOVE, slot, itemStack, itemStack, (ItemStack)null, false, false, filter, false, (ItemStack)null, itemStack);
         } else {
            ItemStack oldItemStack = itemContainer.internal_removeSlot(slot);
            return new SlotTransaction(true, ActionType.REMOVE, slot, oldItemStack, (ItemStack)null, oldItemStack, false, false, false);
         }
      });
   }
   ...
   protected static ItemStackSlotTransaction internal_removeItemStackFromSlot(@Nonnull ItemContainer itemContainer, short slot, int quantityToRemove, boolean allOrNothing, boolean filter) {
      ...
      return (ItemStackSlotTransaction)itemContainer.writeAction(() -> {
         if (filter && itemContainer.cantRemoveFromSlot(slot)) {
            ItemStack itemStack = itemContainer.internal_getSlot(slot);
            return new ItemStackSlotTransaction(false, ActionType.REMOVE, slot, itemStack, itemStack, (ItemStack)null, allOrNothing, false, filter, false, (ItemStack)null, itemStack.withQuantity(quantityToRemove));
         } else {
            ItemStack slotItemStack = itemContainer.internal_getSlot(slot);
            if (slotItemStack == null) {
               return new ItemStackSlotTransaction(false, ActionType.REMOVE, slot, (ItemStack)null, (ItemStack)null, (ItemStack)null, allOrNothing, false, filter, false, (ItemStack)null, (ItemStack)null);
            } else {
               int quantity = slotItemStack.getQuantity();
               ...
               if (allOrNothing && quantityRemaining > 0) {
                  return new ItemStackSlotTransaction(false, ActionType.REMOVE, slot, slotItemStack, slotItemStack, (ItemStack)null, allOrNothing, false, filter, false, (ItemStack)null, slotItemStack.withQuantity(quantityRemaining));
               } else {
                  ...
                  return new ItemStackSlotTransaction(true, ActionType.REMOVE, slot, slotItemStack, itemStack, newStack, allOrNothing, false, filter, false, (ItemStack)null, remainder);
               }
            }
         }
      });
   ...
   protected static ItemStackSlotTransaction internal_removeItemStackFromSlot(@Nonnull ItemContainer itemContainer, short slot, @Nullable ItemStack itemStackToRemove, int quantityToRemove, boolean allOrNothing, boolean filter, BiPredicate<ItemStack, ItemStack> predicate) {
      ...
      return (ItemStackSlotTransaction)itemContainer.writeAction(() -> {
         if (filter && itemContainer.cantRemoveFromSlot(slot)) {
            ItemStack itemStack = itemContainer.internal_getSlot(slot);
            return new ItemStackSlotTransaction(false, ActionType.REMOVE, slot, itemStack, itemStack, (ItemStack)null, allOrNothing, false, filter, false, itemStackToRemove, itemStackToRemove);
         } else {
            ItemStack slotItemStack = itemContainer.internal_getSlot(slot);
            if ((slotItemStack != null || itemStackToRemove == null) && (slotItemStack == null || itemStackToRemove != null) && (slotItemStack == null || predicate.test(slotItemStack, itemStackToRemove))) {
               if (slotItemStack == null) {
                  return new ItemStackSlotTransaction(true, ActionType.REMOVE, slot, (ItemStack)null, (ItemStack)null, (ItemStack)null, allOrNothing, false, filter, false, itemStackToRemove, itemStackToRemove);
               } else {
                  int quantity = slotItemStack.getQuantity();
                  int quantityAdjustment = Math.min(quantity, quantityToRemove);
                  int newQuantity = quantity - quantityAdjustment;
                  int quantityRemaining = quantityToRemove - quantityAdjustment;
                  if (allOrNothing && quantityRemaining > 0) {
                     return new ItemStackSlotTransaction(false, ActionType.REMOVE, slot, slotItemStack, slotItemStack, (ItemStack)null, allOrNothing, false, filter, false, itemStackToRemove, itemStackToRemove);
                  } else {
                     ItemStack itemStack = slotItemStack.withQuantity(newQuantity);
                     itemContainer.internal_setSlot(slot, itemStack);
                     ItemStack newStack = slotItemStack.withQuantity(quantityAdjustment);
   ...
   protected static ItemStackTransaction internal_addItemStack(@Nonnull ItemContainer itemContainer, @Nonnull ItemStack itemStack, boolean allOrNothing, boolean fullStacks, boolean filter) {
      ...
      if (item == null) {
         ...
         return (ItemStackTransaction)itemContainer.writeAction(() -> {
            if (allOrNothing) {
   ...
   protected static ListTransaction<ItemStackTransaction> internal_addItemStacks(@Nonnull ItemContainer itemContainer, @Nullable List<ItemStack> itemStacks, boolean allOrNothing, boolean fullStacks, boolean filter) {
      return itemStacks != null && !itemStacks.isEmpty() ? (ListTransaction)itemContainer.writeAction(() -> {
         if (allOrNothing) {
            for(ItemStack itemStack : itemStacks) {
               ...
               testQuantityRemaining = testAddToEmptySlots(itemContainer, itemStack, itemMaxStack, testQuantityRemaining, filter);
               if (testQuantityRemaining > 0) {
                  return new ListTransaction(false, (List)itemStacks.stream().map((i) -> new ItemStackTransaction(false, ActionType.ADD, itemStack, itemStack, allOrNothing, filter, Collections.emptyList())).collect(Collectors.toList()));
               }
            }
         }
   ...
   protected static ListTransaction<ItemStackSlotTransaction> internal_addItemStacksOrdered(@Nonnull ItemContainer itemContainer, short offset, @Nullable List<ItemStack> itemStacks, boolean allOrNothing, boolean filter) {
      if (itemStacks != null && !itemStacks.isEmpty()) {
         ...
         return (ListTransaction)itemContainer.writeAction(() -> {
            if (allOrNothing) {
               for(short i = 0; i < itemStacks.size(); ++i) {
                  ...
                  if (testQuantityRemaining > 0) {
                     ...
                     for(short i1 = 0; i1 < itemStacks.size(); ++i1) {
                        ...
                        list.add(new ItemStackSlotTransaction(false, ActionType.ADD, islot, (ItemStack)null, (ItemStack)null, (ItemStack)null, allOrNothing, false, filter, false, itemStack, itemStack));
                     }
         ...
         return ListTransaction.<ItemStackSlotTransaction>getEmptyTransaction(true);
      }
   }
   ...
   protected static ListTransaction<ItemStackTransaction> internal_removeItemStacks(@Nonnull ItemContainer itemContainer, @Nullable List<ItemStack> itemStacks, boolean allOrNothing, boolean filter) {
      if (itemStacks != null && !itemStacks.isEmpty()) {
         ...
         return (ListTransaction)itemContainer.writeAction(() -> {
            if (allOrNothing) {
               for(ItemStack itemStack : itemStacks) {
                  int testQuantityRemaining = testRemoveItemStackFromItems(itemContainer, itemStack, itemStack.getQuantity(), filter);
                  if (testQuantityRemaining > 0) {
                     return new ListTransaction(false, (List)itemStacks.stream().map((ix) -> new ItemStackTransaction(false, ActionType.ADD, itemStack, itemStack, allOrNothing, filter, Collections.emptyList())).collect(Collectors.toList()));
                  }
               }
            }
         ...
         return ListTransaction.<ItemStackTransaction>getEmptyTransaction(true);
      }
   }
