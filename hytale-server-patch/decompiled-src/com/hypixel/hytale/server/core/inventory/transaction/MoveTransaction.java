...
public class MoveTransaction<T extends Transaction> implements Transaction {
   ...
   public MoveTransaction<T> toParent(ItemContainer parent, short start, ItemContainer container) {
      ...
      switch (moveType) {
         case MOVE_TO_SELF -> var10000 = new MoveTransaction(this.succeeded(), this.removeTransaction, moveType, this.getOtherContainer(), this.addTransaction.toParent(parent, start, container));
         case MOVE_FROM_SELF -> var10000 = new MoveTransaction(this.succeeded(), this.removeTransaction.toParent(parent, start, container), moveType, this.getOtherContainer(), this.addTransaction);
   ...
   public MoveTransaction<T> fromParent(ItemContainer parent, short start, @Nonnull ItemContainer container) {
      ...
      switch (moveType) {
         case MOVE_TO_SELF:
            T newAddTransaction = this.addTransaction.fromParent(parent, start, container);
   ...
   public String toString() {
      ...
      return "MoveTransaction{succeeded=" + var10000 + ", removeTransaction=" + String.valueOf(this.removeTransaction) + ", moveType=" + String.valueOf(this.moveType) + ", otherContainer=" + String.valueOf(this.otherContainer) + ", addTransaction=" + String.valueOf(this.addTransaction) + "}";
   }
}
