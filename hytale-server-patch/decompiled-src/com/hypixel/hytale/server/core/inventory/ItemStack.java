...
public class ItemStack implements NetworkSerializable<ItemWithAllMetadata> {
   ...
   public ItemStack(@Nonnull String itemId, int quantity) {
      this(itemId, quantity, (BsonDocument)null);
   }
   ...
   @Nonnull
   public Item getItem() {
      Item item = (Item)Item.getAssetMap().getAsset(this.itemId);
   ...
   public String toString() {
      ...
      return "ItemStack{itemId=" + var10000 + ", quantity=" + this.quantity + ", maxDurability=" + this.maxDurability + ", durability=" + this.durability + ", metadata=" + String.valueOf(this.metadata) + "}";
   }
   ...
   public static ItemStack fromPacket(@Nullable ItemQuantity packet) {
      if (packet == null) {
         ...
         return quantity <= 0 ? null : new ItemStack(packet.itemId, quantity, (BsonDocument)null);
      }
   }
