...
public abstract class ItemContainer {
   public static final CodecMapCodec<ItemContainer> CODEC = new CodecMapCodec<ItemContainer>(true);
   ...
   public ItemContainer() {
      this.externalChangeEventRegistry = new SyncEventBusRegistry<Void, ItemContainerChangeEvent>(LOGGER, ItemContainerChangeEvent.class);
      this.internalChangeEventRegistry = new SyncEventBusRegistry<Void, ItemContainerChangeEvent>(LOGGER, ItemContainerChangeEvent.class);
   }
   ...
   public EventRegistration registerChangeEvent(short priority, @Nonnull Consumer<ItemContainerChangeEvent> consumer) {
      return this.externalChangeEventRegistry.register(priority, (Object)null, consumer);
   }

   public ClearTransaction clear() {
      ClearTransaction transaction = (ClearTransaction)this.writeAction(this::internal_clear);
   ...
   public boolean canAddItemStackToSlot(short slot, @Nonnull ItemStack itemStack, boolean allOrNothing, boolean filter) {
      ...
      return (Boolean)this.writeAction(() -> {
   ...
   public ItemStack getItemStack(short slot) {
      validateSlotIndex(slot, this.getCapacity());
      return (ItemStack)this.readAction(() -> this.internal_getSlot(slot));
   }
   ...
   private ListTransaction<ItemStackSlotTransaction> replaceAll(SlotReplacementFunction func, boolean ignoreEmpty) {
      ListTransaction<ItemStackSlotTransaction> transaction = (ListTransaction)this.writeAction(() -> {
   ...
   protected ItemStackSlotTransaction internal_replaceItemStack(short slot, @Nullable ItemStack itemStackToRemove, ItemStack itemStack) {
      validateSlotIndex(slot, this.getCapacity());
      return (ItemStackSlotTransaction)this.writeAction(() -> {
         ItemStack slotItemStack = this.internal_getSlot(slot);
         if ((slotItemStack != null || itemStackToRemove == null) && (slotItemStack == null || itemStackToRemove != null) && (slotItemStack == null || itemStackToRemove.isStackableWith(slotItemStack))) {
            ...
            return new ItemStackSlotTransaction(true, ActionType.REPLACE, slot, slotItemStack, itemStack, slotItemStack, true, false, false, false, itemStack, (ItemStack)null);
         } else {
            return new ItemStackSlotTransaction(false, ActionType.REPLACE, slot, slotItemStack, slotItemStack, (ItemStack)null, true, false, false, false, itemStack, itemStack);
         }
      });
   }
   ...
   protected MoveTransaction<ItemStackTransaction> internal_moveItemStackFromSlot(short slot, @Nonnull ItemContainer containerTo, boolean allOrNothing, boolean filter) {
      validateSlotIndex(slot, this.getCapacity());
      return (MoveTransaction)this.writeAction(() -> (MoveTransaction)containerTo.writeAction(() -> {
            if (filter && this.cantRemoveFromSlot(slot)) {
               return null;
            } else {
               ItemStack itemFrom = this.internal_removeSlot(slot);
               if (ItemStack.isEmpty(itemFrom)) {
                  SlotTransaction slotTransaction = new SlotTransaction(false, ActionType.REMOVE, slot, (ItemStack)null, (ItemStack)null, (ItemStack)null, false, false, filter);
                  return new MoveTransaction(false, slotTransaction, MoveType.MOVE_FROM_SELF, containerTo, ItemStackTransaction.FAILED_ADD);
               } else {
                  SlotTransaction fromTransaction = new SlotTransaction(true, ActionType.REMOVE, slot, itemFrom, (ItemStack)null, (ItemStack)null, false, false, filter);
   ...
   public ListTransaction<MoveTransaction<ItemStackTransaction>> moveAllItemStacksTo(ItemContainer... containerTo) {
      return this.moveAllItemStacksTo((Predicate)null, containerTo);
   }
   ...
   protected ListTransaction<MoveTransaction<ItemStackTransaction>> internal_moveAllItemStacksTo(@Nullable Predicate<ItemStack> itemPredicate, ItemContainer[] containerTo) {
      return (ListTransaction)this.writeAction(() -> {
         List<MoveTransaction<ItemStackTransaction>> transactions = new ObjectArrayList();
   ...
   protected ListTransaction<MoveTransaction<SlotTransaction>> internal_swapItems(short srcPos, @Nonnull ItemContainer containerTo, short destPos, short length) {
      if (srcPos < 0) {
         ...
         return (ListTransaction)this.writeAction(() -> (ListTransaction)containerTo.writeAction(() -> {
   ...
   protected MoveTransaction<SlotTransaction> internal_swapItems(@Nonnull ItemContainer containerTo, short slotFrom, short slotTo) {
      ...
      SlotTransaction from = new SlotTransaction(true, ActionType.REPLACE, slotFrom, itemFrom, itemTo, (ItemStack)null, false, false, false);
      SlotTransaction to = new SlotTransaction(true, ActionType.REPLACE, slotTo, itemTo, itemFrom, (ItemStack)null, false, false, false);
   ...
   public boolean canRemoveItemStack(@Nullable ItemStack itemStack, boolean exactAmount, boolean filter) {
      return itemStack == null ? true : (Boolean)this.readAction(() -> {
   ...
   public boolean canRemoveItemStacks(@Nullable List<ItemStack> itemStacks, boolean exactAmount, boolean filter) {
      return itemStacks != null && !itemStacks.isEmpty() ? (Boolean)this.readAction(() -> {
         for(ItemStack itemStack : itemStacks) {
            int testQuantityRemaining = InternalContainerUtilItemStack.testRemoveItemStackFromItems(this, itemStack, itemStack.getQuantity(), filter);
            if (testQuantityRemaining > 0) {
               return false;
   ...
   public boolean canRemoveResource(@Nullable ResourceQuantity resource, boolean exactAmount, boolean filter) {
      return resource == null ? true : (Boolean)this.readAction(() -> {
   ...
   public boolean canRemoveResources(@Nullable List<ResourceQuantity> resources, boolean exactAmount, boolean filter) {
      return resources != null && !resources.isEmpty() ? (Boolean)this.readAction(() -> {
   ...
   public ListTransaction<ResourceTransaction> removeResources(@Nullable List<ResourceQuantity> resources, boolean allOrNothing, boolean exactAmount, boolean filter) {
      if (resources != null && !resources.isEmpty()) {
         ...
         return ListTransaction.<ResourceTransaction>getEmptyTransaction(true);
      }
   }
   ...
   public boolean canRemoveMaterial(@Nullable MaterialQuantity material, boolean exactAmount, boolean filter) {
      return material == null ? true : (Boolean)this.readAction(() -> {
   ...
   public boolean canRemoveMaterials(@Nullable List<MaterialQuantity> materials, boolean exactAmount, boolean filter) {
      return materials != null && !materials.isEmpty() ? (Boolean)this.readAction(() -> {
   ...
   public List<TestRemoveItemSlotResult> getSlotMaterialsToRemove(@Nullable List<MaterialQuantity> materials, boolean exactAmount, boolean filter) {
      ...
      return materials != null && !materials.isEmpty() ? (List)this.readAction(() -> {
         for(MaterialQuantity material : materials) {
   ...
   public ListTransaction<MaterialTransaction> removeMaterials(@Nullable List<MaterialQuantity> materials, boolean allOrNothing, boolean exactAmount, boolean filter) {
      if (materials != null && !materials.isEmpty()) {
         ...
         return ListTransaction.<MaterialTransaction>getEmptyTransaction(true);
      }
   }
   ...
   public ListTransaction<MaterialSlotTransaction> removeMaterialsOrdered(short offset, @Nullable List<MaterialQuantity> materials, boolean allOrNothing, boolean exactAmount, boolean filter) {
      if (materials != null && !materials.isEmpty()) {
         if (offset + materials.size() > this.getCapacity()) {
            return ListTransaction.<MaterialSlotTransaction>getEmptyTransaction(false);
         } else {
         ...
         return ListTransaction.<MaterialSlotTransaction>getEmptyTransaction(true);
      }
   }
   ...
   public int countItemStacks(@Nonnull Predicate<ItemStack> itemPredicate) {
      return (Integer)this.readAction(() -> {
         int count = 0;
   ...
   public List<ItemStack> removeAllItemStacks() {
      ...
      ListTransaction<SlotTransaction> transaction = (ListTransaction)this.writeAction(() -> {
         ...
         for(short i = 0; i < this.getCapacity(); ++i) {
            if (!this.cantRemoveFromSlot(i)) {
               ...
               if (!ItemStack.isEmpty(itemStack)) {
                  items.add(itemStack);
                  transactions.add(new SlotTransaction(true, ActionType.REMOVE, i, itemStack, (ItemStack)null, itemStack, false, false, true));
               }
            }
         }
      ...
      return (ListTransaction)this.writeAction(() -> {
         ...
         for(short i = 0; i < stacks.length; ++i) {
            if (!this.cantRemoveFromSlot(i)) {
               ...
               if (!this.cantAddToSlot(i, replacement, existing)) {
                  ++stackOffset;
   ...
   protected void sendUpdate(@Nonnull Transaction transaction) {
      if (transaction.succeeded()) {
         ...
         this.externalChangeEventRegistry.dispatchFor((Object)null).dispatch(event);
         this.internalChangeEventRegistry.dispatchFor((Object)null).dispatch(event);
      }
   }
   ...
   public static <T extends ItemContainer> T ensureContainerCapacity(@Nullable T inputContainer, short capacity, @Nonnull Short2ObjectConcurrentHashMap.ShortFunction<T> newContainerSupplier, List<ItemStack> remainder) {
      if (inputContainer == null) {
         ...
         return (T)(inputContainer.getCapacity() == capacity ? inputContainer : copy(inputContainer, newContainerSupplier.apply(capacity), remainder));
      }
   }
   ...
   public static record TempItemData(ItemStack itemStack, Item item) {
   }

   public static record ItemContainerChangeEvent(ItemContainer container, Transaction transaction) implements IEvent<Void> {
      @Nonnull
      public String toString() {
         String var10000 = String.valueOf(this.container);
         return "ItemContainerChangeEvent{container=" + var10000 + ", transaction=" + String.valueOf(this.transaction) + "}";
      }
   }
}
