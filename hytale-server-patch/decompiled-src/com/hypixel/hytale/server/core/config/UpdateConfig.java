...
public class UpdateConfig {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(UpdateConfig.class, UpdateConfig::new).append(new KeyedCodec("Enabled", Codec.BOOLEAN), (o, b) -> o.enabled = b, (o) -> o.enabled).documentation("Determines whether to enable automatic update checks.").add()).append(new KeyedCodec("CheckIntervalSeconds", Codec.INTEGER), (o, i) -> o.checkIntervalSeconds = i, (o) -> o.checkIntervalSeconds).documentation("The interval, in seconds, between automatic update checks.").add()).append(new KeyedCodec("NotifyPlayersOnAvailable", Codec.BOOLEAN), (o, b) -> o.notifyPlayersOnAvailable = b, (o) -> o.notifyPlayersOnAvailable).documentation("Whether to notify players in-game when an update is available.").add()).append(new KeyedCodec("Patchline", Codec.STRING), (o, s) -> o.patchline = s, (o) -> o.patchline).documentation("The patchline to check for updates on.").add()).append(new KeyedCodec("RunBackupBeforeUpdate", Codec.BOOLEAN), (o, b) -> o.runBackupBeforeUpdate = b, (o) -> o.runBackupBeforeUpdate).documentation("Determines whether to run a backup before applying an update.").add()).append(new KeyedCodec("BackupConfigBeforeUpdate", Codec.BOOLEAN), (o, b) -> o.backupConfigBeforeUpdate = b, (o) -> o.backupConfigBeforeUpdate).documentation("Determines whether to backup the server config before applying an update.").add()).append(new KeyedCodec("AutoApplyMode", new EnumCodec(AutoApplyMode.class)), (o, m) -> o.autoApplyMode = m, (o) -> o.autoApplyMode).documentation("The mode for automatically applying updates.").add()).append(new KeyedCodec("AutoApplyDelayMinutes", Codec.INTEGER), (o, i) -> o.autoApplyDelayMinutes = i, (o) -> o.autoApplyDelayMinutes).documentation("The delay in minutes before auto-applying an update while using SCHEDULED mode.").add()).build();
   }
