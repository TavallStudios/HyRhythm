...
public class BeaconSpatialSystem extends SpatialSystem<EntityStore> {
   private static final Query<EntityStore> QUERY = Query.<EntityStore>and(SpawnBeacon.getComponentType(), FloodFillPositionSelector.getComponentType(), TransformComponent.getComponentType());
