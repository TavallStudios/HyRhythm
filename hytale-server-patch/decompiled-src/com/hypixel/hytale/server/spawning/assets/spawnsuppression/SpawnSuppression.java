...
public class SpawnSuppression implements JsonAssetWithMap<String, IndexedAssetMap<String, SpawnSuppression>> {
   ...
   public static AssetStore<String, SpawnSuppression, IndexedAssetMap<String, SpawnSuppression>> getAssetStore() {
      if (ASSET_STORE == null) {
         ASSET_STORE = AssetRegistry.<String, SpawnSuppression, IndexedAssetMap<String, SpawnSuppression>>getAssetStore(SpawnSuppression.class);
      }
   ...
   static {
      ...
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(SpawnSuppression::getAssetStore));
   }
}
