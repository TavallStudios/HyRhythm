...
public class SpawnMarkersCommand extends AbstractCommandCollection {
   @Nonnull
   private static final AssetArgumentType<SpawnMarker, ?> SPAWN_MARKER_ASSET_TYPE = new AssetArgumentType("server.commands.spawning.markers.arg.marker.name", SpawnMarker.class, "server.commands.spawning.markers.arg.marker.usage");
   ...
   private static class Add extends AbstractPlayerCommand {
      ...
      public Add() {
         ...
         this.markerArg = this.withRequiredArg("marker", "server.commands.spawning.markers.add.arg.marker.desc", SpawnMarkersCommand.SPAWN_MARKER_ASSET_TYPE);
      ...
      protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world) {
         if (!context.isPlayer()) {
            ...
            SpawnMarker marker = (SpawnMarker)this.markerArg.get(context);
            ...
            if ((Boolean)this.flipArg.get(context)) {
