...
public class SpawnMarkerBlockReference implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(SpawnMarkerBlockReference.class, SpawnMarkerBlockReference::new).append(new KeyedCodec("BlockPosition", Vector3i.CODEC), (reference, o) -> reference.blockPosition = o, (reference) -> reference.blockPosition).add()).build();
   }
}
