...
public class SpawnMarkerBlockState extends BlockState {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(SpawnMarkerBlockState.class, SpawnMarkerBlockState::new, BlockState.BASE_CODEC).append(new KeyedCodec("MarkerReference", PersistentRef.CODEC), (spawn, o) -> spawn.spawnMarkerReference = o, (spawn) -> spawn.spawnMarkerReference).add()).build();
   }
