...
public class ChunkSpawnedNPCData implements Component<ChunkStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ChunkSpawnedNPCData.class, ChunkSpawnedNPCData::new).append(new KeyedCodec("EnvironmentSpawnCounts", new Object2DoubleMapCodec(Codec.STRING, Object2DoubleOpenHashMap::new, false)), (chunk, o) -> {
         ...
         while(i$.hasNext()) {
            Int2DoubleMap.Entry entry = (Int2DoubleMap.Entry)i$.next();
