...
public class SpawnSuppressionComponent implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(SpawnSuppressionComponent.class, SpawnSuppressionComponent::new).append(new KeyedCodec("SpawnSuppression", Codec.STRING), (suppressor, s) -> suppressor.spawnSuppression = s, (suppressor) -> suppressor.spawnSuppression).add()).build();
   }
}
