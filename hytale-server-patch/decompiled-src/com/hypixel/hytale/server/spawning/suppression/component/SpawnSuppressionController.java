...
public class SpawnSuppressionController implements Resource<EntityStore> {
   ...
   private final Long2ObjectConcurrentHashMap<ChunkSuppressionEntry> chunkSuppressionMap = new Long2ObjectConcurrentHashMap<ChunkSuppressionEntry>(true, ChunkUtil.indexChunk(-2147483648, -2147483648));
