...
public class BuilderActionTriggerSpawnBeacon extends BuilderActionBase {
   ...
   public BuilderActionTriggerSpawnBeacon readConfig(@Nonnull JsonElement data) {
      this.requireAsset(data, "BeaconSpawn", this.beaconId, BeaconSpawnExistsValidator.required(), BuilderDescriptorState.Stable, "The beacon spawn config ID", (String)null);
      this.requireInt(data, "Range", this.range, IntSingleValidator.greater0(), BuilderDescriptorState.Stable, "The distance to search for a beacon to trigger", (String)null);
      this.getString(data, "TargetSlot", (s) -> this.targetSlot = s, (String)null, StringNullOrNotEmptyValidator.get(), BuilderDescriptorState.Stable, "A slot to use as the target for the spawned NPC. If omitted the NPC itself will be used", (String)null);
      return this;
   }
