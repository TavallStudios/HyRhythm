...
public class BeaconSpawnWrapper extends SpawnWrapper<BeaconNPCSpawn> {
   ...
   public BeaconSpawnWrapper(@Nonnull BeaconNPCSpawn spawn) {
      ...
      WeightedMap.Builder<RoleSpawnParameters> mapBuilder = WeightedMap.<RoleSpawnParameters>builder(RoleSpawnParameters.EMPTY_ARRAY);
   ...
   public RoleSpawnParameters pickRole(Random chanceProvider) {
      return this.weightedRoles.size() == 0 ? null : (RoleSpawnParameters)this.weightedRoles.get(chanceProvider);
   }
}
