...
public class LocalSpawnForceTriggerSystem extends EntityTickingSystem<EntityStore> {
   ...
   public void tick(float dt, int systemIndex, @Nonnull Store<EntityStore> store) {
      LocalSpawnState state = (LocalSpawnState)store.getResource(this.localSpawnStateResourceType);
   ...
   public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
      ...
      LocalSpawnController controller = (LocalSpawnController)archetypeChunk.getComponent(index, this.spawnControllerComponentType);
