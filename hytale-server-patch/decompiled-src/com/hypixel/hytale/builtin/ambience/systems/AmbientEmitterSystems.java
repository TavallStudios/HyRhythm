...
public class AmbientEmitterSystems {
   public static class EntityAdded extends HolderSystem<EntityStore> {
      ...
      public EntityAdded(@Nonnull ComponentType<EntityStore, AmbientEmitterComponent> ambientEmitterComponentType, @Nonnull ComponentType<EntityStore, TransformComponent> transformComponentType, @Nonnull ComponentType<EntityStore, NetworkId> networkIdComponentType, @Nonnull ComponentType<EntityStore, Intangible> intangibleComponentType, @Nonnull ComponentType<EntityStore, PrefabCopyableComponent> prefabCopyableComponentType) {
         ...
         this.query = Query.<EntityStore>and(ambientEmitterComponentType, transformComponentType);
      }
   ...
   public static class EntityRefAdded extends RefSystem<EntityStore> {
      ...
      public void onEntityAdded(@Nonnull Ref<EntityStore> ref, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         AmbientEmitterComponent emitterComponent = (AmbientEmitterComponent)store.getComponent(ref, this.ambientEmitterComponentType);
   ...
   public static class Ticking extends EntityTickingSystem<EntityStore> {
      ...
      public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         AmbientEmitterComponent emitterComponent = (AmbientEmitterComponent)archetypeChunk.getComponent(index, this.ambientEmitterComponentType);
         ...
         if (spawnedEmitterRef != null && spawnedEmitterRef.isValid()) {
            TransformComponent ownedEmitterTransform = (TransformComponent)commandBuffer.getComponent(spawnedEmitterRef, this.transformComponentType);
