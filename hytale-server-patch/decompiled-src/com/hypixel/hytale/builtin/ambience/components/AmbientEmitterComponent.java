...
public class AmbientEmitterComponent implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(AmbientEmitterComponent.class, AmbientEmitterComponent::new).append(new KeyedCodec("SoundEventId", Codec.STRING), (emitter, s) -> emitter.soundEventId = s, (emitter) -> emitter.soundEventId).add()).build();
   }
}
