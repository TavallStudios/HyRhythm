      ...
      if (playerComponent != null) {
         ...
         if (!inventory.usingToolsItem()) {
            ...
            if (inHandItemStack != null && !inHandItemStack.isEmpty()) {
               AdventureMetadata adventureMeta = (AdventureMetadata)inHandItemStack.getFromMetadataOrDefault("Adventure", AdventureMetadata.CODEC);
               ...
               inventory.getHotbar().replaceItemStackInSlot((short)inventory.getActiveHotbarSlot(), inHandItemStack, edited);
