...
public class PortalWorld implements Resource<EntityStore> {
   ...
   public PortalType getPortalType() {
      return this.portalTypeId == null ? null : (PortalType)PortalType.getAssetMap().getAsset(this.portalTypeId);
   }
   ...
   public UpdatePortal createUpdatePacket(@Nonnull World world) {
      return new UpdatePortal(this.createStateForPacket(world), (PortalDef)null);
   }
