...
public class PortalDevice implements Component<ChunkStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PortalDevice.class, PortalDevice::new).append(new KeyedCodec("Config", PortalDeviceConfig.CODEC), (portal, o) -> portal.config = o, (portal) -> portal.config).add()).append(new KeyedCodec("BaseBlockType", Codec.STRING), (portal, o) -> portal.baseBlockTypeKey = o, (portal) -> portal.baseBlockTypeKey).add()).append(new KeyedCodec("DestinationWorld", Codec.UUID_BINARY), (portal, o) -> portal.destinationWorldUuid = o, (portal) -> portal.destinationWorldUuid).add()).build();
   }
}
