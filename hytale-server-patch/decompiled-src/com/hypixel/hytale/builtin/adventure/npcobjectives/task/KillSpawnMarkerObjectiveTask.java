...
public class KillSpawnMarkerObjectiveTask extends KillObjectiveTask {
   ...
   protected TransactionRecord[] setup0(@Nonnull Objective objective, @Nonnull World world, @Nonnull Store<EntityStore> store) {
      ...
      if (objectivePosition != null) {
         ...
         spatialResource.getSpatialStructure().collect(objectivePosition, (double)asset.getRadius(), results);
         ...
         while(var10.hasNext()) {
            ...
            SpawnMarkerEntity entitySpawnMarkerComponent = (SpawnMarkerEntity)store.getComponent(ref, SPAWN_MARKER_COMPONENT_TYPE);
