...
public class BuilderActionCompleteTask extends BuilderActionPlayAnimation {
   ...
   public BuilderActionCompleteTask readConfig(@Nonnull JsonElement data) {
      ...
      this.getBoolean(data, "PlayAnimation", this.playAnimation, true, BuilderDescriptorState.Stable, "Whether or not to play the animation associated with completing this task", (String)null);
