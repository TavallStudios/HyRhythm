...
public class KillSpawnMarkerObjectiveTaskAsset extends KillObjectiveTaskAsset {
   ...
   protected boolean matchesAsset0(ObjectiveTaskAsset task) {
      if (!super.matchesAsset0(task)) {
         return false;
      } else if (task instanceof KillSpawnMarkerObjectiveTaskAsset) {
   ...
   public String toString() {
      String var10000 = Arrays.toString(this.spawnMarkerIds);
      return "KillSpawnMarkerObjectiveTaskAsset{spawnMarkerIds=" + var10000 + ", radius=" + this.radius + "} " + super.toString();
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(KillSpawnMarkerObjectiveTaskAsset.class, KillSpawnMarkerObjectiveTaskAsset::new, KillObjectiveTaskAsset.CODEC).append(new KeyedCodec("Radius", Codec.FLOAT), (killSpawnMarkerObjectiveTaskAsset, aFloat) -> killSpawnMarkerObjectiveTaskAsset.radius = aFloat, (killSpawnMarkerObjectiveTaskAsset) -> killSpawnMarkerObjectiveTaskAsset.radius).addValidator(Validators.greaterThan(0.0F)).add()).append(new KeyedCodec("SpawnMarkerIds", Codec.STRING_ARRAY), (killSpawnMarkerObjectiveTaskAsset, s) -> killSpawnMarkerObjectiveTaskAsset.spawnMarkerIds = s, (killSpawnMarkerObjectiveTaskAsset) -> killSpawnMarkerObjectiveTaskAsset.spawnMarkerIds).addValidator(Validators.nonEmptyArray()).addValidator(SpawnMarker.VALIDATOR_CACHE.getArrayValidator()).addValidator(new ArrayValidator((o, results) -> {
         SpawnMarker spawnMarker = (SpawnMarker)SpawnMarker.getAssetMap().getAsset(o);
