...
public class BuilderSensorHasTask extends BuilderSensorBase {
   ...
   public Builder<Sensor> readConfig(@Nonnull JsonElement data) {
      this.requireStringArray(data, "TasksById", this.tasksById, 0, 2147483647, StringArrayNotEmptyValidator.get(), BuilderDescriptorState.Stable, "Completable tasks to match by name", (String)null);
