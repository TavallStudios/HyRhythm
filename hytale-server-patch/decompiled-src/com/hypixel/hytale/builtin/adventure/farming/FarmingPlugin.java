...
public class FarmingPlugin extends JavaPlugin {
   ...
   protected void setup() {
      ...
      assetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(GrowthModifierAsset.class, new DefaultAssetMap()).setPath("Farming/Modifiers")).setCodec(GrowthModifierAsset.CODEC)).loadsAfter(new Class[]{Weather.class})).setKeyFunction(GrowthModifierAsset::getId)).build());
      assetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(FarmingCoopAsset.class, new DefaultAssetMap()).setPath("Farming/Coops")).setCodec(FarmingCoopAsset.CODEC)).loadsAfter(new Class[]{ItemDropList.class, NPCGroup.class})).setKeyFunction(FarmingCoopAsset::getId)).build());
      ...
      chunkStoreRegistry.registerSystem(new FarmingSystems.Ticking(blockSectionComponentType, chunkSectionComponentType, this.farmingBlockComponentType, this.tiledSoilBlockComponentType, this.coopBlockStateComponentType));
