...
public class FarmingBlockState implements Component<ChunkStore> {
   ...
   public String toString() {
      ...
      return "FarmingBlockState{loaded=" + var10000 + ", baseCrop=" + this.baseCrop + ", stageStart=" + String.valueOf(this.stageStart) + ", currentFarmingStageSetName='" + this.currentFarmingStageSetName + "', currentFarmingStageIndex=" + this.currentFarmingStageIndex + ", stageCompletionTimes=" + Arrays.toString(this.stageCompletionTimes) + ", stageSetAfterHarvest='" + this.stageSetAfterHarvest + "', lastGrowthMultiplier=" + this.lastGrowthMultiplier + "} " + super.toString();
   }
