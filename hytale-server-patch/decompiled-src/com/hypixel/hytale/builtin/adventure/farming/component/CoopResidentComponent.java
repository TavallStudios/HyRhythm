...
public class CoopResidentComponent implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CoopResidentComponent.class, CoopResidentComponent::new).append(new KeyedCodec("CoopLocation", Vector3i.CODEC), (comp, ref) -> comp.coopLocation = ref, (comp) -> comp.coopLocation).add()).append(new KeyedCodec("MarkedForDespawn", BuilderCodec.BOOLEAN), (comp, markedForDespawn) -> comp.markedForDespawn = markedForDespawn, (comp) -> comp.markedForDespawn).add()).build();
   }
}
