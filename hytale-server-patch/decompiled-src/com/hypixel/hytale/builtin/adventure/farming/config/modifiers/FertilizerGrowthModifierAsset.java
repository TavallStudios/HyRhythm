...
public class FertilizerGrowthModifierAsset extends GrowthModifierAsset {
      ...
      if (chunkRef != null && chunkRef.isValid()) {
         ...
         if (blockComponentChunk == null) {
            ...
            if (blockBelowRef != null && blockBelowRef.isValid()) {
               TilledSoilBlock belowTilledSoilComponent = (TilledSoilBlock)commandBuffer.getComponent(blockBelowRef, TilledSoilBlock.getComponentType());
               return belowTilledSoilComponent != null && belowTilledSoilComponent.isFertilized() ? super.getCurrentGrowthMultiplier(commandBuffer, sectionRef, blockRef, x, y, z, initialTick) : 1.0;
            } else {
               return 1.0;
            }
         }
   ...
   static {
      CODEC = BuilderCodec.builder(FertilizerGrowthModifierAsset.class, FertilizerGrowthModifierAsset::new, ABSTRACT_CODEC).build();
   }
}
