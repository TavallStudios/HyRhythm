...
public abstract class SpreadGrowthBehaviour {
   @Nonnull
   public static final CodecMapCodec<SpreadGrowthBehaviour> CODEC = new CodecMapCodec<SpreadGrowthBehaviour>("Type");
   @Nonnull
