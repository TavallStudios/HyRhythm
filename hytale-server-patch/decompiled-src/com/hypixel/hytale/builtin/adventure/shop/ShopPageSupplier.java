...
public class ShopPageSupplier implements OpenCustomUIInteraction.CustomPageSupplier {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ShopPageSupplier.class, ShopPageSupplier::new).appendInherited(new KeyedCodec("ShopId", Codec.STRING), (data, o) -> data.shopId = o, (data) -> data.shopId, (data, parent) -> data.shopId = parent.shopId).add()).build();
   }
}
