...
public class ShopPlugin extends JavaPlugin {
   ...
   protected void setup() {
      ...
      assetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(ShopAsset.class, new DefaultAssetMap()).setPath("Shops")).setCodec(ShopAsset.CODEC)).setKeyFunction(ShopAsset::getId)).loadsAfter(new Class[]{Item.class})).build());
      assetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(BarterShopAsset.class, new DefaultAssetMap()).setPath("BarterShops")).setCodec(BarterShopAsset.CODEC)).setKeyFunction(BarterShopAsset::getId)).loadsAfter(new Class[]{Item.class})).build());
