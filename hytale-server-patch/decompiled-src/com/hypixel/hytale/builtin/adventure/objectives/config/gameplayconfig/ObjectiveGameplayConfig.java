...
public class ObjectiveGameplayConfig {
   ...
   public static ObjectiveGameplayConfig get(@Nonnull GameplayConfig config) {
      return (ObjectiveGameplayConfig)config.getPluginConfig().get(ObjectiveGameplayConfig.class);
   }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ObjectiveGameplayConfig.class, ObjectiveGameplayConfig::new).appendInherited(new KeyedCodec("StarterObjectiveLinePerWorld", new MapCodec(Codec.STRING, Object2ObjectOpenHashMap::new, true)), (o, s) -> o.starterObjectiveLinePerWorld = s, (o) -> o.starterObjectiveLinePerWorld, (o, parent) -> o.starterObjectiveLinePerWorld = parent.starterObjectiveLinePerWorld).addValidator(ObjectiveLineAsset.VALIDATOR_CACHE.getMapValueValidator()).add()).build();
   }
}
