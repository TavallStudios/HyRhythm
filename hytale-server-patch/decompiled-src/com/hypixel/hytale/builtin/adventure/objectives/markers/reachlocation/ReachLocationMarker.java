...
public class ReachLocationMarker implements Component<EntityStore> {
   ...
   public String getLocationName() {
      ReachLocationMarkerAsset asset = (ReachLocationMarkerAsset)ReachLocationMarkerAsset.getAssetMap().getAsset(this.markerId);
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ReachLocationMarker.class, ReachLocationMarker::new).append(new KeyedCodec("MarkerId", Codec.STRING), (reachLocationMarkerEntity, uuid) -> reachLocationMarkerEntity.markerId = uuid, (reachLocationMarkerEntity) -> reachLocationMarkerEntity.markerId).addValidator(Validators.nonNull()).add()).build();
   }
}
