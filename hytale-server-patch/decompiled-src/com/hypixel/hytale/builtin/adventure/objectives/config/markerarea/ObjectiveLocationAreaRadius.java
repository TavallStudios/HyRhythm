...
public class ObjectiveLocationAreaRadius extends ObjectiveLocationMarkerArea {
   ...
   public boolean hasPlayerInExitArea(@Nonnull SpatialResource<Ref<EntityStore>, EntityStore> spatialComponent, @Nonnull ComponentType<EntityStore, PlayerRef> playerRefComponentType, @Nonnull Vector3d markerPosition, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
      ...
      if (reference == null) {
         ...
         return VectorSphereUtil.isInside(markerPosition.x, markerPosition.y, markerPosition.z, (double)this.exitArea, (double)this.exitArea, (double)this.exitArea, transformComponent.getPosition());
      }
   }
   ...
   protected void computeAreaBoxes() {
      this.entryAreaBox = new Box((double)(-this.entryArea), (double)(-this.entryArea), (double)(-this.entryArea), (double)this.entryArea, (double)this.entryArea, (double)this.entryArea);
      this.exitAreaBox = new Box((double)(-this.exitArea), (double)(-this.exitArea), (double)(-this.exitArea), (double)this.exitArea, (double)this.exitArea, (double)this.exitArea);
   }
   ...
   static {
      ...
      })).afterDecode(ObjectiveLocationAreaRadius::computeAreaBoxes)).build();
   }
}
