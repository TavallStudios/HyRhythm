...
public abstract class ObjectiveTypeSetup {
   @Nonnull
   public static final CodecMapCodec<ObjectiveTypeSetup> CODEC = new CodecMapCodec<ObjectiveTypeSetup>("Type");
   ...
   static {
      CODEC.register((String)"Objective", SetupObjective.class, SetupObjective.CODEC);
      CODEC.register((String)"ObjectiveLine", SetupObjectiveLine.class, SetupObjectiveLine.CODEC);
   }
}
