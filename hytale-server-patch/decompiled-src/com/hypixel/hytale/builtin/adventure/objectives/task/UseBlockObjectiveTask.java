...
public class UseBlockObjectiveTask extends CountObjectiveTask {
   ...
   protected TransactionRecord[] setup0(@Nonnull Objective objective, @Nonnull World world, @Nonnull Store<EntityStore> store) {
      this.eventRegistry.register((Class)LivingEntityUseBlockEvent.class, world.getName(), (event) -> {
   ...
   static {
      CODEC = BuilderCodec.builder(UseBlockObjectiveTask.class, UseBlockObjectiveTask::new, CountObjectiveTask.CODEC).build();
   }
}
