...
public class CraftObjectiveTaskAsset extends CountObjectiveTaskAsset {
   ...
   public String toString() {
      ...
      return "CraftObjectiveTaskAsset{itemId='" + var10000 + "'} " + super.toString();
   }

   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(CraftObjectiveTaskAsset.class, CraftObjectiveTaskAsset::new, CountObjectiveTaskAsset.CODEC).append(new KeyedCodec("ItemId", Codec.STRING), (objective, entityType) -> objective.itemId = entityType, (objective) -> objective.itemId).addValidator(Validators.nonNull()).addValidator(Item.VALIDATOR_CACHE.getValidator()).add()).build();
   }
}
