...
public abstract class TaskConditionAsset {
   @Nonnull
   public static final CodecMapCodec<TaskConditionAsset> CODEC = new CodecMapCodec<TaskConditionAsset>("Type");
   ...
   static {
      CODEC.register((String)"SoloInventory", SoloInventoryCondition.class, SoloInventoryCondition.CODEC);
   }
}
