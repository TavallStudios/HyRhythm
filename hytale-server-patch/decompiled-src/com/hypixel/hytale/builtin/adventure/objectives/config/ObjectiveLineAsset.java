...
public class ObjectiveLineAsset implements JsonAssetWithMap<String, DefaultAssetMap<String, ObjectiveLineAsset>> {
   ...
   public static AssetStore<String, ObjectiveLineAsset, DefaultAssetMap<String, ObjectiveLineAsset>> getAssetStore() {
      if (ASSET_STORE == null) {
         ASSET_STORE = AssetRegistry.<String, ObjectiveLineAsset, DefaultAssetMap<String, ObjectiveLineAsset>>getAssetStore(ObjectiveLineAsset.class);
      }
   ...
   static {
      ...
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(ObjectiveLineAsset::getAssetStore));
   }
}
