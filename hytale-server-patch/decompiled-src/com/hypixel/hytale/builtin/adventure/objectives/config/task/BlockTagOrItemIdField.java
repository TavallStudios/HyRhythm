...
public class BlockTagOrItemIdField {
   ...
   protected int blockTagIndex = -2147483648;
   ...
   public boolean isBlockTypeIncluded(String blockTypeToCheck) {
      if (this.blockTagIndex != -2147483648) {
   ...
   public void consumeItemStacks(@Nonnull ItemContainer container, int quantity) {
      ...
      } else if (this.blockTagIndex != -2147483648) {
   ...
   public boolean equals(@Nullable Object o) {
      if (this == o) {
         ...
         if (this.blockTag != null) {
            if (!this.blockTag.equals(that.blockTag)) {
               return false;
            }
         } else if (that.blockTag != null) {
            return false;
         }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(BlockTagOrItemIdField.class, BlockTagOrItemIdField::new).append(new KeyedCodec("BlockTag", Codec.STRING), (blockTagOrItemIdField, s) -> blockTagOrItemIdField.blockTag = s, (blockTagOrItemIdField) -> blockTagOrItemIdField.blockTag).add()).append(new KeyedCodec("ItemId", Codec.STRING), (blockTagOrItemIdField, blockTypeKey) -> blockTagOrItemIdField.itemId = blockTypeKey, (blockTagOrItemIdField) -> blockTagOrItemIdField.itemId).addValidator(Item.VALIDATOR_CACHE.getValidator()).add()).validator((task, validationResults) -> {
