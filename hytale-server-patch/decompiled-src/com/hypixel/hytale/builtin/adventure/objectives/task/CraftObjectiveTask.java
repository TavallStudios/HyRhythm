...
public class CraftObjectiveTask extends CountObjectiveTask {
   ...
   protected TransactionRecord[] setup0(@Nonnull Objective objective, @Nonnull World world, @Nonnull Store<EntityStore> store) {
      this.eventRegistry.register((Class)PlayerCraftEvent.class, world.getName(), (event) -> {
   ...
   static {
      CODEC = BuilderCodec.builder(CraftObjectiveTask.class, CraftObjectiveTask::new, CountObjectiveTask.CODEC).build();
   }
}
