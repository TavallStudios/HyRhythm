...
public class HourRangeTriggerCondition extends ObjectiveLocationTriggerCondition {
   ...
   public boolean isConditionMet(@Nonnull ComponentAccessor<EntityStore> componentAccessor, Ref<EntityStore> ref, ObjectiveLocationMarker objectiveLocationMarker) {
      int currentHour = ((WorldTimeResource)componentAccessor.getResource(WORLD_TIME_RESOURCE_RESOURCE_TYPE)).getCurrentHour();
   ...
   public String toString() {
      int var10000 = this.minHour;
      return "HourRangeTriggerCondition{minHour=" + var10000 + ", maxHour=" + this.maxHour + "} " + super.toString();
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(HourRangeTriggerCondition.class, HourRangeTriggerCondition::new).append(new KeyedCodec("MinHour", Codec.INTEGER), (hourRangeTriggerCondition, integer) -> hourRangeTriggerCondition.minHour = integer, (hourRangeTriggerCondition) -> hourRangeTriggerCondition.minHour).add()).append(new KeyedCodec("MaxHour", Codec.INTEGER), (hourRangeTriggerCondition, integer) -> hourRangeTriggerCondition.maxHour = integer, (hourRangeTriggerCondition) -> hourRangeTriggerCondition.maxHour).add()).build();
