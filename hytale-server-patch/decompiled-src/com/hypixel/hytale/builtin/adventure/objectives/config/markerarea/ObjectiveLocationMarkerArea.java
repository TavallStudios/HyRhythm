...
public abstract class ObjectiveLocationMarkerArea {
   @Nonnull
   public static final CodecMapCodec<ObjectiveLocationMarkerArea> CODEC = new CodecMapCodec<ObjectiveLocationMarkerArea>("Type");
   ...
   public String toString() {
      String var10000 = String.valueOf(this.entryAreaBox);
      return "ObjectiveLocationMarkerArea{, entryAreaBox=" + var10000 + ", exitAreaBox=" + String.valueOf(this.exitAreaBox) + "}";
   }

   static {
      CODEC.register((String)"Box", ObjectiveLocationAreaBox.class, ObjectiveLocationAreaBox.CODEC);
      CODEC.register((String)"Radius", ObjectiveLocationAreaRadius.class, ObjectiveLocationAreaRadius.CODEC);
   }
}
