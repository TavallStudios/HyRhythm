...
public class ReputationRank implements JsonAssetWithMap<String, DefaultAssetMap<String, ReputationRank>> {
   ...
   public static AssetStore<String, ReputationRank, DefaultAssetMap<String, ReputationRank>> getAssetStore() {
      if (ASSET_STORE == null) {
         ASSET_STORE = AssetRegistry.<String, ReputationRank, DefaultAssetMap<String, ReputationRank>>getAssetStore(ReputationRank.class);
      }
   ...
   public String toString() {
      ...
      return "ReputationRank{id='" + var10000 + "', minValue=" + this.minValue + ", maxValue=" + this.maxValue + ", attitude=" + String.valueOf(this.attitude) + "}";
   }
   ...
   static {
      ...
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(ReputationRank::getAssetStore));
   }
}
