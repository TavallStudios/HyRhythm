...
public class ReputationSetCommand extends AbstractTargetPlayerCommand {
   ...
   public ReputationSetCommand() {
      ...
      this.reputationGroupIdArg = this.withRequiredArg("reputationGroupId", "server.commands.reputation.set.reputationGroupId.desc", REPUTATION_GROUP_ARG_TYPE);
      this.valueArg = this.withRequiredArg("value", "server.commands.reputation.set.value.desc", ArgTypes.INTEGER);
   }
