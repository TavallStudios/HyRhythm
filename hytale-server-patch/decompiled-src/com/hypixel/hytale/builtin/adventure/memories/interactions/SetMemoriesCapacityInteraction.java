...
public class SetMemoriesCapacityInteraction extends SimpleInstantInteraction {
   ...
   protected void firstRun(@Nonnull InteractionType type, @Nonnull InteractionContext context, @Nonnull CooldownHandler cooldownHandler) {
      ...
      PlayerMemories memoriesComponent = (PlayerMemories)commandBuffer.ensureAndGetComponent(ref, PlayerMemories.getComponentType());
      if (this.capacity <= memoriesComponent.getMemoriesCapacity()) {
         ...
         if (previousCapacity <= 0) {
            ...
            if (playerRefComponent != null) {
               ...
               NotificationUtil.sendNotification(playerConnection, MESSAGE_SERVER_MEMORIES_GENERAL_FEATURE_UNLOCKED_NOTIFICATION, (Message)null, (String)"NotificationIcons/MemoriesIcon.png");
