...
public class MemoriesConditionInteraction extends Interaction {
   ...
   protected void configurePacket(@Nonnull com.hypixel.hytale.protocol.Interaction packet) {
      ...
      while(var3.hasNext()) {
         Int2ObjectMap.Entry<String> e = (Int2ObjectMap.Entry)var3.next();
   ...
   public boolean walk(@Nonnull Collector collector, @Nonnull InteractionContext context) {
      ...
      while(var3.hasNext()) {
         Int2ObjectMap.Entry<String> entry = (Int2ObjectMap.Entry)var3.next();
         if (InteractionManager.walkInteraction(collector, context, new MemoriesTag(entry.getIntKey()), (String)entry.getValue())) {
            return true;
         }
      }
   ...
   private static record MemoriesTag(int memoryLevel) implements CollectorTag {
   }
}
