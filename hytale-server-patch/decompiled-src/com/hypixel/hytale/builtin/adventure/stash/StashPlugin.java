   ...
   public static ListTransaction<ItemStackTransaction> stash(@Nonnull ItemContainerState containerState, boolean clearDropList) {
      ...
      if (droplist == null) {
         ...
         if (stacks.isEmpty()) {
            ...
            long positionHash = (long)blockPosition.hashCode();
            ...
            for(int idx = 0; idx < stacks.size() && idx < slots.size(); ++idx) {
               ...
               ItemStackSlotTransaction transaction = itemContainer.addItemStackToSlot(slot, (ItemStack)stacks.get(idx));
            ...
            if (clearDropList && anySucceeded) {
               containerState.setDroplist((String)null);
            }
   ...
   private static class StashSystem extends RefSystem<ChunkStore> {
      ...
      public void onEntityAdded(@Nonnull Ref<ChunkStore> ref, @Nonnull AddReason reason, @Nonnull Store<ChunkStore> store, @Nonnull CommandBuffer<ChunkStore> commandBuffer) {
         ...
         if (world.getWorldConfig().getGameMode() != GameMode.Creative) {
            ItemContainerState itemContainerStateComponent = (ItemContainerState)store.getComponent(ref, this.itemContainerStateComponentType);
