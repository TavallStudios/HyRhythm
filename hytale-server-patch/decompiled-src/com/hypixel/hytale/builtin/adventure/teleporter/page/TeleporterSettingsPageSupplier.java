...
public class TeleporterSettingsPageSupplier implements OpenCustomUIInteraction.CustomPageSupplier {
   ...
   public CustomUIPage tryCreate(@Nonnull Ref<EntityStore> ref, @Nonnull ComponentAccessor<EntityStore> componentAccessor, @Nonnull PlayerRef playerRef, @Nonnull InteractionContext context) {
      ...
      if (targetBlock == null) {
         ...
         BlockComponentChunk blockComponentChunk = chunkRef != null && chunkRef.isValid() ? (BlockComponentChunk)chunkComponentStore.getComponent(chunkRef, BlockComponentChunk.getComponentType()) : null;
