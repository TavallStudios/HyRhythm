...
public class TeleporterInteraction extends SimpleBlockInteraction {
   ...
   private boolean interact(@Nonnull World world, @Nonnull CommandBuffer<EntityStore> commandBuffer, @Nonnull InteractionContext context, @Nonnull Vector3i targetBlock) {
                                    ...
                                    if (transformComponent == null) {
                                       ...
                                       if (teleportComponent == null) {
                                          ...
                                          if (this.particle != null) {
                                             ...
                                             ParticleUtil.spawnParticleEffect((String)this.particle, particlePosition, results, commandBuffer);
                                          }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(TeleporterInteraction.class, TeleporterInteraction::new, SimpleBlockInteraction.CODEC).appendInherited(new KeyedCodec("Particle", Codec.STRING), (interaction, s) -> interaction.particle = s, (interaction) -> interaction.particle, (interaction, parent) -> interaction.particle = parent.particle).documentation("The particle to play on the entity when teleporting.").add()).appendInherited(new KeyedCodec("ClearOutXZ", Codec.DOUBLE), (interaction, s) -> interaction.clearoutXZ = s, (interaction) -> interaction.clearoutXZ, (interaction, parent) -> interaction.clearoutXZ = parent.clearoutXZ).addValidator(Validators.greaterThanOrEqual(0.0)).documentation("Upon reaching the warp destination, how far away one has to move on the XZ plane in order to use another Teleporter.").add()).appendInherited(new KeyedCodec("ClearOutY", Codec.DOUBLE), (interaction, s) -> interaction.clearoutY = s, (interaction) -> interaction.clearoutY, (interaction, parent) -> interaction.clearoutY = parent.clearoutY).addValidator(Validators.greaterThanOrEqual(0.0)).documentation("Upon reaching the warp destination, how far away one has to move along the Y axis in order to use another Teleporter.").add()).build();
   }
}
