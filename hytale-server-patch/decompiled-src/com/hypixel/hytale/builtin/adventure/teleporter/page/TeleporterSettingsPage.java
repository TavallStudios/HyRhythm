...
public class TeleporterSettingsPage extends InteractiveCustomUIPage<PageEventData> {
   @Nonnull
      ...
      if (teleporter == null) {
         ...
         switch (this.mode.ordinal()) {
            case 0:
               ...
               commandBuilder.set("#WarpDropdown.Entries", getWarpsSortedById(teleporter.getOwnedWarp(), (String)null));
               ...
               break;
            case 1:
               commandBuilder.set("#WarpDropdown.Entries", getWarpsSortedById(teleporter.getOwnedWarp(), ((EntityStore)store.getExternalData()).getWorld().getName()));
               commandBuilder.set("#WarpDropdown.Value", teleporter.getWarp() != null ? teleporter.getWarp() : "");
               Message placeholder;
   ...
   public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store, @Nonnull PageEventData data) {
      ...
      if (playerComponent != null) {
         String language = this.playerRef.getLanguage();
         BlockModule.BlockStateInfo blockStateInfo = (BlockModule.BlockStateInfo)this.blockRef.getStore().getComponent(this.blockRef, BlockModule.BlockStateInfo.getComponentType());
         if (blockStateInfo == null) {
            ...
            if (!chunkRef.isValid()) {
               ...
               Teleporter teleporterComponent = (Teleporter)this.blockRef.getStore().getComponent(this.blockRef, Teleporter.getComponentType());
               if (teleporterComponent == null) {
                  ...
                  switch (this.mode.ordinal()) {
                     case 0:
                        ...
                        break;
                     case 1:
                        teleporterComponent.setWorldUuid((UUID)null);
                        teleporterComponent.setTransform((Transform)null);
                        teleporterComponent.setWarp(data.destinationWarp != null && !data.destinationWarp.isEmpty() ? data.destinationWarp : null);
                  }
   ...
   public static class PageEventData {
      ...
      static {
         CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PageEventData.class, PageEventData::new).append(new KeyedCodec("@BlockRelative", Codec.BOOLEAN), (pageEventData, o) -> pageEventData.isBlockRelative = o, (pageEventData) -> pageEventData.isBlockRelative).add()).append(new KeyedCodec("@X", Codec.DOUBLE), (pageEventData, o) -> pageEventData.x = o, (pageEventData) -> pageEventData.x).add()).append(new KeyedCodec("@Y", Codec.DOUBLE), (pageEventData, o) -> pageEventData.y = o, (pageEventData) -> pageEventData.y).add()).append(new KeyedCodec("@Z", Codec.DOUBLE), (pageEventData, o) -> pageEventData.z = o, (pageEventData) -> pageEventData.z).add()).append(new KeyedCodec("@XIsRelative", Codec.BOOLEAN), (pageEventData, o) -> pageEventData.xIsRelative = o, (pageEventData) -> pageEventData.xIsRelative).add()).append(new KeyedCodec("@YIsRelative", Codec.BOOLEAN), (pageEventData, o) -> pageEventData.yIsRelative = o, (pageEventData) -> pageEventData.yIsRelative).add()).append(new KeyedCodec("@ZIsRelative", Codec.BOOLEAN), (pageEventData, o) -> pageEventData.zIsRelative = o, (pageEventData) -> pageEventData.zIsRelative).add()).append(new KeyedCodec("@Yaw", Codec.FLOAT), (pageEventData, o) -> pageEventData.yaw = o, (pageEventData) -> pageEventData.yaw).add()).append(new KeyedCodec("@Pitch", Codec.FLOAT), (pageEventData, o) -> pageEventData.pitch = o, (pageEventData) -> pageEventData.pitch).add()).append(new KeyedCodec("@Roll", Codec.FLOAT), (pageEventData, o) -> pageEventData.roll = o, (pageEventData) -> pageEventData.roll).add()).append(new KeyedCodec("@YawIsRelative", Codec.BOOLEAN), (pageEventData, o) -> pageEventData.yawIsRelative = o, (pageEventData) -> pageEventData.yawIsRelative).add()).append(new KeyedCodec("@PitchIsRelative", Codec.BOOLEAN), (pageEventData, o) -> pageEventData.pitchIsRelative = o, (pageEventData) -> pageEventData.pitchIsRelative).add()).append(new KeyedCodec("@RollIsRelative", Codec.BOOLEAN), (pageEventData, o) -> pageEventData.rollIsRelative = o, (pageEventData) -> pageEventData.pitchIsRelative).add()).append(new KeyedCodec("@World", Codec.STRING), (pageEventData, o) -> pageEventData.world = o, (pageEventData) -> pageEventData.world).add()).append(new KeyedCodec("@Warp", Codec.STRING), (pageEventData, o) -> pageEventData.destinationWarp = o, (pageEventData) -> pageEventData.destinationWarp).add()).append(new KeyedCodec("@NewWarp", Codec.STRING), (pageEventData, o) -> pageEventData.warpName = o, (pageEventData) -> pageEventData.warpName).add()).build();
      }
   }
   ...
   public static enum Mode {
      ...
      @Nonnull
      public static final Codec<Mode> CODEC = new EnumCodec<Mode>(Mode.class);
   }
}
