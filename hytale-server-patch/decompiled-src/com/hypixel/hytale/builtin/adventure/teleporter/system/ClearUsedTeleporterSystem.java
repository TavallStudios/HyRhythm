...
public class ClearUsedTeleporterSystem extends EntityTickingSystem<EntityStore> {
   ...
   public ClearUsedTeleporterSystem(@Nonnull ComponentType<EntityStore, UsedTeleporter> usedTeleporterComponentType, @Nonnull ComponentType<EntityStore, TransformComponent> transformComponentType, @Nonnull ComponentType<EntityStore, TeleportRecord> teleportRecordComponentType, @Nonnull ComponentType<EntityStore, Teleport> teleportComponentType, @Nonnull ComponentType<EntityStore, PendingTeleport> pendingTeleportComponentType) {
   ...
   private boolean shouldClear(@Nonnull World world, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk) {
      UsedTeleporter usedTeleporter = (UsedTeleporter)archetypeChunk.getComponent(index, this.usedTeleporterComponentType);
      ...
      TeleportRecord teleportRecord = (TeleportRecord)archetypeChunk.getComponent(index, this.teleportRecordComponentType);
