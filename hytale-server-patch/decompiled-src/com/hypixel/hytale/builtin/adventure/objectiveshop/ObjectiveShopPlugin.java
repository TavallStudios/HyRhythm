...
public class ObjectiveShopPlugin extends JavaPlugin {
   ...
   protected void setup() {
      instance = this;
      ChoiceInteraction.CODEC.register((String)"StartObjective", StartObjectiveInteraction.class, StartObjectiveInteraction.CODEC);
      ChoiceRequirement.CODEC.register((String)"CanStartObjective", CanStartObjectiveRequirement.class, CanStartObjectiveRequirement.CODEC);
