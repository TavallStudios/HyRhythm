...
public class CameraShake implements NetworkSerializable<com.hypixel.hytale.protocol.CameraShake>, JsonAssetWithMap<String, IndexedAssetMap<String, CameraShake>> {
   ...
   public static AssetStore<String, CameraShake, IndexedAssetMap<String, CameraShake>> getAssetStore() {
      if (ASSET_STORE == null) {
         ASSET_STORE = AssetRegistry.<String, CameraShake, IndexedAssetMap<String, CameraShake>>getAssetStore(CameraShake.class);
      }
   ...
   public String toString() {
      ...
      return "CameraShake{id='" + var10000 + "', data=" + String.valueOf(this.data) + ", firstPerson=" + String.valueOf(this.firstPerson) + ", thirdPerson=" + String.valueOf(this.thirdPerson) + "}";
   }

   static {
      CODEC = ((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(CameraShake.class, CameraShake::new, Codec.STRING, (o, v) -> o.id = v, CameraShake::getId, (o, data) -> o.data = data, (o) -> o.data).appendInherited(new KeyedCodec("FirstPerson", CameraShakeConfig.CODEC), (o, v) -> o.firstPerson = v, (o) -> o.firstPerson, (o, p) -> o.firstPerson = p.firstPerson).documentation("The camera shake to apply to the first-person camera").addValidator(Validators.nonNull()).add()).appendInherited(new KeyedCodec("ThirdPerson", CameraShakeConfig.CODEC), (o, v) -> o.thirdPerson = v, (o) -> o.thirdPerson, (o, p) -> o.thirdPerson = p.thirdPerson).documentation("The camera shake to apply to the third-person camera").addValidator(Validators.nonNull()).add()).build();
      CHILD_ASSET_CODEC = new ContainedAssetCodec(CameraShake.class, CODEC);
      VALIDATOR_CACHE = new ValidatorCache<String>(new AssetKeyValidator(CameraShake::getAssetStore));
   }
}
