...
public class ViewBobbing implements NetworkSerializable<com.hypixel.hytale.protocol.ViewBobbing>, JsonAssetWithMap<MovementType, AssetMap<MovementType, ViewBobbing>> {
   ...
   public String toString() {
      ...
      return "ViewBobbing{id=" + var10000 + ", data=" + String.valueOf(this.data) + ", firstPerson=" + String.valueOf(this.firstPerson) + "}";
   }

   static {
      CODEC = ((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(ViewBobbing.class, ViewBobbing::new, MOVEMENT_TYPE_CODEC, (o, v) -> o.id = v, ViewBobbing::getId, (o, data) -> o.data = data, (o) -> o.data).appendInherited(new KeyedCodec("FirstPerson", CameraShakeConfig.CODEC), (o, v) -> o.firstPerson = v, (o) -> o.firstPerson, (o, p) -> o.firstPerson = p.firstPerson).documentation("The camera shake profile to be applied").addValidator(Validators.nonNull()).add()).build();
   }
}
