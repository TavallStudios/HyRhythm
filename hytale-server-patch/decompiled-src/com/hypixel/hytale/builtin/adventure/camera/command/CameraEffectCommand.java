...
public class CameraEffectCommand extends AbstractCommandCollection {
   ...
   protected static class DamageCommand extends AbstractTargetPlayerCommand {
      ...
      public DamageCommand() {
         ...
         this.causeArg = this.withRequiredArg("cause", "server.commands.camshake.damage.cause.desc", DAMAGE_CAUSE_ARGUMENT_TYPE);
      ...
      protected void execute(@Nonnull CommandContext context, @Nullable Ref<EntityStore> sourceRef, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world, @Nonnull Store<EntityStore> store) {
         ...
         float damageAmount = (Float)context.get(this.damageArg);
         ...
         if (this.effectArg.provided(context)) {
            cameraEffectId = ((CameraEffect)context.get(this.effectArg)).getId();
   ...
   protected static class DebugCommand extends AbstractTargetPlayerCommand {
      ...
      protected void execute(@Nonnull CommandContext context, @Nullable Ref<EntityStore> sourceRef, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world, @Nonnull Store<EntityStore> store) {
         ...
         float intensity = (Float)context.get(this.intensityArg);
