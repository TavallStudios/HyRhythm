...
public class CreativeHubEntityConfig implements Component<EntityStore> {
   ...
   public static CreativeHubEntityConfig ensureAndGet(@Nonnull Holder<EntityStore> holder) {
      ...
      return (CreativeHubEntityConfig)holder.ensureAndGetComponent(type);
   }

   @Nullable
   public static CreativeHubEntityConfig get(@Nonnull Holder<EntityStore> holder) {
      ComponentType<EntityStore, CreativeHubEntityConfig> type = getComponentType();
      return (CreativeHubEntityConfig)holder.getComponent(type);
   }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(CreativeHubEntityConfig.class, CreativeHubEntityConfig::new).appendInherited(new KeyedCodec("ParentHubWorldUuid", Codec.UUID_STRING), (o, i) -> o.parentHubWorldUuid = i, (o) -> o.parentHubWorldUuid, (o, p) -> o.parentHubWorldUuid = p.parentHubWorldUuid).add()).build();
   }
}
