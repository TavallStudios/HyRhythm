...
public class BasicChanceBlockGrowthProcedure extends TickProcedure {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(BasicChanceBlockGrowthProcedure.class, BasicChanceBlockGrowthProcedure::new, TickProcedure.BASE_CODEC).addField(new KeyedCodec("NextId", Codec.STRING), (proc, v) -> proc.to = v, (proc) -> proc.to)).addField(new KeyedCodec("ChanceMin", Codec.INTEGER), (proc, v) -> proc.chanceMin = v, (proc) -> proc.chanceMin)).addField(new KeyedCodec("Chance", Codec.INTEGER), (proc, v) -> proc.chance = v, (proc) -> proc.chance)).addField(new KeyedCodec("NextTicking", Codec.BOOLEAN), (proc, v) -> proc.nextTicking = v, (proc) -> proc.nextTicking)).build();
   }
}
