...
public class MergeWaitingBlocksSystem extends RefSystem<ChunkStore> {
   ...
   public void onEntityAdded(@Nonnull Ref<ChunkStore> ref, @Nonnull AddReason reason, @Nonnull Store<ChunkStore> store, @Nonnull CommandBuffer<ChunkStore> commandBuffer) {
      ...
      WorldChunk worldChunkComponent = (WorldChunk)store.getComponent(ref, COMPONENT_TYPE);
   ...
   public static void mergeTickingBlocks(@Nonnull ChunkStore store, int x, int z) {
      ...
      BlockChunk blockChunkComponent = (BlockChunk)store.getChunkComponent(chunkIndex, BlockChunk.getComponentType());
