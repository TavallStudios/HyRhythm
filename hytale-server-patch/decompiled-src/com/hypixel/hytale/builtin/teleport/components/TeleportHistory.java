...
public class TeleportHistory implements Component<EntityStore> {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.back);
      return "TeleportHistory{back=" + var10000 + ", forward=" + String.valueOf(this.forward) + "}";
   }
   ...
   public static class Waypoint {
      ...
      public String toString() {
         ...
         return "Waypoint{world='" + var10000 + "', position=" + String.valueOf(this.position) + ", rotation=" + String.valueOf(this.rotation) + ", message='" + this.message + "'}";
      }
   }
}
