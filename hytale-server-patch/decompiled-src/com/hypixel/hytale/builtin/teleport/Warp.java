...
public class Warp {
   ...
   public String toString() {
      ...
      return "Warp{id='" + var10000 + "', transform=" + String.valueOf(this.transform) + ", creator='" + this.creator + "', creationDate=" + String.valueOf(this.creationDate) + "}";
   }
   ...
   static {
      CODEC = new BsonFunctionCodec<Warp>(((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(Warp.class, Warp::new).addField(new KeyedCodec("Id", Codec.STRING), (warp, s) -> warp.id = s, (warp) -> warp.id)).addField(new KeyedCodec("World", Codec.STRING), (warp, s) -> warp.world = s, (warp) -> warp.world)).addField(new KeyedCodec("Creator", Codec.STRING), (warp, s) -> warp.creator = s, (warp) -> warp.creator)).append(new KeyedCodec("Date", Codec.LONG), (warp, s) -> warp.creationDate = Instant.ofEpochMilli(s), (warp) -> null).addValidator(Validators.deprecated()).add()).append(new KeyedCodec("CreationDate", Codec.INSTANT), (o, i) -> o.creationDate = i, (o) -> o.creationDate).add()).build(), (warp, bsonValue) -> {
      ...
      ARRAY_CODEC = new ArrayCodec<Warp>(CODEC, (x$0) -> new Warp[x$0]);
   }
}
