...
public class SpawnSetCommand extends AbstractWorldCommand {
   ...
   public SpawnSetCommand() {
      ...
      this.positionArg = this.withOptionalArg("position", "server.commands.spawn.set.position.desc", ArgTypes.RELATIVE_POSITION);
      this.rotationArg = this.withDefaultArg("rotation", "server.commands.spawn.set.rotation.desc", ArgTypes.ROTATION, Vector3f.FORWARD, "server.commands.spawn.set.rotation.default.desc");
   }
