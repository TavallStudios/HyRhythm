      ...
      if (!TeleportPlugin.get().isWarpsLoaded()) {
         ...
         if (context.isPlayer() && !this.pageArg.provided(context)) {
            ...
            if (ref != null && ref.isValid()) {
               ...
               World playerWorld = ((EntityStore)store.getExternalData()).getWorld();
               playerWorld.execute(() -> {
            ...
            int pageNumber = this.pageArg.provided(context) ? (Integer)this.pageArg.get(context) : 1;
            if (pageNumber < 1) {
               ...
               if (paginated.size() < pageNumber) {
                  ...
                  List<Warp> page = (List)paginated.get(pageNumber - 1);
                  int i = 1;
