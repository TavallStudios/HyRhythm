      ...
      for(int i = 0; i < propertyPath.length - 1; ++i) {
         ...
         if (current instanceof BsonDocument) {
            ...
            if (!(current instanceof BsonArray) || !StringUtil.isNumericString(propertyPath[i])) {
               String var10002 = String.join(".", propertyPath);
               throw new IllegalArgumentException("Element is not Object or (Array or invalid index)! " + var10002 + ", " + propertyPath[i] + ", " + String.valueOf(current));
            }
