...
public class AssetEditorFetchAutoCompleteDataEvent implements IAsyncEvent<String> {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.editorClient);
      return "AssetEditorFetchAutoCompleteDataEvent{editorClient=" + var10000 + ", dataSet='" + this.dataSet + "', query='" + this.query + "', results=" + Arrays.toString(this.results) + "}";
   }
}
