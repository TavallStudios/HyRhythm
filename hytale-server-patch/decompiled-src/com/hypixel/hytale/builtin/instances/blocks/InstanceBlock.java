...
public class InstanceBlock implements Component<ChunkStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(InstanceBlock.class, InstanceBlock::new).appendInherited(new KeyedCodec("WorldName", Codec.UUID_BINARY), (o, i) -> o.worldUUID = i, (o) -> o.worldUUID, (o, p) -> o.worldUUID = p.worldUUID).add()).appendInherited(new KeyedCodec("CloseOnBlockRemove", Codec.BOOLEAN), (o, i) -> o.closeOnRemove = i, (o) -> o.closeOnRemove, (o, p) -> o.closeOnRemove = p.closeOnRemove).add()).build();
   }
   ...
   public static class OnRemove extends RefSystem<ChunkStore> {
      ...
      public void onEntityRemove(@Nonnull Ref<ChunkStore> ref, @Nonnull RemoveReason reason, @Nonnull Store<ChunkStore> store, @Nonnull CommandBuffer<ChunkStore> commandBuffer) {
         InstanceBlock instance = (InstanceBlock)commandBuffer.getComponent(ref, InstanceBlock.getComponentType());
