...
public class ConfigureInstanceBlockPage extends InteractiveCustomUIPage<PageData> {
   ...
   public ConfigureInstanceBlockPage(@Nonnull PlayerRef playerRef, @Nonnull Ref<ChunkStore> ref) {
      ...
      this.instanceBlock = (ConfigurableInstanceBlock)ref.getStore().getComponent(ref, ConfigurableInstanceBlock.getComponentType());
      this.ref = ref;
   ...
   public void build(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder commandBuilder, @Nonnull UIEventBuilder eventBuilder, @Nonnull Store<EntityStore> store) {
      ...
      eventBuilder.addEventBinding(CustomUIEventBindingType.ValueChanged, "#PositionOffset #Use #CheckBox", (new EventData()).append("Action", ConfigureInstanceBlockPage.Action.PositionOffset.name()).append("@PositionOffset", "#PositionOffset #Use #CheckBox.Value"), false);
      this.buildRotation(commandBuilder);
      eventBuilder.addEventBinding(CustomUIEventBindingType.ValueChanged, "#Rotation #Use #CheckBox", (new EventData()).append("Action", ConfigureInstanceBlockPage.Action.Rotation.name()).append("@Rotation", "#Rotation #Use #CheckBox.Value"), false);
      ...
      eventBuilder.addEventBinding(CustomUIEventBindingType.Activating, "#SaveButton", (new EventData()).append("Action", ConfigureInstanceBlockPage.Action.Save.name()).append("@Instance", "#Instance #Input.Value").append("@InstanceKey", "#InstanceKey #Input.Value").append("@PositionOffset", "#PositionOffset #Use #CheckBox.Value").append("@PositionOffsetX", "#PositionOffset #X #Input.Value").append("@PositionOffsetY", "#PositionOffset #Y #Input.Value").append("@PositionOffsetZ", "#PositionOffset #Z #Input.Value").append("@Rotation", "#Rotation #Use #CheckBox.Value").append("@RotationPitch", "#Rotation #Pitch #Input.Value").append("@RotationYaw", "#Rotation #Yaw #Input.Value").append("@RotationRoll", "#Rotation #Roll #Input.Value").append("@PersonalReturnPoint", "#PersonalReturnPoint #CheckBox.Value").append("@CloseOnBlockRemove", "#CloseOnBlockRemove #CheckBox.Value").append("@RemoveBlockAfter", "#RemoveBlockAfter #Input.Value"));
   }

   public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store, @Nonnull PageData data) {
      Player playerComponent = (Player)store.getComponent(ref, Player.getComponentType());
      BlockModule.BlockStateInfo info = (BlockModule.BlockStateInfo)this.ref.getStore().getComponent(this.ref, BlockModule.BlockStateInfo.getComponentType());
      BlockComponentChunk blockComponentChunk = (BlockComponentChunk)this.ref.getStore().getComponent(info.getChunkRef(), BlockComponentChunk.getComponentType());
      ...
      switch (data.action.ordinal()) {
         case 0:
            ...
            if (data.positionOffset) {
               ...
               this.instanceBlock.setPositionOffset((Vector3d)null);
            }
            ...
            if (data.rotation) {
               ...
               this.instanceBlock.setRotation((Vector3f)null);
            }
   ...
   public static class PageData {
      ...
      static {
         CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PageData.class, PageData::new).addField(new KeyedCodec("Action", new EnumCodec(Action.class)), (o, i) -> o.action = i, (o) -> o.action)).addField(new KeyedCodec("@Instance", Codec.STRING), (o, i) -> o.instance = i, (o) -> o.instance)).addField(new KeyedCodec("@InstanceKey", Codec.STRING), (o, i) -> o.instanceKey = i, (o) -> o.instanceKey)).addField(new KeyedCodec("@PositionOffset", Codec.BOOLEAN), (o, i) -> o.positionOffset = i, (o) -> o.positionOffset)).addField(new KeyedCodec("@PositionOffsetX", Codec.DOUBLE), (o, i) -> o.positionX = i, (o) -> o.positionX)).addField(new KeyedCodec("@PositionOffsetY", Codec.DOUBLE), (o, i) -> o.positionY = i, (o) -> o.positionY)).addField(new KeyedCodec("@PositionOffsetZ", Codec.DOUBLE), (o, i) -> o.positionZ = i, (o) -> o.positionZ)).addField(new KeyedCodec("@Rotation", Codec.BOOLEAN), (o, i) -> o.rotation = i, (o) -> o.rotation)).addField(new KeyedCodec("@RotationPitch", Codec.FLOAT), (o, i) -> o.rotationPitch = i, (o) -> o.rotationPitch)).addField(new KeyedCodec("@RotationYaw", Codec.FLOAT), (o, i) -> o.rotationYaw = i, (o) -> o.rotationYaw)).addField(new KeyedCodec("@RotationRoll", Codec.FLOAT), (o, i) -> o.rotationRoll = i, (o) -> o.rotationRoll)).addField(new KeyedCodec("@PersonalReturnPoint", Codec.BOOLEAN), (o, i) -> o.personalReturnPoint = i, (o) -> o.personalReturnPoint)).addField(new KeyedCodec("@CloseOnBlockRemove", Codec.BOOLEAN), (o, i) -> o.closeOnBlockRemove = i, (o) -> o.closeOnBlockRemove)).addField(new KeyedCodec("@RemoveBlockAfter", Codec.DOUBLE), (o, i) -> o.removeBlockAfter = i, (o) -> o.removeBlockAfter)).build();
      }
   }
