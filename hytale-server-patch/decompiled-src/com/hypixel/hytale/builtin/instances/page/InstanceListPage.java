...
public class InstanceListPage extends InteractiveCustomUIPage<PageData> {
   ...
   public static class PageData {
      ...
      static {
         CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PageData.class, PageData::new).addField(new KeyedCodec("Instance", BuilderCodec.STRING), (o, i) -> o.instance = i, (o) -> o.instance)).addField(new KeyedCodec("Action", new EnumCodec(Action.class)), (o, i) -> o.action = i, (o) -> o.action)).addField(new KeyedCodec("File", Codec.STRING), (o, s) -> o.file = s, (o) -> o.file)).addField(new KeyedCodec("@SearchQuery", Codec.STRING), (o, s) -> o.searchQuery = s, (o) -> o.searchQuery)).addField(new KeyedCodec("SearchResult", Codec.STRING), (o, s) -> o.searchResult = s, (o) -> o.searchResult)).build();
      }
   }
