...
public class InstanceEditLoadCommand extends AbstractAsyncCommand {
   ...
   public InstanceEditLoadCommand() {
      ...
      this.instanceNameArg = (RequiredArg)this.withRequiredArg("instanceName", "server.commands.instances.edit.arg.name", ArgTypes.STRING).addValidator(new InstanceValidator());
   }
