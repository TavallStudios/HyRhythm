         ...
         if (!archetype.contains(Teleport.getComponentType()) && !archetype.contains(PendingTeleport.getComponentType())) {
            ...
            if (chunkRef != null && chunkRef.isValid()) {
               ...
               if (blockRef != null && blockRef.isValid()) {
                  ConfigurableInstanceBlock configurableInstanceBlock = (ConfigurableInstanceBlock)chunkStore.getStore().getComponent(blockRef, ConfigurableInstanceBlock.getComponentType());
                        ...
                        if (removeBlockAfter >= 0.0) {
                           if (removeBlockAfter == 0.0) {
                              ...
                              if (worldChunk != null) {
                                 ...
                                 ((HytaleLogger.Api)LOGGER.atWarning()).log("Failed to remove block at %s,%s,%s as chunk is not loaded", targetBlock.x, targetBlock.y, targetBlock.z);
                              }
                           } else {
