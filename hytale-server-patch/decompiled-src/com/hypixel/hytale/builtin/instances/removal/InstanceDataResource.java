...
public class InstanceDataResource implements Resource<ChunkStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(InstanceDataResource.class, InstanceDataResource::new).append(new KeyedCodec("TimeoutTimer", Codec.INSTANT), (o, i) -> o.timeoutTimer = i, (o) -> o.timeoutTimer).add()).append(new KeyedCodec("IdleTimeoutTimer", Codec.INSTANT), (o, i) -> o.idleTimeoutTimer = i, (o) -> o.idleTimeoutTimer).add()).append(new KeyedCodec("HadPlayer", Codec.BOOLEAN), (o, i) -> o.hadPlayer = i, (o) -> o.hadPlayer).add()).append(new KeyedCodec("WorldTimeoutTimer", Codec.INSTANT), (o, i) -> o.worldTimeoutTimer = i, (o) -> o.worldTimeoutTimer).add()).build();
   }
}
