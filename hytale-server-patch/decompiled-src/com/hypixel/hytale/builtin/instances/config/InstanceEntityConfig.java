...
public class InstanceEntityConfig implements Component<EntityStore> {
   ...
   public static InstanceEntityConfig ensureAndGet(@Nonnull Holder<EntityStore> holder) {
      ...
      return (InstanceEntityConfig)holder.ensureAndGetComponent(type);
   }

   @Nullable
   public static InstanceEntityConfig removeAndGet(@Nonnull Holder<EntityStore> holder) {
      ComponentType<EntityStore, InstanceEntityConfig> type = getComponentType();
      InstanceEntityConfig component = (InstanceEntityConfig)holder.getComponent(type);
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(InstanceEntityConfig.class, InstanceEntityConfig::new).appendInherited(new KeyedCodec("ReturnPoint", WorldReturnPoint.CODEC), (o, i) -> o.returnPoint = i, (o) -> o.returnPoint, (o, p) -> o.returnPoint = p.returnPoint).add()).build();
   }
}
