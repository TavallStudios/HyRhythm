...
public class TagSetPlugin extends JavaPlugin {
   ...
   protected void setup() {
      instance = this;
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(NPCGroup.class, new IndexedLookupTableAssetMap((x$0) -> new NPCGroup[x$0])).setPath("NPC/Groups")).setCodec(NPCGroup.CODEC)).setKeyFunction(NPCGroup::getId)).setReplaceOnRemove(NPCGroup::new)).loadsBefore(new Class[]{Interaction.class})).build());
   ...
   public static <T extends TagSet> TagSetLookup get(Class<T> clazz) {
      return (TagSetLookup)Objects.requireNonNull((TagSetLookup)instance.lookups.get(clazz), "Class is not registered with the TagSet module!");
   }
