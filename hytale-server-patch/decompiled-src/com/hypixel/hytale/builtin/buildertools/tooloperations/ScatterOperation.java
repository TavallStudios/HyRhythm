...
public class ScatterOperation extends ToolOperation {
   ...
   boolean execute0(int x, int y, int z) {
      ...
      if (currentBlock <= 0 && this.builderState.isAsideBlock(this.edit.getAccessor(), x, y, z) && ((BlockType)this.assetMap.getAsset(this.edit.getBlock(x, y - 1, z))).getFlags().isStackable && this.random.nextInt(100) <= this.brushDensity) {
