...
public class FloodOperation extends ToolOperation {
   ...
   public void execute(ComponentAccessor<EntityStore> componentAccessor) {
      ...
      Player playerComponent = (Player)componentAccessor.getComponent(this.playerRef, Player.getComponentType());

      assert playerComponent != null;

      PlayerRef playerRefComponent = (PlayerRef)componentAccessor.getComponent(this.playerRef, PlayerRef.getComponentType());
