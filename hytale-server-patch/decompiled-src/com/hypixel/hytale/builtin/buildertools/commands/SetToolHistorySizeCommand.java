...
public class SetToolHistorySizeCommand extends CommandBase {
   ...
   protected void executeSync(@Nonnull CommandContext context) {
      BuilderToolsPlugin.get().setToolHistorySize((Integer)this.historyLengthArg.get(context));
      context.sendMessage(Message.translation("server.commands.settoolhistorysize.set").param("size", (Integer)this.historyLengthArg.get(context)));
   }
}
