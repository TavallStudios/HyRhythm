...
public class Pos1Command extends AbstractPlayerCommand {
   ...
   public Pos1Command() {
      ...
      this.xArg = this.withOptionalArg("x", "server.commands.pos1.x.desc", ArgTypes.INTEGER);
      this.yArg = this.withOptionalArg("y", "server.commands.pos1.y.desc", ArgTypes.INTEGER);
      this.zArg = this.withOptionalArg("z", "server.commands.pos1.z.desc", ArgTypes.INTEGER);
   ...
   protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world) {
      ...
      if (PrototypePlayerBuilderToolSettings.isOkayToDoCommandsOnSelection(ref, playerComponent, store)) {
         ...
         if (this.xArg.provided(context) && this.yArg.provided(context) && this.zArg.provided(context)) {
            intTriple = new Vector3i((Integer)this.xArg.get(context), (Integer)this.yArg.get(context), (Integer)this.zArg.get(context));
         } else {
