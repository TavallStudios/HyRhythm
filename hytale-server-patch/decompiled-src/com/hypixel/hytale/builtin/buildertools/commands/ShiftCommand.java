...
public class ShiftCommand extends AbstractPlayerCommand {
   ...
   public ShiftCommand() {
      ...
      this.distanceArg = this.withDefaultArg("distance", "server.commands.shift.distance.desc", ArgTypes.INTEGER, 1, "1");
      this.axisArg = this.withOptionalArg("axis", "server.commands.shift.axis.desc", new EnumArgumentType("server.commands.parsing.argtype.axis.name", Axis.class));
