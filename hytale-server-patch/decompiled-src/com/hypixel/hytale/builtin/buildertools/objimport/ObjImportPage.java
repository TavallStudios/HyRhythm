         ...
         if (data.sizeMode != null) {
            ...
            if (data.rotation != null) {
               ...
               switch (this.rotationStr) {
                  case "z_up" -> var9 = ObjImportPage.MeshRotation.Z_UP_TO_Y_UP;
                  case "x_up" -> var9 = ObjImportPage.MeshRotation.X_UP_TO_Y_UP;
                  default -> var9 = ObjImportPage.MeshRotation.NONE;
               }
