...
public class PrefabEditorExitConfirmPage extends InteractiveCustomUIPage<PageData> {
   @Nonnull
   ...
   public void build(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder commandBuilder, @Nonnull UIEventBuilder eventBuilder, @Nonnull Store<EntityStore> store) {
      ...
      commandBuilder.set("#WarningMessage.TextSpans", Message.translation("server.commands.editprefab.exit.unsavedWarning.message").param("count", this.dirtyPrefabs.size()));
      int index = 0;
      ...
      eventBuilder.addEventBinding(CustomUIEventBindingType.Activating, "#ConfirmExitButton", (new EventData()).append("Action", PrefabEditorExitConfirmPage.Action.ConfirmExit.name()));
      eventBuilder.addEventBinding(CustomUIEventBindingType.Activating, "#CancelButton", (new EventData()).append("Action", PrefabEditorExitConfirmPage.Action.Cancel.name()));
      eventBuilder.addEventBinding(CustomUIEventBindingType.Activating, "#SaveAndExitButton", (new EventData()).append("Action", PrefabEditorExitConfirmPage.Action.SaveAndExit.name()));
   }
