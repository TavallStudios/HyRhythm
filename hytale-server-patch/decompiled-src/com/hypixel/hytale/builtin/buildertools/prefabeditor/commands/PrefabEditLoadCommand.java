...
public class PrefabEditLoadCommand extends AbstractAsyncPlayerCommand {
   ...
   public PrefabEditLoadCommand() {
      ...
      this.pasteLevelGoalArg = (DefaultArg)this.withDefaultArg("pasteLevelGoal", "server.commands.editprefab.load.pasteLevelGoal.desc", ArgTypes.INTEGER, 55, "server.commands.editprefab.load.pasteLevelGoal.default.desc").addValidator(Validators.range(0, 320));
