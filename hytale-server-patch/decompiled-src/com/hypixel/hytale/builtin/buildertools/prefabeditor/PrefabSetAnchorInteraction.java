...
public class PrefabSetAnchorInteraction extends SimpleInstantInteraction {
            ...
            if (prefabEditSession == null) {
               ...
               if (targetBlock == null) {
                  ...
                  if (prefabEditingMetadata == null) {
                     ...
                     prefabEditingMetadata.setAnchorPoint(targetBlockPos, ((EntityStore)commandBuffer.getExternalData()).getWorld());
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(PrefabSetAnchorInteraction.class, PrefabSetAnchorInteraction::new, SimpleInstantInteraction.CODEC).documentation("Sets the prefab anchor.")).build();
   }
}
