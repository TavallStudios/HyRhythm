   ...
   protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world) {
      ...
      if (prefabEditSession == null) {
         ...
         if (selectedPrefab == null) {
            ...
            selectionMax.subtract(selectionMin);
            Vector3d min = new Vector3d((double)selectionMin.x, (double)selectionMin.y, (double)selectionMin.z);
            Vector3d max = new Vector3d((double)(selectionMax.x + 1), (double)(selectionMax.y + 1), (double)(selectionMax.z + 1));
