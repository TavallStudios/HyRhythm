...
public class PrefabTeleportPage extends InteractiveCustomUIPage<PageData> {
      ...
      if (data.getSearchQuery() != null) {
         ...
         if (data.getPrefabUuid() != null) {
            try {
               ...
               PrefabEditingMetadata metadata = (PrefabEditingMetadata)this.prefabEditSession.getLoadedPrefabMetadata().get(prefabUuid);
               if (metadata != null) {
                  ...
                  Vector3d teleportPosition = new Vector3d((double)centerX + 0.5, (double)teleportY, (double)centerZ + 0.5);
   ...
   public static class PageData {
      ...
      static {
         CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PageData.class, PageData::new).addField(new KeyedCodec("@SearchQuery", Codec.STRING), (entry, s) -> entry.searchQuery = s, (entry) -> entry.searchQuery)).addField(new KeyedCodec("PrefabUuid", Codec.STRING), (entry, s) -> entry.prefabUuid = s, (entry) -> entry.prefabUuid)).build();
      }
   }
}
