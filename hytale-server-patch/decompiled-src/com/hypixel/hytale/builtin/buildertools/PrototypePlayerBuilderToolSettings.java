...
public class PrototypePlayerBuilderToolSettings {
   @Nonnull
   private static final Message MESSAGE_BUILDER_TOOLS_CANNOT_PERFORM_COMMAND_IN_TRANSFORMATION_MODE = Message.translation("server.builderTools.cannotPerformCommandInTransformationMode");
   ...
   @Nullable
   private FluidChange[] fluidChangesForPlaySelectionToolPasteMode = null;
   @Nullable
   private EntityChange[] entityChangesForPlaySelectionToolPasteMode = null;
   @Nullable
   ...
   public void setEntityChangesForPlaySelectionToolPasteMode(@Nullable EntityChange[] entityChanges) {
      this.entityChangesForPlaySelectionToolPasteMode = entityChanges;
   }

   @Nullable
   public EntityChange[] getEntityChangesForPlaySelectionToolPasteMode() {
   ...
   public static record FluidChange(int x, int y, int z, int fluidId, byte fluidLevel) {
   }

   public static record EntityChange(double x, double y, double z, Holder<EntityStore> entityHolder) {
   }
}
