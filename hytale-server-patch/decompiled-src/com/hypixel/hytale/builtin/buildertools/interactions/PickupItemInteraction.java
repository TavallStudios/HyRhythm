   ...
   protected final void firstRun(@Nonnull InteractionType type, @Nonnull InteractionContext context, @Nonnull CooldownHandler cooldownHandler) {
      ...
      if (playerComponent == null) {
         ...
         if (targetRef != null && targetRef.isValid()) {
            ItemComponent itemComponent = (ItemComponent)commandBuffer.getComponent(targetRef, ItemComponent.getComponentType());
            if (itemComponent == null) {
               context.getState().state = InteractionState.Failed;
            } else {
               TransformComponent transformComponent = (TransformComponent)commandBuffer.getComponent(targetRef, TransformComponent.getComponentType());
