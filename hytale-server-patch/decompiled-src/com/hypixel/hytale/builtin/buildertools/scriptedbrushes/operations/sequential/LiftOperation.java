...
public class LiftOperation extends SequenceBrushOperation {
   public static final BuilderCodec<LiftOperation> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(LiftOperation.class, LiftOperation::new).documentation("Lift all blocks up by one (duplicating the block) that are touching air, preserving the material")).build();
