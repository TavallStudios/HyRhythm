...
public class JumpIfToolArgOperation extends SequenceBrushOperation {
   public static final BuilderCodec<JumpIfToolArgOperation> CODEC;
   @Nonnull
   ...
   public JumpIfToolArgOperation() {
      ...
      this.comparisonTypeArg = JumpIfToolArgOperation.ComparisonType.Equals;
      this.comparisonValueArg = "";
         ...
         if (itemStack == null) {
            ...
            if (toolArgs != null && toolArgs.containsKey(this.argNameArg)) {
               ...
               if (argValue instanceof Boolean) {
                  ...
                  switch (this.comparisonTypeArg.ordinal()) {
                     case 0 -> shouldJump = boolValue == expectedValue;
                     case 1 -> shouldJump = boolValue != expectedValue;
                  }
               } else if (argValue instanceof String) {
                  String stringValue = (String)argValue;
                  switch (this.comparisonTypeArg.ordinal()) {
                     case 0 -> shouldJump = stringValue.equalsIgnoreCase(this.comparisonValueArg);
                     case 1 -> shouldJump = !stringValue.equalsIgnoreCase(this.comparisonValueArg);
                     case 2 -> shouldJump = stringValue.toLowerCase().contains(this.comparisonValueArg.toLowerCase());
                  }
               } else {
