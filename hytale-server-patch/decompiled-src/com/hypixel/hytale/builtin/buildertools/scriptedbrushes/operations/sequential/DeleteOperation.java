...
public class DeleteOperation extends SequenceBrushOperation {
   public static final BuilderCodec<DeleteOperation> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(DeleteOperation.class, DeleteOperation::new).documentation("Remove all blocks and fluids in the area")).build();

   public DeleteOperation() {
      super("Delete", "Remove all blocks and fluids in the area", true);
   }
