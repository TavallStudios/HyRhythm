...
public class BlockPatternOperation extends SequenceBrushOperation {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(BlockPatternOperation.class, BlockPatternOperation::new).append(new KeyedCodec("BlockPattern", BlockPattern.CODEC), (op, val) -> op.blockPatternArg = val, (op) -> op.blockPatternArg).documentation("The pattern of blocks to use in your set").add()).documentation("Change the material of the brush to a pattern of blocks")).build();
   }
}
