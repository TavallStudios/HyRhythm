...
public class IgnoreExistingBrushDataOperation extends GlobalBrushOperation {
   public static final BuilderCodec<IgnoreExistingBrushDataOperation> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(IgnoreExistingBrushDataOperation.class, IgnoreExistingBrushDataOperation::new).documentation("Ignores any existing brush settings specified on the tool")).build();
