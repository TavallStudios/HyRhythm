...
public class DisableHoldInteractionOperation extends GlobalBrushOperation {
   public static final BuilderCodec<DisableHoldInteractionOperation> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(DisableHoldInteractionOperation.class, DisableHoldInteractionOperation::new).documentation("Disables the ability of the brush to activate multiple times on holding a button")).build();
