...
public class EchoOperation extends SequenceBrushOperation {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(EchoOperation.class, EchoOperation::new).append(new KeyedCodec("Message", Codec.STRING), (op, val) -> op.messageArg = val, (op) -> op.messageArg).documentation("A message to print to chat when this operation is ran").add()).documentation("Print some text to chat")).build();
   }
}
