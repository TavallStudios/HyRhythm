...
public abstract class BrushOperation {
   public static final CodecMapCodec<BrushOperation> OPERATION_CODEC = new CodecMapCodec<BrushOperation>("Id");
   ...
   public <T> BrushOperationSetting<T> createBrushSetting(@Nonnull String name, String description, T defaultValue, ArgumentType<T> argumentType) {
      BrushOperationSetting<T> brushOperationSetting = new BrushOperationSetting<T>(name, description, defaultValue, argumentType);
   ...
   public <T> BrushOperationSetting<T> createBrushSetting(@Nonnull String name, String description, T defaultValue, ArgumentType<T> argumentType, Function<BrushOperationSetting<T>, String> toStringFunction) {
      BrushOperationSetting<T> brushOperationSetting = new BrushOperationSetting<T>(name, description, defaultValue, argumentType, toStringFunction);
      this.registeredOperationSettings.put(name.toLowerCase(), brushOperationSetting);
      return brushOperationSetting;
   }
