...
public class SmoothOperation extends SequenceBrushOperation {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(SmoothOperation.class, SmoothOperation::new).append(new KeyedCodec("SmoothStrength", Codec.INTEGER), (op, val) -> op.smoothStrength = val, (op) -> op.smoothStrength).documentation("The strength of smoothing").add()).documentation("Smooths the blocks within the brush area as to make the area more natural looking")).build();
   }
}
