...
public class HistoryMaskOperation extends SequenceBrushOperation {
   ...
   public HistoryMaskOperation() {
      ...
      this.historyMaskArg = BrushConfig.HistoryMask.None;
   }
