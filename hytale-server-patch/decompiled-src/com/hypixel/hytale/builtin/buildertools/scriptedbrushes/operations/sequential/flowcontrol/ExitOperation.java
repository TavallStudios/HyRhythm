...
public class ExitOperation extends SequenceBrushOperation {
   public static final BuilderCodec<ExitOperation> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ExitOperation.class, ExitOperation::new).documentation("Exit the execution of the stack")).build();
