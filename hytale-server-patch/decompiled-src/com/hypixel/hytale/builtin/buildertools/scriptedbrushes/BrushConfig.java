...
public class BrushConfig {
   ...
   public static enum DataGettingFlags {
      ...
      public int getValue(BrushConfig brushConfig) {
         return (Integer)this.valueGetter.apply(brushConfig);
      }
   }
}
