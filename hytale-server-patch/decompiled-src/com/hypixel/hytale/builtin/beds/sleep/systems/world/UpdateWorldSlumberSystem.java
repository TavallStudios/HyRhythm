...
public class UpdateWorldSlumberSystem extends TickingSystem<EntityStore> {
   ...
   public void tick(float dt, int systemIndex, @Nonnull Store<EntityStore> store) {
      ...
      if (worldSleep instanceof WorldSlumber slumber) {
         ...
         if (sleepingIsOver) {
            ...
            store.forEachEntityParallel(this.playerSomnolenceComponentType, (index, archetypeChunk, commandBuffer) -> {
               PlayerSomnolence somnolenceComponent = (PlayerSomnolence)archetypeChunk.getComponent(index, this.playerSomnolenceComponentType);
      ...
      if (playerRefs.isEmpty()) {
         ...
         for(PlayerRef playerRef : playerRefs) {
            ...
            if (ref != null && ref.isValid()) {
               PlayerSomnolence somnolenceComponent = (PlayerSomnolence)store.getComponent(ref, playerSomnolenceComponentType);
