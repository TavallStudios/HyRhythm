...
public class RegisterTrackerSystem extends HolderSystem<EntityStore> {
   ...
   public RegisterTrackerSystem(@Nonnull ComponentType<EntityStore, PlayerRef> playerRefComponentType, @Nonnull ComponentType<EntityStore, SleepTracker> sleepTrackerComponentType) {
