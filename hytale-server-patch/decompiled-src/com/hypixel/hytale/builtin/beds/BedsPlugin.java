...
public class BedsPlugin extends JavaPlugin {
   ...
   protected void setup() {
      ...
      entityStoreRegistry.registerSystem(new UpdateSleepPacketSystem(playerRefComponentType, this.playerSomnolenceComponentType, this.sleepTrackerComponentType, this.worldSomnolenceResourceType, worldTimeResourceType));
