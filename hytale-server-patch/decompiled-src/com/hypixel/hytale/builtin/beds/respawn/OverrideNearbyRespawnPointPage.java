   ...
   public void build(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder commandBuilder, @Nonnull UIEventBuilder eventBuilder, @Nonnull Store<EntityStore> store) {
      ...
      if (headRotationComponent != null) {
         ...
         if (playerRefComponent != null) {
            double direction = Math.toDegrees((double)headRotationComponent.getRotation().getYaw());
            ...
            for(int i = 0; i < this.nearbyRespawnPoints.length; ++i) {
               ...
               double angle = Math.atan2((double)(nearbyRespawnPointPosition.z - this.respawnPointPosition.z), (double)(nearbyRespawnPointPosition.x - this.respawnPointPosition.x));
