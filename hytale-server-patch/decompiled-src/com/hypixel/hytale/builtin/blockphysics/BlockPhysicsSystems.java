...
public class BlockPhysicsSystems {
   ...
   public static class Ticking extends EntityTickingSystem<ChunkStore> implements DisableProcessingAssert {
      ...
      public void tick(float dt, int index, @Nonnull ArchetypeChunk<ChunkStore> archetypeChunk, @Nonnull Store<ChunkStore> store, @Nonnull CommandBuffer<ChunkStore> commandBuffer) {
         ...
         try {
            BlockSection blockSectionComponent = (BlockSection)archetypeChunk.getComponent(index, BlockSection.getComponentType());
            ...
            BlockPhysics blockPhysicsComponent = (BlockPhysics)archetypeChunk.getComponent(index, BlockPhysics.getComponentType());
            ...
            WorldChunk worldChunkComponent = (WorldChunk)commandBuffer.getComponent(columnRef, WorldChunk.getComponentType());
            if (worldChunkComponent == null) {
               return;
            }

            CachedAccessor accessor = BlockPhysicsSystems.CachedAccessor.of(commandBuffer, blockSectionComponent, blockPhysicsComponent, fluidSectionComponent, section.getX(), section.getY(), section.getZ(), 14);
            blockSectionComponent.forEachTicking(worldChunkComponent, accessor, section.getY(), (wc, accessor1, localX, localY, localZ, blockId) -> {
