...
public class DeployablesPlugin extends JavaPlugin {
   ...
   protected void setup() {
      instance = this;
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(DeployableSpawner.class, new DefaultAssetMap()).setPath("DeployableSpawners")).setCodec(DeployableSpawner.CODEC)).setKeyFunction(DeployableSpawner::getId)).loadsAfter(new Class[]{ModelAsset.class, EntityEffect.class, SoundEvent.class})).loadsBefore(new Class[]{Interaction.class})).build());
      ...
      DeployableConfig.CODEC.register((String)"Trap", DeployableTrapConfig.class, DeployableTrapConfig.CODEC);
      DeployableConfig.CODEC.register((String)"TrapSpawner", DeployableTrapSpawnerConfig.class, DeployableTrapSpawnerConfig.CODEC);
      DeployableConfig.CODEC.register((String)"Aoe", DeployableAoeConfig.class, DeployableAoeConfig.CODEC);
      DeployableConfig.CODEC.register((String)"Turret", DeployableTurretConfig.class, DeployableTurretConfig.CODEC);
