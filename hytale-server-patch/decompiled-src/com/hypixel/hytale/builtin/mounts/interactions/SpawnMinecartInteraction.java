   ...
   protected void interactWithBlock(@Nonnull World world, @Nonnull CommandBuffer<EntityStore> commandBuffer, @Nonnull InteractionType type, @Nonnull InteractionContext context, @Nullable ItemStack itemInHand, @Nonnull Vector3i targetBlock, @Nonnull CooldownHandler cooldownHandler) {
      ...
      if (chunk != null) {
         ...
         if (railConfig != null) {
            ...
            BlockBoundingBoxes.RotatedVariantBoxes bounding = ((BlockBoundingBoxes)BlockBoundingBoxes.getAssetMap().getAsset(block.getHitboxTypeIndex())).get(blockRotation);
         ...
         ModelAsset modelAsset = (ModelAsset)ModelAsset.getAssetMap().getAsset(this.modelId);
         if (modelAsset == null) {
