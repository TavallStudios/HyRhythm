...
public class SeatingInteraction extends SimpleBlockInteraction {
   ...
   protected void interactWithBlock(@Nonnull World world, @Nonnull CommandBuffer<EntityStore> commandBuffer, @Nonnull InteractionType type, @Nonnull InteractionContext context, @Nullable ItemStack itemInHand, @Nonnull Vector3i targetBlock, @Nonnull CooldownHandler cooldownHandler) {
      ...
      if (player != null) {
         ...
         if (result == BlockMountAPI.DidNotMount.ALREADY_MOUNTED) {
            ...
            BlockMountAPI.Mounted mounted = (BlockMountAPI.Mounted)result;
            BlockSoundSet soundSet = (BlockSoundSet)BlockSoundSet.getAssetMap().getAsset(mounted.blockType().getBlockSoundSetIndex());
            String seatSoundId = soundSet == null ? null : (String)soundSet.getSoundEventIds().getOrDefault(BlockSoundEvent.Walk, (Object)null);
            if (seatSoundId != null) {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(SeatingInteraction.class, SeatingInteraction::new, SimpleBlockInteraction.CODEC).documentation("Arranges perfect seating accommodations")).build();
   }
}
