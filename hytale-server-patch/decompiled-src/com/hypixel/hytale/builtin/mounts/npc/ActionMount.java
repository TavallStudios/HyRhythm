...
public class ActionMount extends ActionBase {
   ...
   public boolean execute(@Nonnull Ref<EntityStore> ref, @Nonnull Role role, InfoProvider sensorInfo, double dt, @Nonnull Store<EntityStore> store) {
      ...
      NPCMountComponent mountComponent = (NPCMountComponent)store.getComponent(ref, mountComponentType);
      if (mountComponent != null) {
         return false;
      } else {
         mountComponent = (NPCMountComponent)store.ensureAndGetComponent(ref, mountComponentType);
