...
public class MinecartComponent implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(MinecartComponent.class, MinecartComponent::new).append(new KeyedCodec("SourceItem", Codec.STRING), (o, v) -> o.sourceItem = v, (o) -> o.sourceItem).add()).build();
   }
}
