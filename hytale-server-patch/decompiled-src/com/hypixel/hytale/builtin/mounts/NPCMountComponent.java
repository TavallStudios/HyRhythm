...
public class NPCMountComponent implements Component<EntityStore> {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(NPCMountComponent.class, NPCMountComponent::new).append(new KeyedCodec("OriginalRoleIndex", Codec.INTEGER), (mountComponent, integer) -> mountComponent.originalRoleIndex = integer, (mountComponent) -> mountComponent.originalRoleIndex).add()).build();
   }
}
