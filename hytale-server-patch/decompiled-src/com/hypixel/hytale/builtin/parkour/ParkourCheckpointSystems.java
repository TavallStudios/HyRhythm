...
public class ParkourCheckpointSystems {
   public static class Init extends RefSystem<EntityStore> {
      ...
      public Init(ComponentType<EntityStore, ParkourCheckpoint> parkourCheckpointComponentType) {
         ...
         this.query = Query.<EntityStore>and(parkourCheckpointComponentType, transformComponentType);
      }
      ...
      public void onEntityAdded(@Nonnull Ref<EntityStore> ref, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         ParkourCheckpoint entity = (ParkourCheckpoint)store.getComponent(ref, this.parkourCheckpointComponentType);
         ParkourPlugin.get().updateLastIndex(entity.getIndex());
         ParkourPlugin.get().getCheckpointUUIDMap().put(entity.getIndex(), ((UUIDComponent)store.getComponent(ref, this.uuidComponentComponentType)).getUuid());
      }
