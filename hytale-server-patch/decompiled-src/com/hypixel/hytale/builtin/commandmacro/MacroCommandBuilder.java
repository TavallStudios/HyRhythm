...
public class MacroCommandBuilder implements JsonAssetWithMap<String, DefaultAssetMap<String, MacroCommandBuilder>> {
   ...
   static {
      CODEC = ((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(MacroCommandBuilder.class, MacroCommandBuilder::new, Codec.STRING, (builder, id) -> builder.id = id, (builder) -> builder.id, (builder, data) -> builder.data = data, (builder) -> builder.data).append(new KeyedCodec("Name", Codec.STRING, true), (builder, name) -> builder.name = name, (builder) -> builder.name).add()).append(new KeyedCodec("Aliases", Codec.STRING_ARRAY, false), (builder, aliases) -> builder.aliases = aliases, (builder) -> builder.aliases).add()).append(new KeyedCodec("Description", Codec.STRING, true), (builder, description) -> builder.description = description, (builder) -> builder.description).add()).append(new KeyedCodec("Parameters", new ArrayCodec(MacroCommandParameter.CODEC, (x$0) -> new MacroCommandParameter[x$0]), false), (builder, parameters) -> builder.parameters = parameters, (builder) -> builder.parameters).add()).append(new KeyedCodec("Commands", Codec.STRING_ARRAY, true), (builder, commands) -> builder.commands = commands, (builder) -> builder.commands).add()).build();
   }
}
