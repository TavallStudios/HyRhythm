...
public class MacroCommandParameter {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(MacroCommandParameter.class, MacroCommandParameter::new).append(new KeyedCodec("Name", Codec.STRING, true), (macroParameter, name) -> macroParameter.name = name, (macroParameter) -> macroParameter.name).add()).append(new KeyedCodec("Description", Codec.STRING, true), (macroParameter, description) -> macroParameter.description = description, (macroParameter) -> macroParameter.description).add()).append(new KeyedCodec("Requirement", new EnumCodec(ParameterRequirement.class), true), (macroParameter, requirement) -> macroParameter.requirement = requirement, (macroParameter) -> macroParameter.requirement).add()).append(new KeyedCodec("ArgType", new EnumCodec(ArgumentTypeEnum.class)), (macroParameter, argumentType) -> macroParameter.argumentType = argumentType, (macroParameter) -> macroParameter.argumentType).add()).append(new KeyedCodec("DefaultValue", Codec.STRING), (macroParameter, defaultValue) -> macroParameter.defaultValue = defaultValue, (macroParameter) -> macroParameter.defaultValue).add()).append(new KeyedCodec("DefaultValueDescription", Codec.STRING), (macroParameter, defaultValueDescription) -> macroParameter.defaultValueDescription = defaultValueDescription, (macroParameter) -> macroParameter.defaultValueDescription).add()).build();
   }
