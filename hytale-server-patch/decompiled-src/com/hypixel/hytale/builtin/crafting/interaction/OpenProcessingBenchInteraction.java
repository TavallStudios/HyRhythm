...
public class OpenProcessingBenchInteraction extends SimpleBlockInteraction {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(OpenProcessingBenchInteraction.class, OpenProcessingBenchInteraction::new, SimpleBlockInteraction.CODEC).documentation("Opens the processing bench page.")).build();
   }
}
