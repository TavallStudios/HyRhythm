...
public class PlayerCraftingSystems {
   public static class CraftingHolderSystem extends HolderSystem<EntityStore> {
      ...
      public CraftingHolderSystem(@Nonnull ComponentType<EntityStore, Player> playerComponentType, @Nonnull ComponentType<EntityStore, CraftingManager> craftingManagerComponentType) {
   ...
   public static class CraftingRefSystem extends RefSystem<EntityStore> {
      ...
      public CraftingRefSystem(@Nonnull ComponentType<EntityStore, Player> playerComponentType, @Nonnull ComponentType<EntityStore, CraftingManager> craftingManagerComponentType) {
         this.craftingManagerComponentType = craftingManagerComponentType;
         this.query = Query.<EntityStore>and(playerComponentType, craftingManagerComponentType);
      }
      ...
      public void onEntityRemove(@Nonnull Ref<EntityStore> ref, @Nonnull RemoveReason reason, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         CraftingManager craftingManagerComponent = (CraftingManager)commandBuffer.getComponent(ref, this.craftingManagerComponentType);
   ...
   public static class CraftingTickingSystem extends EntityTickingSystem<EntityStore> {
      ...
      public void tick(float dt, int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         CraftingManager craftingManagerComponent = (CraftingManager)archetypeChunk.getComponent(index, this.craftingManagerComponentType);
