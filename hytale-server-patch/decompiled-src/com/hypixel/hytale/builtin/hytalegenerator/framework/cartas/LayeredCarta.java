...
public class LayeredCarta<R> extends TriCarta<R> {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.layers);
      return "LayeredCarta{layers=" + var10000 + ", allValues=" + String.valueOf(this.allValues) + ", defaultValue=" + String.valueOf(this.defaultValue) + "}";
   }
}
