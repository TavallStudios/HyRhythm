...
public class SolidMaterial {
   ...
   public boolean equals(Object o) {
      if (!(o instanceof SolidMaterial that)) {
         return false;
      } else {
   ...
   public static int contentHash(int blockId, int support, int rotation, int filler, @Nullable Holder<ChunkStore> holder) {
      return Objects.hash(new Object[]{blockId, support, rotation, filler, holder});
   }

   @Nonnull
   public String toString() {
      String var10000 = String.valueOf(this.materialCache);
      return "SolidMaterial{materialCache=" + var10000 + ", blockId=" + this.blockId + ", support=" + this.support + ", rotation=" + this.rotation + ", filler=" + this.filler + ", holder=" + String.valueOf(this.holder) + "}";
   }
}
