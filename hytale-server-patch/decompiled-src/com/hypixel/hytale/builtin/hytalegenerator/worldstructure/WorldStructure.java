...
public class WorldStructure {
   ...
   public WorldStructure(@Nonnull BiCarta<Integer> biomeMap, @Nonnull Registry<Biome> biomeRegistry, int biomeTransitionDistance, int maxBiomeEdgeDistance, @Nonnull PositionProvider spawnPositions) {
