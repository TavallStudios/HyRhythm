...
public class NViewport {
   ...
   public void refresh() {
      ...
      for(LongIterator var3 = this.affectedChunkIndices.iterator(); var3.hasNext(); futures[i++] = future) {
         long chunkIndex = (Long)var3.next();
         ChunkStore chunkStore = this.world.getChunkStore();
         future = chunkStore.getChunkReferenceAsync(chunkIndex, 9);
      }
