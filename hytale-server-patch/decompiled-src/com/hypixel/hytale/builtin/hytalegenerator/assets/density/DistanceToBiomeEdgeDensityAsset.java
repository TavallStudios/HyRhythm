...
public class DistanceToBiomeEdgeDensityAsset extends DensityAsset {
   @Nonnull
   public static final BuilderCodec<DistanceToBiomeEdgeDensityAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(DistanceToBiomeEdgeDensityAsset.class, DistanceToBiomeEdgeDensityAsset::new, DensityAsset.ABSTRACT_CODEC).build();
   }
}
