...
public class ImportedPropAsset extends PropAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ImportedPropAsset.class, ImportedPropAsset::new, PropAsset.ABSTRACT_CODEC).append(new KeyedCodec("Name", Codec.STRING, true), (asset, v) -> asset.name = v, (asset) -> asset.name).add()).build();
   }
}
