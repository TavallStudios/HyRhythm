...
public class CurveReturnTypeAsset extends ReturnTypeAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(CurveReturnTypeAsset.class, CurveReturnTypeAsset::new, ReturnTypeAsset.ABSTRACT_CODEC).append(new KeyedCodec("Curve", CurveAsset.CODEC, true), (t, k) -> t.curveAsset = k, (t) -> t.curveAsset).add()).build();
   }
}
