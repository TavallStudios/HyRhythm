...
public class IntegerBounds3dAsset implements JsonAssetWithMap<String, DefaultAssetMap<String, IntegerBounds3dAsset>> {
   ...
   static {
      CODEC = ((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(IntegerBounds3dAsset.class, IntegerBounds3dAsset::new, Codec.STRING, (asset, id) -> asset.id = id, (config) -> config.id, (config, data) -> config.data = data, (config) -> config.data).append(new KeyedCodec("PointA", Vector3i.CODEC, true), (t, value) -> t.pointA = value, (t) -> t.pointA).add()).append(new KeyedCodec("PointB", Vector3i.CODEC, true), (t, value) -> t.pointB = value, (t) -> t.pointB).add()).build();
   }
}
