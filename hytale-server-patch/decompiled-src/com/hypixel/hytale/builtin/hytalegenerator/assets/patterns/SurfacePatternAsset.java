...
public class SurfacePatternAsset extends PatternAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(SurfacePatternAsset.class, SurfacePatternAsset::new, PatternAsset.ABSTRACT_CODEC).append(new KeyedCodec("Surface", PatternAsset.CODEC, true), (t, k) -> t.surface = k, (k) -> k.surface).add()).append(new KeyedCodec("Medium", PatternAsset.CODEC, true), (t, k) -> t.origin = k, (k) -> k.origin).add()).append(new KeyedCodec("SurfaceRadius", Codec.DOUBLE, false), (t, k) -> t.surfaceRadius = k, (k) -> k.surfaceRadius).addValidator(Validators.greaterThanOrEqual(0.0)).add()).append(new KeyedCodec("MediumRadius", Codec.DOUBLE, false), (t, k) -> t.originRadius = k, (k) -> k.originRadius).addValidator(Validators.greaterThanOrEqual(0.0)).add()).append(new KeyedCodec("SurfaceGap", Codec.INTEGER, false), (t, k) -> t.surfaceGap = k, (k) -> k.surfaceGap).addValidator(Validators.greaterThanOrEqual(0)).add()).append(new KeyedCodec("MediumGap", Codec.INTEGER, false), (t, k) -> t.originGap = k, (k) -> k.originGap).addValidator(Validators.greaterThanOrEqual(0)).add()).append(new KeyedCodec("RequireAllFacings", Codec.BOOLEAN, false), (t, k) -> t.requireAllFacings = k, (k) -> k.requireAllFacings).add()).append(new KeyedCodec("Facings", new ArrayCodec(SurfacePattern.Facing.CODEC, (x$0) -> new SurfacePattern.Facing[x$0]), true), (t, k) -> t.facings = k, (k) -> k.facings).add()).build();
   }
}
