...
public class DensityPropAsset extends PropAsset {
   ...
   public Prop build(@Nonnull PropAsset.Argument argument) {
      if (super.skip()) {
         ...
         return (Prop)(this.scannerAsset != null && this.patternAsset != null && this.densityAsset != null && this.materialProviderAsset != null ? new DensityProp(this.range, this.densityAsset.build(DensityAsset.from(argument)), this.materialProviderAsset.build(MaterialProviderAsset.argumentFrom(argument)), this.scannerAsset.build(ScannerAsset.argumentFrom(argument)), this.patternAsset.build(PatternAsset.argumentFrom(argument)), placementMask, new Material(argument.materialCache.EMPTY_AIR, argument.materialCache.EMPTY_FLUID)) : Prop.noProp());
      }
   }
