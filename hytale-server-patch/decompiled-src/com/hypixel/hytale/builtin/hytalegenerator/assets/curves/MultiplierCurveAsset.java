...
public class MultiplierCurveAsset extends CurveAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(MultiplierCurveAsset.class, MultiplierCurveAsset::new, CurveAsset.ABSTRACT_CODEC).append(new KeyedCodec("Curves", new ArrayCodec(CurveAsset.CODEC, (x$0) -> new CurveAsset[x$0]), true), (t, k) -> t.curveAssets = k, (k) -> k.curveAssets).add()).build();
   }
}
