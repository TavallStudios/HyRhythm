...
public class DensityTerrainAsset extends TerrainAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(DensityTerrainAsset.class, DensityTerrainAsset::new, TerrainAsset.ABSTRACT_CODEC).append(new KeyedCodec("Density", DensityAsset.CODEC, true), (t, k) -> t.densityAsset = k, (t) -> t.densityAsset).add()).build();
   }
}
