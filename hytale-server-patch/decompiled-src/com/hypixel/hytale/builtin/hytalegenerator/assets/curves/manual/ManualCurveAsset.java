...
public class ManualCurveAsset extends CurveAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ManualCurveAsset.class, ManualCurveAsset::new, CurveAsset.ABSTRACT_CODEC).append(new KeyedCodec("Points", new ArrayCodec(PointInOutAsset.CODEC, (x$0) -> new PointInOutAsset[x$0]), true), (t, k) -> t.nodes = k, (t) -> t.nodes).addValidator((LegacyValidator)((v, r) -> {
