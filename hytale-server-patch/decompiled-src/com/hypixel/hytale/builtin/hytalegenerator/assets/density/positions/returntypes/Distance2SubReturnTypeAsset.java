...
public class Distance2SubReturnTypeAsset extends ReturnTypeAsset {
   @Nonnull
   public static final BuilderCodec<Distance2SubReturnTypeAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(Distance2SubReturnTypeAsset.class, Distance2SubReturnTypeAsset::new, ReturnTypeAsset.ABSTRACT_CODEC).build();
   }
}
