...
public class Distance2DivReturnTypeAsset extends ReturnTypeAsset {
   @Nonnull
   public static final BuilderCodec<Distance2DivReturnTypeAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(Distance2DivReturnTypeAsset.class, Distance2DivReturnTypeAsset::new, ReturnTypeAsset.ABSTRACT_CODEC).build();
   }
}
