...
public class MultiplierDensityAsset extends DensityAsset {
   @Nonnull
   public static final BuilderCodec<MultiplierDensityAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(MultiplierDensityAsset.class, MultiplierDensityAsset::new, DensityAsset.ABSTRACT_CODEC).build();
   }
}
