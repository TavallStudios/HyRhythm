...
public class ConstantVectorProviderAsset extends VectorProviderAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ConstantVectorProviderAsset.class, ConstantVectorProviderAsset::new, ABSTRACT_CODEC).append(new KeyedCodec("Value", Vector3d.CODEC, true), (asset, value) -> asset.value = value, (asset) -> asset.value).add()).build();
   }
}
