...
public class DensityDelimitedEnvironmentProviderAsset extends EnvironmentProviderAsset {
   ...
   public static class DelimiterAsset implements Cleanable, JsonAssetWithMap<String, DefaultAssetMap<String, DelimiterAsset>> {
      ...
      static {
         CODEC = ((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(DelimiterAsset.class, DelimiterAsset::new, Codec.STRING, (asset, id) -> asset.id = id, (config) -> config.id, (config, data) -> config.data = data, (config) -> config.data).append(new KeyedCodec("Range", RangeDoubleAsset.CODEC, true), (t, value) -> t.rangeAsset = value, (t) -> t.rangeAsset).add()).append(new KeyedCodec("Environment", EnvironmentProviderAsset.CODEC, true), (t, value) -> t.environmentProviderAsset = value, (t) -> t.environmentProviderAsset).add()).build();
      }
   }
}
