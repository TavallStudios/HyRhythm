...
public class ExportedDensityAsset extends DensityAsset {
   ...
   public Density build(@Nonnull DensityAsset.Argument argument) {
      if (!this.isSkipped() && this.inputs().length != 0) {
         ...
         if (exported == null) {
            ...
            Density builtInstance = (Density)exported.threadInstances.get(argument.workerId);
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ExportedDensityAsset.class, ExportedDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("SingleInstance", Codec.BOOLEAN, false), (asset, value) -> asset.singleInstance = value, (asset) -> asset.singleInstance).add()).build();
   }
}
