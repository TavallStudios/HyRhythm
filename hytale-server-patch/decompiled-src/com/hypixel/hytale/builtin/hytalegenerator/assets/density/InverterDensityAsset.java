...
public class InverterDensityAsset extends DensityAsset {
   @Nonnull
   public static final BuilderCodec<InverterDensityAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(InverterDensityAsset.class, InverterDensityAsset::new, DensityAsset.ABSTRACT_CODEC).build();
   }
}
