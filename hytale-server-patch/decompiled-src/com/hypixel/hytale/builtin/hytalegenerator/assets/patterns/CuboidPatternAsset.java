...
public class CuboidPatternAsset extends PatternAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CuboidPatternAsset.class, CuboidPatternAsset::new, PatternAsset.ABSTRACT_CODEC).append(new KeyedCodec("SubPattern", PatternAsset.CODEC, true), (t, k) -> t.subPatternAsset = k, (k) -> k.subPatternAsset).add()).append(new KeyedCodec("Min", Vector3i.CODEC, true), (t, k) -> t.min = k, (k) -> k.min).add()).append(new KeyedCodec("Max", Vector3i.CODEC, true), (t, k) -> t.max = k, (k) -> k.max).add()).build();
   }
}
