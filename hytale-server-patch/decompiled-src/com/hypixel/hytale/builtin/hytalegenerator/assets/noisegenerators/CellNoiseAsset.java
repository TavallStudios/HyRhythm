...
public class CellNoiseAsset extends NoiseAsset {
   ...
   public CellNoiseField build(@Nonnull SeedBox parentSeed) {
      ...
      return new CellNoiseField((Integer)childSeed.createSupplier().get(), this.scale, this.scale, this.scale, this.jitter, this.octaves, this.cellType, FastNoiseLite.DomainWarpType.OpenSimplex2, this.warpAmount, this.warpScale);
   }
