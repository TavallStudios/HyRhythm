...
public class EqualsConditionAsset extends ConditionAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(EqualsConditionAsset.class, EqualsConditionAsset::new, ConditionAsset.ABSTRACT_CODEC).append(new KeyedCodec("ContextToCheck", ConditionParameter.CODEC, true), (t, k) -> t.parameter = k, (k) -> k.parameter).add()).append(new KeyedCodec("Value", Codec.INTEGER, true), (t, k) -> t.value = k, (k) -> k.value).add()).build();
   }
}
