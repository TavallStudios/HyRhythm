...
public class YOverrideDensityAsset extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(YOverrideDensityAsset.class, YOverrideDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("Value", Codec.DOUBLE, true), (t, k) -> t.value = k, (t) -> t.value).add()).build();
   }
}
