...
public class ImportedAssignmentsAsset extends AssignmentsAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ImportedAssignmentsAsset.class, ImportedAssignmentsAsset::new, AssignmentsAsset.ABSTRACT_CODEC).append(new KeyedCodec("Name", Codec.STRING, true), (asset, v) -> asset.name = v, (asset) -> asset.name).add()).build();
   }
}
