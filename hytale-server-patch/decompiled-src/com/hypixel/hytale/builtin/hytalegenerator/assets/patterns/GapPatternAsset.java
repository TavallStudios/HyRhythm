...
public class GapPatternAsset extends PatternAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(GapPatternAsset.class, GapPatternAsset::new, PatternAsset.ABSTRACT_CODEC).append(new KeyedCodec("GapPattern", PatternAsset.CODEC, true), (t, k) -> t.gapPatternAsset = k, (k) -> k.gapPatternAsset).add()).append(new KeyedCodec("AnchorPattern", PatternAsset.CODEC, true), (t, k) -> t.anchorPatternAsset = k, (k) -> k.anchorPatternAsset).add()).append(new KeyedCodec("GapSize", Codec.DOUBLE, true), (t, k) -> t.gapSize = k, (k) -> k.gapSize).addValidator(Validators.greaterThanOrEqual(0.0)).add()).append(new KeyedCodec("AnchorSize", Codec.DOUBLE, true), (t, k) -> t.anchorSize = k, (k) -> k.anchorSize).addValidator(Validators.greaterThanOrEqual(0.0)).add()).append(new KeyedCodec("AnchorRoughness", Codec.DOUBLE, true), (t, k) -> t.anchorRoughness = k, (k) -> k.anchorRoughness).addValidator(Validators.greaterThanOrEqual(0.0)).add()).append(new KeyedCodec("DepthDown", Codec.INTEGER, true), (t, k) -> t.depthDown = k, (k) -> k.depthDown).addValidator(Validators.greaterThanOrEqual(0)).add()).append(new KeyedCodec("DepthUp", Codec.INTEGER, true), (t, k) -> t.depthUp = k, (k) -> k.depthUp).addValidator(Validators.greaterThanOrEqual(0)).add()).append(new KeyedCodec("Angles", new ArrayCodec(Codec.FLOAT, (x$0) -> new Float[x$0]), true), (t, k) -> t.angles = k, (k) -> k.angles).add()).build();
   }
}
