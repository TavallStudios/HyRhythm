...
public class AnchorDensityAsset extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(AnchorDensityAsset.class, AnchorDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("Reversed", Codec.BOOLEAN, false), (t, k) -> t.isReversed = k, (k) -> k.isReversed).add()).build();
   }
}
