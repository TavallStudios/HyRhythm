...
public class CylinderDensityAsset extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CylinderDensityAsset.class, CylinderDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("RadialCurve", CurveAsset.CODEC, true), (t, k) -> t.radialCurveAsset = k, (k) -> k.radialCurveAsset).add()).append(new KeyedCodec("AxialCurve", CurveAsset.CODEC, true), (t, k) -> t.axialCurveAsset = k, (k) -> k.axialCurveAsset).add()).append(new KeyedCodec("NewYAxis", Vector3d.CODEC, false), (t, k) -> {
         if (k.length() != 0.0) {
            t.newYAxis = k;
         }
