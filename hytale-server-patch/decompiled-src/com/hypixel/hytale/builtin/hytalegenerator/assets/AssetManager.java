...
public class AssetManager {
   ...
   public AssetManager(@Nonnull EventRegistry eventRegistry, @Nonnull HytaleLogger logger) {
      ...
      eventRegistry.register((Class)LoadedAssetsEvent.class, DensityAsset.class, this::loadDensityAssets);
      eventRegistry.register((Class)LoadedAssetsEvent.class, AssignmentsAsset.class, this::loadAssignmentsAssets);
      eventRegistry.register((Class)LoadedAssetsEvent.class, BiomeAsset.class, this::loadBiomeAssets);
      eventRegistry.register((Class)LoadedAssetsEvent.class, WorldStructureAsset.class, this::loadWorldStructureAssets);
      eventRegistry.register((Class)LoadedAssetsEvent.class, SettingsAsset.class, this::loadSettingsAssets);
      eventRegistry.register((Class)LoadedAssetsEvent.class, BlockMaskAsset.class, this::loadBlockMaskAssets);
   }
   ...
   private void loadBlockMaskAssets(@Nonnull LoadedAssetsEvent<String, BlockMaskAsset, DefaultAssetMap<String, BlockMaskAsset>> event) {
      ...
      for(BlockMaskAsset value : event.getLoadedAssets().values()) {
         ...
         this.logger.at(Level.FINE).log("Loaded BlockMask asset " + String.valueOf(value));
      }
   ...
   private void loadDensityAssets(@Nonnull LoadedAssetsEvent<String, DensityAsset, DefaultAssetMap<String, DensityAsset>> event) {
      ...
      for(DensityAsset value : event.getLoadedAssets().values()) {
         ...
         this.logger.at(Level.FINE).log("Loaded Density asset " + String.valueOf(value));
      }
   ...
   private void loadSettingsAssets(@Nonnull LoadedAssetsEvent<String, SettingsAsset, DefaultAssetMap<String, SettingsAsset>> event) {
      SettingsAsset asset = (SettingsAsset)event.getLoadedAssets().get("Settings");
      if (asset != null) {
   ...
   public WorldStructureAsset getWorldStructureAsset(@Nonnull String id) {
      return (WorldStructureAsset)this.worldStructureAssets.get(id);
   }
   ...
   static {
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(BiomeAsset.class, new DefaultAssetMap()).setPath("HytaleGenerator/Biomes")).setKeyFunction(BiomeAsset::getId)).setCodec(BiomeAsset.CODEC)).build());
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(WorldStructureAsset.class, new DefaultAssetMap()).setPath("HytaleGenerator/WorldStructures")).setKeyFunction(WorldStructureAsset::getId)).setCodec(WorldStructureAsset.CODEC)).build());
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(DensityAsset.class, new DefaultAssetMap()).setPath("HytaleGenerator/Density")).setKeyFunction(DensityAsset::getId)).setCodec(DensityAsset.CODEC)).build());
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(BlockMaskAsset.class, new DefaultAssetMap()).setPath("HytaleGenerator/MaterialMasks")).setKeyFunction(BlockMaskAsset::getId)).setCodec(BlockMaskAsset.CODEC)).build());
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(AssignmentsAsset.class, new DefaultAssetMap()).setPath("HytaleGenerator/Assignments")).setKeyFunction(AssignmentsAsset::getId)).setCodec(AssignmentsAsset.CODEC)).build());
      AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(SettingsAsset.class, new DefaultAssetMap()).setPath("HytaleGenerator/Settings")).setKeyFunction(SettingsAsset::getId)).setCodec(SettingsAsset.CODEC)).build());
      ...
      PositionProviderAsset.CODEC.register("Occurrence", FieldFunctionOccurrencePositionProviderAsset.class, FieldFunctionOccurrencePositionProviderAsset.CODEC);
      ...
      EnvironmentProviderAsset.CODEC.register("DensityDelimited", DensityDelimitedEnvironmentProviderAsset.class, DensityDelimitedEnvironmentProviderAsset.CODEC);
