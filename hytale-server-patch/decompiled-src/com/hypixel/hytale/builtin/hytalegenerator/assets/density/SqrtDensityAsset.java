...
public class SqrtDensityAsset extends DensityAsset {
   @Nonnull
   public static final BuilderCodec<SqrtDensityAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(SqrtDensityAsset.class, SqrtDensityAsset::new, DensityAsset.ABSTRACT_CODEC).build();
   }
}
