...
public class Distance2MulReturnTypeAsset extends ReturnTypeAsset {
   @Nonnull
   public static final BuilderCodec<Distance2MulReturnTypeAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(Distance2MulReturnTypeAsset.class, Distance2MulReturnTypeAsset::new, ReturnTypeAsset.ABSTRACT_CODEC).build();
   }
}
