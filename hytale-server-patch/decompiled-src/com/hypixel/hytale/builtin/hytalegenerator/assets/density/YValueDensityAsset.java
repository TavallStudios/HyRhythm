...
public class YValueDensityAsset extends DensityAsset {
   @Nonnull
   public static final BuilderCodec<YValueDensityAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(YValueDensityAsset.class, YValueDensityAsset::new, DensityAsset.ABSTRACT_CODEC).build();
   }
}
