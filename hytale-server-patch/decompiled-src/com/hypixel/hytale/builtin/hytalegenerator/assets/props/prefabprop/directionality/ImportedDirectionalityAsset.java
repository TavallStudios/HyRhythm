...
public class ImportedDirectionalityAsset extends DirectionalityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ImportedDirectionalityAsset.class, ImportedDirectionalityAsset::new, DirectionalityAsset.ABSTRACT_CODEC).append(new KeyedCodec("Name", Codec.STRING, true), (asset, v) -> asset.name = v, (asset) -> asset.name).add()).build();
   }
}
