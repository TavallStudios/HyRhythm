...
public class ZValueDensityAsset extends DensityAsset {
   @Nonnull
   public static final BuilderCodec<ZValueDensityAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(ZValueDensityAsset.class, ZValueDensityAsset::new, DensityAsset.ABSTRACT_CODEC).build();
   }
}
