...
public class Mesh3DPositionProviderAsset extends PositionProviderAsset {
   ...
   public PositionProvider build(@Nonnull PositionProviderAsset.Argument argument) {
      return (PositionProvider)(super.skip() ? PositionProvider.noPositionProvider() : new Mesh3DPositionProvider(this.pointGeneratorAsset.build(argument.parentSeed)));
   }

   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(Mesh3DPositionProviderAsset.class, Mesh3DPositionProviderAsset::new, PositionProviderAsset.ABSTRACT_CODEC).append(new KeyedCodec("PointGenerator", PointGeneratorAsset.CODEC, true), (asset, v) -> asset.pointGeneratorAsset = v, (asset) -> asset.pointGeneratorAsset).add()).build();
   }
}
