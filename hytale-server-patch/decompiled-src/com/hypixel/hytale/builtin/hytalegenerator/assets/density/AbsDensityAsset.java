...
public class AbsDensityAsset extends DensityAsset {
   @Nonnull
   public static final BuilderCodec<AbsDensityAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(AbsDensityAsset.class, AbsDensityAsset::new, DensityAsset.ABSTRACT_CODEC).build();
   }
}
