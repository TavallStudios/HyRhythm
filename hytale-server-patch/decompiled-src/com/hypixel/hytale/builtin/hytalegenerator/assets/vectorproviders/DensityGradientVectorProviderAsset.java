...
public class DensityGradientVectorProviderAsset extends VectorProviderAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(DensityGradientVectorProviderAsset.class, DensityGradientVectorProviderAsset::new, VectorProviderAsset.ABSTRACT_CODEC).append(new KeyedCodec("Density", DensityAsset.CODEC, true), (asset, value) -> asset.densityAsset = value, (asset) -> asset.densityAsset).add()).append(new KeyedCodec("SampleDistance", BuilderCodec.DOUBLE, true), (asset, value) -> asset.sampleDistance = value, (asset) -> asset.sampleDistance).addValidator(Validators.greaterThanOrEqual(0.0)).add()).build();
   }
}
