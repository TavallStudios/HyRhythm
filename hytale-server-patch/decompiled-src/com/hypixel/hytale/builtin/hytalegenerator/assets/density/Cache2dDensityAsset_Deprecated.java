...
public class Cache2dDensityAsset_Deprecated extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(Cache2dDensityAsset_Deprecated.class, Cache2dDensityAsset_Deprecated::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("Y", Codec.DOUBLE, false), (t, k) -> t.y = k, (t) -> t.y).add()).build();
   }
}
