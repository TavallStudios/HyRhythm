...
public class Distance2ReturnTypeAsset extends ReturnTypeAsset {
   @Nonnull
   public static final BuilderCodec<Distance2ReturnTypeAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(Distance2ReturnTypeAsset.class, Distance2ReturnTypeAsset::new, ReturnTypeAsset.ABSTRACT_CODEC).build();
   }
}
