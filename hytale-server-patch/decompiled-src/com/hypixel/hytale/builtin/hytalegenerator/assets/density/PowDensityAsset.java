...
public class PowDensityAsset extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(PowDensityAsset.class, PowDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("Exponent", Codec.DOUBLE, true), (t, k) -> t.exponent = k, (t) -> t.exponent).add()).build();
   }
}
