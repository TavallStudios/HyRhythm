...
public class CuboidDensityAsset extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CuboidDensityAsset.class, CuboidDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("Curve", CurveAsset.CODEC, true), (t, k) -> t.densityCurveAsset = k, (k) -> k.densityCurveAsset).add()).append(new KeyedCodec("Scale", Vector3d.CODEC, false), (t, k) -> t.scaleVector = k, (k) -> k.scaleVector).addValidator((LegacyValidator)((v, r) -> {
