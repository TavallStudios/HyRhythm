...
public class ImportedPatternAsset extends PatternAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ImportedPatternAsset.class, ImportedPatternAsset::new, PatternAsset.ABSTRACT_CODEC).append(new KeyedCodec("Name", Codec.STRING, true), (t, k) -> t.name = k, (k) -> k.name).add()).build();
   }
}
