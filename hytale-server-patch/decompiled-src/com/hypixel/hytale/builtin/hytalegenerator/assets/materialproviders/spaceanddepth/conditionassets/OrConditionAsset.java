...
public class OrConditionAsset extends ConditionAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(OrConditionAsset.class, OrConditionAsset::new, ConditionAsset.ABSTRACT_CODEC).append(new KeyedCodec("Conditions", new ArrayCodec(ConditionAsset.CODEC, (x$0) -> new ConditionAsset[x$0]), true), (t, k) -> t.conditionAssets = k, (k) -> k.conditionAssets).addValidator(Validators.nonNullArrayElements()).add()).build();
   }
}
