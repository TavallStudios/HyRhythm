...
public class PipelineDensityAsset extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(PipelineDensityAsset.class, PipelineDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("Pipeline", new ArrayCodec(DensityAsset.CODEC, (x$0) -> new DensityAsset[x$0])), (t, k) -> t.pipeline = k, (t) -> t.pipeline).add()).build();
   }
}
