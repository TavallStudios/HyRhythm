...
public class RotatorDensityAsset extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(RotatorDensityAsset.class, RotatorDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("NewYAxis", Vector3d.CODEC, true), (t, k) -> t.newYAxis = k, (t) -> t.newYAxis).add()).append(new KeyedCodec("SpinAngle", Codec.DOUBLE, true), (t, k) -> t.spinAngle = k, (t) -> t.spinAngle).add()).build();
   }
}
