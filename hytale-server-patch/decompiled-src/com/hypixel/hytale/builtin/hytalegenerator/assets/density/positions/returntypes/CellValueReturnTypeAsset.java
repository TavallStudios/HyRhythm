...
public class CellValueReturnTypeAsset extends ReturnTypeAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CellValueReturnTypeAsset.class, CellValueReturnTypeAsset::new, ReturnTypeAsset.ABSTRACT_CODEC).append(new KeyedCodec("Density", DensityAsset.CODEC, true), (t, k) -> t.densityAsset = k, (t) -> t.densityAsset).add()).append(new KeyedCodec("DefaultValue", Codec.DOUBLE, false), (t, k) -> t.defaultValue = k, (t) -> t.defaultValue).add()).build();
   }
}
