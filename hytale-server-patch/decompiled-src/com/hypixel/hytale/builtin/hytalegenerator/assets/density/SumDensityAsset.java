...
public class SumDensityAsset extends DensityAsset {
   @Nonnull
   public static final BuilderCodec<SumDensityAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(SumDensityAsset.class, SumDensityAsset::new, DensityAsset.ABSTRACT_CODEC).build();
   }
}
