...
public class MixDensityAsset extends DensityAsset {
   ...
   public Density build(@Nonnull DensityAsset.Argument argument) {
      if (this.isSkipped()) {
         ...
         return (Density)(builtInputs.size() != 3 ? new ConstantValueDensity(0.0) : new MixDensity((Density)builtInputs.get(0), (Density)builtInputs.get(1), (Density)builtInputs.get(2)));
      }
   }
