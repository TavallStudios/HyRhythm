...
public class MinDensityAsset extends DensityAsset {
   @Nonnull
   public static final BuilderCodec<MinDensityAsset> CODEC;
   ...
   static {
      CODEC = BuilderCodec.builder(MinDensityAsset.class, MinDensityAsset::new, DensityAsset.ABSTRACT_CODEC).build();
   }
}
