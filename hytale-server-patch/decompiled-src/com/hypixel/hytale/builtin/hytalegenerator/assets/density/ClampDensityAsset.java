...
public class ClampDensityAsset extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(ClampDensityAsset.class, ClampDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("WallA", Codec.DOUBLE, true), (t, k) -> t.wallA = k, (k) -> k.wallA).add()).append(new KeyedCodec("WallB", Codec.DOUBLE, true), (t, k) -> t.wallB = k, (k) -> k.wallB).add()).build();
   }
}
