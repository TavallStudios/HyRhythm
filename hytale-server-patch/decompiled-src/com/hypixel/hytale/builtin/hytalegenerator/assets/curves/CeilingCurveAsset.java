...
public class CeilingCurveAsset extends CurveAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CeilingCurveAsset.class, CeilingCurveAsset::new, CurveAsset.ABSTRACT_CODEC).append(new KeyedCodec("Curve", CurveAsset.CODEC, true), (t, k) -> t.curveAsset = k, (k) -> k.curveAsset).add()).append(new KeyedCodec("Ceiling", Codec.DOUBLE, true), (t, k) -> t.limit = k, (k) -> k.limit).add()).build();
   }
}
