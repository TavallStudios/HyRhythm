...
public class FrameworkPositionProviderAsset extends PositionProviderAsset {
   @Nonnull
   public static final BuilderCodec<FrameworkPositionProviderAsset> CODEC;
   private String name = "";
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(FrameworkPositionProviderAsset.class, FrameworkPositionProviderAsset::new, PositionProviderAsset.ABSTRACT_CODEC).append(new KeyedCodec("Name", Codec.STRING, true), (asset, v) -> asset.name = v, (asset) -> asset.name).add()).build();
   }
}
