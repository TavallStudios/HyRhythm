...
public class ZOverrideDensityAsset extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ZOverrideDensityAsset.class, ZOverrideDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("Value", Codec.DOUBLE, true), (t, k) -> t.value = k, (t) -> t.value).add()).build();
   }
}
