...
public class AngleDensityAsset extends DensityAsset {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(AngleDensityAsset.class, AngleDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("VectorProvider", VectorProviderAsset.CODEC, true), (asset, value) -> asset.vectorProviderAsset = value, (value) -> value.vectorProviderAsset).add()).append(new KeyedCodec("Vector", Vector3d.CODEC, true), (asset, value) -> asset.vector = value, (asset) -> asset.vector).add()).append(new KeyedCodec("IsAxis", Codec.BOOLEAN, true), (asset, value) -> asset.isAxis = value, (asset) -> asset.isAxis).add()).build();
   }
}
