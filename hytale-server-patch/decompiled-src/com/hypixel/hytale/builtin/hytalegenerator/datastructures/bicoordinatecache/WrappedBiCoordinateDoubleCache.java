...
public class WrappedBiCoordinateDoubleCache implements BiCoordinateCache<Double> {
   ...
   public String toString() {
      ...
      return "WrappedBiCoordinateDoubleCache{sizeX=" + var10000 + ", sizeZ=" + this.sizeZ + ", values=" + Arrays.toString(this.values) + ", populated=" + Arrays.toString(this.populated) + ", size=" + this.size + "}";
   }
}
