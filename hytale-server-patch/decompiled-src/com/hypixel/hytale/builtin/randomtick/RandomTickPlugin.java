...
public class RandomTickPlugin extends JavaPlugin {
   ...
   protected void setup() {
      ...
      RandomTickProcedure.CODEC.register((String)"ChangeIntoBlock", ChangeIntoBlockProcedure.class, ChangeIntoBlockProcedure.CODEC);
      RandomTickProcedure.CODEC.register((String)"SpreadTo", SpreadToProcedure.class, SpreadToProcedure.CODEC);
   }
