...
public class PrefabPathSystems {
   public static class AddOrRemove extends HolderSystem<EntityStore> {
      ...
      public void onEntityAdd(@Nonnull Holder<EntityStore> holder, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store) {
         PatrolPathMarkerEntity pathMarker = (PatrolPathMarkerEntity)holder.getComponent(PATH_MARKER_ENTITY_COMPONENT_TYPE);
         WorldPathData worldPathData = (WorldPathData)store.getResource(STORE_WORLD_PATH_DATA_RESOURCE_TYPE);
         WorldGenId worldGenIdComponent = (WorldGenId)holder.getComponent(WORLD_GEN_ID_COMPONENT_TYPE);
      ...
      public void onEntityRemoved(@Nonnull Holder<EntityStore> holder, @Nonnull RemoveReason reason, @Nonnull Store<EntityStore> store) {
         PatrolPathMarkerEntity pathMarker = (PatrolPathMarkerEntity)holder.getComponent(PatrolPathMarkerEntity.getComponentType());
   ...
   public static class NameplateHolderSystem extends HolderSystem<EntityStore> {
      ...
      public void onEntityAdd(@Nonnull Holder<EntityStore> holder, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store) {
         ...
         Nameplate nameplateComponent = (Nameplate)holder.getComponent(Nameplate.getComponentType());
   ...
   public static class WorldGenChangeSystem extends RefChangeSystem<EntityStore, WorldGenId> {
      ...
      public void onComponentAdded(@Nonnull Ref<EntityStore> ref, @Nonnull WorldGenId component, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         PatrolPathMarkerEntity patrolPathMarkerComponent = (PatrolPathMarkerEntity)commandBuffer.getComponent(ref, PatrolPathMarkerEntity.getComponentType());
      ...
      public void onComponentSet(@Nonnull Ref<EntityStore> ref, @Nullable WorldGenId oldComponent, @Nonnull WorldGenId newComponent, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
         PatrolPathMarkerEntity patrolPathMarkerComponent = (PatrolPathMarkerEntity)commandBuffer.getComponent(ref, PatrolPathMarkerEntity.getComponentType());
      ...
      public void onComponentRemoved(@Nonnull Ref<EntityStore> ref, @Nonnull WorldGenId component, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
