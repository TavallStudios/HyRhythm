...
public class PrefabPathUpdatePauseCommand extends AbstractWorldCommand {
   ...
   public PrefabPathUpdatePauseCommand() {
      ...
      this.entityIdArg = (EntityWrappedArg)this.withOptionalArg("entityId", "server.commands.npcpath.update.pause.entityId.desc", ArgTypes.ENTITY_ID);
   ...
   protected void execute(@Nonnull CommandContext context, @Nonnull World world, @Nonnull Store<EntityStore> store) {
      Double pauseTime = (Double)this.pauseTimeArg.get(context);
      Ref<EntityStore> ref;
      ...
      PatrolPathMarkerEntity patrolPathMarkerComponent = (PatrolPathMarkerEntity)store.getComponent(ref, PatrolPathMarkerEntity.getComponentType());
