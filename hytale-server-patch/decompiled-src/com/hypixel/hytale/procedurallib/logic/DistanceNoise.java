...
public abstract class DistanceNoise implements NoiseFunction {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.cellDistanceFunction);
      return "DistanceNoise{cellDistanceFunction=" + var10000 + ", pointEvaluator=" + String.valueOf(this.pointEvaluator) + ", distance2Function=" + String.valueOf(this.distance2Function) + "}";
   }
