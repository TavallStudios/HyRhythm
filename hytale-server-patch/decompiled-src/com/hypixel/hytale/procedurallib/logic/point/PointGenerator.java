...
public class PointGenerator implements IPointGenerator {
   ...
   public String toString() {
      ...
      return "PointGenerator{seedOffset=" + var10000 + ", cellDistanceFunction=" + String.valueOf(this.cellDistanceFunction) + ", pointEvaluator=" + String.valueOf(this.pointEvaluator) + "}";
   }
}
