...
public class PerlinNoise implements NoiseFunction {
   ...
   public double get(int seed, int offsetSeed, double x, double y, double z) {
      ...
      double xd0 = x - (double)x0;
      double yd0 = y - (double)y0;
      double zd0 = z - (double)z0;
      double xd1 = xd0 - 1.0;
      double yd1 = yd0 - 1.0;
      double zd1 = zd0 - 1.0;
      double xf00 = GeneralNoise.lerp(GeneralNoise.gradCoord3D(offsetSeed, x0, y0, z0, xd0, yd0, zd0), GeneralNoise.gradCoord3D(offsetSeed, x1, y0, z0, xd1, yd0, zd0), xs);
      double xf10 = GeneralNoise.lerp(GeneralNoise.gradCoord3D(offsetSeed, x0, y1, z0, xd0, yd1, zd0), GeneralNoise.gradCoord3D(offsetSeed, x1, y1, z0, xd1, yd1, zd0), xs);
      double xf01 = GeneralNoise.lerp(GeneralNoise.gradCoord3D(offsetSeed, x0, y0, z1, xd0, yd0, zd1), GeneralNoise.gradCoord3D(offsetSeed, x1, y0, z1, xd1, yd0, zd1), xs);
      double xf11 = GeneralNoise.lerp(GeneralNoise.gradCoord3D(offsetSeed, x0, y1, z1, xd0, yd1, zd1), GeneralNoise.gradCoord3D(offsetSeed, x1, y1, z1, xd1, yd1, zd1), xs);
