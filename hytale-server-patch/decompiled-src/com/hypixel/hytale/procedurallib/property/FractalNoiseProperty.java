...
public class FractalNoiseProperty implements NoiseProperty {
   ...
   public String toString() {
      ...
      return "FractalNoiseProperty{seedOffset=" + var10000 + ", function=" + String.valueOf(this.function) + ", fractalFunction=" + String.valueOf(this.fractalFunction) + ", octaves=" + this.octaves + ", lacunarity=" + this.lacunarity + ", persistence=" + this.persistence + "}";
   }
      ...
      MULTI_RIGID(new FractalFunction() {
         ...
         public double get(int seed, int offsetSeed, double x, double y, double z, int octaves, double lacunarity, double persistence, @Nonnull NoiseFunction3d noise) {
            ...
            for(int i = 1; i < octaves; ++i) {
               ...
               ++offsetSeed;
               sum -= (1.0 - Math.abs(noise.get(seed, offsetSeed, x, y, z))) * (double)amp;
            }
