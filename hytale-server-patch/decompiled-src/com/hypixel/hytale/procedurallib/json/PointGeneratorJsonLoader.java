...
public class PointGeneratorJsonLoader<K extends SeedResource> extends JsonLoader<K, IPointGenerator> {
   ...
   public IPointGenerator load() {
      ...
      double offsetX = -1.0 / 0.0;
      double offsetY = -1.0 / 0.0;
      double offsetZ = -1.0 / 0.0;
      if (this.has("Offset")) {
      ...
      if (offsetX != -1.0 / 0.0 || offsetY != -1.0 / 0.0 || offsetZ != -1.0 / 0.0) {
         if (offsetX == -1.0 / 0.0) {
            offsetX = 0.0;
         }
   ...
   protected int loadSeed() {
      ...
      if (this.has("Seed")) {
         ...
         this.seed.get().reportSeeds(seedVal, this.seed.original, this.seed.seed, (String)null);
      }
