...
public class FloatRangeJsonLoader<K extends SeedResource> extends JsonLoader<K, IFloatRange> {
   ...
   public FloatRangeJsonLoader(@Nonnull SeedString<K> seed, Path dataFolder, JsonElement json, float default1, float default2, FloatToFloatFunction function) {
      ...
      this.function = (FloatToFloatFunction)Objects.requireNonNull(function);
   }
      ...
      if (this.json != null && !this.json.isJsonNull()) {
         if (this.json.isJsonArray()) {
            ...
            if (array.size() != 1 && array.size() != 2) {
               ...
               return (IFloatRange)(array.size() == 1 ? new FloatRange.Constant(this.function.get(array.get(0).getAsFloat())) : new FloatRange.Normal(this.function.get(array.get(0).getAsFloat()), this.function.get(array.get(1).getAsFloat())));
            }
         ...
         return (IFloatRange)(this.default1 == this.default2 ? new FloatRange.Constant(this.function.get(this.default1)) : new FloatRange.Normal(this.function.get(this.default1), this.function.get(this.default2)));
      }
   }
