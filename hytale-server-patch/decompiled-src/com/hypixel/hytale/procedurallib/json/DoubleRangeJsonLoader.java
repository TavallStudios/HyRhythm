...
public class DoubleRangeJsonLoader<K extends SeedResource> extends JsonLoader<K, IDoubleRange> {
   ...
   public DoubleRangeJsonLoader(@Nonnull SeedString<K> seed, Path dataFolder, JsonElement json, double default1, double default2, DoubleToDoubleFunction function) {
      ...
      this.function = (DoubleToDoubleFunction)Objects.requireNonNull(function);
   }
      ...
      if (this.json != null && !this.json.isJsonNull()) {
         if (this.json.isJsonArray()) {
            ...
            if (array.size() != 1 && array.size() != 2) {
               ...
               return (IDoubleRange)(array.size() == 1 ? new DoubleRange.Constant(this.function.get(array.get(0).getAsDouble())) : new DoubleRange.Normal(this.function.get(array.get(0).getAsDouble()), this.function.get(array.get(1).getAsDouble())));
            }
         ...
         return (IDoubleRange)(this.default1 == this.default2 ? new DoubleRange.Constant(this.function.get(this.default1)) : new DoubleRange.Normal(this.function.get(this.default1), this.function.get(this.default2)));
      }
   }
