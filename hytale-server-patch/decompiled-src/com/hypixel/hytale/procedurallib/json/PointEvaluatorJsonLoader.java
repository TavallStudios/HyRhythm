...
public class PointEvaluatorJsonLoader<T extends SeedResource> extends AbstractCellJitterJsonLoader<T, PointEvaluator> {
   ...
   public PointEvaluatorJsonLoader(@Nonnull SeedString<T> seed, Path dataFolder, JsonElement json) {
      this(seed, dataFolder, json, (PointDistanceFunction)null);
   }
   ...
   public PointEvaluator load() {
      ...
      switch (this.measurementMode) {
         case CENTRE_DISTANCE -> var10000 = this.loadCentrePointEvaluator();
         case BORDER_DISTANCE -> var10000 = this.loadBorderPointEvaluator();
   ...
   public PointEvaluator loadCentrePointEvaluator() {
      return PointEvaluator.of(this.loadPointDistanceFunction(), this.loadDensity(), this.loadDistanceRange(), this.loadSkipCount(), this.loadSkipMode(), this.loadJitter());
   }
