...
public class CoordinateRotatorJsonLoader<K extends SeedResource> extends JsonLoader<K, CoordinateRotator> {
   ...
   public CoordinateRotator load() {
      ...
      if (pitch == 0.0 && yaw == 0.0) {
         ...
         return (CoordinateRotator)(originX == 0.0 && originY == 0.0 && originZ == 0.0 ? new CoordinateRotator(pitch, yaw) : new CoordinateOriginRotator(pitch, yaw, originX, originY, originZ));
      }
   }
