...
public class CoordinateRandomizer implements ICoordinateRandomizer {
   ...
   public String toString() {
      String var10000 = Arrays.toString(this.xNoise);
      return "CoordinateRandomizer{xNoise=" + var10000 + ", yNoise=" + Arrays.toString(this.yNoise) + ", zNoise=" + Arrays.toString(this.zNoise) + "}";
   }
   ...
   public static class AmplitudeNoiseProperty {
      ...
      @Nonnull
      public String toString() {
         String var10000 = String.valueOf(this.property);
         return "AmplitudeNoiseProperty{property=" + var10000 + ", amplitude=" + this.amplitude + "}";
      }
   }
