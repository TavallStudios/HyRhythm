...
public class HistoricMetric {
   ...
   private HistoricMetric(@Nonnull Builder builder) {
      ...
      Arrays.fill(this.timestamps, 9223372036854775807L);
   }
   ...
   static {
      METRICS_CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(HistoricMetric.class, HistoricMetric::new).append(new KeyedCodec("PeriodsNanos", Codec.LONG_ARRAY), (historicMetric, s) -> {
         throw new UnsupportedOperationException("Not supported");
