...
public class JVMMetrics {
   ...
   static {
      ...
      MEMORY_USAGE_METRICS_REGISTRY = new MetricsRegistry<MemoryUsage>();
      ...
      GARBAGE_COLLECTOR_METRICS_REGISTRY = new MetricsRegistry<GarbageCollectorMXBean>();
      ...
      MEMORY_POOL_METRICS_REGISTRY = new MetricsRegistry<MemoryPoolMXBean>();
      ...
      MEMORY_POOL_METRICS_REGISTRY.register("UsageThreshold", (memoryPoolMXBean) -> !memoryPoolMXBean.isUsageThresholdSupported() ? null : memoryPoolMXBean, usageThreshold);
      usageThreshold = new MetricsRegistry<MemoryPoolMXBean>();
      ...
      MEMORY_POOL_METRICS_REGISTRY.register("CollectionUsageThreshold", (memoryPoolMXBean) -> !memoryPoolMXBean.isCollectionUsageThresholdSupported() ? null : memoryPoolMXBean, usageThreshold);
      ...
      if (ManagementFactory.getOperatingSystemMXBean() instanceof com.sun.management.OperatingSystemMXBean) {
         usageThreshold.register("CpuLoad", (operatingSystemMXBean) -> ((com.sun.management.OperatingSystemMXBean)operatingSystemMXBean).getCpuLoad(), Codec.DOUBLE);
         usageThreshold.register("ProcessCpuLoad", (operatingSystemMXBean) -> ((com.sun.management.OperatingSystemMXBean)operatingSystemMXBean).getProcessCpuLoad(), Codec.DOUBLE);
         usageThreshold.register("TotalMemorySize", (operatingSystemMXBean) -> ((com.sun.management.OperatingSystemMXBean)operatingSystemMXBean).getTotalMemorySize(), Codec.LONG);
         usageThreshold.register("FreeMemorySize", (operatingSystemMXBean) -> ((com.sun.management.OperatingSystemMXBean)operatingSystemMXBean).getFreeMemorySize(), Codec.LONG);
         usageThreshold.register("TotalSwapSpaceSize", (operatingSystemMXBean) -> ((com.sun.management.OperatingSystemMXBean)operatingSystemMXBean).getTotalSwapSpaceSize(), Codec.LONG);
         usageThreshold.register("FreeSwapSpaceSize", (operatingSystemMXBean) -> ((com.sun.management.OperatingSystemMXBean)operatingSystemMXBean).getFreeSwapSpaceSize(), Codec.LONG);
      }
      ...
      usageThreshold.register("InputArguments", (runtimeMXBean) -> (String[])runtimeMXBean.getInputArguments().toArray((x$0) -> new String[x$0]), Codec.STRING_ARRAY);
      ...
      METRICS_REGISTRY.register("GarbageCollectors", (memoryMXBean) -> (GarbageCollectorMXBean[])ManagementFactory.getGarbageCollectorMXBeans().toArray((x$0) -> new GarbageCollectorMXBean[x$0]), new ArrayCodec(GARBAGE_COLLECTOR_METRICS_REGISTRY, (x$0) -> new GarbageCollectorMXBean[x$0]));
      METRICS_REGISTRY.register("MemoryPools", (memoryMXBean) -> (MemoryPoolMXBean[])ManagementFactory.getMemoryPoolMXBeans().toArray((x$0) -> new MemoryPoolMXBean[x$0]), new ArrayCodec(MEMORY_POOL_METRICS_REGISTRY, (x$0) -> new MemoryPoolMXBean[x$0]));
      METRICS_REGISTRY.register("Threads", (aVoid) -> {
         ...
         return data;
      }, new ArrayCodec(JVMMetrics.ThreadMetricData.METRICS_REGISTRY, (x$0) -> new ThreadMetricData[x$0]));
   ...
   private static class ThreadMetricData {
      @Nonnull
      public static final MetricsRegistry<StackTraceElement> STACK_TRACE_ELEMENT_METRICS_REGISTRY = new MetricsRegistry<StackTraceElement>();
      @Nonnull
      ...
      static {
         ...
         METRICS_REGISTRY = new MetricsRegistry<ThreadMetricData>();
         ...
         METRICS_REGISTRY.register("State", (threadMetricData) -> threadMetricData.threadInfo.getThreadState(), new EnumCodec(Thread.State.class));
         ...
         METRICS_REGISTRY.register("StackTrace", (threadMetricData) -> threadMetricData.threadInfo.getStackTrace(), new ArrayCodec(STACK_TRACE_ELEMENT_METRICS_REGISTRY, (x$0) -> new StackTraceElement[x$0]));
         METRICS_REGISTRY.register("InitStackTrace", (threadMetricData) -> threadMetricData.thread instanceof InitStackThread ? ((InitStackThread)threadMetricData.thread).getInitStack() : null, new ArrayCodec(STACK_TRACE_ELEMENT_METRICS_REGISTRY, (x$0) -> new StackTraceElement[x$0]));
         METRICS_REGISTRY.register("Interrupted", (threadMetricData) -> threadMetricData.thread != null ? threadMetricData.thread.isInterrupted() : null, Codec.BOOLEAN);
