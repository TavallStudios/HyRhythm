...
public class IndexedStorageFile_v0 implements Closeable {
   ...
   protected int clearSegments(int firstSegmentIndex, @Nonnull ByteBuffer tempIndexBuffer) throws IOException {
      ...
      int segmentIndex;
      for(int nextSegmentIndex = firstSegmentIndex; nextSegmentIndex != 0 && nextSegmentIndex != -2147483648; nextSegmentIndex = segmentIndex) {
   ...
   private SegmentRangeLock findFreeSegment(int count) {
      ...
      while(true) {
         label95:
         while(found >= count) {
            SegmentRangeLock segmentRangeLock = this.tryWriteLockSegmentRange(start, count);
   ...
   public String toString() {
      ...
      return "IndexedStorageFile{fileChannel=" + var10000 + ", compressionLevel=" + this.compressionLevel + ", contiguousBlobs=" + this.contiguousBlobs + ", blobCount=" + this.blobCount + ", segmentSize=" + this.segmentSize + ", mappedBlobIndexes=" + String.valueOf(this.mappedBlobIndexes) + ", nextSegmentIndexes=" + Arrays.toString(this.nextSegmentIndexes) + "}";
   }
   ...
   static {
      ...
      NEXT_SEGMENT_OFFSET = SOH.next(4);
