...
public class PathUtil {
   ...
   public static Path relativize(@Nonnull Path pathA, @Nonnull Path pathB) {
      ...
      return Objects.equals(absolutePathA.getRoot(), absolutePathB.getRoot()) ? absolutePathA.normalize().relativize(absolutePathB.normalize()).normalize() : absolutePathB.normalize();
   }
