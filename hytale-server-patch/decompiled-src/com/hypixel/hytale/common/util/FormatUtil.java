...
public class FormatUtil {
   ...
   public static String simpleTimeUnitFormat(long min, double average, long max, TimeUnit timeUnit, @Nonnull TimeUnit largestUnit, int rounding) {
      int roundValue = (int)Math.pow(10.0, (double)rounding);
      ...
      String unitStr = (String)timeUnitToShortString.get(largestUnit);
   ...
   public static String simpleFormat(long min1, double average1, long max1, @Nonnull DoubleUnaryOperator doubleFunction, int rounding) {
      ...
      double min = Math.abs(average - doubleFunction.applyAsDouble((double)min1));
      double max = Math.abs(doubleFunction.applyAsDouble((double)max1) - average);
   ...
   public static String timeUnitToString(@Nonnull Metric metric, @Nonnull TimeUnit timeUnit) {
      ...
      String var10000 = timeUnitToString(Math.round(metric.getAverage()), timeUnit);
      return var10000 + "  +/-" + timeUnitToString(range, timeUnit);
   }
   ...
   public static String timeUnitToString(long value, @Nonnull TimeUnit timeUnit, boolean paddingBetween) {
      ...
      boolean var10000 = p | timeToStringPart(time, sb, p, timeUnit, TimeUnit.NANOSECONDS, "ns", true, paddingBetween);
      return sb.toString();
   }
   ...
   public static String bytesToString(long bytes, boolean si) {
      ...
      if (bytes < (long)unit) {
         ...
         Object[] var10001 = new Object[]{(double)bytes / Math.pow((double)unit, (double)exp), null};
         char var10004 = (si ? "kMGTPE" : "KMGTPE").charAt(exp - 1);
         var10001[1] = var10004 + (si ? "" : "i");
         return String.format("%.1f %sB", var10001);
      }
   }
   ...
   public static String addNumberSuffix(int i) {
      ...
      switch (i % 100) {
         ...
         case 13:
            ...
            break;
         default:
            var10000 = i + NUMBER_SUFFIXES[i % 10];
      }
