...
public class AuthorInfo {
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(AuthorInfo.class, AuthorInfo::new).append(new KeyedCodec("Name", Codec.STRING), (authorInfo, s) -> authorInfo.name = s, (authorInfo) -> authorInfo.name).add()).append(new KeyedCodec("Email", Codec.STRING), (authorInfo, s) -> authorInfo.email = s, (authorInfo) -> authorInfo.email).add()).append(new KeyedCodec("Url", Codec.STRING), (authorInfo, s) -> authorInfo.url = s, (authorInfo) -> authorInfo.url).add()).build();
   }
}
