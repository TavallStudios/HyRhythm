...
public class PluginManifest {
   ...
   public String toString() {
      String var10000 = this.group;
      return "PluginManifest{group='" + var10000 + "', name='" + this.name + "', version='" + String.valueOf(this.version) + "', description='" + this.description + "', authors=" + String.valueOf(this.authors) + ", website='" + this.website + "', main='" + this.main + "', serverVersion=" + this.serverVersion + ", dependencies=" + String.valueOf(this.dependencies) + ", optionalDependencies=" + String.valueOf(this.optionalDependencies) + ", disabledByDefault=" + this.disabledByDefault + "}";
   }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BUILDER.append(new KeyedCodec("Group", Codec.STRING), (manifest, o) -> manifest.group = o, (manifest) -> manifest.group).add()).append(new KeyedCodec("Name", Codec.STRING), (manifest, o) -> manifest.name = o, (manifest) -> manifest.name).addValidator(Validators.nonNull()).add()).append(new KeyedCodec("Version", Semver.CODEC), (manifest, o) -> manifest.version = o, (manifest) -> manifest.version).add()).append(new KeyedCodec("Description", Codec.STRING), (manifest, o) -> manifest.description = o, (manifest) -> manifest.description).add()).append(new KeyedCodec("Authors", new ArrayCodec(AuthorInfo.CODEC, (x$0) -> new AuthorInfo[x$0])), (manifest, o) -> manifest.authors = List.of(o), (manifest) -> (AuthorInfo[])manifest.authors.toArray((x$0) -> new AuthorInfo[x$0])).add()).append(new KeyedCodec("Website", Codec.STRING), (manifest, o) -> manifest.website = o, (manifest) -> manifest.website).add()).append(new KeyedCodec("Main", Codec.STRING), (manifest, o) -> manifest.main = o, (manifest) -> manifest.main).add()).append(new KeyedCodec("ServerVersion", Codec.STRING), (manifest, o) -> manifest.serverVersion = o, (manifest) -> manifest.serverVersion).add()).append(new KeyedCodec("Dependencies", new ObjectMapCodec(SemverRange.CODEC, Object2ObjectLinkedOpenHashMap::new, PluginIdentifier::toString, PluginIdentifier::fromString)), (manifest, o) -> manifest.dependencies = o, (manifest) -> manifest.dependencies).add()).append(new KeyedCodec("OptionalDependencies", new ObjectMapCodec(SemverRange.CODEC, Object2ObjectLinkedOpenHashMap::new, PluginIdentifier::toString, PluginIdentifier::fromString)), (manifest, o) -> manifest.optionalDependencies = o, (manifest) -> manifest.optionalDependencies).add()).append(new KeyedCodec("LoadBefore", new ObjectMapCodec(SemverRange.CODEC, Object2ObjectLinkedOpenHashMap::new, PluginIdentifier::toString, PluginIdentifier::fromString)), (manifest, o) -> manifest.loadBefore = o, (manifest) -> manifest.loadBefore).add()).append(new KeyedCodec("DisabledByDefault", Codec.BOOLEAN), (manifest, o) -> manifest.disabledByDefault = o, (manifest) -> manifest.disabledByDefault).add()).append(new KeyedCodec("IncludesAssetPack", Codec.BOOLEAN), (manifest, o) -> manifest.includesAssetPack = o, (o) -> o.includesAssetPack).add()).build();
      BUILDER.append(new KeyedCodec("SubPlugins", new ArrayCodec(CODEC, (x$0) -> new PluginManifest[x$0])), (manifest, o) -> manifest.subPlugins = List.of(o), (manifest) -> (PluginManifest[])manifest.subPlugins.toArray((x$0) -> new PluginManifest[x$0])).add();
      ARRAY_CODEC = new ArrayCodec<PluginManifest[]>(CODEC, (x$0) -> new PluginManifest[x$0]);
   ...
   public static class CoreBuilder {
      ...
      public PluginManifest build() {
         return new PluginManifest(this.group, this.name, this.version, this.description, Collections.emptyList(), (String)null, this.main, ManifestUtil.getVersion() == null ? "0.0.0-dev" : ManifestUtil.getVersion(), this.dependencies, this.optionalDependencies, this.loadBefore, Collections.emptyList(), false);
      }
   }
}
