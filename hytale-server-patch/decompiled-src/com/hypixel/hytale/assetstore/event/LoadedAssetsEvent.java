...
public class LoadedAssetsEvent<K, T extends JsonAsset<K>, M extends AssetMap<K, T>> extends AssetsEvent<K, T> {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.loadedAssets);
      return "LoadedAssetsEvent{loadedAssets=" + var10000 + ", initial=" + this.initial + ", query=" + String.valueOf(this.query) + "} " + super.toString();
   }
}
