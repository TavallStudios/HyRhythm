...
public class FluidFXMovementSettings {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof FluidFXMovementSettings)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.swimUpSpeed, this.swimDownSpeed, this.sinkSpeed, this.horizontalSpeedMultiplier, this.fieldOfViewMultiplier, this.entryVelocityMultiplier});
   }
}
