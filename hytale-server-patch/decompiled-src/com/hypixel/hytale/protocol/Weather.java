...
public class Weather {
   ...
   public int computeSize() {
      ...
      if (this.moons != null) {
         ...
         for(Map.Entry<Integer, String> kvp : this.moons.entrySet()) {
            moonsSize += 4 + PacketIO.stringSize((String)kvp.getValue());
         }
   ...
   public Weather clone() {
      ...
      copy.clouds = this.clouds != null ? (Cloud[])Arrays.stream(this.clouds).map((ex) -> ex.clone()).toArray((x$0) -> new Cloud[x$0]) : null;
      ...
      if (this.sunlightColors != null) {
         ...
         for(Map.Entry<Float, Color> e : this.sunlightColors.entrySet()) {
            m.put((Float)e.getKey(), ((Color)e.getValue()).clone());
         }
      ...
      if (this.skyTopColors != null) {
         ...
         for(Map.Entry<Float, ColorAlpha> e : this.skyTopColors.entrySet()) {
            m.put((Float)e.getKey(), ((ColorAlpha)e.getValue()).clone());
         }
