...
public class EqualizerEffect {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof EqualizerEffect)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.lowGain, this.lowCutOff, this.lowMidGain, this.lowMidCenter, this.lowMidWidth, this.highMidGain, this.highMidCenter, this.highMidWidth, this.highGain, this.highCutOff});
   }
}
