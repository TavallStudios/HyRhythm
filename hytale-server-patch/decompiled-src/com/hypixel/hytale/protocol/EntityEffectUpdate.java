...
public class EntityEffectUpdate {
   ...
   public static EntityEffectUpdate deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + statusEffectIconVarLen + statusEffectIconLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof EntityEffectUpdate)) {
         return false;
      } else {
         EntityEffectUpdate other = (EntityEffectUpdate)obj;
         return Objects.equals(this.type, other.type) && this.id == other.id && this.remainingTime == other.remainingTime && this.infinite == other.infinite && this.debuff == other.debuff && Objects.equals(this.statusEffectIcon, other.statusEffectIcon);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.id, this.remainingTime, this.infinite, this.debuff, this.statusEffectIcon});
   }
}
