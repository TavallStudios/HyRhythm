...
public class RoofConnectedBlockRuleSet {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof RoofConnectedBlockRuleSet)) {
         return false;
      } else {
         RoofConnectedBlockRuleSet other = (RoofConnectedBlockRuleSet)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.regular, this.hollow, this.topperBlockId, this.width, this.materialName});
   }
}
