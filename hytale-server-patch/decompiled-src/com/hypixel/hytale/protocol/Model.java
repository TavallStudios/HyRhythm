...
public class Model {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.detailBoxes != null) {
         ...
         for(Map.Entry<String, DetailBox[]> e : this.detailBoxes.entrySet()) {
            PacketIO.writeVarString(buf, (String)e.getKey(), 4096000);
            VarInt.write(buf, ((DetailBox[])e.getValue()).length);

            for(DetailBox arrItem : (DetailBox[])e.getValue()) {
   ...
   public int computeSize() {
      ...
      if (this.detailBoxes != null) {
         ...
         for(Map.Entry<String, DetailBox[]> kvp : this.detailBoxes.entrySet()) {
            detailBoxesSize += PacketIO.stringSize((String)kvp.getKey()) + VarInt.size(((DetailBox[])kvp.getValue()).length) + ((DetailBox[])kvp.getValue()).length * 37;
         }
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 99) {
         ...
         if ((nullBits[0] & 16) != 0) {
            ...
            int pos = offset + 99 + textureOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[0] & 32) != 0) {
            ...
            int pos = offset + 99 + gradientSetOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[0] & 64) != 0) {
            ...
            int pos = offset + 99 + gradientIdOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[0] & 128) != 0) {
            ...
            int pos = offset + 99 + cameraOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 1) != 0) {
            ...
            int pos = offset + 99 + animationSetsOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 2) != 0) {
            ...
            int pos = offset + 99 + attachmentsOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 4) != 0) {
            ...
            int pos = offset + 99 + particlesOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 8) != 0) {
            ...
            int pos = offset + 99 + trailsOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 16) != 0) {
            ...
            int pos = offset + 99 + detailBoxesOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 32) != 0) {
            ...
            int pos = offset + 99 + phobiaModelOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public Model clone() {
      ...
      copy.attachments = this.attachments != null ? (ModelAttachment[])Arrays.stream(this.attachments).map((ex) -> ex.clone()).toArray((x$0) -> new ModelAttachment[x$0]) : null;
      ...
      if (this.detailBoxes != null) {
         ...
         for(Map.Entry<String, DetailBox[]> e : this.detailBoxes.entrySet()) {
            m.put((String)e.getKey(), (DetailBox[])Arrays.stream((DetailBox[])e.getValue()).map((x) -> x.clone()).toArray((x$0) -> new DetailBox[x$0]));
         }
