...
public class CombatTextUpdate extends ComponentUpdate {
   ...
   public static CombatTextUpdate deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if (textLen < 0) {
         ...
         int var10000 = pos + textVarLen + textLen;
         return obj;
      }
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof CombatTextUpdate)) {
         return false;
      } else {
         CombatTextUpdate other = (CombatTextUpdate)obj;
         return this.hitAngleDeg == other.hitAngleDeg && Objects.equals(this.text, other.text);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.hitAngleDeg, this.text});
   }
}
