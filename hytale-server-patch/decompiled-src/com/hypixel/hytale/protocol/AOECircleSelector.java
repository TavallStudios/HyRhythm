...
public class AOECircleSelector extends Selector {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AOECircleSelector)) {
         return false;
      } else {
         AOECircleSelector other = (AOECircleSelector)obj;
         return this.range == other.range && Objects.equals(this.offset, other.offset);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.range, this.offset});
   }
}
