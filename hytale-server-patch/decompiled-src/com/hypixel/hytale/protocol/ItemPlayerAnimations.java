...
public class ItemPlayerAnimations {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.animations != null) {
         ...
         for(Map.Entry<String, ItemAnimation> e : this.animations.entrySet()) {
            PacketIO.writeVarString(buf, (String)e.getKey(), 4096000);
            ((ItemAnimation)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public int computeSize() {
      ...
      if (this.animations != null) {
         ...
         for(Map.Entry<String, ItemAnimation> kvp : this.animations.entrySet()) {
            animationsSize += PacketIO.stringSize((String)kvp.getKey()) + ((ItemAnimation)kvp.getValue()).computeSize();
         }
   ...
   public ItemPlayerAnimations clone() {
      ...
      if (this.animations != null) {
         ...
         for(Map.Entry<String, ItemAnimation> e : this.animations.entrySet()) {
            m.put((String)e.getKey(), ((ItemAnimation)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ItemPlayerAnimations)) {
         return false;
      } else {
         ItemPlayerAnimations other = (ItemPlayerAnimations)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.animations, this.wiggleWeights, this.camera, this.pullbackConfig, this.useFirstPersonOverride});
   }
}
