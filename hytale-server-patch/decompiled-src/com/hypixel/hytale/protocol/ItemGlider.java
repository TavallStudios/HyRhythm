...
public class ItemGlider {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ItemGlider)) {
         return false;
      } else {
         ItemGlider other = (ItemGlider)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.terminalVelocity, this.fallSpeedMultiplier, this.horizontalSpeedMultiplier, this.speed});
   }
}
