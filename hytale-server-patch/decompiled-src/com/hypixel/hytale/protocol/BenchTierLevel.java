...
public class BenchTierLevel {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BenchTierLevel)) {
         return false;
      } else {
         BenchTierLevel other = (BenchTierLevel)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.benchUpgradeRequirement, this.craftingTimeReductionModifier, this.extraInputSlot, this.extraOutputSlot});
   }
}
