...
public class AOECylinderSelector extends Selector {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AOECylinderSelector)) {
         return false;
      } else {
         AOECylinderSelector other = (AOECylinderSelector)obj;
         return this.range == other.range && this.height == other.height && Objects.equals(this.offset, other.offset);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.range, this.height, this.offset});
   }
}
