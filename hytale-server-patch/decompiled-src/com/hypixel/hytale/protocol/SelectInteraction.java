...
public class SelectInteraction extends SimpleInteraction {
   ...
   public SelectInteraction clone() {
      ...
      copy.hitEntityRules = this.hitEntityRules != null ? (HitEntity[])Arrays.stream(this.hitEntityRules).map((ex) -> ex.clone()).toArray((x$0) -> new HitEntity[x$0]) : null;
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SelectInteraction)) {
         return false;
      } else {
   ...
   public int hashCode() {
      ...
      result = 31 * result + Objects.hashCode(this.failOn);
      return result;
   }
}
