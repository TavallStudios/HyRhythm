...
public class PlaceBlockInteraction extends SimpleInteraction {
   ...
   public PlaceBlockInteraction(@Nonnull WaitForDataFrom waitForDataFrom, @Nullable InteractionEffects effects, float horizontalSpeedMultiplier, float runTime, boolean cancelOnItemChange, @Nullable Map<GameMode, InteractionSettings> settings, @Nullable InteractionRules rules, @Nullable int[] tags, @Nullable InteractionCameraSettings camera, int next, int failed, int blockId, boolean removeItemInHand, boolean allowDragPlacement) {
      ...
      this.allowDragPlacement = allowDragPlacement;
   }
   ...
   public PlaceBlockInteraction(@Nonnull PlaceBlockInteraction other) {
      ...
      this.allowDragPlacement = other.allowDragPlacement;
   }

   @Nonnull
   public static PlaceBlockInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      PlaceBlockInteraction obj = new PlaceBlockInteraction();
      ...
      obj.blockId = buf.getIntLE(offset + 19);
      obj.removeItemInHand = buf.getByte(offset + 23) != 0;
      obj.allowDragPlacement = buf.getByte(offset + 24) != 0;
      if ((nullBits & 1) != 0) {
         int varPos0 = offset + 45 + buf.getIntLE(offset + 25);
         obj.effects = InteractionEffects.deserialize(buf, varPos0);
      }

      if ((nullBits & 2) != 0) {
         int varPos1 = offset + 45 + buf.getIntLE(offset + 29);
      ...
      if ((nullBits & 4) != 0) {
         int varPos2 = offset + 45 + buf.getIntLE(offset + 33);
         obj.rules = InteractionRules.deserialize(buf, varPos2);
      }

      if ((nullBits & 8) != 0) {
         int varPos3 = offset + 45 + buf.getIntLE(offset + 37);
      ...
      if ((nullBits & 16) != 0) {
         int varPos4 = offset + 45 + buf.getIntLE(offset + 41);
   ...
   public int serialize(@Nonnull ByteBuf buf) {
      ...
      buf.writeByte(this.removeItemInHand ? 1 : 0);
      buf.writeByte(this.allowDragPlacement ? 1 : 0);
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 45) {
         ...
         if ((nullBits & 2) != 0) {
            ...
            int pos = offset + 45 + settingsOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 16) != 0) {
            ...
            int pos = offset + 45 + cameraOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public PlaceBlockInteraction clone() {
      ...
      copy.allowDragPlacement = this.allowDragPlacement;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof PlaceBlockInteraction)) {
         return false;
      } else {
         PlaceBlockInteraction other = (PlaceBlockInteraction)obj;
   ...
   public int hashCode() {
      ...
      result = 31 * result + Boolean.hashCode(this.removeItemInHand);
      result = 31 * result + Boolean.hashCode(this.allowDragPlacement);
      return result;
   }
}
