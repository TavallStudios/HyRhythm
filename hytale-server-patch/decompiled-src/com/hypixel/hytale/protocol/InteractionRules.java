...
public class InteractionRules {
   ...
   public InteractionRules clone() {
      ...
      copy.blockedBy = this.blockedBy != null ? (InteractionType[])Arrays.copyOf(this.blockedBy, this.blockedBy.length) : null;
      copy.blocking = this.blocking != null ? (InteractionType[])Arrays.copyOf(this.blocking, this.blocking.length) : null;
      copy.interruptedBy = this.interruptedBy != null ? (InteractionType[])Arrays.copyOf(this.interruptedBy, this.interruptedBy.length) : null;
      copy.interrupting = this.interrupting != null ? (InteractionType[])Arrays.copyOf(this.interrupting, this.interrupting.length) : null;
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof InteractionRules)) {
         return false;
      } else {
