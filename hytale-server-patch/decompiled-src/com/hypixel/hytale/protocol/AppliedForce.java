...
public class AppliedForce {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AppliedForce)) {
         return false;
      } else {
         AppliedForce other = (AppliedForce)obj;
         return Objects.equals(this.direction, other.direction) && this.adjustVertical == other.adjustVertical && this.force == other.force;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.direction, this.adjustVertical, this.force});
   }
}
