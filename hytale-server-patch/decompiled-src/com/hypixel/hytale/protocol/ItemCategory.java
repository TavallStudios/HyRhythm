...
public class ItemCategory {
   ...
   public static ItemCategory deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 8) != 0) {
         ...
         if ((long)(varPos3 + varIntLen) + (long)childrenCount * 6L > (long)buf.readableBytes()) {
   ...
   public ItemCategory clone() {
      ...
      copy.children = this.children != null ? (ItemCategory[])Arrays.stream(this.children).map((e) -> e.clone()).toArray((x$0) -> new ItemCategory[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ItemCategory)) {
         return false;
      } else {
