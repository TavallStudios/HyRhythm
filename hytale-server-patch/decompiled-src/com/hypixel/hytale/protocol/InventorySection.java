...
public class InventorySection {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.items != null) {
         ...
         for(Map.Entry<Integer, ItemWithAllMetadata> e : this.items.entrySet()) {
            ...
            ((ItemWithAllMetadata)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.items != null) {
         ...
         for(Map.Entry<Integer, ItemWithAllMetadata> kvp : this.items.entrySet()) {
            itemsSize += 4 + ((ItemWithAllMetadata)kvp.getValue()).computeSize();
         }
   ...
   public InventorySection clone() {
      ...
      if (this.items != null) {
         ...
         for(Map.Entry<Integer, ItemWithAllMetadata> e : this.items.entrySet()) {
            m.put((Integer)e.getKey(), ((ItemWithAllMetadata)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof InventorySection)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.items, this.capacity});
   }
}
