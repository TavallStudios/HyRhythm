...
public class RepeatInteraction extends SimpleInteraction {
   ...
   public static RepeatInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      RepeatInteraction obj = new RepeatInteraction();
      ...
      obj.forkInteractions = buf.getIntLE(offset + 19);
      obj.repeat = buf.getIntLE(offset + 23);
      if ((nullBits & 1) != 0) {
         int varPos0 = offset + 47 + buf.getIntLE(offset + 27);
         obj.effects = InteractionEffects.deserialize(buf, varPos0);
      }

      if ((nullBits & 2) != 0) {
         int varPos1 = offset + 47 + buf.getIntLE(offset + 31);
      ...
      if ((nullBits & 4) != 0) {
         int varPos2 = offset + 47 + buf.getIntLE(offset + 35);
         obj.rules = InteractionRules.deserialize(buf, varPos2);
      }

      if ((nullBits & 8) != 0) {
         int varPos3 = offset + 47 + buf.getIntLE(offset + 39);
      ...
      if ((nullBits & 16) != 0) {
         int varPos4 = offset + 47 + buf.getIntLE(offset + 43);
   ...
   public static int computeBytesConsumed(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 4) != 0) {
         int fieldOffset2 = buf.getIntLE(offset + 35);
      ...
      if ((nullBits & 8) != 0) {
         int fieldOffset3 = buf.getIntLE(offset + 39);
      ...
      if ((nullBits & 16) != 0) {
         int fieldOffset4 = buf.getIntLE(offset + 43);
   ...
   public int serialize(@Nonnull ByteBuf buf) {
      ...
      buf.writeIntLE(this.forkInteractions);
      buf.writeIntLE(this.repeat);
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 47) {
         ...
         if ((nullBits & 1) != 0) {
            int effectsOffset = buffer.getIntLE(offset + 27);
            if (effectsOffset < 0) {
         ...
         if ((nullBits & 2) != 0) {
            int settingsOffset = buffer.getIntLE(offset + 31);
            if (settingsOffset < 0) {
               return ValidationResult.error("Invalid offset for Settings");
            }

            int pos = offset + 47 + settingsOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 4) != 0) {
            int rulesOffset = buffer.getIntLE(offset + 35);
            if (rulesOffset < 0) {
               return ValidationResult.error("Invalid offset for Rules");
            }

            int pos = offset + 47 + rulesOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 8) != 0) {
            int tagsOffset = buffer.getIntLE(offset + 39);
            if (tagsOffset < 0) {
               return ValidationResult.error("Invalid offset for Tags");
            }

            int pos = offset + 47 + tagsOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 16) != 0) {
            int cameraOffset = buffer.getIntLE(offset + 43);
            if (cameraOffset < 0) {
               return ValidationResult.error("Invalid offset for Camera");
            }

            int pos = offset + 47 + cameraOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof RepeatInteraction)) {
         return false;
      } else {
         RepeatInteraction other = (RepeatInteraction)obj;
   ...
   public int hashCode() {
      ...
      result = 31 * result + Integer.hashCode(this.forkInteractions);
      result = 31 * result + Integer.hashCode(this.repeat);
      return result;
   }
}
