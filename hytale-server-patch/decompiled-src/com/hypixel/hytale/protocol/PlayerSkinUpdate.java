...
public class PlayerSkinUpdate extends ComponentUpdate {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof PlayerSkinUpdate) {
         PlayerSkinUpdate other = (PlayerSkinUpdate)obj;
         return Objects.equals(this.skin, other.skin);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.skin});
   }
}
