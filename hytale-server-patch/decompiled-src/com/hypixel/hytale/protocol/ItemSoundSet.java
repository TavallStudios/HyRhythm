...
public class ItemSoundSet {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.soundEventIndices != null) {
         ...
         for(Map.Entry<ItemSoundEvent, Integer> e : this.soundEventIndices.entrySet()) {
            buf.writeByte(((ItemSoundEvent)e.getKey()).getValue());
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ItemSoundSet)) {
         return false;
      } else {
         ItemSoundSet other = (ItemSoundSet)obj;
         return Objects.equals(this.id, other.id) && Objects.equals(this.soundEventIndices, other.soundEventIndices);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.soundEventIndices});
   }
}
