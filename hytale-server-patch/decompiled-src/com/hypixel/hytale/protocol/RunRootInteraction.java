...
public class RunRootInteraction extends SimpleInteraction {
   ...
   public static RunRootInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      RunRootInteraction obj = new RunRootInteraction();
      ...
      obj.rootInteraction = buf.getIntLE(offset + 19);
      if ((nullBits & 1) != 0) {
         int varPos0 = offset + 43 + buf.getIntLE(offset + 23);
         obj.effects = InteractionEffects.deserialize(buf, varPos0);
      }

      if ((nullBits & 2) != 0) {
         int varPos1 = offset + 43 + buf.getIntLE(offset + 27);
      ...
      if ((nullBits & 4) != 0) {
         int varPos2 = offset + 43 + buf.getIntLE(offset + 31);
         obj.rules = InteractionRules.deserialize(buf, varPos2);
      }

      if ((nullBits & 8) != 0) {
         int varPos3 = offset + 43 + buf.getIntLE(offset + 35);
      ...
      if ((nullBits & 16) != 0) {
         int varPos4 = offset + 43 + buf.getIntLE(offset + 39);
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof RunRootInteraction)) {
         return false;
      } else {
         RunRootInteraction other = (RunRootInteraction)obj;
