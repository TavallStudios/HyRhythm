...
public class MountedUpdate extends ComponentUpdate {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof MountedUpdate)) {
         return false;
      } else {
         MountedUpdate other = (MountedUpdate)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.mountedToEntity, this.attachmentOffset, this.controller, this.block});
   }
}
