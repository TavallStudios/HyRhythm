...
public class PhysicsConfig {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof PhysicsConfig)) {
         return false;
      } else {
         PhysicsConfig other = (PhysicsConfig)obj;
