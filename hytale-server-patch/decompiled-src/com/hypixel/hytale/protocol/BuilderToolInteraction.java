...
public class BuilderToolInteraction extends SimpleInteraction {
   ...
   public static BuilderToolInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      BuilderToolInteraction obj = new BuilderToolInteraction();
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolInteraction)) {
         return false;
      } else {
         BuilderToolInteraction other = (BuilderToolInteraction)obj;
