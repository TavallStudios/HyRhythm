...
public class BlockFlags {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BlockFlags)) {
         return false;
      } else {
         BlockFlags other = (BlockFlags)obj;
         return this.isUsable == other.isUsable && this.isStackable == other.isStackable;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.isUsable, this.isStackable});
   }
}
