...
public class BlockMovementSettings {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BlockMovementSettings)) {
         return false;
      } else {
         BlockMovementSettings other = (BlockMovementSettings)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.isClimbable, this.climbUpSpeedMultiplier, this.climbDownSpeedMultiplier, this.climbLateralSpeedMultiplier, this.isBouncy, this.bounceVelocity, this.drag, this.friction, this.terminalVelocityModifier, this.horizontalSpeedMultiplier, this.acceleration, this.jumpForceMultiplier});
   }
}
