...
public class ReverbEffect {
   ...
   public static ReverbEffect deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + idVarLen + idLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ReverbEffect)) {
         return false;
      } else {
         ReverbEffect other = (ReverbEffect)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.dryGain, this.modalDensity, this.diffusion, this.gain, this.highFrequencyGain, this.decayTime, this.highFrequencyDecayRatio, this.reflectionGain, this.reflectionDelay, this.lateReverbGain, this.lateReverbDelay, this.roomRolloffFactor, this.airAbsorptionHighFrequencyGain, this.limitDecayHighFrequency});
   }
}
