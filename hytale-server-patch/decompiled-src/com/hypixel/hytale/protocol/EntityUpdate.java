...
public class EntityUpdate {
   ...
   public static EntityUpdate deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         if ((long)(varPos0 + varIntLen) + (long)removedCount * 1L > (long)buf.readableBytes()) {
   ...
   public EntityUpdate clone() {
      ...
      copy.removed = this.removed != null ? (ComponentUpdateType[])Arrays.copyOf(this.removed, this.removed.length) : null;
      copy.updates = this.updates != null ? (ComponentUpdate[])Arrays.copyOf(this.updates, this.updates.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof EntityUpdate)) {
         return false;
      } else {
         EntityUpdate other = (EntityUpdate)obj;
