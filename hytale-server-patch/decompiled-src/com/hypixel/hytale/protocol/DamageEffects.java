...
public class DamageEffects {
   ...
   public DamageEffects clone() {
      ...
      copy.worldParticles = this.worldParticles != null ? (WorldParticle[])Arrays.stream(this.worldParticles).map((e) -> e.clone()).toArray((x$0) -> new WorldParticle[x$0]) : null;
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof DamageEffects)) {
         return false;
      } else {
