...
public class EntityStatUpdate {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.modifiers != null) {
         ...
         for(Map.Entry<String, Modifier> e : this.modifiers.entrySet()) {
            PacketIO.writeVarString(buf, (String)e.getKey(), 4096000);
            ((Modifier)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public int computeSize() {
      ...
      if (this.modifiers != null) {
         ...
         for(Map.Entry<String, Modifier> kvp : this.modifiers.entrySet()) {
            modifiersSize += PacketIO.stringSize((String)kvp.getKey()) + 6;
         }
   ...
   public EntityStatUpdate clone() {
      ...
      if (this.modifiers != null) {
         ...
         for(Map.Entry<String, Modifier> e : this.modifiers.entrySet()) {
            m.put((String)e.getKey(), ((Modifier)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof EntityStatUpdate)) {
         return false;
      } else {
         EntityStatUpdate other = (EntityStatUpdate)obj;
         return Objects.equals(this.op, other.op) && this.predictable == other.predictable && this.value == other.value && Objects.equals(this.modifiers, other.modifiers) && Objects.equals(this.modifierKey, other.modifierKey) && Objects.equals(this.modifier, other.modifier);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.op, this.predictable, this.value, this.modifiers, this.modifierKey, this.modifier});
   }
}
