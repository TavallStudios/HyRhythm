...
public class InteractionEffects {
   ...
   public InteractionEffects clone() {
      ...
      copy.firstPersonParticles = this.firstPersonParticles != null ? (ModelParticle[])Arrays.stream(this.firstPersonParticles).map((e) -> e.clone()).toArray((x$0) -> new ModelParticle[x$0]) : null;
      copy.worldSoundEventIndex = this.worldSoundEventIndex;
      copy.localSoundEventIndex = this.localSoundEventIndex;
      copy.trails = this.trails != null ? (ModelTrail[])Arrays.stream(this.trails).map((e) -> e.clone()).toArray((x$0) -> new ModelTrail[x$0]) : null;
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof InteractionEffects)) {
         return false;
      } else {
