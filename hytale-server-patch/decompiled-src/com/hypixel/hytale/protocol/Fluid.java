...
public class Fluid {
   ...
   public Fluid() {
      ...
      this.drawType = FluidDrawType.None;
   }
   ...
   public Fluid clone() {
      ...
      copy.cubeTextures = this.cubeTextures != null ? (BlockTextures[])Arrays.stream(this.cubeTextures).map((e) -> e.clone()).toArray((x$0) -> new BlockTextures[x$0]) : null;
      ...
      copy.particles = this.particles != null ? (ModelParticle[])Arrays.stream(this.particles).map((e) -> e.clone()).toArray((x$0) -> new ModelParticle[x$0]) : null;
