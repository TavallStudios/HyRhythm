...
public class DamageEntityInteraction extends Interaction {
   ...
   public int next = -2147483648;
   public int failed = -2147483648;
   public int blocked = -2147483648;
   @Nullable
   ...
   public int serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.targetedDamage != null) {
         ...
         for(Map.Entry<String, TargetedDamage> e : this.targetedDamage.entrySet()) {
            ...
            ((TargetedDamage)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public int computeSize() {
      ...
      if (this.targetedDamage != null) {
         ...
         for(Map.Entry<String, TargetedDamage> kvp : this.targetedDamage.entrySet()) {
            targetedDamageSize += PacketIO.stringSize((String)kvp.getKey()) + ((TargetedDamage)kvp.getValue()).computeSize();
         }
   ...
   public DamageEntityInteraction clone() {
      ...
      copy.angledDamage = this.angledDamage != null ? (AngledDamage[])Arrays.stream(this.angledDamage).map((ex) -> ex.clone()).toArray((x$0) -> new AngledDamage[x$0]) : null;
      if (this.targetedDamage != null) {
         Map<String, TargetedDamage> m = new HashMap();

         for(Map.Entry<String, TargetedDamage> e : this.targetedDamage.entrySet()) {
            m.put((String)e.getKey(), ((TargetedDamage)e.getValue()).clone());
         }

         copy.targetedDamage = m;
      }

      copy.entityStatsOnHit = this.entityStatsOnHit != null ? (EntityStatOnHit[])Arrays.stream(this.entityStatsOnHit).map((ex) -> ex.clone()).toArray((x$0) -> new EntityStatOnHit[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof DamageEntityInteraction)) {
         return false;
      } else {
