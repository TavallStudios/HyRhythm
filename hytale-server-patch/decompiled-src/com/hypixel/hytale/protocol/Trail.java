...
public class Trail {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.texture, this.lifeSpan, this.roll, this.start, this.end, this.lightInfluence, this.renderMode, this.intersectionHighlight, this.smooth, this.frameSize, this.frameRange, this.frameLifeSpan});
   }
}
