...
public class StairConnectedBlockRuleSet {
   ...
   public static StairConnectedBlockRuleSet deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + materialNameVarLen + materialNameLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof StairConnectedBlockRuleSet)) {
         return false;
      } else {
         StairConnectedBlockRuleSet other = (StairConnectedBlockRuleSet)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.straightBlockId, this.cornerLeftBlockId, this.cornerRightBlockId, this.invertedCornerLeftBlockId, this.invertedCornerRightBlockId, this.materialName});
   }
}
