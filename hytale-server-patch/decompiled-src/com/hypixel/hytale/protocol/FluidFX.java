...
public class FluidFX {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof FluidFX)) {
         return false;
      } else {
         FluidFX other = (FluidFX)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.shader, this.fogMode, this.fogColor, this.fogDistance, this.fogDepthStart, this.fogDepthFalloff, this.colorFilter, this.colorSaturation, this.distortionAmplitude, this.distortionFrequency, this.particle, this.movementSettings});
   }
}
