...
public class BlockSoundSet {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.soundEventIndices != null) {
         ...
         for(Map.Entry<BlockSoundEvent, Integer> e : this.soundEventIndices.entrySet()) {
            buf.writeByte(((BlockSoundEvent)e.getKey()).getValue());
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BlockSoundSet)) {
         return false;
      } else {
         BlockSoundSet other = (BlockSoundSet)obj;
         return Objects.equals(this.id, other.id) && Objects.equals(this.soundEventIndices, other.soundEventIndices) && Objects.equals(this.moveInRepeatRange, other.moveInRepeatRange);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.soundEventIndices, this.moveInRepeatRange});
   }
}
