...
public class IncrementCooldownInteraction extends SimpleInteraction {
   ...
   public static IncrementCooldownInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      obj.cooldownIncrementTime = buf.getFloatLE(offset + 19);
      obj.cooldownIncrementCharge = buf.getIntLE(offset + 23);
   ...
   public int serialize(@Nonnull ByteBuf buf) {
      ...
      buf.writeFloatLE(this.cooldownIncrementTime);
      buf.writeIntLE(this.cooldownIncrementCharge);
      buf.writeFloatLE(this.cooldownIncrementChargeTime);
      buf.writeByte(this.cooldownIncrementInterrupt ? 1 : 0);
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 56) {
         return ValidationResult.error("Buffer too small: expected at least 56 bytes");
      } else {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof IncrementCooldownInteraction)) {
         return false;
      } else {
         IncrementCooldownInteraction other = (IncrementCooldownInteraction)obj;
   ...
   public int hashCode() {
      ...
      result = 31 * result + Float.hashCode(this.cooldownIncrementTime);
      result = 31 * result + Integer.hashCode(this.cooldownIncrementCharge);
      result = 31 * result + Float.hashCode(this.cooldownIncrementChargeTime);
      result = 31 * result + Boolean.hashCode(this.cooldownIncrementInterrupt);
      return result;
   }
}
