...
public class BreakBlockInteraction extends SimpleBlockInteraction {
   ...
   public static BreakBlockInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         int varPos0 = offset + 41 + buf.getIntLE(offset + 21);
         obj.effects = InteractionEffects.deserialize(buf, varPos0);
      }

      if ((nullBits & 2) != 0) {
         int varPos1 = offset + 41 + buf.getIntLE(offset + 25);
      ...
      if ((nullBits & 4) != 0) {
         int varPos2 = offset + 41 + buf.getIntLE(offset + 29);
         obj.rules = InteractionRules.deserialize(buf, varPos2);
      }

      if ((nullBits & 8) != 0) {
         int varPos3 = offset + 41 + buf.getIntLE(offset + 33);
      ...
      if ((nullBits & 16) != 0) {
         int varPos4 = offset + 41 + buf.getIntLE(offset + 37);
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 41) {
         ...
         if ((nullBits & 1) != 0) {
            ...
            int pos = offset + 41 + effectsOffset;
         ...
         if ((nullBits & 2) != 0) {
            ...
            int pos = offset + 41 + settingsOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 16) != 0) {
            ...
            int pos = offset + 41 + cameraOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BreakBlockInteraction)) {
         return false;
      } else {
         BreakBlockInteraction other = (BreakBlockInteraction)obj;
   ...
   public int hashCode() {
      ...
      result = 31 * result + Boolean.hashCode(this.harvest);
      return result;
   }
}
