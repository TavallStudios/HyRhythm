...
public class AmbienceFXSoundEffect {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AmbienceFXSoundEffect)) {
         return false;
      } else {
         AmbienceFXSoundEffect other = (AmbienceFXSoundEffect)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.reverbEffectIndex, this.equalizerEffectIndex, this.isInstant});
   }
}
