...
public class ResetCooldownInteraction extends SimpleInteraction {
   ...
   public static ResetCooldownInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      ResetCooldownInteraction obj = new ResetCooldownInteraction();
   ...
   public static int computeBytesConsumed(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 32) != 0) {
         ...
         pos5 += InteractionCooldown.computeBytesConsumed(buf, pos5);
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 43) {
         ...
         if ((nullBits & 32) != 0) {
            ...
            int pos = offset + 43 + cooldownOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ResetCooldownInteraction)) {
         return false;
      } else {
         ResetCooldownInteraction other = (ResetCooldownInteraction)obj;
