...
public class ModelAttachment {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ModelAttachment)) {
         return false;
      } else {
         ModelAttachment other = (ModelAttachment)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.model, this.texture, this.gradientSet, this.gradientId});
   }
}
