...
public class EntityEffectsUpdate extends ComponentUpdate {
   ...
   public EntityEffectsUpdate clone() {
      ...
      copy.entityEffectUpdates = (EntityEffectUpdate[])Arrays.stream(this.entityEffectUpdates).map((e) -> e.clone()).toArray((x$0) -> new EntityEffectUpdate[x$0]);
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof EntityEffectsUpdate) {
