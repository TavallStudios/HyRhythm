...
public class BlockGroup {
   ...
   public static BlockGroup deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         if ((long)(pos + namesVarLen) + (long)namesCount * 1L > (long)buf.readableBytes()) {
   ...
   public BlockGroup clone() {
      ...
      copy.names = this.names != null ? (String[])Arrays.copyOf(this.names, this.names.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof BlockGroup) {
