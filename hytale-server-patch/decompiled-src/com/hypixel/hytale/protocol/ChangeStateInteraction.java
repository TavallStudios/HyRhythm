...
public class ChangeStateInteraction extends SimpleBlockInteraction {
   ...
   public int computeSize() {
      ...
      if (this.stateChanges != null) {
         ...
         for(Map.Entry<String, String> kvp : this.stateChanges.entrySet()) {
            stateChangesSize += PacketIO.stringSize((String)kvp.getKey()) + PacketIO.stringSize((String)kvp.getValue());
         }
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 44) {
         ...
         if ((nullBits & 32) != 0) {
            ...
            int pos = offset + 44 + stateChangesOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ChangeStateInteraction)) {
         return false;
      } else {
