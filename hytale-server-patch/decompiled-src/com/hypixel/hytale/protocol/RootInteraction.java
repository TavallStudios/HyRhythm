...
public class RootInteraction {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.settings != null) {
         ...
         for(Map.Entry<GameMode, RootInteractionSettings> e : this.settings.entrySet()) {
            ...
            ((RootInteractionSettings)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public int computeSize() {
      ...
      if (this.settings != null) {
         ...
         for(Map.Entry<GameMode, RootInteractionSettings> kvp : this.settings.entrySet()) {
            settingsSize += 1 + ((RootInteractionSettings)kvp.getValue()).computeSize();
         }
   ...
   public RootInteraction clone() {
      ...
      if (this.settings != null) {
         ...
         for(Map.Entry<GameMode, RootInteractionSettings> e : this.settings.entrySet()) {
            m.put((GameMode)e.getKey(), ((RootInteractionSettings)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof RootInteraction)) {
         return false;
      } else {
