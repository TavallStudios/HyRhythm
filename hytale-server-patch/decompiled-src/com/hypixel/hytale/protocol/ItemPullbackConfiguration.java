...
public class ItemPullbackConfiguration {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ItemPullbackConfiguration)) {
         return false;
      } else {
         ItemPullbackConfiguration other = (ItemPullbackConfiguration)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.leftOffsetOverride, this.leftRotationOverride, this.rightOffsetOverride, this.rightRotationOverride});
   }
}
