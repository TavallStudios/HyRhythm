...
public class ConnectedBlockRuleSet {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ConnectedBlockRuleSet)) {
         return false;
      } else {
         ConnectedBlockRuleSet other = (ConnectedBlockRuleSet)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.stair, other.stair) && Objects.equals(this.roof, other.roof);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.stair, this.roof});
   }
}
