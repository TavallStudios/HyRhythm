...
public class ModelUpdate extends ComponentUpdate {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ModelUpdate)) {
         return false;
      } else {
         ModelUpdate other = (ModelUpdate)obj;
         return Objects.equals(this.model, other.model) && this.entityScale == other.entityScale;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.model, this.entityScale});
   }
}
