...
public class ToggleGliderInteraction extends SimpleInteraction {
   ...
   public static ToggleGliderInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      ToggleGliderInteraction obj = new ToggleGliderInteraction();
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ToggleGliderInteraction)) {
         return false;
      } else {
         ToggleGliderInteraction other = (ToggleGliderInteraction)obj;
