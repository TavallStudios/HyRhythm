...
public class ParticleAnimationFrame {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ParticleAnimationFrame)) {
         return false;
      } else {
         ParticleAnimationFrame other = (ParticleAnimationFrame)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.frameIndex, this.scale, this.rotation, this.color, this.opacity});
   }
}
