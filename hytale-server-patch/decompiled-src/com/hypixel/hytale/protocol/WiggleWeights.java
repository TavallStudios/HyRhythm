...
public class WiggleWeights {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof WiggleWeights)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.x, this.xDeceleration, this.y, this.yDeceleration, this.z, this.zDeceleration, this.roll, this.rollDeceleration, this.pitch, this.pitchDeceleration});
   }
}
