...
public class FirstClickInteraction extends Interaction {
   ...
   public int click = -2147483648;
   public int held = -2147483648;
   ...
   public static FirstClickInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      FirstClickInteraction obj = new FirstClickInteraction();
      ...
      obj.click = buf.getIntLE(offset + 11);
      obj.held = buf.getIntLE(offset + 15);
      if ((nullBits & 1) != 0) {
         int varPos0 = offset + 39 + buf.getIntLE(offset + 19);
         obj.effects = InteractionEffects.deserialize(buf, varPos0);
      }

      if ((nullBits & 2) != 0) {
         int varPos1 = offset + 39 + buf.getIntLE(offset + 23);
      ...
      if ((nullBits & 4) != 0) {
         int varPos2 = offset + 39 + buf.getIntLE(offset + 27);
         obj.rules = InteractionRules.deserialize(buf, varPos2);
      }

      if ((nullBits & 8) != 0) {
         int varPos3 = offset + 39 + buf.getIntLE(offset + 31);
      ...
      if ((nullBits & 16) != 0) {
         int varPos4 = offset + 39 + buf.getIntLE(offset + 35);
   ...
   public int serialize(@Nonnull ByteBuf buf) {
      ...
      buf.writeIntLE(this.click);
      buf.writeIntLE(this.held);
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof FirstClickInteraction)) {
         return false;
      } else {
         FirstClickInteraction other = (FirstClickInteraction)obj;
   ...
   public int hashCode() {
      ...
      result = 31 * result + Integer.hashCode(this.click);
      result = 31 * result + Integer.hashCode(this.held);
      return result;
   }
}
