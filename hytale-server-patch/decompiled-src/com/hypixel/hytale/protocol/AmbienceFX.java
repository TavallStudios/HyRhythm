...
public class AmbienceFX {
   ...
   public AmbienceFX clone() {
      ...
      copy.sounds = this.sounds != null ? (AmbienceFXSound[])Arrays.stream(this.sounds).map((e) -> e.clone()).toArray((x$0) -> new AmbienceFXSound[x$0]) : null;
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AmbienceFX)) {
         return false;
      } else {
