...
public class InteractionCameraSettings {
   ...
   public static InteractionCameraSettings deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         if ((long)(varPos0 + varIntLen) + (long)firstPersonCount * 29L > (long)buf.readableBytes()) {
      ...
      if ((nullBits & 2) != 0) {
         ...
         if ((long)(varPos1 + varIntLen) + (long)thirdPersonCount * 29L > (long)buf.readableBytes()) {
   ...
   public InteractionCameraSettings clone() {
      ...
      copy.firstPerson = this.firstPerson != null ? (InteractionCamera[])Arrays.stream(this.firstPerson).map((e) -> e.clone()).toArray((x$0) -> new InteractionCamera[x$0]) : null;
      copy.thirdPerson = this.thirdPerson != null ? (InteractionCamera[])Arrays.stream(this.thirdPerson).map((e) -> e.clone()).toArray((x$0) -> new InteractionCamera[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof InteractionCameraSettings)) {
         return false;
      } else {
         InteractionCameraSettings other = (InteractionCameraSettings)obj;
