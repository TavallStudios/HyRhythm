...
public class Bench {
   ...
   public static Bench deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         if ((long)(pos + benchTierLevelsVarLen) + (long)benchTierLevelsCount * 17L > (long)buf.readableBytes()) {
   ...
   public Bench clone() {
      ...
      copy.benchTierLevels = this.benchTierLevels != null ? (BenchTierLevel[])Arrays.stream(this.benchTierLevels).map((e) -> e.clone()).toArray((x$0) -> new BenchTierLevel[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof Bench) {
         Bench other = (Bench)obj;
         return Arrays.equals(this.benchTierLevels, other.benchTierLevels);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      int result = 1;
      result = 31 * result + Arrays.hashCode(this.benchTierLevels);
      return result;
   }
}
