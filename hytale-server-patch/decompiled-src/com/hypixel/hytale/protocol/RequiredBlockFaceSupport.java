...
public class RequiredBlockFaceSupport {
   ...
   public RequiredBlockFaceSupport() {
      this.support = SupportMatch.Ignored;
      this.matchSelf = SupportMatch.Ignored;
   }
   ...
   public RequiredBlockFaceSupport clone() {
      ...
      copy.filler = this.filler != null ? (Vector3i[])Arrays.stream(this.filler).map((e) -> e.clone()).toArray((x$0) -> new Vector3i[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof RequiredBlockFaceSupport)) {
         return false;
      } else {
         RequiredBlockFaceSupport other = (RequiredBlockFaceSupport)obj;
         return Objects.equals(this.faceType, other.faceType) && Objects.equals(this.selfFaceType, other.selfFaceType) && Objects.equals(this.blockSetId, other.blockSetId) && this.blockTypeId == other.blockTypeId && this.tagIndex == other.tagIndex && this.fluidId == other.fluidId && Objects.equals(this.support, other.support) && Objects.equals(this.matchSelf, other.matchSelf) && this.allowSupportPropagation == other.allowSupportPropagation && this.rotate == other.rotate && Arrays.equals(this.filler, other.filler);
      }
   }
