...
public class CameraInteraction extends SimpleInteraction {
   ...
   public CameraInteraction() {
      this.cameraAction = CameraActionType.ForcePerspective;
      this.cameraPerspective = CameraPerspectiveType.First;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof CameraInteraction)) {
         return false;
      } else {
         CameraInteraction other = (CameraInteraction)obj;
   ...
   public int hashCode() {
      ...
      result = 31 * result + Float.hashCode(this.cameraInteractionTime);
      return result;
   }
}
