...
public class InteractableUpdate extends ComponentUpdate {
   ...
   public static InteractableUpdate deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + interactionHintVarLen + interactionHintLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof InteractableUpdate) {
         InteractableUpdate other = (InteractableUpdate)obj;
         return Objects.equals(this.interactionHint, other.interactionHint);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.interactionHint});
   }
}
