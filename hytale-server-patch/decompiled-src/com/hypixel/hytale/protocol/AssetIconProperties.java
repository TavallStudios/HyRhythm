...
public class AssetIconProperties {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetIconProperties)) {
         return false;
      } else {
         AssetIconProperties other = (AssetIconProperties)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.scale, this.translation, this.rotation});
   }
}
