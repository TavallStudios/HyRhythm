...
public class ProjectileConfig {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ProjectileConfig)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.physicsConfig, this.model, this.launchForce, this.spawnOffset, this.rotationOffset, this.interactions, this.launchLocalSoundEventIndex, this.projectileSoundEventIndex});
   }
}
