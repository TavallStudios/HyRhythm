...
public class ModelDisplay {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ModelDisplay)) {
         return false;
      } else {
         ModelDisplay other = (ModelDisplay)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.node, this.attachTo, this.translation, this.rotation, this.scale});
   }
}
