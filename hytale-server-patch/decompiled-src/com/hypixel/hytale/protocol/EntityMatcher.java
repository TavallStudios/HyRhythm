...
public class EntityMatcher {
   ...
   public EntityMatcher() {
      this.type = EntityMatcherType.Server;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof EntityMatcher)) {
         return false;
      } else {
         EntityMatcher other = (EntityMatcher)obj;
         return Objects.equals(this.type, other.type) && this.invert == other.invert;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.invert});
   }
}
