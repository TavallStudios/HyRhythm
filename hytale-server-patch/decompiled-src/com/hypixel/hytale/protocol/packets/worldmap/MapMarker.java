...
public class MapMarker {
      ...
      if (idLen < 0) {
         ...
         if (idLen < 0) {
            ...
            if ((nullBits & 4) != 0) {
               ...
               if ((long)(varPos0 + varIntLen) + (long)idLen * 0L > (long)buf.readableBytes()) {
            ...
            if ((nullBits & 8) != 0) {
               ...
               int varIntLen = VarInt.length(buf, varPos0);
               if ((long)(varPos0 + varIntLen) + (long)idLen * 1L > (long)buf.readableBytes()) {
   ...
   public MapMarker clone() {
      ...
      copy.contextMenuItems = this.contextMenuItems != null ? (ContextMenuItem[])Arrays.stream(this.contextMenuItems).map((e) -> e.clone()).toArray((x$0) -> new ContextMenuItem[x$0]) : null;
      copy.components = this.components != null ? (MapMarkerComponent[])Arrays.copyOf(this.components, this.components.length) : null;
      return copy;
   }
