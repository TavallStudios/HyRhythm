...
public class SetCreativeItem implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SetCreativeItem)) {
         return false;
      } else {
         SetCreativeItem other = (SetCreativeItem)obj;
         return this.inventorySectionId == other.inventorySectionId && this.slotId == other.slotId && Objects.equals(this.item, other.item) && this.override == other.override;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.inventorySectionId, this.slotId, this.item, this.override});
   }
}
