...
public class DropItemStack implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof DropItemStack)) {
         return false;
      } else {
         DropItemStack other = (DropItemStack)obj;
         return this.inventorySectionId == other.inventorySectionId && this.slotId == other.slotId && this.quantity == other.quantity;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.inventorySectionId, this.slotId, this.quantity});
   }
}
