...
public class UpdatePlayerInventory implements Packet, ToClientPacket {
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 30) {
         ...
         if ((nullBits & 4) != 0) {
            ...
            int pos = offset + 30 + hotbarOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 8) != 0) {
            ...
            int pos = offset + 30 + utilityOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 16) != 0) {
            ...
            int pos = offset + 30 + builderMaterialOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 64) != 0) {
            ...
            int pos = offset + 30 + backpackOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdatePlayerInventory)) {
         return false;
      } else {
