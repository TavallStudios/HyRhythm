...
public class MoveItemStack implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof MoveItemStack)) {
         return false;
      } else {
         MoveItemStack other = (MoveItemStack)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.fromSectionId, this.fromSlotId, this.quantity, this.toSectionId, this.toSlotId});
   }
}
