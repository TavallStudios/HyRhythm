...
public class InventoryAction implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof InventoryAction)) {
         return false;
      } else {
         InventoryAction other = (InventoryAction)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.inventorySectionId, this.inventoryActionType, this.actionData});
   }
}
