...
public class BuilderToolBlockArg {
   ...
   public static BuilderToolBlockArg deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + defaultValueVarLen + defaultValueLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolBlockArg)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.defaultValue, this.allowPattern});
   }
}
