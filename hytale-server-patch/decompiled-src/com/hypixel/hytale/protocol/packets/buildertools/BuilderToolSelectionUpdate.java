...
public class BuilderToolSelectionUpdate implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolSelectionUpdate)) {
         return false;
      } else {
         BuilderToolSelectionUpdate other = (BuilderToolSelectionUpdate)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.xMin, this.yMin, this.zMin, this.xMax, this.yMax, this.zMax});
   }
}
