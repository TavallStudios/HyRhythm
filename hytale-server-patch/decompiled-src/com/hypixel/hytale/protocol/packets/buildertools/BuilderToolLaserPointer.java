...
public class BuilderToolLaserPointer implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolLaserPointer)) {
         return false;
      } else {
         BuilderToolLaserPointer other = (BuilderToolLaserPointer)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.playerNetworkId, this.startX, this.startY, this.startZ, this.endX, this.endY, this.endZ, this.color, this.durationMs});
   }
}
