...
public class BuilderToolEntityAction implements Packet, ToServerPacket {
   ...
   public BuilderToolEntityAction() {
      this.action = EntityToolAction.Remove;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolEntityAction)) {
         return false;
      } else {
         BuilderToolEntityAction other = (BuilderToolEntityAction)obj;
         return this.entityId == other.entityId && Objects.equals(this.action, other.action);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.entityId, this.action});
   }
}
