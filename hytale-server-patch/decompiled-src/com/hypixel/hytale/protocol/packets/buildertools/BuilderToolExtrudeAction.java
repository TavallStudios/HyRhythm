...
public class BuilderToolExtrudeAction implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolExtrudeAction)) {
         return false;
      } else {
         BuilderToolExtrudeAction other = (BuilderToolExtrudeAction)obj;
         return this.x == other.x && this.y == other.y && this.z == other.z && this.xNormal == other.xNormal && this.yNormal == other.yNormal && this.zNormal == other.zNormal;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.x, this.y, this.z, this.xNormal, this.yNormal, this.zNormal});
   }
}
