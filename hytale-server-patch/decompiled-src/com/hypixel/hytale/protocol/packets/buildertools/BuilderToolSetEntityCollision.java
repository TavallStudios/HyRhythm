...
public class BuilderToolSetEntityCollision implements Packet, ToServerPacket {
   ...
   public static BuilderToolSetEntityCollision deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + collisionTypeVarLen + collisionTypeLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolSetEntityCollision)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.entityId, this.collisionType});
   }
}
