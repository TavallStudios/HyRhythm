...
public class BuilderToolState {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.args != null) {
         ...
         for(Map.Entry<String, BuilderToolArg> e : this.args.entrySet()) {
            ...
            ((BuilderToolArg)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public int computeSize() {
      ...
      if (this.args != null) {
         ...
         for(Map.Entry<String, BuilderToolArg> kvp : this.args.entrySet()) {
            argsSize += PacketIO.stringSize((String)kvp.getKey()) + ((BuilderToolArg)kvp.getValue()).computeSize();
         }
   ...
   public BuilderToolState clone() {
      ...
      if (this.args != null) {
         ...
         for(Map.Entry<String, BuilderToolArg> e : this.args.entrySet()) {
            m.put((String)e.getKey(), ((BuilderToolArg)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolState)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.isBrush, this.brushData, this.args});
   }
}
