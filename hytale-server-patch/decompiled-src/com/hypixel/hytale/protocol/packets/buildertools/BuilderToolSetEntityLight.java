...
public class BuilderToolSetEntityLight implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolSetEntityLight)) {
         return false;
      } else {
         BuilderToolSetEntityLight other = (BuilderToolSetEntityLight)obj;
         return this.entityId == other.entityId && Objects.equals(this.light, other.light);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.entityId, this.light});
   }
}
