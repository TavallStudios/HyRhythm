...
public class BuilderToolFloatArg {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolFloatArg)) {
         return false;
      } else {
         BuilderToolFloatArg other = (BuilderToolFloatArg)obj;
         return this.defaultValue == other.defaultValue && this.min == other.min && this.max == other.max;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.defaultValue, this.min, this.max});
   }
}
