...
public class BuilderToolSelectionTransform implements Packet, ToServerPacket {
   ...
   public BuilderToolSelectionTransform(@Nullable Quatf rotation, @Nullable BlockPosition translationOffset, @Nullable BlockPosition initialSelectionMin, @Nullable BlockPosition initialSelectionMax, @Nullable Vector3f initialRotationOrigin, boolean cutOriginal, boolean applyTransformationToSelectionMinMax, boolean isExitingTransformMode, @Nullable BlockPosition initialPastePointForClipboardPaste) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolSelectionTransform)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.rotation, this.translationOffset, this.initialSelectionMin, this.initialSelectionMax, this.initialRotationOrigin, this.cutOriginal, this.applyTransformationToSelectionMinMax, this.isExitingTransformMode, this.initialPastePointForClipboardPaste});
   }
}
