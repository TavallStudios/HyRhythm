...
public class BuilderToolRotateClipboard implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof BuilderToolRotateClipboard)) {
         return false;
      } else {
         BuilderToolRotateClipboard other = (BuilderToolRotateClipboard)obj;
         return this.angle == other.angle && Objects.equals(this.axis, other.axis);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.angle, this.axis});
   }
}
