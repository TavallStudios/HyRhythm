...
public class BuilderToolSelectionToolAskForClipboard implements Packet, ToServerPacket {
   ...
   public static BuilderToolSelectionToolAskForClipboard deserialize(@Nonnull ByteBuf buf, int offset) {
      BuilderToolSelectionToolAskForClipboard obj = new BuilderToolSelectionToolAskForClipboard();
      return obj;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof BuilderToolSelectionToolAskForClipboard) {
         BuilderToolSelectionToolAskForClipboard other = (BuilderToolSelectionToolAskForClipboard)obj;
         return true;
      } else {
         return false;
      }
