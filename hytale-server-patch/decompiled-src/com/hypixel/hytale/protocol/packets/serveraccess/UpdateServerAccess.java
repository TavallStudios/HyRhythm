...
public class UpdateServerAccess implements Packet, ToServerPacket {
   ...
   public UpdateServerAccess clone() {
      ...
      copy.hosts = this.hosts != null ? (HostAddress[])Arrays.stream(this.hosts).map((e) -> e.clone()).toArray((x$0) -> new HostAddress[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateServerAccess)) {
         return false;
      } else {
         UpdateServerAccess other = (UpdateServerAccess)obj;
         return Objects.equals(this.access, other.access) && Arrays.equals(this.hosts, other.hosts);
      }
   }
