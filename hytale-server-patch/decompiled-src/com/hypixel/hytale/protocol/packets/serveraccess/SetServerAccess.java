...
public class SetServerAccess implements Packet, ToServerPacket {
   ...
   public static SetServerAccess deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + passwordVarLen + passwordLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SetServerAccess)) {
         return false;
      } else {
         SetServerAccess other = (SetServerAccess)obj;
         return Objects.equals(this.access, other.access) && Objects.equals(this.password, other.password);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.access, this.password});
   }
}
