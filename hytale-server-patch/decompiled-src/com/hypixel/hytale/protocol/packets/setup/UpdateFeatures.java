...
public class UpdateFeatures implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.features != null) {
         ...
         for(Map.Entry<ClientFeature, Boolean> e : this.features.entrySet()) {
            buf.writeByte(((ClientFeature)e.getKey()).getValue());
            buf.writeByte((Boolean)e.getValue() ? 1 : 0);
         }
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof UpdateFeatures) {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.features});
   }
}
