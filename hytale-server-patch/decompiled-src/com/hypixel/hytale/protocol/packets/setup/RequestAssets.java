...
public class RequestAssets implements Packet, ToServerPacket {
   ...
   public RequestAssets clone() {
      ...
      copy.assets = this.assets != null ? (Asset[])Arrays.stream(this.assets).map((e) -> e.clone()).toArray((x$0) -> new Asset[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof RequestAssets) {
         RequestAssets other = (RequestAssets)obj;
