...
public class WorldSettings implements Packet, ToClientPacket {
   ...
   public WorldSettings clone() {
      ...
      copy.requiredAssets = this.requiredAssets != null ? (Asset[])Arrays.stream(this.requiredAssets).map((e) -> e.clone()).toArray((x$0) -> new Asset[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof WorldSettings)) {
         return false;
      } else {
         WorldSettings other = (WorldSettings)obj;
         return this.worldHeight == other.worldHeight && Arrays.equals(this.requiredAssets, other.requiredAssets);
      }
   }
   ...
   public int hashCode() {
      ...
      result = 31 * result + Arrays.hashCode(this.requiredAssets);
      return result;
   }
}
