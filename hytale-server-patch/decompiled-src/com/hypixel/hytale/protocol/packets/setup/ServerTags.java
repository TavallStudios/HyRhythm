...
public class ServerTags implements Packet, ToClientPacket {
   ...
   public int computeSize() {
      ...
      if (this.tags != null) {
         ...
         for(Map.Entry<String, Integer> kvp : this.tags.entrySet()) {
            tagsSize += PacketIO.stringSize((String)kvp.getKey()) + 4;
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof ServerTags) {
         ServerTags other = (ServerTags)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.tags});
   }
}
