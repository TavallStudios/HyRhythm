...
public class RequestCommonAssetsRebuild implements Packet, ToClientPacket {
   ...
   public static RequestCommonAssetsRebuild deserialize(@Nonnull ByteBuf buf, int offset) {
      RequestCommonAssetsRebuild obj = new RequestCommonAssetsRebuild();
      return obj;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof RequestCommonAssetsRebuild) {
         RequestCommonAssetsRebuild other = (RequestCommonAssetsRebuild)obj;
         return true;
      } else {
         return false;
      }
