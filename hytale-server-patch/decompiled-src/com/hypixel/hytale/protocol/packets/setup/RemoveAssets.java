...
public class RemoveAssets implements Packet, ToClientPacket {
   ...
   public RemoveAssets clone() {
      ...
      copy.asset = this.asset != null ? (Asset[])Arrays.stream(this.asset).map((e) -> e.clone()).toArray((x$0) -> new Asset[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof RemoveAssets) {
         RemoveAssets other = (RemoveAssets)obj;
