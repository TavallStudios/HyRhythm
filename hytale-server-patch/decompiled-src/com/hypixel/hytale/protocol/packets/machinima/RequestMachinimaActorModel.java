...
public class RequestMachinimaActorModel implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof RequestMachinimaActorModel)) {
         return false;
      } else {
         RequestMachinimaActorModel other = (RequestMachinimaActorModel)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.modelId, this.sceneName, this.actorName});
   }
}
