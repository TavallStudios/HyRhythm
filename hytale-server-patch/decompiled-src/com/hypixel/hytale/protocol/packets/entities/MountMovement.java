...
public class MountMovement implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof MountMovement)) {
         return false;
      } else {
         MountMovement other = (MountMovement)obj;
         return Objects.equals(this.absolutePosition, other.absolutePosition) && Objects.equals(this.bodyOrientation, other.bodyOrientation) && Objects.equals(this.movementStates, other.movementStates);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.absolutePosition, this.bodyOrientation, this.movementStates});
   }
}
