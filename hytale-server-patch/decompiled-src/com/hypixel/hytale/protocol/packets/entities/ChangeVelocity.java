...
public class ChangeVelocity implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ChangeVelocity)) {
         return false;
      } else {
         ChangeVelocity other = (ChangeVelocity)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.x, this.y, this.z, this.changeType, this.config});
   }
}
