...
public class PlayAnimation implements Packet, ToClientPacket {
   ...
   public PlayAnimation() {
      this.slot = AnimationSlot.Movement;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof PlayAnimation)) {
         return false;
      } else {
         PlayAnimation other = (PlayAnimation)obj;
         return this.entityId == other.entityId && Objects.equals(this.itemAnimationsId, other.itemAnimationsId) && Objects.equals(this.animationId, other.animationId) && Objects.equals(this.slot, other.slot);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.entityId, this.itemAnimationsId, this.animationId, this.slot});
   }
}
