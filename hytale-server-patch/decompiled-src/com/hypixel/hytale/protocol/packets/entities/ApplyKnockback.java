...
public class ApplyKnockback implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ApplyKnockback)) {
         return false;
      } else {
         ApplyKnockback other = (ApplyKnockback)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.hitPosition, this.x, this.y, this.z, this.changeType});
   }
}
