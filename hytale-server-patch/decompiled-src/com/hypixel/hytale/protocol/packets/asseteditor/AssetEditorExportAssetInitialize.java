...
public class AssetEditorExportAssetInitialize implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorExportAssetInitialize)) {
         return false;
      } else {
         AssetEditorExportAssetInitialize other = (AssetEditorExportAssetInitialize)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.asset, this.oldPath, this.size, this.failed});
   }
}
