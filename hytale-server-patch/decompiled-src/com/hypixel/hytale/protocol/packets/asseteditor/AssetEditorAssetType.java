...
public class AssetEditorAssetType {
   ...
   public AssetEditorAssetType() {
      this.editorType = AssetEditorEditorType.None;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorAssetType)) {
         return false;
      } else {
         AssetEditorAssetType other = (AssetEditorAssetType)obj;
         return Objects.equals(this.id, other.id) && Objects.equals(this.icon, other.icon) && this.isColoredIcon == other.isColoredIcon && Objects.equals(this.path, other.path) && Objects.equals(this.fileExtension, other.fileExtension) && Objects.equals(this.editorType, other.editorType);
      }
   }
