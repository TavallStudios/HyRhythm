...
public class AssetEditorExportDeleteAssets implements Packet, ToClientPacket {
   ...
   public AssetEditorExportDeleteAssets clone() {
      ...
      copy.asset = this.asset != null ? (AssetEditorAsset[])Arrays.stream(this.asset).map((e) -> e.clone()).toArray((x$0) -> new AssetEditorAsset[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AssetEditorExportDeleteAssets) {
         AssetEditorExportDeleteAssets other = (AssetEditorExportDeleteAssets)obj;
