...
public class AssetEditorRequestChildrenListReply implements Packet, ToClientPacket {
   ...
   public AssetEditorRequestChildrenListReply clone() {
      ...
      copy.childrenIds = this.childrenIds != null ? (String[])Arrays.copyOf(this.childrenIds, this.childrenIds.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorRequestChildrenListReply)) {
         return false;
      } else {
         AssetEditorRequestChildrenListReply other = (AssetEditorRequestChildrenListReply)obj;
