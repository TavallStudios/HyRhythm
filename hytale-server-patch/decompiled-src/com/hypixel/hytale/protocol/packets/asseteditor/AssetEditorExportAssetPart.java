...
public class AssetEditorExportAssetPart implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AssetEditorExportAssetPart) {
         AssetEditorExportAssetPart other = (AssetEditorExportAssetPart)obj;
         return Arrays.equals(this.part, other.part);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      int result = 1;
      result = 31 * result + Arrays.hashCode(this.part);
      return result;
   }
}
