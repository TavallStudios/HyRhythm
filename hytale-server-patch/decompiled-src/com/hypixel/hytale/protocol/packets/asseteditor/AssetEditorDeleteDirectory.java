...
public class AssetEditorDeleteDirectory implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorDeleteDirectory)) {
         return false;
      } else {
         AssetEditorDeleteDirectory other = (AssetEditorDeleteDirectory)obj;
         return this.token == other.token && Objects.equals(this.path, other.path);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.token, this.path});
   }
}
