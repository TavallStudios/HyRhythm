...
public class AssetEditorRequestDatasetReply implements Packet, ToClientPacket {
   ...
   public AssetEditorRequestDatasetReply clone() {
      ...
      copy.name = this.name;
      copy.ids = this.ids != null ? (String[])Arrays.copyOf(this.ids, this.ids.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorRequestDatasetReply)) {
         return false;
      } else {
         AssetEditorRequestDatasetReply other = (AssetEditorRequestDatasetReply)obj;
