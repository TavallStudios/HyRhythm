...
public class AssetEditorAssetPackSetup implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.packs != null) {
         ...
         for(Map.Entry<String, AssetPackManifest> e : this.packs.entrySet()) {
            PacketIO.writeVarString(buf, (String)e.getKey(), 4096000);
            ((AssetPackManifest)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.packs != null) {
         ...
         for(Map.Entry<String, AssetPackManifest> kvp : this.packs.entrySet()) {
            packsSize += PacketIO.stringSize((String)kvp.getKey()) + ((AssetPackManifest)kvp.getValue()).computeSize();
         }
   ...
   public AssetEditorAssetPackSetup clone() {
      ...
      if (this.packs != null) {
         ...
         for(Map.Entry<String, AssetPackManifest> e : this.packs.entrySet()) {
            m.put((String)e.getKey(), ((AssetPackManifest)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AssetEditorAssetPackSetup) {
         AssetEditorAssetPackSetup other = (AssetEditorAssetPackSetup)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.packs});
   }
}
