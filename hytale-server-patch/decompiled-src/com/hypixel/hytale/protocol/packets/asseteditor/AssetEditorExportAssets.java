...
public class AssetEditorExportAssets implements Packet, ToServerPacket {
   ...
   public AssetEditorExportAssets clone() {
      ...
      copy.paths = this.paths != null ? (AssetPath[])Arrays.stream(this.paths).map((e) -> e.clone()).toArray((x$0) -> new AssetPath[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AssetEditorExportAssets) {
         AssetEditorExportAssets other = (AssetEditorExportAssets)obj;
