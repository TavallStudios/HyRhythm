...
public class AssetEditorUpdateWeatherPreviewLock implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AssetEditorUpdateWeatherPreviewLock) {
         AssetEditorUpdateWeatherPreviewLock other = (AssetEditorUpdateWeatherPreviewLock)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.locked});
   }
}
