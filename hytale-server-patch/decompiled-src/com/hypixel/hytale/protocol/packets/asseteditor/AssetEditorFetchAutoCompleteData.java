...
public class AssetEditorFetchAutoCompleteData implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorFetchAutoCompleteData)) {
         return false;
      } else {
         AssetEditorFetchAutoCompleteData other = (AssetEditorFetchAutoCompleteData)obj;
         return this.token == other.token && Objects.equals(this.dataset, other.dataset) && Objects.equals(this.query, other.query);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.token, this.dataset, this.query});
   }
}
