...
public class AssetEditorActivateButton implements Packet, ToServerPacket {
   ...
   public static AssetEditorActivateButton deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + buttonIdVarLen + buttonIdLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AssetEditorActivateButton) {
         AssetEditorActivateButton other = (AssetEditorActivateButton)obj;
         return Objects.equals(this.buttonId, other.buttonId);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.buttonId});
   }
}
