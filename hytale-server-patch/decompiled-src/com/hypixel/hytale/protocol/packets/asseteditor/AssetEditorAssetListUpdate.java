...
public class AssetEditorAssetListUpdate implements Packet, ToClientPacket {
   ...
   public AssetEditorAssetListUpdate clone() {
      ...
      copy.pack = this.pack;
      copy.additions = this.additions != null ? (AssetEditorFileEntry[])Arrays.stream(this.additions).map((e) -> e.clone()).toArray((x$0) -> new AssetEditorFileEntry[x$0]) : null;
      copy.deletions = this.deletions != null ? (AssetEditorFileEntry[])Arrays.stream(this.deletions).map((e) -> e.clone()).toArray((x$0) -> new AssetEditorFileEntry[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorAssetListUpdate)) {
         return false;
      } else {
         AssetEditorAssetListUpdate other = (AssetEditorAssetListUpdate)obj;
