...
public class AssetEditorFetchJsonAssetWithParentsReply implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.assets != null) {
         ...
         for(Map.Entry<AssetPath, String> e : this.assets.entrySet()) {
            ((AssetPath)e.getKey()).serialize(buf);
   ...
   public int computeSize() {
      ...
      if (this.assets != null) {
         ...
         for(Map.Entry<AssetPath, String> kvp : this.assets.entrySet()) {
            assetsSize += ((AssetPath)kvp.getKey()).computeSize() + PacketIO.stringSize((String)kvp.getValue());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorFetchJsonAssetWithParentsReply)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.token, this.assets});
   }
}
