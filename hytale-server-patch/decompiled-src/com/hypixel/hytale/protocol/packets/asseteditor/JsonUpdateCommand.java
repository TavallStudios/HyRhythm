...
public class JsonUpdateCommand {
   ...
   public JsonUpdateCommand clone() {
      ...
      copy.type = this.type;
      copy.path = this.path != null ? (String[])Arrays.copyOf(this.path, this.path.length) : null;
      copy.value = this.value;
      copy.previousValue = this.previousValue;
      copy.firstCreatedProperty = this.firstCreatedProperty != null ? (String[])Arrays.copyOf(this.firstCreatedProperty, this.firstCreatedProperty.length) : null;
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof JsonUpdateCommand)) {
         return false;
      } else {
