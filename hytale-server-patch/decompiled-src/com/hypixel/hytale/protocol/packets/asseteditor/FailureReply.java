...
public class FailureReply implements Packet, ToServerPacket, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof FailureReply)) {
         return false;
      } else {
         FailureReply other = (FailureReply)obj;
         return this.token == other.token && Objects.equals(this.message, other.message);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.token, this.message});
   }
}
