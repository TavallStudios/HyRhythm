...
public class AssetEditorFetchAutoCompleteDataReply implements Packet, ToClientPacket {
   ...
   public AssetEditorFetchAutoCompleteDataReply clone() {
      ...
      copy.results = this.results != null ? (String[])Arrays.copyOf(this.results, this.results.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorFetchAutoCompleteDataReply)) {
         return false;
      } else {
         AssetEditorFetchAutoCompleteDataReply other = (AssetEditorFetchAutoCompleteDataReply)obj;
