...
public class AssetEditorFetchLastModifiedAssets implements Packet, ToServerPacket {
   ...
   public static AssetEditorFetchLastModifiedAssets deserialize(@Nonnull ByteBuf buf, int offset) {
      AssetEditorFetchLastModifiedAssets obj = new AssetEditorFetchLastModifiedAssets();
      return obj;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AssetEditorFetchLastModifiedAssets) {
         AssetEditorFetchLastModifiedAssets other = (AssetEditorFetchLastModifiedAssets)obj;
         return true;
      } else {
         return false;
      }
