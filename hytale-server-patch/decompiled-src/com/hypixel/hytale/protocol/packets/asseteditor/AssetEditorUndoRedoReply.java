...
public class AssetEditorUndoRedoReply implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorUndoRedoReply)) {
         return false;
      } else {
         AssetEditorUndoRedoReply other = (AssetEditorUndoRedoReply)obj;
         return this.token == other.token && Objects.equals(this.command, other.command);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.token, this.command});
   }
}
