...
public class AssetEditorFetchJsonAssetWithParents implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorFetchJsonAssetWithParents)) {
         return false;
      } else {
         AssetEditorFetchJsonAssetWithParents other = (AssetEditorFetchJsonAssetWithParents)obj;
         return this.token == other.token && Objects.equals(this.path, other.path) && this.isFromOpenedTab == other.isFromOpenedTab;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.token, this.path, this.isFromOpenedTab});
   }
}
