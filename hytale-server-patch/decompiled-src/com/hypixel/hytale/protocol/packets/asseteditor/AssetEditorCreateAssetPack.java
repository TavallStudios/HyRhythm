...
public class AssetEditorCreateAssetPack implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorCreateAssetPack)) {
         return false;
      } else {
         AssetEditorCreateAssetPack other = (AssetEditorCreateAssetPack)obj;
         return this.token == other.token && Objects.equals(this.manifest, other.manifest);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.token, this.manifest});
   }
}
