...
public class AssetEditorAssetUpdated implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorAssetUpdated)) {
         return false;
      } else {
         AssetEditorAssetUpdated other = (AssetEditorAssetUpdated)obj;
         return Objects.equals(this.path, other.path) && Arrays.equals(this.data, other.data);
      }
   }
