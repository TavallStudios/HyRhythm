...
public class AssetEditorExportComplete implements Packet, ToClientPacket {
   ...
   public AssetEditorExportComplete clone() {
      ...
      copy.assets = this.assets != null ? (TimestampedAssetReference[])Arrays.stream(this.assets).map((e) -> e.clone()).toArray((x$0) -> new TimestampedAssetReference[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AssetEditorExportComplete) {
         AssetEditorExportComplete other = (AssetEditorExportComplete)obj;
         return Arrays.equals(this.assets, other.assets);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      int result = 1;
      result = 31 * result + Arrays.hashCode(this.assets);
      return result;
   }
}
