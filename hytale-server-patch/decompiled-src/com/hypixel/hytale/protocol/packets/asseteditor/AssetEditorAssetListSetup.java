...
public class AssetEditorAssetListSetup implements Packet, ToClientPacket {
   ...
   public AssetEditorAssetListSetup clone() {
      ...
      copy.tree = this.tree;
      copy.paths = this.paths != null ? (AssetEditorFileEntry[])Arrays.stream(this.paths).map((e) -> e.clone()).toArray((x$0) -> new AssetEditorFileEntry[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorAssetListSetup)) {
         return false;
      } else {
         AssetEditorAssetListSetup other = (AssetEditorAssetListSetup)obj;
