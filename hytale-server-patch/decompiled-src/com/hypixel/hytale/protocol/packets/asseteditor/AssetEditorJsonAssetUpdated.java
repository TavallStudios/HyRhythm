...
public class AssetEditorJsonAssetUpdated implements Packet, ToClientPacket {
   ...
   public AssetEditorJsonAssetUpdated clone() {
      ...
      copy.commands = this.commands != null ? (JsonUpdateCommand[])Arrays.stream(this.commands).map((e) -> e.clone()).toArray((x$0) -> new JsonUpdateCommand[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorJsonAssetUpdated)) {
         return false;
      } else {
         AssetEditorJsonAssetUpdated other = (AssetEditorJsonAssetUpdated)obj;
         return Objects.equals(this.path, other.path) && Arrays.equals(this.commands, other.commands);
      }
   }
