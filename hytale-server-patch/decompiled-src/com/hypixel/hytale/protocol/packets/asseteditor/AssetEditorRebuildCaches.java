...
public class AssetEditorRebuildCaches {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorRebuildCaches)) {
         return false;
      } else {
         AssetEditorRebuildCaches other = (AssetEditorRebuildCaches)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.blockTextures, this.models, this.modelTextures, this.mapGeometry, this.itemIcons});
   }
}
