...
public class AssetEditorSetupSchemas implements Packet, ToClientPacket {
   ...
   public AssetEditorSetupSchemas clone() {
      ...
      copy.schemas = this.schemas != null ? (SchemaFile[])Arrays.stream(this.schemas).map((e) -> e.clone()).toArray((x$0) -> new SchemaFile[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AssetEditorSetupSchemas) {
         AssetEditorSetupSchemas other = (AssetEditorSetupSchemas)obj;
