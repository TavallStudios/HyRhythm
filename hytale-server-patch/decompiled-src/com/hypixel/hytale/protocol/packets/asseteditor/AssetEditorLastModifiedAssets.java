...
public class AssetEditorLastModifiedAssets implements Packet, ToClientPacket {
   ...
   public AssetEditorLastModifiedAssets clone() {
      ...
      copy.assets = this.assets != null ? (AssetInfo[])Arrays.stream(this.assets).map((e) -> e.clone()).toArray((x$0) -> new AssetInfo[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AssetEditorLastModifiedAssets) {
         AssetEditorLastModifiedAssets other = (AssetEditorLastModifiedAssets)obj;
