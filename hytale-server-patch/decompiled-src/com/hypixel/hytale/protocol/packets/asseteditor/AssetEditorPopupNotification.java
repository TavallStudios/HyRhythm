...
public class AssetEditorPopupNotification implements Packet, ToClientPacket {
   ...
   @Nonnull
   public AssetEditorPopupNotificationType type;
   @Nullable
   ...
   public AssetEditorPopupNotification() {
      this.type = AssetEditorPopupNotificationType.Info;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AssetEditorPopupNotification)) {
         return false;
      } else {
         AssetEditorPopupNotification other = (AssetEditorPopupNotification)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.message, other.message);
      }
   }
