...
public class SyncInteractionChain {
   ...
   public int overrideRootInteraction = -2147483648;
   @Nonnull
      ...
      if (this.interactionData != null) {
         ...
         for(int i = 0; i < this.interactionData.length; ++i) {
            if (this.interactionData[i] != null) {
               interactionDataBitfield[i / 8] |= (byte)(1 << i % 8);
            }
         }
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 61) {
         ...
         if ((nullBits & 2) != 0) {
            ...
            int pos = offset + 61 + utilityItemIdOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 4) != 0) {
            ...
            int pos = offset + 61 + toolsItemIdOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 8) != 0) {
            ...
            int pos = offset + 61 + forkedIdOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 32) != 0) {
            ...
            int pos = offset + 61 + newForksOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 64) != 0) {
            ...
            int pos = offset + 61 + interactionDataOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public SyncInteractionChain clone() {
      ...
      copy.newForks = this.newForks != null ? (SyncInteractionChain[])Arrays.stream(this.newForks).map((e) -> e.clone()).toArray((x$0) -> new SyncInteractionChain[x$0]) : null;
      copy.operationBaseIndex = this.operationBaseIndex;
      copy.interactionData = this.interactionData != null ? (InteractionSyncData[])Arrays.stream(this.interactionData).map((e) -> e != null ? e.clone() : null).toArray((x$0) -> new InteractionSyncData[x$0]) : null;
      return copy;
   }
   ...
   public int hashCode() {
      ...
      result = 31 * result + Arrays.hashCode(this.interactionData);
      return result;
   }
}
