...
public class SyncInteractionChains implements Packet, ToServerPacket, ToClientPacket {
   ...
   public SyncInteractionChains clone() {
      ...
      copy.updates = (SyncInteractionChain[])Arrays.stream(this.updates).map((e) -> e.clone()).toArray((x$0) -> new SyncInteractionChain[x$0]);
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof SyncInteractionChains) {
