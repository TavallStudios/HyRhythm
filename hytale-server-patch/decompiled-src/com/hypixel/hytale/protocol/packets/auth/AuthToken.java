...
public class AuthToken implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return Objects.equals(this.accessToken, other.accessToken) && Objects.equals(this.serverAuthorizationGrant, other.serverAuthorizationGrant);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.accessToken, this.serverAuthorizationGrant});
   }
}
