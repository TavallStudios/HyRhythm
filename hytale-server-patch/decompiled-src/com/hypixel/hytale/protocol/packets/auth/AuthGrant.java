...
public class AuthGrant implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AuthGrant)) {
         return false;
      } else {
         AuthGrant other = (AuthGrant)obj;
         return Objects.equals(this.authorizationGrant, other.authorizationGrant) && Objects.equals(this.serverIdentityToken, other.serverIdentityToken);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.authorizationGrant, this.serverIdentityToken});
   }
}
