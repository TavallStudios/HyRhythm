...
public class OpenWindow implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof OpenWindow)) {
         return false;
      } else {
         OpenWindow other = (OpenWindow)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.windowType, this.windowData, this.inventory, this.extraResources});
   }
}
