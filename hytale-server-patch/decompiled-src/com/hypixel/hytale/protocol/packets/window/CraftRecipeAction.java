...
public class CraftRecipeAction extends WindowAction {
   ...
   public static CraftRecipeAction deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + recipeIdVarLen + recipeIdLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof CraftRecipeAction)) {
         return false;
      } else {
         CraftRecipeAction other = (CraftRecipeAction)obj;
         return Objects.equals(this.recipeId, other.recipeId) && this.quantity == other.quantity;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.recipeId, this.quantity});
   }
}
