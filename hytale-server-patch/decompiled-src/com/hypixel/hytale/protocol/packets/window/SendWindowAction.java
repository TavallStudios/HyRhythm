...
public class SendWindowAction implements Packet, ToServerPacket {
   ...
   public int computeSize() {
      int size = 4;
      size += this.action.computeSizeWithTypeId();
      return size;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SendWindowAction)) {
         return false;
      } else {
         SendWindowAction other = (SendWindowAction)obj;
         return this.id == other.id && Objects.equals(this.action, other.action);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.action});
   }
}
