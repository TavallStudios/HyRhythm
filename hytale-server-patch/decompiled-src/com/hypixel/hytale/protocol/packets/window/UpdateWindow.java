...
public class UpdateWindow implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateWindow)) {
         return false;
      } else {
         UpdateWindow other = (UpdateWindow)obj;
         return this.id == other.id && Objects.equals(this.windowData, other.windowData) && Objects.equals(this.inventory, other.inventory) && Objects.equals(this.extraResources, other.extraResources);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.windowData, this.inventory, this.extraResources});
   }
}
