...
public class ServerSetFluids implements Packet, ToClientPacket {
   ...
   public ServerSetFluids clone() {
      ...
      copy.y = this.y;
      copy.z = this.z;
      copy.cmds = (SetFluidCmd[])Arrays.stream(this.cmds).map((e) -> e.clone()).toArray((x$0) -> new SetFluidCmd[x$0]);
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ServerSetFluids)) {
         return false;
      } else {
         ServerSetFluids other = (ServerSetFluids)obj;
