...
public class PlaySoundEvent2D implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof PlaySoundEvent2D)) {
         return false;
      } else {
         PlaySoundEvent2D other = (PlaySoundEvent2D)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.soundEventIndex, this.category, this.volumeModifier, this.pitchModifier});
   }
}
