...
public class UpdateSleepState implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateSleepState)) {
         return false;
      } else {
         UpdateSleepState other = (UpdateSleepState)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.grayFade, this.sleepUi, this.clock, this.multiplayer});
   }
}
