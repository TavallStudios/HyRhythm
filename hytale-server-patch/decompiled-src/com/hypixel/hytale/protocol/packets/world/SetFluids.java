...
public class SetFluids implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SetFluids)) {
         return false;
      } else {
         SetFluids other = (SetFluids)obj;
         return this.x == other.x && this.y == other.y && this.z == other.z && Arrays.equals(this.data, other.data);
      }
   }
