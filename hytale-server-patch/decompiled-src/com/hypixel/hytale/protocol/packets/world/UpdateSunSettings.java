...
public class UpdateSunSettings implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateSunSettings)) {
         return false;
      } else {
         UpdateSunSettings other = (UpdateSunSettings)obj;
         return this.heightPercentage == other.heightPercentage && this.angleRadians == other.angleRadians;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.heightPercentage, this.angleRadians});
   }
}
