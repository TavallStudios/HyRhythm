...
public class UpdateEditorWeatherOverride implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof UpdateEditorWeatherOverride) {
         UpdateEditorWeatherOverride other = (UpdateEditorWeatherOverride)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.weatherIndex});
   }
}
