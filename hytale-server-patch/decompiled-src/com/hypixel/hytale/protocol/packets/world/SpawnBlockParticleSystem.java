...
public class SpawnBlockParticleSystem implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SpawnBlockParticleSystem)) {
         return false;
      } else {
         SpawnBlockParticleSystem other = (SpawnBlockParticleSystem)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.blockId, this.particleType, this.position});
   }
}
