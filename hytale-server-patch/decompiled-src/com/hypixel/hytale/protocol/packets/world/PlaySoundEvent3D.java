...
public class PlaySoundEvent3D implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof PlaySoundEvent3D)) {
         return false;
      } else {
         PlaySoundEvent3D other = (PlaySoundEvent3D)obj;
         return this.soundEventIndex == other.soundEventIndex && Objects.equals(this.category, other.category) && Objects.equals(this.position, other.position) && this.volumeModifier == other.volumeModifier && this.pitchModifier == other.pitchModifier;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.soundEventIndex, this.category, this.position, this.volumeModifier, this.pitchModifier});
   }
}
