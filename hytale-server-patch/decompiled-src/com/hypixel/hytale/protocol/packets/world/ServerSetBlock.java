...
public class ServerSetBlock implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ServerSetBlock)) {
         return false;
      } else {
         ServerSetBlock other = (ServerSetBlock)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.x, this.y, this.z, this.blockId, this.filler, this.rotation});
   }
}
