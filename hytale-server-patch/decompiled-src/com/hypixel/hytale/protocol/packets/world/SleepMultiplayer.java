...
public class SleepMultiplayer {
   ...
   public static SleepMultiplayer deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + awakeSampleCount * 16;
      }
   ...
   public SleepMultiplayer clone() {
      ...
      copy.awakeSample = this.awakeSample != null ? (UUID[])Arrays.copyOf(this.awakeSample, this.awakeSample.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SleepMultiplayer)) {
         return false;
      } else {
         SleepMultiplayer other = (SleepMultiplayer)obj;
