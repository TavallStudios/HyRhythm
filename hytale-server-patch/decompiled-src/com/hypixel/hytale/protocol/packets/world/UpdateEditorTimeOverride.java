...
public class UpdateEditorTimeOverride implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateEditorTimeOverride)) {
         return false;
      } else {
         UpdateEditorTimeOverride other = (UpdateEditorTimeOverride)obj;
         return Objects.equals(this.gameTime, other.gameTime) && this.paused == other.paused;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.gameTime, this.paused});
   }
}
