...
public class SetChunkTintmap implements Packet, ToClientPacket {
   ...
   public static SetChunkTintmap deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + tintmapCount * 1;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SetChunkTintmap)) {
         return false;
      } else {
         SetChunkTintmap other = (SetChunkTintmap)obj;
         return this.x == other.x && this.z == other.z && Arrays.equals(this.tintmap, other.tintmap);
      }
   }
   ...
   public int hashCode() {
      ...
      result = 31 * result + Arrays.hashCode(this.tintmap);
      return result;
   }
}
