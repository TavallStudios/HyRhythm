...
public class Ping implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         Ping other = (Ping)obj;
         return this.id == other.id && Objects.equals(this.time, other.time) && this.lastPingValueRaw == other.lastPingValueRaw && this.lastPingValueDirect == other.lastPingValueDirect && this.lastPingValueTick == other.lastPingValueTick;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.time, this.lastPingValueRaw, this.lastPingValueDirect, this.lastPingValueTick});
   }
}
