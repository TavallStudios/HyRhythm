...
public class Disconnect implements Packet, ToServerPacket, ToClientPacket {
   ...
   public Disconnect() {
      this.type = DisconnectType.Disconnect;
   }
   ...
   public static Disconnect deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + reasonVarLen + reasonLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return Objects.equals(this.reason, other.reason) && Objects.equals(this.type, other.type);
      }
   }
