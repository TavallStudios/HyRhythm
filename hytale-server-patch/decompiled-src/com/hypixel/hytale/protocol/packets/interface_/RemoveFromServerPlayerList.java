...
public class RemoveFromServerPlayerList implements Packet, ToClientPacket {
   ...
   public static RemoveFromServerPlayerList deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + playersCount * 16;
      }
   ...
   public RemoveFromServerPlayerList clone() {
      ...
      copy.players = this.players != null ? (UUID[])Arrays.copyOf(this.players, this.players.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof RemoveFromServerPlayerList) {
         RemoveFromServerPlayerList other = (RemoveFromServerPlayerList)obj;
