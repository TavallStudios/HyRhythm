...
public class OpenChatWithCommand implements Packet, ToClientPacket {
   ...
   public static OpenChatWithCommand deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + commandVarLen + commandLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof OpenChatWithCommand) {
         OpenChatWithCommand other = (OpenChatWithCommand)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.command});
   }
}
