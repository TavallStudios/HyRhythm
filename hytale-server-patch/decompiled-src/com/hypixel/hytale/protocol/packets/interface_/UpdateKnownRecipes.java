...
public class UpdateKnownRecipes implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.known != null) {
         ...
         for(Map.Entry<String, CraftingRecipe> e : this.known.entrySet()) {
            PacketIO.writeVarString(buf, (String)e.getKey(), 4096000);
            ((CraftingRecipe)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.known != null) {
         ...
         for(Map.Entry<String, CraftingRecipe> kvp : this.known.entrySet()) {
            knownSize += PacketIO.stringSize((String)kvp.getKey()) + ((CraftingRecipe)kvp.getValue()).computeSize();
         }
   ...
   public UpdateKnownRecipes clone() {
      ...
      if (this.known != null) {
         ...
         for(Map.Entry<String, CraftingRecipe> e : this.known.entrySet()) {
            m.put((String)e.getKey(), ((CraftingRecipe)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof UpdateKnownRecipes) {
         UpdateKnownRecipes other = (UpdateKnownRecipes)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.known});
   }
}
