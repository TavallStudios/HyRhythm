...
public class UpdateVisibleHudComponents implements Packet, ToClientPacket {
   ...
   public UpdateVisibleHudComponents clone() {
      ...
      copy.visibleComponents = this.visibleComponents != null ? (HudComponent[])Arrays.copyOf(this.visibleComponents, this.visibleComponents.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof UpdateVisibleHudComponents) {
         UpdateVisibleHudComponents other = (UpdateVisibleHudComponents)obj;
         return Arrays.equals(this.visibleComponents, other.visibleComponents);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      int result = 1;
      result = 31 * result + Arrays.hashCode(this.visibleComponents);
      return result;
   }
}
