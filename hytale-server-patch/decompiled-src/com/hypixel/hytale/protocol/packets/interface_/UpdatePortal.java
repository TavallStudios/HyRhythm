...
public class UpdatePortal implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdatePortal)) {
         return false;
      } else {
         UpdatePortal other = (UpdatePortal)obj;
         return Objects.equals(this.state, other.state) && Objects.equals(this.definition, other.definition);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.state, this.definition});
   }
}
