...
public class UpdateLanguage implements Packet, ToServerPacket {
   ...
   public static UpdateLanguage deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + languageVarLen + languageLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof UpdateLanguage) {
         UpdateLanguage other = (UpdateLanguage)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.language});
   }
}
