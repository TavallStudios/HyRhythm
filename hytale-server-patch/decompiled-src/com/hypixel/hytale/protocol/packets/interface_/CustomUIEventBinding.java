...
public class CustomUIEventBinding {
   ...
   @Nonnull
   public CustomUIEventBindingType type;
   @Nullable
   ...
   public CustomUIEventBinding() {
      this.type = CustomUIEventBindingType.Activating;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof CustomUIEventBinding)) {
         return false;
      } else {
         CustomUIEventBinding other = (CustomUIEventBinding)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.selector, other.selector) && Objects.equals(this.data, other.data) && this.locksInterface == other.locksInterface;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.selector, this.data, this.locksInterface});
   }
}
