...
public class ResetUserInterfaceState implements Packet, ToClientPacket {
   ...
   public static ResetUserInterfaceState deserialize(@Nonnull ByteBuf buf, int offset) {
      ResetUserInterfaceState obj = new ResetUserInterfaceState();
      return obj;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof ResetUserInterfaceState) {
         ResetUserInterfaceState other = (ResetUserInterfaceState)obj;
         return true;
      } else {
         return false;
      }
