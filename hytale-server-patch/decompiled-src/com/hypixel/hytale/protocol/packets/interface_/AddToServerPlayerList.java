...
public class AddToServerPlayerList implements Packet, ToClientPacket {
   ...
   public AddToServerPlayerList clone() {
      ...
      copy.players = this.players != null ? (ServerPlayerListPlayer[])Arrays.stream(this.players).map((e) -> e.clone()).toArray((x$0) -> new ServerPlayerListPlayer[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AddToServerPlayerList) {
         AddToServerPlayerList other = (AddToServerPlayerList)obj;
