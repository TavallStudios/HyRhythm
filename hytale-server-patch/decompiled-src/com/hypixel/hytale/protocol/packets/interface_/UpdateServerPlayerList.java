...
public class UpdateServerPlayerList implements Packet, ToClientPacket {
   ...
   public UpdateServerPlayerList clone() {
      ...
      copy.players = this.players != null ? (ServerPlayerListUpdate[])Arrays.stream(this.players).map((e) -> e.clone()).toArray((x$0) -> new ServerPlayerListUpdate[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof UpdateServerPlayerList) {
         UpdateServerPlayerList other = (UpdateServerPlayerList)obj;
         return Arrays.equals(this.players, other.players);
      } else {
         return false;
      }
   }
