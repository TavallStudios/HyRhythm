...
public class CustomPageEvent implements Packet, ToServerPacket {
   ...
   @Nonnull
   public CustomPageEventType type;
   @Nullable
   public String data;
   ...
   public CustomPageEvent() {
      this.type = CustomPageEventType.Acknowledge;
   }
   ...
   public static CustomPageEvent deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + dataVarLen + dataLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof CustomPageEvent)) {
         return false;
      } else {
         CustomPageEvent other = (CustomPageEvent)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.data, other.data);
      }
   }
