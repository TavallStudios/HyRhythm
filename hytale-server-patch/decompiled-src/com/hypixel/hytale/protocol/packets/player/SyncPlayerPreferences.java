...
public class SyncPlayerPreferences implements Packet, ToServerPacket {
   ...
   public SyncPlayerPreferences() {
      this.armorItemsPreferredPickupLocation = PickupLocation.Hotbar;
      this.weaponAndToolItemsPreferredPickupLocation = PickupLocation.Hotbar;
      this.usableItemsItemsPreferredPickupLocation = PickupLocation.Hotbar;
      this.solidBlockItemsPreferredPickupLocation = PickupLocation.Hotbar;
      this.miscItemsPreferredPickupLocation = PickupLocation.Hotbar;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SyncPlayerPreferences)) {
         return false;
      } else {
