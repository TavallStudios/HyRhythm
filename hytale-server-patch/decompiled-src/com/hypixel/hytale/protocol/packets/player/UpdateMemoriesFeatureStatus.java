...
public class UpdateMemoriesFeatureStatus implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof UpdateMemoriesFeatureStatus) {
         UpdateMemoriesFeatureStatus other = (UpdateMemoriesFeatureStatus)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.isFeatureUnlocked});
   }
}
