...
public class UpdateMovementSettings implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof UpdateMovementSettings) {
         UpdateMovementSettings other = (UpdateMovementSettings)obj;
         return Objects.equals(this.movementSettings, other.movementSettings);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.movementSettings});
   }
}
