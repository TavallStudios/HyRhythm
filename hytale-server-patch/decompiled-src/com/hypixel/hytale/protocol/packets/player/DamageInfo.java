...
public class DamageInfo implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof DamageInfo)) {
         return false;
      } else {
         DamageInfo other = (DamageInfo)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.damageSourcePosition, this.damageAmount, this.damageCause});
   }
}
