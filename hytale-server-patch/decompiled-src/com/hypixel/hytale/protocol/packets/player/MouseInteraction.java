...
public class MouseInteraction implements Packet, ToServerPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof MouseInteraction)) {
         return false;
      } else {
         MouseInteraction other = (MouseInteraction)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.clientTimestamp, this.activeSlot, this.itemInHandId, this.screenPoint, this.mouseButton, this.mouseMotion, this.worldInteraction});
   }
}
