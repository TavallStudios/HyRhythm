...
public class DisplayDebug implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof DisplayDebug)) {
         return false;
      } else {
         DisplayDebug other = (DisplayDebug)obj;
         return Objects.equals(this.shape, other.shape) && Arrays.equals(this.matrix, other.matrix) && Objects.equals(this.color, other.color) && this.time == other.time && this.fade == other.fade && Arrays.equals(this.frustumProjection, other.frustumProjection) && this.opacity == other.opacity;
      }
   }
