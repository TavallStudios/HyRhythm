...
public class JoinWorld implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof JoinWorld)) {
         return false;
      } else {
         JoinWorld other = (JoinWorld)obj;
         return this.clearWorld == other.clearWorld && this.fadeInOut == other.fadeInOut && Objects.equals(this.worldUuid, other.worldUuid);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.clearWorld, this.fadeInOut, this.worldUuid});
   }
}
