...
public class UpdateRepulsionConfig implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.repulsionConfigs != null) {
         ...
         for(Map.Entry<Integer, RepulsionConfig> e : this.repulsionConfigs.entrySet()) {
            buf.writeIntLE((Integer)e.getKey());
            ((RepulsionConfig)e.getValue()).serialize(buf);
         }
      }
   ...
   public UpdateRepulsionConfig clone() {
      ...
      if (this.repulsionConfigs != null) {
         ...
         for(Map.Entry<Integer, RepulsionConfig> e : this.repulsionConfigs.entrySet()) {
            m.put((Integer)e.getKey(), ((RepulsionConfig)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateRepulsionConfig)) {
         return false;
      } else {
         UpdateRepulsionConfig other = (UpdateRepulsionConfig)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.repulsionConfigs, other.repulsionConfigs);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.maxId, this.repulsionConfigs});
   }
}
