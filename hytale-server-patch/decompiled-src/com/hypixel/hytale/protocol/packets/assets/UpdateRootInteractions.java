...
public class UpdateRootInteractions implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.interactions != null) {
         ...
         for(Map.Entry<Integer, RootInteraction> e : this.interactions.entrySet()) {
            ...
            ((RootInteraction)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.interactions != null) {
         ...
         for(Map.Entry<Integer, RootInteraction> kvp : this.interactions.entrySet()) {
            interactionsSize += 4 + ((RootInteraction)kvp.getValue()).computeSize();
         }
   ...
   public UpdateRootInteractions clone() {
      ...
      if (this.interactions != null) {
         ...
         for(Map.Entry<Integer, RootInteraction> e : this.interactions.entrySet()) {
            m.put((Integer)e.getKey(), ((RootInteraction)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateRootInteractions)) {
         return false;
      } else {
