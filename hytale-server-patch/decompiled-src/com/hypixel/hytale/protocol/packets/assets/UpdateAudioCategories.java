...
public class UpdateAudioCategories implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.categories != null) {
         ...
         for(Map.Entry<Integer, AudioCategory> e : this.categories.entrySet()) {
            ...
            ((AudioCategory)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.categories != null) {
         ...
         for(Map.Entry<Integer, AudioCategory> kvp : this.categories.entrySet()) {
            categoriesSize += 4 + ((AudioCategory)kvp.getValue()).computeSize();
         }
   ...
   public UpdateAudioCategories clone() {
      ...
      if (this.categories != null) {
         ...
         for(Map.Entry<Integer, AudioCategory> e : this.categories.entrySet()) {
            m.put((Integer)e.getKey(), ((AudioCategory)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateAudioCategories)) {
         return false;
      } else {
         UpdateAudioCategories other = (UpdateAudioCategories)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.categories, other.categories);
      }
   }
