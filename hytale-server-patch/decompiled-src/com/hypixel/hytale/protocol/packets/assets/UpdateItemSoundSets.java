...
public class UpdateItemSoundSets implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.itemSoundSets != null) {
         ...
         for(Map.Entry<Integer, ItemSoundSet> e : this.itemSoundSets.entrySet()) {
            buf.writeIntLE((Integer)e.getKey());
            ((ItemSoundSet)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.itemSoundSets != null) {
         ...
         for(Map.Entry<Integer, ItemSoundSet> kvp : this.itemSoundSets.entrySet()) {
            itemSoundSetsSize += 4 + ((ItemSoundSet)kvp.getValue()).computeSize();
         }
   ...
   public UpdateItemSoundSets clone() {
      ...
      if (this.itemSoundSets != null) {
         ...
         for(Map.Entry<Integer, ItemSoundSet> e : this.itemSoundSets.entrySet()) {
            m.put((Integer)e.getKey(), ((ItemSoundSet)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateItemSoundSets)) {
         return false;
      } else {
         UpdateItemSoundSets other = (UpdateItemSoundSets)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.itemSoundSets, other.itemSoundSets);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.maxId, this.itemSoundSets});
   }
}
