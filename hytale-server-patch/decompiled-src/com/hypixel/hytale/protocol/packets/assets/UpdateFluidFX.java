...
public class UpdateFluidFX implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.fluidFX != null) {
         ...
         for(Map.Entry<Integer, FluidFX> e : this.fluidFX.entrySet()) {
            buf.writeIntLE((Integer)e.getKey());
            ((FluidFX)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.fluidFX != null) {
         ...
         for(Map.Entry<Integer, FluidFX> kvp : this.fluidFX.entrySet()) {
            fluidFXSize += 4 + ((FluidFX)kvp.getValue()).computeSize();
         }
   ...
   public UpdateFluidFX clone() {
      ...
      if (this.fluidFX != null) {
         ...
         for(Map.Entry<Integer, FluidFX> e : this.fluidFX.entrySet()) {
            m.put((Integer)e.getKey(), ((FluidFX)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateFluidFX)) {
         return false;
      } else {
         UpdateFluidFX other = (UpdateFluidFX)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.fluidFX, other.fluidFX);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.maxId, this.fluidFX});
   }
}
