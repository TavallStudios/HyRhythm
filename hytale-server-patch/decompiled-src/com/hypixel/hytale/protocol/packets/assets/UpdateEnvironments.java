...
public class UpdateEnvironments implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.environments != null) {
         ...
         for(Map.Entry<Integer, WorldEnvironment> e : this.environments.entrySet()) {
            ...
            ((WorldEnvironment)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.environments != null) {
         ...
         for(Map.Entry<Integer, WorldEnvironment> kvp : this.environments.entrySet()) {
            environmentsSize += 4 + ((WorldEnvironment)kvp.getValue()).computeSize();
         }
   ...
   public UpdateEnvironments clone() {
      ...
      if (this.environments != null) {
         ...
         for(Map.Entry<Integer, WorldEnvironment> e : this.environments.entrySet()) {
            m.put((Integer)e.getKey(), ((WorldEnvironment)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateEnvironments)) {
         return false;
      } else {
         UpdateEnvironments other = (UpdateEnvironments)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.environments, other.environments) && this.rebuildMapGeometry == other.rebuildMapGeometry;
      }
   }
