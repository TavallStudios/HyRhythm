...
public class UpdateRecipes implements Packet, ToClientPacket {
   ...
   public int computeSize() {
      ...
      if (this.recipes != null) {
         ...
         for(Map.Entry<String, CraftingRecipe> kvp : this.recipes.entrySet()) {
            recipesSize += PacketIO.stringSize((String)kvp.getKey()) + ((CraftingRecipe)kvp.getValue()).computeSize();
         }
   ...
   public UpdateRecipes clone() {
      ...
      copy.removedRecipes = this.removedRecipes != null ? (String[])Arrays.copyOf(this.removedRecipes, this.removedRecipes.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateRecipes)) {
         return false;
      } else {
