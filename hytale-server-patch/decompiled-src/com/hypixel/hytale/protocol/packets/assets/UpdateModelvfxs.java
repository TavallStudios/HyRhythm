...
public class UpdateModelvfxs implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.modelVFXs != null) {
         ...
         for(Map.Entry<Integer, ModelVFX> e : this.modelVFXs.entrySet()) {
            buf.writeIntLE((Integer)e.getKey());
            ((ModelVFX)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.modelVFXs != null) {
         ...
         for(Map.Entry<Integer, ModelVFX> kvp : this.modelVFXs.entrySet()) {
            modelVFXsSize += 4 + ((ModelVFX)kvp.getValue()).computeSize();
         }
   ...
   public UpdateModelvfxs clone() {
      ...
      if (this.modelVFXs != null) {
         ...
         for(Map.Entry<Integer, ModelVFX> e : this.modelVFXs.entrySet()) {
            m.put((Integer)e.getKey(), ((ModelVFX)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateModelvfxs)) {
         return false;
      } else {
         UpdateModelvfxs other = (UpdateModelvfxs)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.modelVFXs, other.modelVFXs);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.maxId, this.modelVFXs});
   }
}
