...
public class UpdateParticleSpawners implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.particleSpawners != null) {
         ...
         for(Map.Entry<String, ParticleSpawner> e : this.particleSpawners.entrySet()) {
            ...
            ((ParticleSpawner)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public int computeSize() {
      ...
      if (this.particleSpawners != null) {
         ...
         for(Map.Entry<String, ParticleSpawner> kvp : this.particleSpawners.entrySet()) {
            particleSpawnersSize += PacketIO.stringSize((String)kvp.getKey()) + ((ParticleSpawner)kvp.getValue()).computeSize();
         }
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 10) {
         ...
         if ((nullBits & 2) != 0) {
            ...
            int pos = offset + 10 + removedParticleSpawnersOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public UpdateParticleSpawners clone() {
      ...
      if (this.particleSpawners != null) {
         ...
         for(Map.Entry<String, ParticleSpawner> e : this.particleSpawners.entrySet()) {
            m.put((String)e.getKey(), ((ParticleSpawner)e.getValue()).clone());
         }

         copy.particleSpawners = m;
      }

      copy.removedParticleSpawners = this.removedParticleSpawners != null ? (String[])Arrays.copyOf(this.removedParticleSpawners, this.removedParticleSpawners.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateParticleSpawners)) {
         return false;
      } else {
         UpdateParticleSpawners other = (UpdateParticleSpawners)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.particleSpawners, other.particleSpawners) && Arrays.equals(this.removedParticleSpawners, other.removedParticleSpawners);
      }
   }
