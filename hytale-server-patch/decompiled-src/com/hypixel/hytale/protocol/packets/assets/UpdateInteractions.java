...
public class UpdateInteractions implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.interactions != null) {
         ...
         for(Map.Entry<Integer, Interaction> e : this.interactions.entrySet()) {
   ...
   public int computeSize() {
      ...
      if (this.interactions != null) {
         ...
         for(Map.Entry<Integer, Interaction> kvp : this.interactions.entrySet()) {
            interactionsSize += 4 + ((Interaction)kvp.getValue()).computeSizeWithTypeId();
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateInteractions)) {
         return false;
      } else {
         UpdateInteractions other = (UpdateInteractions)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.interactions, other.interactions);
      }
   }
