...
public class UpdateParticleSystems implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.particleSystems != null) {
         ...
         for(Map.Entry<String, ParticleSystem> e : this.particleSystems.entrySet()) {
            PacketIO.writeVarString(buf, (String)e.getKey(), 4096000);
            ((ParticleSystem)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public int computeSize() {
      ...
      if (this.particleSystems != null) {
         ...
         for(Map.Entry<String, ParticleSystem> kvp : this.particleSystems.entrySet()) {
            particleSystemsSize += PacketIO.stringSize((String)kvp.getKey()) + ((ParticleSystem)kvp.getValue()).computeSize();
         }
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 10) {
         ...
         if ((nullBits & 2) != 0) {
            ...
            int pos = offset + 10 + removedParticleSystemsOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public UpdateParticleSystems clone() {
      ...
      if (this.particleSystems != null) {
         ...
         for(Map.Entry<String, ParticleSystem> e : this.particleSystems.entrySet()) {
            m.put((String)e.getKey(), ((ParticleSystem)e.getValue()).clone());
         }

         copy.particleSystems = m;
      }

      copy.removedParticleSystems = this.removedParticleSystems != null ? (String[])Arrays.copyOf(this.removedParticleSystems, this.removedParticleSystems.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateParticleSystems)) {
         return false;
      } else {
         UpdateParticleSystems other = (UpdateParticleSystems)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.particleSystems, other.particleSystems) && Arrays.equals(this.removedParticleSystems, other.removedParticleSystems);
      }
   }
   ...
   public int hashCode() {
      ...
      result = 31 * result + Arrays.hashCode(this.removedParticleSystems);
      return result;
   }
}
