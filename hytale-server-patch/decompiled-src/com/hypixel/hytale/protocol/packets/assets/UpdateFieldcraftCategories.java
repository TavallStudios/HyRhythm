...
public class UpdateFieldcraftCategories implements Packet, ToClientPacket {
   ...
   public UpdateFieldcraftCategories clone() {
      ...
      copy.type = this.type;
      copy.itemCategories = this.itemCategories != null ? (ItemCategory[])Arrays.stream(this.itemCategories).map((e) -> e.clone()).toArray((x$0) -> new ItemCategory[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateFieldcraftCategories)) {
         return false;
      } else {
         UpdateFieldcraftCategories other = (UpdateFieldcraftCategories)obj;
         return Objects.equals(this.type, other.type) && Arrays.equals(this.itemCategories, other.itemCategories);
      }
   }
   ...
   public int hashCode() {
      ...
      result = 31 * result + Arrays.hashCode(this.itemCategories);
      return result;
   }
}
