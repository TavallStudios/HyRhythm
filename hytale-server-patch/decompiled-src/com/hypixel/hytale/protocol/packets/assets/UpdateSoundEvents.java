...
public class UpdateSoundEvents implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.soundEvents != null) {
         ...
         for(Map.Entry<Integer, SoundEvent> e : this.soundEvents.entrySet()) {
            ...
            ((SoundEvent)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.soundEvents != null) {
         ...
         for(Map.Entry<Integer, SoundEvent> kvp : this.soundEvents.entrySet()) {
            soundEventsSize += 4 + ((SoundEvent)kvp.getValue()).computeSize();
         }
   ...
   public UpdateSoundEvents clone() {
      ...
      if (this.soundEvents != null) {
         ...
         for(Map.Entry<Integer, SoundEvent> e : this.soundEvents.entrySet()) {
            m.put((Integer)e.getKey(), ((SoundEvent)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateSoundEvents)) {
         return false;
      } else {
         UpdateSoundEvents other = (UpdateSoundEvents)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.soundEvents, other.soundEvents);
      }
   }
