...
public class UpdateAmbienceFX implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.ambienceFX != null) {
         ...
         for(Map.Entry<Integer, AmbienceFX> e : this.ambienceFX.entrySet()) {
            buf.writeIntLE((Integer)e.getKey());
            ((AmbienceFX)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.ambienceFX != null) {
         ...
         for(Map.Entry<Integer, AmbienceFX> kvp : this.ambienceFX.entrySet()) {
            ambienceFXSize += 4 + ((AmbienceFX)kvp.getValue()).computeSize();
         }
   ...
   public UpdateAmbienceFX clone() {
      ...
      if (this.ambienceFX != null) {
         ...
         for(Map.Entry<Integer, AmbienceFX> e : this.ambienceFX.entrySet()) {
            m.put((Integer)e.getKey(), ((AmbienceFX)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateAmbienceFX)) {
         return false;
      } else {
         UpdateAmbienceFX other = (UpdateAmbienceFX)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.ambienceFX, other.ambienceFX);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.maxId, this.ambienceFX});
   }
}
