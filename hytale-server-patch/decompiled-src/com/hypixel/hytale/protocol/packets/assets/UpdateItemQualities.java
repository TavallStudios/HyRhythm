...
public class UpdateItemQualities implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.itemQualities != null) {
         ...
         for(Map.Entry<Integer, ItemQuality> e : this.itemQualities.entrySet()) {
            ...
            ((ItemQuality)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.itemQualities != null) {
         ...
         for(Map.Entry<Integer, ItemQuality> kvp : this.itemQualities.entrySet()) {
            itemQualitiesSize += 4 + ((ItemQuality)kvp.getValue()).computeSize();
         }
   ...
   public UpdateItemQualities clone() {
      ...
      if (this.itemQualities != null) {
         ...
         for(Map.Entry<Integer, ItemQuality> e : this.itemQualities.entrySet()) {
            m.put((Integer)e.getKey(), ((ItemQuality)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateItemQualities)) {
         return false;
      } else {
         UpdateItemQualities other = (UpdateItemQualities)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.itemQualities, other.itemQualities);
      }
   }
