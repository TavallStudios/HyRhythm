...
public class UpdateFluids implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.fluids != null) {
         ...
         for(Map.Entry<Integer, Fluid> e : this.fluids.entrySet()) {
            ...
            ((Fluid)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.fluids != null) {
         ...
         for(Map.Entry<Integer, Fluid> kvp : this.fluids.entrySet()) {
            fluidsSize += 4 + ((Fluid)kvp.getValue()).computeSize();
         }
   ...
   public UpdateFluids clone() {
      ...
      if (this.fluids != null) {
         ...
         for(Map.Entry<Integer, Fluid> e : this.fluids.entrySet()) {
            m.put((Integer)e.getKey(), ((Fluid)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateFluids)) {
         return false;
      } else {
         UpdateFluids other = (UpdateFluids)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.fluids, other.fluids);
      }
   }
