...
public class UpdateItemReticles implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.itemReticleConfigs != null) {
         ...
         for(Map.Entry<Integer, ItemReticleConfig> e : this.itemReticleConfigs.entrySet()) {
            ...
            ((ItemReticleConfig)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.itemReticleConfigs != null) {
         ...
         for(Map.Entry<Integer, ItemReticleConfig> kvp : this.itemReticleConfigs.entrySet()) {
            itemReticleConfigsSize += 4 + ((ItemReticleConfig)kvp.getValue()).computeSize();
         }
   ...
   public UpdateItemReticles clone() {
      ...
      if (this.itemReticleConfigs != null) {
         ...
         for(Map.Entry<Integer, ItemReticleConfig> e : this.itemReticleConfigs.entrySet()) {
            m.put((Integer)e.getKey(), ((ItemReticleConfig)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateItemReticles)) {
         return false;
      } else {
         UpdateItemReticles other = (UpdateItemReticles)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.itemReticleConfigs, other.itemReticleConfigs);
      }
   }
