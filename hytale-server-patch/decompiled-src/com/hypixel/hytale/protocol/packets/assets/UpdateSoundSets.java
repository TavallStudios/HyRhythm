...
public class UpdateSoundSets implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.soundSets != null) {
         ...
         for(Map.Entry<Integer, SoundSet> e : this.soundSets.entrySet()) {
            buf.writeIntLE((Integer)e.getKey());
            ((SoundSet)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.soundSets != null) {
         ...
         for(Map.Entry<Integer, SoundSet> kvp : this.soundSets.entrySet()) {
            soundSetsSize += 4 + ((SoundSet)kvp.getValue()).computeSize();
         }
   ...
   public UpdateSoundSets clone() {
      ...
      if (this.soundSets != null) {
         ...
         for(Map.Entry<Integer, SoundSet> e : this.soundSets.entrySet()) {
            m.put((Integer)e.getKey(), ((SoundSet)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateSoundSets)) {
         return false;
      } else {
         UpdateSoundSets other = (UpdateSoundSets)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.soundSets, other.soundSets);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.maxId, this.soundSets});
   }
}
