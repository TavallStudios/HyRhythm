...
public class UpdateEqualizerEffects implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.effects != null) {
         ...
         for(Map.Entry<Integer, EqualizerEffect> e : this.effects.entrySet()) {
            ...
            ((EqualizerEffect)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.effects != null) {
         ...
         for(Map.Entry<Integer, EqualizerEffect> kvp : this.effects.entrySet()) {
            effectsSize += 4 + ((EqualizerEffect)kvp.getValue()).computeSize();
         }
   ...
   public UpdateEqualizerEffects clone() {
      ...
      if (this.effects != null) {
         ...
         for(Map.Entry<Integer, EqualizerEffect> e : this.effects.entrySet()) {
            m.put((Integer)e.getKey(), ((EqualizerEffect)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateEqualizerEffects)) {
         return false;
      } else {
         UpdateEqualizerEffects other = (UpdateEqualizerEffects)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.effects, other.effects);
      }
   }
