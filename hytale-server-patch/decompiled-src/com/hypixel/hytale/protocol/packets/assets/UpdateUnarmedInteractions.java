...
public class UpdateUnarmedInteractions implements Packet, ToClientPacket {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateUnarmedInteractions)) {
         return false;
      } else {
         UpdateUnarmedInteractions other = (UpdateUnarmedInteractions)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.interactions, other.interactions);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.interactions});
   }
}
