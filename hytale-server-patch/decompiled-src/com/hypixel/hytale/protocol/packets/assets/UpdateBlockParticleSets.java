...
public class UpdateBlockParticleSets implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.blockParticleSets != null) {
         ...
         for(Map.Entry<String, BlockParticleSet> e : this.blockParticleSets.entrySet()) {
            ...
            ((BlockParticleSet)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.blockParticleSets != null) {
         ...
         for(Map.Entry<String, BlockParticleSet> kvp : this.blockParticleSets.entrySet()) {
            blockParticleSetsSize += PacketIO.stringSize((String)kvp.getKey()) + ((BlockParticleSet)kvp.getValue()).computeSize();
         }
   ...
   public UpdateBlockParticleSets clone() {
      ...
      if (this.blockParticleSets != null) {
         ...
         for(Map.Entry<String, BlockParticleSet> e : this.blockParticleSets.entrySet()) {
            m.put((String)e.getKey(), ((BlockParticleSet)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateBlockParticleSets)) {
         return false;
      } else {
         UpdateBlockParticleSets other = (UpdateBlockParticleSets)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.blockParticleSets, other.blockParticleSets);
      }
   }
