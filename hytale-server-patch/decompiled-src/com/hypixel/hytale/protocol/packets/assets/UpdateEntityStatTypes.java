...
public class UpdateEntityStatTypes implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.types != null) {
         ...
         for(Map.Entry<Integer, EntityStatType> e : this.types.entrySet()) {
            ...
            ((EntityStatType)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.types != null) {
         ...
         for(Map.Entry<Integer, EntityStatType> kvp : this.types.entrySet()) {
            typesSize += 4 + ((EntityStatType)kvp.getValue()).computeSize();
         }
   ...
   public UpdateEntityStatTypes clone() {
      ...
      if (this.types != null) {
         ...
         for(Map.Entry<Integer, EntityStatType> e : this.types.entrySet()) {
            m.put((Integer)e.getKey(), ((EntityStatType)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateEntityStatTypes)) {
         return false;
      } else {
         UpdateEntityStatTypes other = (UpdateEntityStatTypes)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.types, other.types);
      }
   }
