...
public class UpdateHitboxCollisionConfig implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.hitboxCollisionConfigs != null) {
         ...
         for(Map.Entry<Integer, HitboxCollisionConfig> e : this.hitboxCollisionConfigs.entrySet()) {
            ...
            ((HitboxCollisionConfig)e.getValue()).serialize(buf);
         }
      }
   ...
   public UpdateHitboxCollisionConfig clone() {
      ...
      if (this.hitboxCollisionConfigs != null) {
         ...
         for(Map.Entry<Integer, HitboxCollisionConfig> e : this.hitboxCollisionConfigs.entrySet()) {
            m.put((Integer)e.getKey(), ((HitboxCollisionConfig)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateHitboxCollisionConfig)) {
         return false;
      } else {
         UpdateHitboxCollisionConfig other = (UpdateHitboxCollisionConfig)obj;
         return Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.hitboxCollisionConfigs, other.hitboxCollisionConfigs);
      }
   }
