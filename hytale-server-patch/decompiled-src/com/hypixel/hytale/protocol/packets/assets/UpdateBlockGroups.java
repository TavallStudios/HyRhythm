...
public class UpdateBlockGroups implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.groups != null) {
         ...
         for(Map.Entry<String, BlockGroup> e : this.groups.entrySet()) {
            PacketIO.writeVarString(buf, (String)e.getKey(), 4096000);
            ((BlockGroup)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.groups != null) {
         ...
         for(Map.Entry<String, BlockGroup> kvp : this.groups.entrySet()) {
            groupsSize += PacketIO.stringSize((String)kvp.getKey()) + ((BlockGroup)kvp.getValue()).computeSize();
         }
   ...
   public UpdateBlockGroups clone() {
      ...
      if (this.groups != null) {
         ...
         for(Map.Entry<String, BlockGroup> e : this.groups.entrySet()) {
            m.put((String)e.getKey(), ((BlockGroup)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateBlockGroups)) {
         return false;
      } else {
         UpdateBlockGroups other = (UpdateBlockGroups)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.groups, other.groups);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.groups});
   }
}
