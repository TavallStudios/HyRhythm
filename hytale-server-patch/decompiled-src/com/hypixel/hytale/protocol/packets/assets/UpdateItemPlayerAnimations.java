...
public class UpdateItemPlayerAnimations implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.itemPlayerAnimations != null) {
         ...
         for(Map.Entry<String, ItemPlayerAnimations> e : this.itemPlayerAnimations.entrySet()) {
            PacketIO.writeVarString(buf, (String)e.getKey(), 4096000);
            ((ItemPlayerAnimations)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.itemPlayerAnimations != null) {
         ...
         for(Map.Entry<String, ItemPlayerAnimations> kvp : this.itemPlayerAnimations.entrySet()) {
            itemPlayerAnimationsSize += PacketIO.stringSize((String)kvp.getKey()) + ((ItemPlayerAnimations)kvp.getValue()).computeSize();
         }
   ...
   public UpdateItemPlayerAnimations clone() {
      ...
      if (this.itemPlayerAnimations != null) {
         ...
         for(Map.Entry<String, ItemPlayerAnimations> e : this.itemPlayerAnimations.entrySet()) {
            m.put((String)e.getKey(), ((ItemPlayerAnimations)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateItemPlayerAnimations)) {
         return false;
      } else {
         UpdateItemPlayerAnimations other = (UpdateItemPlayerAnimations)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.itemPlayerAnimations, other.itemPlayerAnimations);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.itemPlayerAnimations});
   }
}
