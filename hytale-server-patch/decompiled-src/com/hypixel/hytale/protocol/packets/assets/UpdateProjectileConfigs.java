...
public class UpdateProjectileConfigs implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.configs != null) {
         ...
         for(Map.Entry<String, ProjectileConfig> e : this.configs.entrySet()) {
            ...
            ((ProjectileConfig)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public int computeSize() {
      ...
      if (this.configs != null) {
         ...
         for(Map.Entry<String, ProjectileConfig> kvp : this.configs.entrySet()) {
            configsSize += PacketIO.stringSize((String)kvp.getKey()) + ((ProjectileConfig)kvp.getValue()).computeSize();
         }
   ...
   public UpdateProjectileConfigs clone() {
      ...
      if (this.configs != null) {
         ...
         for(Map.Entry<String, ProjectileConfig> e : this.configs.entrySet()) {
            m.put((String)e.getKey(), ((ProjectileConfig)e.getValue()).clone());
         }

         copy.configs = m;
      }

      copy.removedConfigs = this.removedConfigs != null ? (String[])Arrays.copyOf(this.removedConfigs, this.removedConfigs.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateProjectileConfigs)) {
         return false;
      } else {
         UpdateProjectileConfigs other = (UpdateProjectileConfigs)obj;
         return Objects.equals(this.type, other.type) && Objects.equals(this.configs, other.configs) && Arrays.equals(this.removedConfigs, other.removedConfigs);
      }
   }
