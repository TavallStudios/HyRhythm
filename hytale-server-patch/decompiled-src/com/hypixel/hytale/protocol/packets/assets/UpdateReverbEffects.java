...
public class UpdateReverbEffects implements Packet, ToClientPacket {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.effects != null) {
         ...
         for(Map.Entry<Integer, ReverbEffect> e : this.effects.entrySet()) {
            ...
            ((ReverbEffect)e.getValue()).serialize(buf);
         }
      }
   ...
   public int computeSize() {
      ...
      if (this.effects != null) {
         ...
         for(Map.Entry<Integer, ReverbEffect> kvp : this.effects.entrySet()) {
            effectsSize += 4 + ((ReverbEffect)kvp.getValue()).computeSize();
         }
   ...
   public UpdateReverbEffects clone() {
      ...
      if (this.effects != null) {
         ...
         for(Map.Entry<Integer, ReverbEffect> e : this.effects.entrySet()) {
            m.put((Integer)e.getKey(), ((ReverbEffect)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof UpdateReverbEffects)) {
         return false;
      } else {
