...
public class WeatherParticle {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof WeatherParticle)) {
         return false;
      } else {
         WeatherParticle other = (WeatherParticle)obj;
         return Objects.equals(this.systemId, other.systemId) && Objects.equals(this.color, other.color) && this.scale == other.scale && this.isOvergroundOnly == other.isOvergroundOnly && this.positionOffsetMultiplier == other.positionOffsetMultiplier;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.systemId, this.color, this.scale, this.isOvergroundOnly, this.positionOffsetMultiplier});
   }
}
