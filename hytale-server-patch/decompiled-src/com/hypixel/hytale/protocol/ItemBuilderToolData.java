...
public class ItemBuilderToolData {
   ...
   public ItemBuilderToolData clone() {
      ...
      copy.ui = this.ui != null ? (String[])Arrays.copyOf(this.ui, this.ui.length) : null;
      copy.tools = this.tools != null ? (BuilderToolState[])Arrays.stream(this.tools).map((e) -> e.clone()).toArray((x$0) -> new BuilderToolState[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ItemBuilderToolData)) {
         return false;
      } else {
