...
public class SoundEventLayerRandomSettings {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SoundEventLayerRandomSettings)) {
         return false;
      } else {
         SoundEventLayerRandomSettings other = (SoundEventLayerRandomSettings)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.minVolume, this.maxVolume, this.minPitch, this.maxPitch, this.maxStartOffset});
   }
}
