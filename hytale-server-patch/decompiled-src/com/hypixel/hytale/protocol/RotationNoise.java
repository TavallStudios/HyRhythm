...
public class RotationNoise {
   ...
   public RotationNoise clone() {
      ...
      copy.pitch = this.pitch != null ? (NoiseConfig[])Arrays.stream(this.pitch).map((e) -> e.clone()).toArray((x$0) -> new NoiseConfig[x$0]) : null;
      copy.yaw = this.yaw != null ? (NoiseConfig[])Arrays.stream(this.yaw).map((e) -> e.clone()).toArray((x$0) -> new NoiseConfig[x$0]) : null;
      copy.roll = this.roll != null ? (NoiseConfig[])Arrays.stream(this.roll).map((e) -> e.clone()).toArray((x$0) -> new NoiseConfig[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof RotationNoise)) {
         return false;
      } else {
