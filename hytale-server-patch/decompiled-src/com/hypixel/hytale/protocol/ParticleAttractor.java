...
public class ParticleAttractor {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ParticleAttractor)) {
         return false;
      } else {
         ParticleAttractor other = (ParticleAttractor)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.position, this.radialAxis, this.trailPositionMultiplier, this.radius, this.radialAcceleration, this.radialTangentAcceleration, this.linearAcceleration, this.radialImpulse, this.radialTangentImpulse, this.linearImpulse, this.dampingMultiplier});
   }
}
