...
public class DamageCause {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return Objects.equals(this.id, other.id) && Objects.equals(this.damageTextColor, other.damageTextColor);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.damageTextColor});
   }
}
