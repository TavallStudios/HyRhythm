...
public class CameraShakeConfig {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof CameraShakeConfig)) {
         return false;
      } else {
         CameraShakeConfig other = (CameraShakeConfig)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.duration, this.startTime, this.continuous, this.easeIn, this.easeOut, this.offset, this.rotation});
   }
}
