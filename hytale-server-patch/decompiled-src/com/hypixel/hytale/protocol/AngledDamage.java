...
public class AngledDamage {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AngledDamage)) {
         return false;
      } else {
         AngledDamage other = (AngledDamage)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.angle, this.angleDistance, this.damageEffects, this.next});
   }
}
