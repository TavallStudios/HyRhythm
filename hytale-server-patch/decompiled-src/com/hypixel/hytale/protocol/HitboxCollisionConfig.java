...
public class HitboxCollisionConfig {
   ...
   public HitboxCollisionConfig() {
      this.collisionType = CollisionType.Hard;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof HitboxCollisionConfig)) {
         return false;
      } else {
         HitboxCollisionConfig other = (HitboxCollisionConfig)obj;
         return Objects.equals(this.collisionType, other.collisionType) && this.softCollisionOffsetRatio == other.softCollisionOffsetRatio;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.collisionType, this.softCollisionOffsetRatio});
   }
}
