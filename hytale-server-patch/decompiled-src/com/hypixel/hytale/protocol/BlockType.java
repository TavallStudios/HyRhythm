...
public class BlockType {
   ...
   public BlockType() {
      ...
      this.blockSupportsRequiredFor = BlockSupportsRequiredForType.Any;
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.support != null) {
         ...
         for(Map.Entry<BlockNeighbor, RequiredBlockFaceSupport[]> e : this.support.entrySet()) {
            buf.writeByte(((BlockNeighbor)e.getKey()).getValue());
            VarInt.write(buf, ((RequiredBlockFaceSupport[])e.getValue()).length);

            for(RequiredBlockFaceSupport arrItem : (RequiredBlockFaceSupport[])e.getValue()) {
      ...
      if (this.supporting != null) {
         ...
         for(Map.Entry<BlockNeighbor, BlockFaceSupport[]> e : this.supporting.entrySet()) {
            buf.writeByte(((BlockNeighbor)e.getKey()).getValue());
            VarInt.write(buf, ((BlockFaceSupport[])e.getValue()).length);

            for(BlockFaceSupport arrItem : (BlockFaceSupport[])e.getValue()) {
               arrItem.serialize(buf);
            }
         }
      } else {
      ...
      if (this.interactions != null) {
         ...
         for(Map.Entry<InteractionType, Integer> e : this.interactions.entrySet()) {
            buf.writeByte(((InteractionType)e.getKey()).getValue());
      ...
      if (this.states != null) {
         ...
         for(Map.Entry<String, Integer> e : this.states.entrySet()) {
   ...
   public int computeSize() {
      ...
      if (this.support != null) {
         ...
         for(Map.Entry<BlockNeighbor, RequiredBlockFaceSupport[]> kvp : this.support.entrySet()) {
            supportSize += 1 + VarInt.size(((RequiredBlockFaceSupport[])kvp.getValue()).length) + Arrays.stream((RequiredBlockFaceSupport[])kvp.getValue()).mapToInt((inner) -> inner.computeSize()).sum();
         }
      ...
      if (this.supporting != null) {
         ...
         for(Map.Entry<BlockNeighbor, BlockFaceSupport[]> kvp : this.supporting.entrySet()) {
            supportingSize += 1 + VarInt.size(((BlockFaceSupport[])kvp.getValue()).length) + Arrays.stream((BlockFaceSupport[])kvp.getValue()).mapToInt((inner) -> inner.computeSize()).sum();
         }
      ...
      if (this.states != null) {
         ...
         for(Map.Entry<String, Integer> kvp : this.states.entrySet()) {
            statesSize += PacketIO.stringSize((String)kvp.getKey()) + 4;
         }
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 260) {
         ...
         if ((nullBits[1] & 2) != 0) {
            ...
            int pos = offset + 260 + shaderEffectOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 8) != 0) {
            ...
            int pos = offset + 260 + modelTextureOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 16) != 0) {
            ...
            int pos = offset + 260 + modelAnimationOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 32) != 0) {
            ...
            int pos = offset + 260 + supportOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 64) != 0) {
            ...
            int pos = offset + 260 + supportingOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[1] & 128) != 0) {
            ...
            int pos = offset + 260 + cubeTexturesOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[2] & 1) != 0) {
            ...
            int pos = offset + 260 + cubeSideMaskTextureOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[2] & 4) != 0) {
            ...
            int pos = offset + 260 + blockParticleSetIdOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[2] & 8) != 0) {
            ...
            int pos = offset + 260 + blockBreakingDecalIdOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[2] & 16) != 0) {
            ...
            int pos = offset + 260 + transitionTextureOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[2] & 32) != 0) {
            ...
            int pos = offset + 260 + transitionToGroupsOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[2] & 64) != 0) {
            ...
            int pos = offset + 260 + interactionHintOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[2] & 128) != 0) {
            ...
            int pos = offset + 260 + gatheringOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[3] & 1) != 0) {
            ...
            int pos = offset + 260 + displayOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[3] & 8) != 0) {
            ...
            int pos = offset + 260 + statesOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[3] & 32) != 0) {
            ...
            int pos = offset + 260 + benchOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits[3] & 64) != 0) {
            ...
            int pos = offset + 260 + connectedBlockRuleSetOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public BlockType clone() {
      ...
      copy.shaderEffect = this.shaderEffect != null ? (ShaderType[])Arrays.copyOf(this.shaderEffect, this.shaderEffect.length) : null;
      copy.hitbox = this.hitbox;
      copy.interactionHitbox = this.interactionHitbox;
      copy.model = this.model;
      copy.modelTexture = this.modelTexture != null ? (ModelTexture[])Arrays.stream(this.modelTexture).map((ex) -> ex.clone()).toArray((x$0) -> new ModelTexture[x$0]) : null;
      ...
      if (this.support != null) {
         ...
         for(Map.Entry<BlockNeighbor, RequiredBlockFaceSupport[]> e : this.support.entrySet()) {
            m.put((BlockNeighbor)e.getKey(), (RequiredBlockFaceSupport[])Arrays.stream((RequiredBlockFaceSupport[])e.getValue()).map((x) -> x.clone()).toArray((x$0) -> new RequiredBlockFaceSupport[x$0]));
         }
      ...
      if (this.supporting != null) {
         ...
         for(Map.Entry<BlockNeighbor, BlockFaceSupport[]> e : this.supporting.entrySet()) {
            m.put((BlockNeighbor)e.getKey(), (BlockFaceSupport[])Arrays.stream((BlockFaceSupport[])e.getValue()).map((x) -> x.clone()).toArray((x$0) -> new BlockFaceSupport[x$0]));
         }
      ...
      copy.cubeTextures = this.cubeTextures != null ? (BlockTextures[])Arrays.stream(this.cubeTextures).map((ex) -> ex.clone()).toArray((x$0) -> new BlockTextures[x$0]) : null;
      ...
      copy.particles = this.particles != null ? (ModelParticle[])Arrays.stream(this.particles).map((ex) -> ex.clone()).toArray((x$0) -> new ModelParticle[x$0]) : null;
