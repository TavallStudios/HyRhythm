...
public class ClearEntityEffectInteraction extends SimpleInteraction {
   ...
   public static ClearEntityEffectInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      ClearEntityEffectInteraction obj = new ClearEntityEffectInteraction();
      ...
      if ((nullBits & 1) != 0) {
         int varPos0 = offset + 44 + buf.getIntLE(offset + 24);
         obj.effects = InteractionEffects.deserialize(buf, varPos0);
      }

      if ((nullBits & 2) != 0) {
         int varPos1 = offset + 44 + buf.getIntLE(offset + 28);
      ...
      if ((nullBits & 4) != 0) {
         int varPos2 = offset + 44 + buf.getIntLE(offset + 32);
         obj.rules = InteractionRules.deserialize(buf, varPos2);
      }

      if ((nullBits & 8) != 0) {
         int varPos3 = offset + 44 + buf.getIntLE(offset + 36);
      ...
      if ((nullBits & 16) != 0) {
         int varPos4 = offset + 44 + buf.getIntLE(offset + 40);
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ClearEntityEffectInteraction)) {
         return false;
      } else {
         ClearEntityEffectInteraction other = (ClearEntityEffectInteraction)obj;
