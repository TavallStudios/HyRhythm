...
public class TargetedDamage {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof TargetedDamage)) {
         return false;
      } else {
         TargetedDamage other = (TargetedDamage)obj;
         return this.index == other.index && Objects.equals(this.damageEffects, other.damageEffects) && this.next == other.next;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.index, this.damageEffects, this.next});
   }
}
