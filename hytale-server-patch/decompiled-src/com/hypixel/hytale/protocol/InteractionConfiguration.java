...
public class InteractionConfiguration {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.useDistance != null) {
         ...
         for(Map.Entry<GameMode, Float> e : this.useDistance.entrySet()) {
            buf.writeByte(((GameMode)e.getKey()).getValue());
            buf.writeFloatLE((Float)e.getValue());
         }
      } else {
      ...
      if (this.priorities != null) {
         ...
         for(Map.Entry<InteractionType, InteractionPriority> e : this.priorities.entrySet()) {
            ...
            ((InteractionPriority)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public int computeSize() {
      ...
      if (this.priorities != null) {
         ...
         for(Map.Entry<InteractionType, InteractionPriority> kvp : this.priorities.entrySet()) {
            prioritiesSize += 1 + ((InteractionPriority)kvp.getValue()).computeSize();
         }
   ...
   public InteractionConfiguration clone() {
      ...
      if (this.priorities != null) {
         ...
         for(Map.Entry<InteractionType, InteractionPriority> e : this.priorities.entrySet()) {
            m.put((InteractionType)e.getKey(), ((InteractionPriority)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof InteractionConfiguration)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.displayOutlines, this.debugOutlines, this.useDistance, this.allEntities, this.priorities});
   }
}
