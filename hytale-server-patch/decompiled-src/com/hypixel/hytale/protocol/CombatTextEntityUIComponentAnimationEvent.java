...
public class CombatTextEntityUIComponentAnimationEvent {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof CombatTextEntityUIComponentAnimationEvent)) {
         return false;
      } else {
         CombatTextEntityUIComponentAnimationEvent other = (CombatTextEntityUIComponentAnimationEvent)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.startAt, this.endAt, this.startScale, this.endScale, this.positionOffset, this.startOpacity, this.endOpacity});
   }
}
