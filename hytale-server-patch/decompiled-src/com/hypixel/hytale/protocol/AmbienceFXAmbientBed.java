...
public class AmbienceFXAmbientBed {
   ...
   public float volume;
   @Nonnull
   public AmbienceTransitionSpeed transitionSpeed;
   ...
   public static AmbienceFXAmbientBed deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + trackVarLen + trackLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof AmbienceFXAmbientBed)) {
         return false;
      } else {
         AmbienceFXAmbientBed other = (AmbienceFXAmbientBed)obj;
         return Objects.equals(this.track, other.track) && this.volume == other.volume && Objects.equals(this.transitionSpeed, other.transitionSpeed);
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.track, this.volume, this.transitionSpeed});
   }
}
