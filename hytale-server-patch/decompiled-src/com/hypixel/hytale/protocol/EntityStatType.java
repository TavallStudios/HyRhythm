...
public class EntityStatType {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof EntityStatType)) {
         return false;
      } else {
         EntityStatType other = (EntityStatType)obj;
         return Objects.equals(this.id, other.id) && this.value == other.value && this.min == other.min && this.max == other.max && Objects.equals(this.minValueEffects, other.minValueEffects) && Objects.equals(this.maxValueEffects, other.maxValueEffects) && Objects.equals(this.resetBehavior, other.resetBehavior) && this.hideFromTooltip == other.hideFromTooltip;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.id, this.value, this.min, this.max, this.minValueEffects, this.maxValueEffects, this.resetBehavior, this.hideFromTooltip});
   }
}
