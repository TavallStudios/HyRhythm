...
public class WorldParticle {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof WorldParticle)) {
         return false;
      } else {
         WorldParticle other = (WorldParticle)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.systemId, this.scale, this.color, this.positionOffset, this.rotationOffset});
   }
}
