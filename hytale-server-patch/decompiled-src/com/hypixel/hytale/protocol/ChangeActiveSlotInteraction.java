...
public class ChangeActiveSlotInteraction extends Interaction {
   ...
   public int targetSlot = -2147483648;
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ChangeActiveSlotInteraction)) {
         return false;
      } else {
         ChangeActiveSlotInteraction other = (ChangeActiveSlotInteraction)obj;
   ...
   public int hashCode() {
      ...
      result = 31 * result + Integer.hashCode(this.targetSlot);
      return result;
   }
}
