...
public class ItemQuantity {
   ...
   public static ItemQuantity deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         int var10000 = pos + itemIdVarLen + itemIdLen;
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ItemQuantity)) {
         return false;
      } else {
         ItemQuantity other = (ItemQuantity)obj;
         return Objects.equals(this.itemId, other.itemId) && this.quantity == other.quantity;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.itemId, this.quantity});
   }
}
