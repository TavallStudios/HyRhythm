...
public class ChargingInteraction extends Interaction {
   ...
   public int serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.chargedNext != null) {
         ...
         for(Map.Entry<Float, Integer> e : this.chargedNext.entrySet()) {
            buf.writeFloatLE((Float)e.getKey());
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 75) {
         ...
         if ((nullBits & 4) != 0) {
            ...
            int pos = offset + 75 + settingsOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 32) != 0) {
            ...
            int pos = offset + 75 + cameraOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 64) != 0) {
            ...
            int pos = offset + 75 + chargedNextOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ChargingInteraction)) {
         return false;
      } else {
