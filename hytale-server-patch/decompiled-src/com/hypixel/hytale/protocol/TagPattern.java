...
public class TagPattern {
   ...
   public TagPattern clone() {
      ...
      copy.operands = this.operands != null ? (TagPattern[])Arrays.stream(this.operands).map((e) -> e.clone()).toArray((x$0) -> new TagPattern[x$0]) : null;
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof TagPattern)) {
         return false;
      } else {
