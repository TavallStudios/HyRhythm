...
public class SelectedHitEntity {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof SelectedHitEntity)) {
         return false;
      } else {
         SelectedHitEntity other = (SelectedHitEntity)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.networkId, this.hitLocation, this.position, this.bodyRotation});
   }
}
