...
public class OffsetNoise {
   ...
   public static OffsetNoise deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         if ((long)(varPos0 + varIntLen) + (long)xCount * 23L > (long)buf.readableBytes()) {
      ...
      if ((nullBits & 2) != 0) {
         ...
         if ((long)(varPos1 + varIntLen) + (long)yCount * 23L > (long)buf.readableBytes()) {
      ...
      if ((nullBits & 4) != 0) {
         ...
         if ((long)(varPos2 + varIntLen) + (long)zCount * 23L > (long)buf.readableBytes()) {
   ...
   public OffsetNoise clone() {
      ...
      copy.x = this.x != null ? (NoiseConfig[])Arrays.stream(this.x).map((e) -> e.clone()).toArray((x$0) -> new NoiseConfig[x$0]) : null;
      copy.y = this.y != null ? (NoiseConfig[])Arrays.stream(this.y).map((e) -> e.clone()).toArray((x$0) -> new NoiseConfig[x$0]) : null;
      copy.z = this.z != null ? (NoiseConfig[])Arrays.stream(this.z).map((e) -> e.clone()).toArray((x$0) -> new NoiseConfig[x$0]) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof OffsetNoise)) {
         return false;
      } else {
         OffsetNoise other = (OffsetNoise)obj;
