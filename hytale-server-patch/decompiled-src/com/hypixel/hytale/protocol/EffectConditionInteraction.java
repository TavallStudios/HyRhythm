...
public class EffectConditionInteraction extends SimpleInteraction {
   ...
   public static EffectConditionInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 32) != 0) {
         ...
         if ((long)(varPos5 + varIntLen) + (long)entityEffectsCount * 4L > (long)buf.readableBytes()) {
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 45) {
         ...
         if ((nullBits & 32) != 0) {
            ...
            int pos = offset + 45 + entityEffectsOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof EffectConditionInteraction)) {
         return false;
      } else {
         EffectConditionInteraction other = (EffectConditionInteraction)obj;
