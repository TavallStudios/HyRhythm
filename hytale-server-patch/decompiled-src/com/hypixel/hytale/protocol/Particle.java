...
public class Particle {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.animationFrames != null) {
         ...
         for(Map.Entry<Integer, ParticleAnimationFrame> e : this.animationFrames.entrySet()) {
            buf.writeIntLE((Integer)e.getKey());
            ((ParticleAnimationFrame)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public Particle clone() {
      ...
      if (this.animationFrames != null) {
         ...
         for(Map.Entry<Integer, ParticleAnimationFrame> e : this.animationFrames.entrySet()) {
            m.put((Integer)e.getKey(), ((ParticleAnimationFrame)e.getValue()).clone());
         }
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.texturePath, this.frameSize, this.uvOption, this.scaleRatioConstraint, this.softParticles, this.softParticlesFadeFactor, this.useSpriteBlending, this.initialAnimationFrame, this.collisionAnimationFrame, this.animationFrames});
   }
}
