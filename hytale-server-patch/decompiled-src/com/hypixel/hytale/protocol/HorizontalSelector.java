...
public class HorizontalSelector extends Selector {
   ...
   public HorizontalSelector() {
      this.direction = HorizontalSelectorDirection.ToLeft;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof HorizontalSelector)) {
         return false;
      } else {
         HorizontalSelector other = (HorizontalSelector)obj;
         return this.extendTop == other.extendTop && this.extendBottom == other.extendBottom && this.yawLength == other.yawLength && this.yawStartOffset == other.yawStartOffset && this.pitchOffset == other.pitchOffset && this.rollOffset == other.rollOffset && this.startDistance == other.startDistance && this.endDistance == other.endDistance && Objects.equals(this.direction, other.direction) && this.testLineOfSight == other.testLineOfSight;
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.extendTop, this.extendBottom, this.yawLength, this.yawStartOffset, this.pitchOffset, this.rollOffset, this.startDistance, this.endDistance, this.direction, this.testLineOfSight});
   }
}
