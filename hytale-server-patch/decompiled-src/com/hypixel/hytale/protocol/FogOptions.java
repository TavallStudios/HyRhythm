...
public class FogOptions {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof FogOptions)) {
         return false;
      } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.ignoreFogLimits, this.effectiveViewDistanceMultiplier, this.fogFarViewDistance, this.fogHeightCameraOffset, this.fogHeightCameraOverriden, this.fogHeightCameraFixed});
   }
}
