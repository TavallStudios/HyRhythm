...
public class AbilityEffects {
   ...
   public static AbilityEffects deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         if ((long)(pos + disabledVarLen) + (long)disabledCount * 1L > (long)buf.readableBytes()) {
   ...
   public AbilityEffects clone() {
      ...
      copy.disabled = this.disabled != null ? (InteractionType[])Arrays.copyOf(this.disabled, this.disabled.length) : null;
      return copy;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (obj instanceof AbilityEffects) {
         AbilityEffects other = (AbilityEffects)obj;
         return Arrays.equals(this.disabled, other.disabled);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      int result = 1;
      result = 31 * result + Arrays.hashCode(this.disabled);
      return result;
   }
}
