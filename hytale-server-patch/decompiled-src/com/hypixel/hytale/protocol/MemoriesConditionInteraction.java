...
public class MemoriesConditionInteraction extends Interaction {
   ...
   public static MemoriesConditionInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      MemoriesConditionInteraction obj = new MemoriesConditionInteraction();
      ...
      if ((nullBits & 1) != 0) {
         int varPos0 = offset + 39 + buf.getIntLE(offset + 15);
         obj.effects = InteractionEffects.deserialize(buf, varPos0);
      }

      if ((nullBits & 2) != 0) {
         int varPos1 = offset + 39 + buf.getIntLE(offset + 19);
      ...
      if ((nullBits & 4) != 0) {
         int varPos2 = offset + 39 + buf.getIntLE(offset + 23);
         obj.rules = InteractionRules.deserialize(buf, varPos2);
      }

      if ((nullBits & 8) != 0) {
         int varPos3 = offset + 39 + buf.getIntLE(offset + 27);
      ...
      if ((nullBits & 16) != 0) {
         int varPos4 = offset + 39 + buf.getIntLE(offset + 31);
         obj.camera = InteractionCameraSettings.deserialize(buf, varPos4);
      }

      if ((nullBits & 32) != 0) {
         int varPos5 = offset + 39 + buf.getIntLE(offset + 35);
         int memoriesNextCount = VarInt.peek(buf, varPos5);
         ...
         obj.memoriesNext = new HashMap(memoriesNextCount);
         ...
         for(int i = 0; i < memoriesNextCount; ++i) {
            ...
            dictPos += 4;
            if (obj.memoriesNext.put(key, val) != null) {
   ...
   public int serialize(@Nonnull ByteBuf buf) {
      ...
      buf.writeIntLE(0);
      int memoriesNextOffsetSlot = buf.writerIndex();
      buf.writeIntLE(0);
      ...
      if (this.memoriesNext != null) {
         ...
         for(Map.Entry<Integer, Integer> e : this.memoriesNext.entrySet()) {
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 39) {
         ...
         if ((nullBits & 32) != 0) {
            int memoriesNextOffset = buffer.getIntLE(offset + 35);
            ...
            int memoriesNextCount = VarInt.peek(buffer, pos);
            if (memoriesNextCount < 0) {
   ...
   public MemoriesConditionInteraction clone() {
      ...
      copy.memoriesNext = this.memoriesNext != null ? new HashMap(this.memoriesNext) : null;
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof MemoriesConditionInteraction)) {
         return false;
      } else {
         MemoriesConditionInteraction other = (MemoriesConditionInteraction)obj;
