...
public class NoiseConfig {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof NoiseConfig)) {
         return false;
      } else {
         NoiseConfig other = (NoiseConfig)obj;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.seed, this.type, this.frequency, this.amplitude, this.clamp});
   }
}
