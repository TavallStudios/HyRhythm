...
public class ItemReticleConfig {
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.serverEvents != null) {
         ...
         for(Map.Entry<Integer, ItemReticle> e : this.serverEvents.entrySet()) {
            ...
            ((ItemReticle)e.getValue()).serialize(buf);
         }
      } else {
      ...
      if (this.clientEvents != null) {
         ...
         for(Map.Entry<ItemReticleClientEvent, ItemReticle> e : this.clientEvents.entrySet()) {
            buf.writeByte(((ItemReticleClientEvent)e.getKey()).getValue());
            ((ItemReticle)e.getValue()).serialize(buf);
         }
      } else {
   ...
   public int computeSize() {
      ...
      if (this.serverEvents != null) {
         ...
         for(Map.Entry<Integer, ItemReticle> kvp : this.serverEvents.entrySet()) {
            serverEventsSize += 4 + ((ItemReticle)kvp.getValue()).computeSize();
         }
      ...
      if (this.clientEvents != null) {
         ...
         for(Map.Entry<ItemReticleClientEvent, ItemReticle> kvp : this.clientEvents.entrySet()) {
            clientEventsSize += 1 + ((ItemReticle)kvp.getValue()).computeSize();
         }
   ...
   public ItemReticleConfig clone() {
      ...
      copy.id = this.id;
      copy.base = this.base != null ? (String[])Arrays.copyOf(this.base, this.base.length) : null;
      if (this.serverEvents != null) {
         Map<Integer, ItemReticle> m = new HashMap();

         for(Map.Entry<Integer, ItemReticle> e : this.serverEvents.entrySet()) {
            m.put((Integer)e.getKey(), ((ItemReticle)e.getValue()).clone());
         }
      ...
      if (this.clientEvents != null) {
         ...
         for(Map.Entry<ItemReticleClientEvent, ItemReticle> e : this.clientEvents.entrySet()) {
            m.put((ItemReticleClientEvent)e.getKey(), ((ItemReticle)e.getValue()).clone());
         }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ItemReticleConfig)) {
         return false;
      } else {
