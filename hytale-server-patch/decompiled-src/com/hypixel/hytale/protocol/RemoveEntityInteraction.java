...
public class RemoveEntityInteraction extends SimpleInteraction {
   ...
   public static RemoveEntityInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      RemoveEntityInteraction obj = new RemoveEntityInteraction();
      ...
      if ((nullBits & 1) != 0) {
         int varPos0 = offset + 40 + buf.getIntLE(offset + 20);
         obj.effects = InteractionEffects.deserialize(buf, varPos0);
      }

      if ((nullBits & 2) != 0) {
         int varPos1 = offset + 40 + buf.getIntLE(offset + 24);
      ...
      if ((nullBits & 4) != 0) {
         int varPos2 = offset + 40 + buf.getIntLE(offset + 28);
         obj.rules = InteractionRules.deserialize(buf, varPos2);
      }

      if ((nullBits & 8) != 0) {
         int varPos3 = offset + 40 + buf.getIntLE(offset + 32);
      ...
      if ((nullBits & 16) != 0) {
         int varPos4 = offset + 40 + buf.getIntLE(offset + 36);
   ...
   public static int computeBytesConsumed(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 8) != 0) {
         ...
         int pos3 = offset + 40 + fieldOffset3;
      ...
      if ((nullBits & 16) != 0) {
         ...
         int pos4 = offset + 40 + fieldOffset4;
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 40) {
         ...
         if ((nullBits & 1) != 0) {
            ...
            int pos = offset + 40 + effectsOffset;
         ...
         if ((nullBits & 2) != 0) {
            ...
            int pos = offset + 40 + settingsOffset;
            if (pos >= buffer.writerIndex()) {
         ...
         if ((nullBits & 16) != 0) {
            ...
            int pos = offset + 40 + cameraOffset;
            if (pos >= buffer.writerIndex()) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof RemoveEntityInteraction)) {
         return false;
      } else {
         RemoveEntityInteraction other = (RemoveEntityInteraction)obj;
