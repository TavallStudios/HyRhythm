...
public class ItemBase {
   ...
   public static ItemBase deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits[3] & 16) != 0) {
         ...
         int varIntLen = VarInt.length(buf, varPos23);
      ...
      if ((nullBits[3] & 32) != 0) {
         ...
         int dictPos = varPos24 + varIntLen;
   ...
   public static int computeBytesConsumed(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits[3] & 8) != 0) {
         ...
         pos22 += VarInt.length(buf, pos22) + sl;
      ...
      if ((nullBits[3] & 16) != 0) {
         ...
         pos23 += VarInt.length(buf, pos23) + arrLen * 4;
      ...
      if ((nullBits[3] & 64) != 0) {
         ...
         pos25 += VarInt.length(buf, pos25) + arrLen * 4;
   ...
   public void serialize(@Nonnull ByteBuf buf) {
      ...
      if (this.interactionVars != null) {
         ...
         for(Map.Entry<String, Integer> e : this.interactionVars.entrySet()) {
      ...
      if (this.itemAppearanceConditions != null) {
         ...
         for(Map.Entry<Integer, ItemAppearanceCondition[]> e : this.itemAppearanceConditions.entrySet()) {
            buf.writeIntLE((Integer)e.getKey());
            VarInt.write(buf, ((ItemAppearanceCondition[])e.getValue()).length);

            for(ItemAppearanceCondition arrItem : (ItemAppearanceCondition[])e.getValue()) {
   ...
   public int computeSize() {
      ...
      if (this.interactionVars != null) {
         ...
         for(Map.Entry<String, Integer> kvp : this.interactionVars.entrySet()) {
            interactionVarsSize += PacketIO.stringSize((String)kvp.getKey()) + 4;
         }
      ...
      if (this.itemAppearanceConditions != null) {
         ...
         for(Map.Entry<Integer, ItemAppearanceCondition[]> kvp : this.itemAppearanceConditions.entrySet()) {
            itemAppearanceConditionsSize += 4 + VarInt.size(((ItemAppearanceCondition[])kvp.getValue()).length) + Arrays.stream((ItemAppearanceCondition[])kvp.getValue()).mapToInt((inner) -> inner.computeSize()).sum();
         }
   ...
   public ItemBase clone() {
      ...
      copy.resourceTypes = this.resourceTypes != null ? (ItemResourceType[])Arrays.stream(this.resourceTypes).map((ex) -> ex.clone()).toArray((x$0) -> new ItemResourceType[x$0]) : null;
      ...
      copy.set = this.set;
      copy.categories = this.categories != null ? (String[])Arrays.copyOf(this.categories, this.categories.length) : null;
      ...
      copy.firstPersonParticles = this.firstPersonParticles != null ? (ModelParticle[])Arrays.stream(this.firstPersonParticles).map((ex) -> ex.clone()).toArray((x$0) -> new ModelParticle[x$0]) : null;
      copy.trails = this.trails != null ? (ModelTrail[])Arrays.stream(this.trails).map((ex) -> ex.clone()).toArray((x$0) -> new ModelTrail[x$0]) : null;
      ...
      if (this.itemAppearanceConditions != null) {
         ...
         for(Map.Entry<Integer, ItemAppearanceCondition[]> e : this.itemAppearanceConditions.entrySet()) {
            m.put((Integer)e.getKey(), (ItemAppearanceCondition[])Arrays.stream((ItemAppearanceCondition[])e.getValue()).map((x) -> x.clone()).toArray((x$0) -> new ItemAppearanceCondition[x$0]));
         }
