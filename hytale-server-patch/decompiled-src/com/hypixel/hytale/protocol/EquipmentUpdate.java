...
public class EquipmentUpdate extends ComponentUpdate {
   ...
   public static EquipmentUpdate deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 1) != 0) {
         ...
         if ((long)(varPos0 + varIntLen) + (long)armorIdsCount * 1L > (long)buf.readableBytes()) {
   ...
   public EquipmentUpdate clone() {
      ...
      copy.armorIds = this.armorIds != null ? (String[])Arrays.copyOf(this.armorIds, this.armorIds.length) : null;
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof EquipmentUpdate)) {
         return false;
      } else {
