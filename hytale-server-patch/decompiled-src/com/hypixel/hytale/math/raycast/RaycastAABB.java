...
public class RaycastAABB {
   ...
   public interface RaycastConsumer {
      void accept(boolean var1, double var2, double var4, double var6, double var8, double var10, double var12, double var14, double var16, double var18, double var20);
   }

   @FunctionalInterface
   public interface RaycastConsumerPlus1<T> {
      void accept(boolean var1, double var2, double var4, double var6, double var8, double var10, double var12, double var14, double var16, double var18, double var20, T var22);
   }

   @FunctionalInterface
   public interface RaycastConsumerPlus2<T, K> {
      void accept(boolean var1, double var2, double var4, double var6, double var8, double var10, double var12, double var14, double var16, double var18, double var20, T var22, K var23);
   }

   @FunctionalInterface
   public interface RaycastConsumerPlus3<T, K, L> {
      void accept(boolean var1, double var2, double var4, double var6, double var8, double var10, double var12, double var14, double var16, double var18, double var20, T var22, K var23, L var24);
   }
}
