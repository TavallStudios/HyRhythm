...
public class Quad4d {
   ...
   public Vector4d get(int idx) {
      Vector4d var10000;
      switch (idx) {
         case 0 -> var10000 = this.a;
         case 1 -> var10000 = this.b;
         case 2 -> var10000 = this.c;
         case 3 -> var10000 = this.d;
   ...
   public Vector4d getCenter(@Nonnull Vector4d target) {
      return target.assign(this.a.x + (this.c.x - this.a.x) * 0.5, this.b.x + (this.b.x - this.b.x) * 0.5, this.c.x + (this.c.x - this.c.x) * 0.5, this.d.x + (this.d.x - this.d.x) * 0.5);
   }
   ...
   public Vector4d getRandom(@Nonnull Random random, @Nonnull Vector4d target) {
      ...
      if (random.nextBoolean()) {
         target.assign(this.a.x * pq + this.b.x * p + this.c.x * q, this.a.y * pq + this.b.y * p + this.c.y * q, this.a.z * pq + this.b.z * p + this.c.z * q, this.a.w * pq + this.b.w * p + this.c.w * q);
      } else {
         target.assign(this.a.x * pq + this.c.x * p + this.d.x * q, this.a.y * pq + this.c.y * p + this.d.y * q, this.a.z * pq + this.c.z * p + this.d.z * q, this.a.w * pq + this.c.w * p + this.d.w * q);
      }
