...
public class DirectionViewProvider implements MatrixProvider {
   ...
   public Matrix4d getMatrix() {
      if (this.invalid) {
         this.matrix.viewDirection(this.position.x, this.position.y, this.position.z, this.direction.x, this.direction.y, this.direction.z, this.up.x, this.up.y, this.up.z);
         this.invalid = false;
      }
   ...
   public String toString() {
      ...
      return "DirectionViewProvider{up=" + var10000 + ", yaw=" + this.yaw + ", pitch=" + this.pitch + ", yawOffset=" + this.yawOffset + ", pitchOffset=" + this.pitchOffset + "}";
   }
   ...
   static {
      ...
      DEFAULT_UP = new Vector3d(0.0, 1.0, 0.0);
   }
}
