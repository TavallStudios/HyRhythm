...
public class Location {
   ...
   public Location(double x, double y, double z) {
      this((String)null, new Vector3d(x, y, z), new Vector3f(0.0F / 0.0F, 0.0F / 0.0F, 0.0F / 0.0F));
   }
   ...
   public Location(double x, double y, double z, float pitch, float yaw, float roll) {
      this((String)null, new Vector3d(x, y, z), new Vector3f(pitch, yaw, roll));
   }
   ...
   public Location(@Nonnull Vector3d position, @Nonnull Vector3f rotation) {
      this((String)null, position, rotation);
   }

   public Location(@Nonnull Transform transform) {
      this((String)null, transform.position, transform.rotation);
   }
   ...
   public String toString() {
      String var10000 = this.world;
      return "Location{world='" + var10000 + "', position=" + String.valueOf(this.position) + ", rotation=" + String.valueOf(this.rotation) + "}";
   }
}
