...
public class Vector2i {
   ...
   public int hashCode() {
      if (this.hash == 0) {
         this.hash = (int)HashUtil.hash((long)this.x, (long)this.y);
      }
