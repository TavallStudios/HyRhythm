...
public class Vector3f {
   ...
   public void addRotationOnAxis(@Nonnull Axis axis, int angle) {
      ...
      switch (axis) {
         case X -> this.setPitch(this.getPitch() + rad);
         case Y -> this.setYaw(this.getYaw() + rad);
         case Z -> this.setRoll(this.getRoll() + rad);
      }
   ...
   public float distanceTo(@Nonnull Vector3f v) {
      return (float)Math.sqrt((double)this.distanceSquaredTo(v));
   }
   ...
   public float distanceTo(float x, float y, float z) {
      return (float)Math.sqrt((double)this.distanceSquaredTo(x, y, z));
   }
   ...
   public float length() {
      return (float)Math.sqrt((double)this.squaredLength());
   }
   ...
   public int hashCode() {
      if (this.hash == 0) {
         this.hash = (int)HashUtil.hash((long)Float.floatToIntBits(this.x), (long)Float.floatToIntBits(this.y), (long)Float.floatToIntBits(this.z));
      }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(Vector3f.class, () -> new Vector3f(0.0F / 0.0F, 0.0F / 0.0F, 0.0F / 0.0F)).metadata(UIDisplayMode.COMPACT)).appendInherited(new KeyedCodec("X", Codec.FLOAT), (o, i) -> o.x = i, (o) -> Float.isNaN(o.x) ? null : o.x, (o, p) -> o.x = p.x).add()).appendInherited(new KeyedCodec("Y", Codec.FLOAT), (o, i) -> o.y = i, (o) -> Float.isNaN(o.y) ? null : o.y, (o, p) -> o.y = p.y).add()).appendInherited(new KeyedCodec("Z", Codec.FLOAT), (o, i) -> o.z = i, (o) -> Float.isNaN(o.z) ? null : o.z, (o, p) -> o.z = p.z).add()).build();
      ROTATION = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(Vector3f.class, () -> new Vector3f(0.0F / 0.0F, 0.0F / 0.0F, 0.0F / 0.0F)).metadata(UIDisplayMode.COMPACT)).appendInherited(new KeyedCodec("Pitch", Codec.FLOAT), (o, i) -> o.x = i, (o) -> Float.isNaN(o.x) ? null : o.x, (o, p) -> o.x = p.x).add()).appendInherited(new KeyedCodec("Yaw", Codec.FLOAT), (o, i) -> o.y = i, (o) -> Float.isNaN(o.y) ? null : o.y, (o, p) -> o.y = p.y).add()).appendInherited(new KeyedCodec("Roll", Codec.FLOAT), (o, i) -> o.z = i, (o) -> Float.isNaN(o.z) ? null : o.z, (o, p) -> o.z = p.z).add()).build();
      ...
      MAX = new Vector3f(3.4028235E38F, 3.4028235E38F, 3.4028235E38F);
      NaN = new Vector3f(0.0F / 0.0F, 0.0F / 0.0F, 0.0F / 0.0F);
      BLOCK_SIDES = new Vector3f[]{UP, DOWN, FORWARD, BACKWARD, LEFT, RIGHT};
      BLOCK_EDGES = new Vector3f[]{add(UP, FORWARD), add(DOWN, FORWARD), add(UP, BACKWARD), add(DOWN, BACKWARD), add(UP, LEFT), add(DOWN, LEFT), add(UP, RIGHT), add(DOWN, RIGHT), add(FORWARD, LEFT), add(FORWARD, RIGHT), add(BACKWARD, LEFT), add(BACKWARD, RIGHT)};
      BLOCK_CORNERS = new Vector3f[]{add(UP, FORWARD, LEFT), add(UP, FORWARD, RIGHT), add(DOWN, FORWARD, LEFT), add(DOWN, FORWARD, RIGHT), add(UP, BACKWARD, LEFT), add(UP, BACKWARD, RIGHT), add(DOWN, BACKWARD, LEFT), add(DOWN, BACKWARD, RIGHT)};
