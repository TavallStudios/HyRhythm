...
public class Transform {
   ...
   public Transform() {
      this(new Vector3d(), new Vector3f(0.0F / 0.0F, 0.0F / 0.0F, 0.0F / 0.0F));
   }

   public Transform(@Nonnull Vector3i position) {
      this(new Vector3d(position), new Vector3f(0.0F / 0.0F, 0.0F / 0.0F, 0.0F / 0.0F));
   }
   ...
   public Transform(double x, double y, double z) {
      this(new Vector3d(x, y, z), new Vector3f(0.0F / 0.0F, 0.0F / 0.0F, 0.0F / 0.0F));
   }
   ...
   public static Vector3d getDirection(float pitch, float yaw) {
      if (Float.isNaN(pitch)) {
         ...
         double len = (double)TrigMathUtil.cos(pitch);
         double x = len * (double)(-TrigMathUtil.sin(yaw));
         double y = (double)TrigMathUtil.sin(pitch);
   ...
   public String toString() {
      ...
      return "Transform{position=" + var10000 + ", rotation=" + String.valueOf(this.rotation) + "}";
   }
   ...
   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(Transform.class, Transform::new).appendInherited(new KeyedCodec("X", Codec.DOUBLE), (o, i) -> o.getPosition().x = i, (o) -> o.getPosition().x, (o, p) -> o.getPosition().x = p.getPosition().x).addValidator(Validators.nonNull()).add()).appendInherited(new KeyedCodec("Y", Codec.DOUBLE), (o, i) -> o.getPosition().y = i, (o) -> o.getPosition().y, (o, p) -> o.getPosition().y = p.getPosition().y).addValidator(Validators.nonNull()).add()).appendInherited(new KeyedCodec("Z", Codec.DOUBLE), (o, i) -> o.getPosition().z = i, (o) -> o.getPosition().z, (o, p) -> o.getPosition().z = p.getPosition().z).addValidator(Validators.nonNull()).add()).appendInherited(new KeyedCodec("Pitch", Codec.FLOAT), (o, i) -> o.getRotation().x = i, (o) -> Float.isNaN(o.getRotation().x) ? null : o.getRotation().x, (o, p) -> o.getRotation().x = p.getRotation().x).add()).appendInherited(new KeyedCodec("Yaw", Codec.FLOAT), (o, i) -> o.getRotation().y = i, (o) -> Float.isNaN(o.getRotation().y) ? null : o.getRotation().y, (o, p) -> o.getRotation().y = p.getRotation().y).add()).appendInherited(new KeyedCodec("Roll", Codec.FLOAT), (o, i) -> o.getRotation().z = i, (o) -> Float.isNaN(o.getRotation().z) ? null : o.getRotation().z, (o, p) -> o.getRotation().z = p.getRotation().z).add()).build();
      CODEC_DEGREES = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(Transform.class, Transform::new).appendInherited(new KeyedCodec("X", Codec.DOUBLE), (o, i) -> o.getPosition().x = i, (o) -> o.getPosition().x, (o, p) -> o.getPosition().x = p.getPosition().x).addValidator(Validators.nonNull()).add()).appendInherited(new KeyedCodec("Y", Codec.DOUBLE), (o, i) -> o.getPosition().y = i, (o) -> o.getPosition().y, (o, p) -> o.getPosition().y = p.getPosition().y).addValidator(Validators.nonNull()).add()).appendInherited(new KeyedCodec("Z", Codec.DOUBLE), (o, i) -> o.getPosition().z = i, (o) -> o.getPosition().z, (o, p) -> o.getPosition().z = p.getPosition().z).addValidator(Validators.nonNull()).add()).appendInherited(new KeyedCodec("Pitch", Codec.FLOAT), (o, i) -> o.getRotation().x = (float)Math.toRadians((double)i), (o) -> Float.isNaN(o.getRotation().x) ? null : (float)Math.toDegrees((double)o.getRotation().x), (o, p) -> o.getRotation().x = p.getRotation().x).add()).appendInherited(new KeyedCodec("Yaw", Codec.FLOAT), (o, i) -> o.getRotation().y = (float)Math.toRadians((double)i), (o) -> Float.isNaN(o.getRotation().y) ? null : (float)Math.toDegrees((double)o.getRotation().y), (o, p) -> o.getRotation().y = p.getRotation().y).add()).appendInherited(new KeyedCodec("Roll", Codec.FLOAT), (o, i) -> o.getRotation().z = (float)Math.toRadians((double)i), (o) -> Float.isNaN(o.getRotation().z) ? null : (float)Math.toDegrees((double)o.getRotation().z), (o, p) -> o.getRotation().z = p.getRotation().z).add()).build();
   }
}
