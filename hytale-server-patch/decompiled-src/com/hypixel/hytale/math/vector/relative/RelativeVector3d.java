...
public class RelativeVector3d {
   ...
   public String toString() {
      ...
      return "RelativeVector3d{vector=" + var10000 + ", relative=" + this.relative + "}";
   }

   static {
      CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(RelativeVector3d.class, RelativeVector3d::new).append(new KeyedCodec("Vector", Vector3d.CODEC), (o, i) -> o.vector = i, RelativeVector3d::getVector).addValidator(Validators.nonNull()).add()).append(new KeyedCodec("Relative", Codec.BOOLEAN), (o, i) -> o.relative = i, RelativeVector3d::isRelative).addValidator(Validators.nonNull()).add()).build();
   }
}
