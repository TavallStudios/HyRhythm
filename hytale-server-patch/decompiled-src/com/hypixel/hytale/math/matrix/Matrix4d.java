...
public class Matrix4d {
   ...
   public Matrix4d translate(double x, double y, double z) {
      for(int i = 0; i < 4; ++i) {
         double[] var10000 = this.m;
         var10000[i + 12] += this.m[i] * x + this.m[i + 4] * y + this.m[i + 8] * z;
      }
   ...
   public Matrix4d setRotateAxis(double a, double x, double y, double z) {
      double sin = (double)TrigMathUtil.sin(a);
      double cos = (double)TrigMathUtil.cos(a);
   ...
   public Matrix4d setRotateEuler(double x, double y, double z) {
      double cx = (double)TrigMathUtil.cos(x);
      double sx = (double)TrigMathUtil.sin(x);
      double cy = (double)TrigMathUtil.cos(y);
      double sy = (double)TrigMathUtil.sin(y);
      double cz = (double)TrigMathUtil.cos(z);
      double sz = (double)TrigMathUtil.sin(z);
      double cxsy = cx * sy;
      double sxsy = sx * sy;
      this.m[0] = cy * cz;
      this.m[1] = -cy * sz;
   ...
   public String toString() {
      double var10000 = this.m[0];
      return "Matrix4d{\n  " + var10000 + " " + this.m[4] + " " + this.m[8] + " " + this.m[12] + "\n  " + this.m[1] + " " + this.m[5] + " " + this.m[9] + " " + this.m[13] + "\n  " + this.m[2] + " " + this.m[6] + " " + this.m[10] + " " + this.m[14] + "\n  " + this.m[3] + " " + this.m[7] + " " + this.m[11] + " " + this.m[15] + "\n}";
   }
