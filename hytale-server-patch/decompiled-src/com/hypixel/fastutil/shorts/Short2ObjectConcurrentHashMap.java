...
public class Short2ObjectConcurrentHashMap<V> {
   ...
   public void putAll(Map<? extends Short, ? extends V> m) {
      ...
      for(Map.Entry<? extends Short, ? extends V> e : m.entrySet()) {
         this.putVal((Short)e.getKey(), e.getValue(), false);
      }
   ...
   public void putAll(Short2ObjectConcurrentHashMap<? extends V> m) {
      this.tryPresize(m.size());
      ObjectIterator var2 = m.short2ObjectEntrySet().iterator();

      while(var2.hasNext()) {
         Short2ObjectMap.Entry<? extends V> e = (Short2ObjectMap.Entry)var2.next();
         this.putVal(e.getShortKey(), e.getValue(), false);
      }
   ...
   public void putAll(Short2ObjectMap<V> m) {
      this.tryPresize(m.size());
      ObjectIterator<? extends Short2ObjectMap.Entry<? extends V>> iterator = m.short2ObjectEntrySet().iterator();

      while(iterator.hasNext()) {
         Short2ObjectMap.Entry<? extends V> next = (Short2ObjectMap.Entry)iterator.next();
         this.putVal(next.getShortKey(), next.getValue(), false);
      }
   ...
   public V remove(Object key) {
      return (V)this.remove((Short)key);
   }
   ...
   public boolean equals(Object o) {
      if (o != this) {
         ...
         ObjectIterator var11 = m.short2ObjectEntrySet().iterator();

         while(var11.hasNext()) {
            Short2ObjectMap.Entry<?> e = (Short2ObjectMap.Entry)var11.next();
            Object mv;
            Object v;
            short mk;
   ...
   public static ShortSet newKeySet() {
      return new KeySetView(new Short2ObjectConcurrentHashMap(), Boolean.TRUE);
   }
      ...
      public final boolean equals(Object o) {
         ...
         if (o instanceof Entry) {
            if (empty != ((Entry)o).isEmpty()) {
               return false;
            } else if (!empty && this.key != ((Entry)o).getShortKey()) {
               return false;
            } else {
   ...
   protected static final class ForwardingNode<V> extends Node<V> {
      ...
      protected Node<V> find(int h, short k) {
         ...
         while(true) {
            Node<V> e;
            int n;
            if (k != this.EMPTY && tab != null && (n = tab.length) != 0 && (e = Short2ObjectConcurrentHashMap.<V>tabAt(tab, n - 1 & h)) != null) {
               int eh;
               short ek;
   ...
   protected static class Traverser<V> {
      ...
      protected final Node<V> advance() {
         ...
         while(e == null) {
            ...
            if ((e = Short2ObjectConcurrentHashMap.<V>tabAt(t, i)) != null && e.hash < 0) {
               if (e instanceof ForwardingNode) {
   ...
   protected static final class EntryIterator<V> extends BaseIterator<V> implements ObjectIterator<Short2ObjectMap.Entry<V>> {
      ...
      public boolean equals(Object o) {
         if (this == o) {
            ...
            if (this.empty != ((Entry)o).isEmpty()) {
               return false;
            } else if (!this.empty && this.key != ((Entry)o).getShortKey()) {
               return false;
            } else {
               return this.val.equals(((Entry)o).getValue());
            }
   ...
   protected static final class KeySpliterator<V> extends Traverser<V> implements ShortSpliterator {
      public long est;
      ...
      public boolean tryAdvance(Consumer<? super Short> action) {
         return action instanceof ShortConsumer ? this.tryAdvance((ShortConsumer)action) : this.tryAdvance((ShortConsumer)((value) -> action.accept(value)));
      }
   ...
   protected static final class EntrySpliterator<V> extends Traverser<V> implements ObjectSpliterator<Short2ObjectMap.Entry<V>> {
      public final Short2ObjectConcurrentHashMap<V> map;
      public long est;
   ...
   public static class KeySetView<V> implements ShortSet {
      ...
      public int hashCode() {
         ...
         for(ShortIterator iter = this.iterator(); iter.hasNext(); h += Short.hashCode(iter.nextShort())) {
         }
               ...
               while(true) {
                  ...
                  label80: {
                     while(true) {
                        ...
                        if ((p = Short2ObjectConcurrentHashMap.<V>tabAt(tab, index)) != null && p.hash < 0) {
                           if (p instanceof ForwardingNode) {
                              tab = ((ForwardingNode)p).nextTable;
                              p = null;
                              TableStack<V> s = spare;
   ...
   protected static final class EntrySetView<V> extends CollectionView<V, Short2ObjectMap.Entry<V>> implements ObjectSet<Short2ObjectMap.Entry<V>>, Serializable {
      public static final long serialVersionUID = 2249069246763182397L;
      ...
      public ObjectIterator<Short2ObjectMap.Entry<V>> iterator() {
         ...
         Node<V>[] t;
         int f = (t = m.table) == null ? 0 : t.length;
         return new EntryIterator<Short2ObjectMap.Entry<V>>(t, f, 0, f, m);
      }
      ...
      public ObjectSpliterator<Short2ObjectMap.Entry<V>> spliterator() {
         ...
         Node<V>[] t;
         int f = (t = m.table) == null ? 0 : t.length;
         return new EntrySpliterator<Short2ObjectMap.Entry<V>>(t, f, 0, f, n < 0L ? 0L : n, m);
      }
   ...
   protected abstract static class ShortReturningBulkTask2<V> extends BulkTask<V, Short> {
      public short result;
   ...
   protected static final class ForEachTransformedKeyTask<V, U> extends BulkTask<V, Void> {
      ...
      public final void compute() {
         ShortFunction<? extends U> transformer;
   ...
   protected static final class ForEachTransformedMappingTask<V, U> extends BulkTask<V, Void> {
      ...
      public final void compute() {
         ShortObjFunction<? super V, ? extends U> transformer;
         Consumer<? super U> action;
         if ((transformer = this.transformer) != null && (action = this.action) != null) {
            int i = this.baseIndex;
   ...
   protected static final class SearchKeysTask<V, U> extends BulkTask<V, U> {
      ...
      public final void compute() {
         ShortFunction<? extends U> searchFunction;
   ...
   protected static final class SearchMappingsTask<V, U> extends BulkTask<V, U> {
      ...
      public final void compute() {
         ShortObjFunction<? super V, ? extends U> searchFunction;
         AtomicReference<U> result;
         if ((searchFunction = this.searchFunction) != null && (result = this.result) != null) {
            int i = this.baseIndex;
   ...
   protected static final class ReduceKeysTask<V> extends ShortReturningBulkTask2<V> {
      public final short EMPTY;
      ...
      public final void compute() {
         ShortReduceTaskOperator reducer;
         if ((reducer = this.reducer) != null) {
            ...
            while((p = this.advance()) != null) {
               ...
               if (!i) {
                  ...
                  i = 1;
                  f = reducer.reduce(this.EMPTY, (short)f, u);
               }
            }
   ...
   protected static final class MapReduceKeysToDoubleTask<V> extends DoubleReturningBulkTask<V> {
      ...
      public final void compute() {
         ShortToDoubleFunction transformer;
   ...
   protected static final class MapReduceMappingsToDoubleTask<V> extends DoubleReturningBulkTask<V> {
      ...
      public final void compute() {
         ToDoubleShortObjFunction<? super V> transformer;
         DoubleBinaryOperator reducer;
         if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
            double r = this.basis;
            int i = this.baseIndex;
   ...
   protected static final class MapReduceKeysToLongTask<V> extends LongReturningBulkTask<V> {
      ...
      public final void compute() {
         ShortToLongFunction transformer;
   ...
   protected static final class MapReduceMappingsToLongTask<V> extends LongReturningBulkTask<V> {
      ...
      public final void compute() {
         ToLongShortObjFunction<? super V> transformer;
         LongBinaryOperator reducer;
         if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
            long r = this.basis;
            int i = this.baseIndex;
   ...
   protected static final class MapReduceKeysToIntTask<V> extends IntReturningBulkTask<V> {
      ...
      public final void compute() {
         ShortToIntFunction transformer;
   ...
   protected static final class MapReduceMappingsToIntTask<V> extends IntReturningBulkTask<V> {
      ...
      public final void compute() {
         ToIntShortObjFunction<? super V> transformer;
         IntBinaryOperator reducer;
         if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
            int r = this.basis;
            int i = this.baseIndex;
