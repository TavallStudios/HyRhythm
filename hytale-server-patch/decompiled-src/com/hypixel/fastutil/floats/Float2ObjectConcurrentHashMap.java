...
public class Float2ObjectConcurrentHashMap<V> {
   ...
   public Float2ObjectConcurrentHashMap() {
      this.EMPTY = -1.0F;
   }

   public Float2ObjectConcurrentHashMap(boolean nonce, float emptyValue) {
      this.EMPTY = emptyValue;
   }

   public Float2ObjectConcurrentHashMap(int initialCapacity) {
      this(initialCapacity, true, -1.0F);
   }

   public Float2ObjectConcurrentHashMap(int initialCapacity, boolean nonce, float emptyValue) {
   ...
   public Float2ObjectConcurrentHashMap(Map<? extends Float, ? extends V> m, float emptyValue) {
      this.sizeCtl = 16;
      this.EMPTY = emptyValue;
      this.putAll(m);
   }

   public Float2ObjectConcurrentHashMap(Float2ObjectConcurrentHashMap<? extends V> m) {
      this.sizeCtl = 16;
      this.EMPTY = m.EMPTY;
      this.putAll(m);
   }

   public Float2ObjectConcurrentHashMap(Float2ObjectMap<V> m) {
      this.sizeCtl = 16;
      this.EMPTY = -1.0F;
      this.putAll(m);
   }

   public Float2ObjectConcurrentHashMap(Float2ObjectMap<V> m, float emptyValue) {
      this.sizeCtl = 16;
      this.EMPTY = emptyValue;
      this.putAll(m);
   }

   public Float2ObjectConcurrentHashMap(int initialCapacity, float loadFactor) {
      this(initialCapacity, loadFactor, 1, -1.0F);
   }

   public Float2ObjectConcurrentHashMap(int initialCapacity, float loadFactor, int concurrencyLevel, float emptyValue) {
   ...
   public V get(float key) {
      if (key == this.EMPTY) {
         ...
         int h = spread(Float.hashCode(key));
         Node<V>[] tab;
         Node<V> e;
         int n;
   ...
   protected final V putVal(float key, V value, boolean onlyIfAbsent) {
      if (key == this.EMPTY) {
         throw new IllegalArgumentException("Key is EMPTY: " + this.EMPTY);
      } else if (value == null) {
         throw new NullPointerException();
      } else {
         int hash = spread(Float.hashCode(key));
         int binCount = 0;
   ...
   public void putAll(Map<? extends Float, ? extends V> m) {
      ...
      for(Map.Entry<? extends Float, ? extends V> e : m.entrySet()) {
         this.putVal((Float)e.getKey(), e.getValue(), false);
      }

   }

   public void putAll(Float2ObjectConcurrentHashMap<? extends V> m) {
      this.tryPresize(m.size());
      ObjectIterator var2 = m.float2ObjectEntrySet().iterator();

      while(var2.hasNext()) {
         Float2ObjectMap.Entry<? extends V> e = (Float2ObjectMap.Entry)var2.next();
         this.putVal(e.getFloatKey(), e.getValue(), false);
      }
   ...
   public void putAll(Float2ObjectMap<V> m) {
      this.tryPresize(m.size());
      ObjectIterator<? extends Float2ObjectMap.Entry<? extends V>> iterator = m.float2ObjectEntrySet().iterator();

      while(iterator.hasNext()) {
         Float2ObjectMap.Entry<? extends V> next = (Float2ObjectMap.Entry)iterator.next();
         this.putVal(next.getFloatKey(), next.getValue(), false);
      }
   ...
   public V remove(Object key) {
      return (V)this.remove((Float)key);
   }

   protected final V replaceNode(float key, V value, Object cv) {
      if (key == this.EMPTY) {
         throw new IllegalArgumentException("Key is EMPTY: " + this.EMPTY);
      } else {
         int hash = spread(Float.hashCode(key));
   ...
   public int hashCode() {
      ...
      if ((tt = this.table) != null) {
         ...
         while(true) {
            ...
            h += Float.hashCode(p.key) ^ p.val.hashCode();
         }
      }
   ...
   public boolean equals(Object o) {
      if (o != this) {
         if (!(o instanceof Float2ObjectConcurrentHashMap)) {
            return false;
         }

         Float2ObjectConcurrentHashMap<?> m = (Float2ObjectConcurrentHashMap)o;
         Node<V>[] t;
         int f = (t = this.table) == null ? 0 : t.length;
         Traverser<V> it = new Traverser<V>(t, f, 0, f);
         ...
         ObjectIterator var11 = m.float2ObjectEntrySet().iterator();

         while(var11.hasNext()) {
            Float2ObjectMap.Entry<?> e = (Float2ObjectMap.Entry)var11.next();
            Object mv;
            Object v;
            float mk;
            if ((mk = e.getFloatKey()) == m.EMPTY || (mv = e.getValue()) == null || (v = this.get(mk)) == null || mv != v && !mv.equals(v)) {
               return false;
            }
         }
      }
   ...
   public int forEach(FloatObjConsumer<? super V> action) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public <X> int forEach(FloatBiObjConsumer<? super V, X> action, X x) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public <X, Y> int forEach(FloatTriObjConsumer<? super V, X, Y> action, X x, Y y) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public int forEachWithByte(FloatObjByteConsumer<? super V> action, byte ii) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public int forEachWithShort(FloatObjShortConsumer<? super V> action, short ii) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public int forEachWithInt(FloatObjIntConsumer<? super V> action, int ii) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public int forEachWithLong(FloatObjLongConsumer<? super V> action, long ii) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public int forEachWithFloat(FloatObjFloatConsumer<? super V> action, float ii) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public int forEachWithDouble(FloatObjDoubleConsumer<? super V> action, double ii) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public <X> int forEachWithByte(FloatBiObjByteConsumer<? super V, X> action, byte ii, X x) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public <X> int forEachWithShort(FloatBiObjShortConsumer<? super V, X> action, short ii, X x) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public <X> int forEachWithInt(FloatBiObjIntConsumer<? super V, X> action, int ii, X x) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public <X> int forEachWithLong(FloatBiObjLongConsumer<? super V, X> action, long ii, X x) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public <X> int forEachWithFloat(FloatBiObjFloatConsumer<? super V, X> action, float ii, X x) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public <X> int forEachWithDouble(FloatBiObjDoubleConsumer<? super V, X> action, double ii, X x) {
      if (action == null) {
         throw new NullPointerException();
      } else {
         int count = 0;
   ...
   public void replaceAll(Float2ObjectOperator<V> function) {
      if (function == null) {
         throw new NullPointerException();
      } else {
         Node<V>[] tt;
   ...
   public static FloatSet newKeySet() {
      return new KeySetView(new Float2ObjectConcurrentHashMap(), Boolean.TRUE);
   }

   public static KeySetView<Boolean> newKeySet(int initialCapacity) {
      return new KeySetView<Boolean>(new Float2ObjectConcurrentHashMap(initialCapacity), Boolean.TRUE);
   }
   ...
   public void forEach(long parallelismThreshold, FloatObjConsumer<? super V> action) {
      if (action == null) {
         throw new NullPointerException();
      } else {
   ...
   public <U> void forEach(long parallelismThreshold, FloatObjFunction<? super V, ? extends U> transformer, Consumer<? super U> action) {
   ...
   public <U> U search(long parallelismThreshold, FloatObjFunction<? super V, ? extends U> searchFunction) {
   ...
   public <U> U search(FloatObjFunction<? super V, ? extends U> searchFunction) {
      if (searchFunction == null) {
         throw new NullPointerException();
      } else {
         Node<V>[] tt;
   ...
   public <U, X> U search(FloatBiObjFunction<? super V, X, ? extends U> searchFunction, X x) {
      if (searchFunction == null) {
         throw new NullPointerException();
      } else {
         Node<V>[] tt;
   ...
   public <U> U searchWithByte(FloatObjByteFunction<? super V, ? extends U> searchFunction, byte x) {
      if (searchFunction == null) {
         throw new NullPointerException();
      } else {
         Node<V>[] tt;
   ...
   public <U> U searchWithShort(FloatObjShortFunction<? super V, ? extends U> searchFunction, short x) {
      if (searchFunction == null) {
         throw new NullPointerException();
      } else {
         Node<V>[] tt;
   ...
   public <U> U searchWithInt(FloatObjIntFunction<? super V, ? extends U> searchFunction, int x) {
      if (searchFunction == null) {
         throw new NullPointerException();
      } else {
         Node<V>[] tt;
   ...
   public <U> U searchWithLong(FloatObjLongFunction<? super V, ? extends U> searchFunction, long x) {
      if (searchFunction == null) {
         throw new NullPointerException();
      } else {
         Node<V>[] tt;
   ...
   public <U> U searchWithFloat(FloatObjFloatFunction<? super V, ? extends U> searchFunction, float x) {
      if (searchFunction == null) {
         throw new NullPointerException();
      } else {
         Node<V>[] tt;
   ...
   public <U> U searchWithDouble(FloatObjDoubleFunction<? super V, ? extends U> searchFunction, double x) {
      if (searchFunction == null) {
         throw new NullPointerException();
      } else {
         Node<V>[] tt;
   ...
   public <U> U reduce(long parallelismThreshold, FloatObjFunction<? super V, ? extends U> transformer, BiFunction<? super U, ? super U, ? extends U> reducer) {
   ...
   public <U> U reduce(FloatObjFunction<? super V, ? extends U> transformer, BiFunction<? super U, ? super U, ? extends U> reducer) {
      if (transformer != null && reducer != null) {
         Node<V>[] tt;
         if ((tt = this.table) == null) {
            return null;
   ...
   public double reduceToDouble(long parallelismThreshold, ToDoubleFloatObjFunction<? super V> transformer, double basis, DoubleBinaryOperator reducer) {
      if (transformer != null && reducer != null) {
   ...
   public long reduceToLong(long parallelismThreshold, ToLongFloatObjFunction<? super V> transformer, long basis, LongBinaryOperator reducer) {
      if (transformer != null && reducer != null) {
   ...
   public int reduceToInt(long parallelismThreshold, ToIntFloatObjFunction<? super V> transformer, int basis, IntBinaryOperator reducer) {
      if (transformer != null && reducer != null) {
   ...
   public void forEachKey(long parallelismThreshold, FloatConsumer action) {
      if (action == null) {
         throw new NullPointerException();
      } else {
   ...
   public <U> void forEachKey(long parallelismThreshold, FloatFunction<? extends U> transformer, Consumer<? super U> action) {
      if (transformer != null && action != null) {
   ...
   public <U> U searchKeys(long parallelismThreshold, FloatFunction<? extends U> searchFunction) {
      if (searchFunction == null) {
         throw new NullPointerException();
      } else {
   ...
   public float reduceKeys(long parallelismThreshold, FloatReduceTaskOperator reducer) {
      if (reducer == null) {
         throw new NullPointerException();
      } else {
   ...
   public <U> U reduceKeys(long parallelismThreshold, FloatFunction<? extends U> transformer, BiFunction<? super U, ? super U, ? extends U> reducer) {
      if (transformer != null && reducer != null) {
   ...
   public double reduceKeysToDouble(long parallelismThreshold, FloatToDoubleFunction transformer, double basis, DoubleBinaryOperator reducer) {
      if (transformer != null && reducer != null) {
   ...
   public long reduceKeysToLong(long parallelismThreshold, FloatToLongFunction transformer, long basis, LongBinaryOperator reducer) {
      if (transformer != null && reducer != null) {
   ...
   public int reduceKeysToInt(long parallelismThreshold, FloatToIntFunction transformer, int basis, IntBinaryOperator reducer) {
      if (transformer != null && reducer != null) {
   ...
   static {
      ...
      try {
         ...
         Class<?> k = Float2ObjectConcurrentHashMap.class;
   ...
   protected static class Node<V> implements Entry<V> {
      ...
      public final int hashCode() {
         return Float.hashCode(this.key) ^ this.val.hashCode();
      }
      ...
      public final boolean equals(Object o) {
         ...
         if (o instanceof Entry) {
            if (empty != ((Entry)o).isEmpty()) {
               return false;
            } else if (!empty && this.key != ((Entry)o).getFloatKey()) {
               return false;
            } else {
   ...
   protected static final class ForwardingNode<V> extends Node<V> {
      ...
      public ForwardingNode(float empty, Node<V>[] tab) {
      ...
      protected Node<V> find(int h, float k) {
         ...
         while(true) {
            Node<V> e;
            int n;
            if (k != this.EMPTY && tab != null && (n = tab.length) != 0 && (e = Float2ObjectConcurrentHashMap.<V>tabAt(tab, n - 1 & h)) != null) {
               int eh;
               float ek;
   ...
   protected static final class TreeNode<V> extends Node<V> {
      ...
      public TreeNode(float empty, int hash, float key, V val, Node<V> next, TreeNode<V> parent) {
   ...
   protected static final class TreeBin<V> extends Node<V> {
      ...
      public TreeBin(float empty, TreeNode<V> b) {
            ...
            if (r == null) {
               ...
               do {
                  ...
                  if ((ph = p.hash) > h) {
                     ...
                     dir = 1;
                  } else if ((dir = Float.compare(k, pk)) == 0) {
      ...
      protected final Node<V> find(int h, float k) {
         if (k != this.EMPTY) {
            Node<V> e = this.first;
      ...
      protected final TreeNode<V> putTreeVal(int h, float k, V v) {
         Class<?> kc = null;
   ...
   protected static class Traverser<V> {
      ...
      protected final Node<V> advance() {
         ...
         while(e == null) {
            ...
            if ((e = Float2ObjectConcurrentHashMap.<V>tabAt(t, i)) != null && e.hash < 0) {
               if (e instanceof ForwardingNode) {
   ...
   protected static class BaseIterator<V> extends Traverser<V> {
      ...
      public BaseIterator(Node<V>[] tab, int size, int index, int limit, Float2ObjectConcurrentHashMap<V> map) {
   ...
   protected static final class KeyIterator<V> implements FloatIterator {
      public Node<V>[] tab;
      public Node<V> next;
      public TableStack<V> stack;
      public TableStack<V> spare;
      ...
      public KeyIterator(Node<V>[] tab, int size, int index, int limit, Float2ObjectConcurrentHashMap<V> map) {
         this.tab = tab;
         this.baseSize = size;
         this.baseIndex = this.index = index;
         this.baseLimit = limit;
   ...
   protected static final class ValueIterator<V> extends BaseIterator<V> implements ObjectIterator<V>, Enumeration<V> {
      public ValueIterator(Node<V>[] tab, int index, int size, int limit, Float2ObjectConcurrentHashMap<V> map) {
   ...
   protected static final class EntryIterator<V> extends BaseIterator<V> implements ObjectIterator<Float2ObjectMap.Entry<V>> {
      public EntryIterator(Node<V>[] tab, int index, int size, int limit, Float2ObjectConcurrentHashMap<V> map) {
         super(tab, index, size, limit, map);
      }
   ...
   protected static final class MapEntry<V> implements Entry<V> {
      ...
      public boolean equals(Object o) {
         if (this == o) {
            ...
            if (this.empty != ((Entry)o).isEmpty()) {
               return false;
            } else if (!this.empty && this.key != ((Entry)o).getFloatKey()) {
               return false;
            } else {
               return this.val.equals(((Entry)o).getValue());
            }
      ...
      public int hashCode() {
         ...
         result = 31 * result + Float.hashCode(this.key);
   ...
   protected static final class KeySpliterator<V> extends Traverser<V> implements FloatSpliterator {
      public long est;
      ...
      public boolean tryAdvance(Consumer<? super Float> action) {
         return action instanceof FloatConsumer ? this.tryAdvance((FloatConsumer)action) : this.tryAdvance((FloatConsumer)((value) -> action.accept(value)));
      }
   ...
   protected static final class EntrySpliterator<V> extends Traverser<V> implements ObjectSpliterator<Float2ObjectMap.Entry<V>> {
      public final Float2ObjectConcurrentHashMap<V> map;
      public long est;

      public EntrySpliterator(Node<V>[] tab, int size, int index, int limit, long est, Float2ObjectConcurrentHashMap<V> map) {
         super(tab, size, index, limit);
         this.map = map;
         this.est = est;
      }
   ...
   public static class KeySetView<V> implements FloatSet {
      public static final long serialVersionUID = 7249069246763182397L;
      public final Float2ObjectConcurrentHashMap<V> map;
      ...
      public FloatIterator iterator() {
         Float2ObjectConcurrentHashMap<V> m = this.map;
         Node<V>[] t;
      ...
      public int hashCode() {
         ...
         for(FloatIterator iter = this.iterator(); iter.hasNext(); h += Float.hashCode(iter.nextFloat())) {
         }
      ...
      public boolean equals(Object o) {
         FloatSet c;
         return o instanceof FloatSet && ((c = (FloatSet)o) == this || this.containsAll(c) && c.containsAll(this));
      }
               ...
               while(true) {
                  ...
                  label80: {
                     while(true) {
                        ...
                        if ((p = Float2ObjectConcurrentHashMap.<V>tabAt(tab, index)) != null && p.hash < 0) {
                           if (p instanceof ForwardingNode) {
                              tab = ((ForwardingNode)p).nextTable;
                              p = null;
                              TableStack<V> s = spare;
   ...
   protected static final class EntrySetView<V> extends CollectionView<V, Float2ObjectMap.Entry<V>> implements ObjectSet<Float2ObjectMap.Entry<V>>, Serializable {
      public static final long serialVersionUID = 2249069246763182397L;

      public EntrySetView(Float2ObjectConcurrentHashMap<V> map) {
         super(map);
      }

      public boolean contains(Object o) {
         if (o instanceof Float2ObjectMap.Entry) {
            Float2ObjectMap.Entry<?> e;
            float k = (e = (Float2ObjectMap.Entry)o).getFloatKey();
            if (!((Entry)o).isEmpty()) {
               Object v;
               Object r;
      ...
      public ObjectIterator<Float2ObjectMap.Entry<V>> iterator() {
         ...
         Node<V>[] t;
         int f = (t = m.table) == null ? 0 : t.length;
         return new EntryIterator<Float2ObjectMap.Entry<V>>(t, f, 0, f, m);
      }

      public boolean add(Float2ObjectMap.Entry<V> e) {
         return this.map.putVal(e.getFloatKey(), e.getValue(), false) == null;
      }

      public boolean addAll(Collection<? extends Float2ObjectMap.Entry<V>> c) {
         boolean added = false;

         for(Float2ObjectMap.Entry<V> e : c) {
            if (this.add(e)) {
               added = true;
            }
         }
      ...
      public ObjectSpliterator<Float2ObjectMap.Entry<V>> spliterator() {
         ...
         Node<V>[] t;
         int f = (t = m.table) == null ? 0 : t.length;
         return new EntrySpliterator<Float2ObjectMap.Entry<V>>(t, f, 0, f, n < 0L ? 0L : n, m);
      }
   ...
   protected abstract static class FloatReturningBulkTask2<V> extends BulkTask<V, Float> {
      public float result;

      public FloatReturningBulkTask2(BulkTask<V, ?> par, int b, int i, int f, Node<V>[] t) {
         super(par, b, i, f, t);
      }
   ...
   protected static final class ForEachKeyTask<V> extends BulkTask<V, Void> {
      ...
      public ForEachKeyTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, FloatConsumer action) {
         super(p, b, i, f, t);
         this.action = action;
      }
   ...
   protected static final class ForEachMappingTask<V> extends BulkTask<V, Void> {
      public final FloatObjConsumer<? super V> action;

      public ForEachMappingTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, FloatObjConsumer<? super V> action) {
         super(p, b, i, f, t);
         this.action = action;
      }

      public final void compute() {
         FloatObjConsumer<? super V> action;
         if ((action = this.action) != null) {
            int i = this.baseIndex;
   ...
   protected static final class ForEachTransformedKeyTask<V, U> extends BulkTask<V, Void> {
      public final FloatFunction<? extends U> transformer;
      public final Consumer<? super U> action;

      public ForEachTransformedKeyTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, FloatFunction<? extends U> transformer, Consumer<? super U> action) {
         super(p, b, i, f, t);
      ...
      public final void compute() {
         FloatFunction<? extends U> transformer;
   ...
   protected static final class ForEachTransformedMappingTask<V, U> extends BulkTask<V, Void> {
      public final FloatObjFunction<? super V, ? extends U> transformer;
      public final Consumer<? super U> action;

      public ForEachTransformedMappingTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, FloatObjFunction<? super V, ? extends U> transformer, Consumer<? super U> action) {
         super(p, b, i, f, t);
         this.transformer = transformer;
         this.action = action;
      }
      ...
      public final void compute() {
         FloatObjFunction<? super V, ? extends U> transformer;
         Consumer<? super U> action;
         if ((transformer = this.transformer) != null && (action = this.action) != null) {
            int i = this.baseIndex;
   ...
   protected static final class SearchKeysTask<V, U> extends BulkTask<V, U> {
      public final FloatFunction<? extends U> searchFunction;
      public final AtomicReference<U> result;

      public SearchKeysTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, FloatFunction<? extends U> searchFunction, AtomicReference<U> result) {
         super(p, b, i, f, t);
      ...
      public final void compute() {
         FloatFunction<? extends U> searchFunction;
   ...
   protected static final class SearchMappingsTask<V, U> extends BulkTask<V, U> {
      public final FloatObjFunction<? super V, ? extends U> searchFunction;
      public final AtomicReference<U> result;

      public SearchMappingsTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, FloatObjFunction<? super V, ? extends U> searchFunction, AtomicReference<U> result) {
         super(p, b, i, f, t);
         this.searchFunction = searchFunction;
         this.result = result;
      }
      ...
      public final void compute() {
         FloatObjFunction<? super V, ? extends U> searchFunction;
         AtomicReference<U> result;
         if ((searchFunction = this.searchFunction) != null && (result = this.result) != null) {
            int i = this.baseIndex;
   ...
   protected static final class ReduceKeysTask<V> extends FloatReturningBulkTask2<V> {
      public final float EMPTY;
      public final FloatReduceTaskOperator reducer;
      public ReduceKeysTask<V> rights;
      public ReduceKeysTask<V> nextRight;

      public ReduceKeysTask(float EMPTY, BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, ReduceKeysTask<V> nextRight, FloatReduceTaskOperator reducer) {
         super(p, b, i, f, t);
      ...
      public final void compute() {
         FloatReduceTaskOperator reducer;
   ...
   protected static final class MapReduceKeysTask<V, U> extends BulkTask<V, U> {
      ...
      public MapReduceKeysTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, MapReduceKeysTask<V, U> nextRight, FloatFunction<? extends U> transformer, BiFunction<? super U, ? super U, ? extends U> reducer) {
         super(p, b, i, f, t);
         this.nextRight = nextRight;
         this.transformer = transformer;
         this.reducer = reducer;
   ...
   protected static final class MapReduceMappingsTask<V, U> extends BulkTask<V, U> {
      ...
      public MapReduceMappingsTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, MapReduceMappingsTask<V, U> nextRight, FloatObjFunction<? super V, ? extends U> transformer, BiFunction<? super U, ? super U, ? extends U> reducer) {
         super(p, b, i, f, t);
         this.nextRight = nextRight;
         this.transformer = transformer;
         this.reducer = reducer;
   ...
   protected static final class MapReduceKeysToDoubleTask<V> extends DoubleReturningBulkTask<V> {
      public final FloatToDoubleFunction transformer;
      ...
      public MapReduceKeysToDoubleTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, MapReduceKeysToDoubleTask<V> nextRight, FloatToDoubleFunction transformer, double basis, DoubleBinaryOperator reducer) {
         super(p, b, i, f, t);
         this.nextRight = nextRight;
         this.transformer = transformer;
         this.basis = basis;
      ...
      public final void compute() {
         FloatToDoubleFunction transformer;
   ...
   protected static final class MapReduceMappingsToDoubleTask<V> extends DoubleReturningBulkTask<V> {
      public final ToDoubleFloatObjFunction<? super V> transformer;
      public final DoubleBinaryOperator reducer;
      public final double basis;
      public MapReduceMappingsToDoubleTask<V> rights;
      public MapReduceMappingsToDoubleTask<V> nextRight;

      public MapReduceMappingsToDoubleTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, MapReduceMappingsToDoubleTask<V> nextRight, ToDoubleFloatObjFunction<? super V> transformer, double basis, DoubleBinaryOperator reducer) {
         super(p, b, i, f, t);
         this.nextRight = nextRight;
         this.transformer = transformer;
         this.basis = basis;
      ...
      public final void compute() {
         ToDoubleFloatObjFunction<? super V> transformer;
         DoubleBinaryOperator reducer;
         if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
            double r = this.basis;
            int i = this.baseIndex;
   ...
   protected static final class MapReduceKeysToLongTask<V> extends LongReturningBulkTask<V> {
      public final FloatToLongFunction transformer;
      ...
      public MapReduceKeysToLongTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, MapReduceKeysToLongTask<V> nextRight, FloatToLongFunction transformer, long basis, LongBinaryOperator reducer) {
         super(p, b, i, f, t);
         this.nextRight = nextRight;
         this.transformer = transformer;
         this.basis = basis;
      ...
      public final void compute() {
         FloatToLongFunction transformer;
   ...
   protected static final class MapReduceMappingsToLongTask<V> extends LongReturningBulkTask<V> {
      public final ToLongFloatObjFunction<? super V> transformer;
      public final LongBinaryOperator reducer;
      public final long basis;
      public MapReduceMappingsToLongTask<V> rights;
      public MapReduceMappingsToLongTask<V> nextRight;

      public MapReduceMappingsToLongTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, MapReduceMappingsToLongTask<V> nextRight, ToLongFloatObjFunction<? super V> transformer, long basis, LongBinaryOperator reducer) {
         super(p, b, i, f, t);
         this.nextRight = nextRight;
         this.transformer = transformer;
         this.basis = basis;
      ...
      public final void compute() {
         ToLongFloatObjFunction<? super V> transformer;
         LongBinaryOperator reducer;
         if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
            long r = this.basis;
            int i = this.baseIndex;
   ...
   protected static final class MapReduceKeysToIntTask<V> extends IntReturningBulkTask<V> {
      public final FloatToIntFunction transformer;
      ...
      public MapReduceKeysToIntTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, MapReduceKeysToIntTask<V> nextRight, FloatToIntFunction transformer, int basis, IntBinaryOperator reducer) {
         super(p, b, i, f, t);
         this.nextRight = nextRight;
         this.transformer = transformer;
         this.basis = basis;
      ...
      public final void compute() {
         FloatToIntFunction transformer;
   ...
   protected static final class MapReduceMappingsToIntTask<V> extends IntReturningBulkTask<V> {
      public final ToIntFloatObjFunction<? super V> transformer;
      public final IntBinaryOperator reducer;
      public final int basis;
      public MapReduceMappingsToIntTask<V> rights;
      public MapReduceMappingsToIntTask<V> nextRight;

      public MapReduceMappingsToIntTask(BulkTask<V, ?> p, int b, int i, int f, Node<V>[] t, MapReduceMappingsToIntTask<V> nextRight, ToIntFloatObjFunction<? super V> transformer, int basis, IntBinaryOperator reducer) {
         super(p, b, i, f, t);
         this.nextRight = nextRight;
         this.transformer = transformer;
         this.basis = basis;
      ...
      public final void compute() {
         ToIntFloatObjFunction<? super V> transformer;
         IntBinaryOperator reducer;
         if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
            int r = this.basis;
            int i = this.baseIndex;
   ...
   @FunctionalInterface
   public interface FloatObjIntConsumer<V> {
